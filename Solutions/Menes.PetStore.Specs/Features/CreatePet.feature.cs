...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Create Pet", "\tIn order to manage the list of pets\r\n\tAs a pet shop owner\r\n\tI want to be able to" +
        ...
        public virtual void CreateANewPetWithValidData(string notes, string id, string name, string tag, string size, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create a new pet with valid data", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 9
...
#line hidden
        ...
        public virtual void AttemptToCreateANewPetWithInvalidData(string notes, string id, string name, string tag, string size, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("Tag", tag);
            argumentsOfScenario.Add("Size", size);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Attempt to create a new pet with invalid data", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 26
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
