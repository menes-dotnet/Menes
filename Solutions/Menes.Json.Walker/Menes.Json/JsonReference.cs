...
namespace Menes.Json
{
    ...
    public readonly struct JsonReference : IEquatable<JsonReference>
    {
        ...
        public string AsDecodedString()
        {
            ...
            writtenBytes = JsonPointerUtilities.DecodeHexPointer(decodedReference.Slice(0, writtenBytes), decodedReference);
            return new string(decodedReference.Slice(0, writtenBytes));
        }
