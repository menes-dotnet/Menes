...
namespace Marain.LineOfBusiness
{
    ...
    /// </summary>
    public readonly struct : IJsonObject<>, IEquatable<>
    {
    /// <summary>
    ...
    private static readonly ImmutableDictionary<string, PropertyValidator<>> __MenesLocalProperties = CreateLocalPropertyValidators();
    private readonly JsonElement jsonElementBacking;
    private readonly ImmutableDictionary<string, JsonAny>? objectBacking;
    /// <summary>
    /// Initializes a new instance of the <see cref = ""/> struct.
    /// </summary>
    /// <param name = "value">The backing <see cref = "JsonElement"/>.</param>
    public (JsonElement value) {
    this .jsonElementBacking = value ; this .objectBacking = default ; }

    /// <summary>
    /// Initializes a new instance of the <see cref = ""/> struct.
    /// </summary>
    /// <param name = "value">A property dictionary.</param>
    public (ImmutableDictionary<string, JsonAny> value) {
    this .jsonElementBacking = default ; this .objectBacking = value ; }

    /// <summary>
    /// Initializes a new instance of the <see cref = ""/> struct.
    /// </summary>
    /// <param name = "jsonObject">The <see cref = "JsonObject"/> from which to construct the value.</param>
    public (JsonObject jsonObject) { if 
    (jsonObject.HasJsonElement) {
    this .jsonElementBacking = jsonObject.AsJsonElement ; this .objectBacking = default ; } else  {
    this .jsonElementBacking = default ; this .objectBacking = jsonObject.AsPropertyDictionary ; }
}
...
public (Marain.LineOfBusiness.PagedListResource conversion)
{
...
/// {Property examples}.
/// </example>
public Marain.LineOfBusiness..EmbeddedValue Embedded
{
    get
    {
        if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
        ...
        if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
        {
            ...
            {
                return new Marain.LineOfBusiness..EmbeddedValue(result);
            }
        }
...
public static implicit operator (Marain.LineOfBusiness.PagedListResource value)
 { return 
new(value); }
/// <summary>
...
/// </summary>
/// <param name = "value">The value from which to convert.</param>
public static implicit operator (Marain.LineOfBusiness.Resource value)
 { return 
(Marain.LineOfBusiness.) value ;  }
/// <summary>
...
public static implicit operator Marain.LineOfBusiness.Resource(value)
{
    return (Marain.LineOfBusiness.)value;
}
...
/// </summary>
/// <param name = "value">The value from which to convert.</param>
public static implicit operator (JsonAny value)
 { if 
(value.HasJsonElement)
 { return 
new(value.AsJsonElement); }
return value.As<>(); }
/// <summary>
/// Conversion to any.
/// </summary>
...
/// </summary>
/// <param name = "value">The value from which to convert.</param>
public static implicit operator (JsonObject value)
 { return 
new(value); }
/// <summary>
...
/// </summary>
/// <param name = "value">The value from which to convert.</param>
public static implicit operator ImmutableDictionary<string, JsonAny>(value)
{
...
public static bool operator ==(lhs, rhs)
{
...
/// </summary>
public static Create(Marain.LineOfBusiness.PagedListResource.LinksValue links, Menes.Json.JsonString? contentType = null, Marain.LineOfBusiness..EmbeddedValue? embedded = null)
{
    ...
    if (embedded is Marain.LineOfBusiness..EmbeddedValue embedded__)
    {
...
public WithLinks(Marain.LineOfBusiness.PagedListResource.LinksValue value)
{
...
/// <param name = "value">The value to set.</param>
/// <returns>The entity with the updated property.</returns>
public WithContentType(Menes.Json.JsonString value)
{
...
/// <param name = "value">The value to set.</param>
/// <returns>The entity with the updated property.</returns>
public WithEmbedded(Marain.LineOfBusiness..EmbeddedValue value)
{
...
/// <inheritdoc/>
public SetProperty<TValue>(string name, TValue value) where TValue  : 
struct , 
...
/// <inheritdoc/>
public SetProperty<TValue>(ReadOnlySpan<char> name, TValue value) where TValue  : 
struct , 
...
/// <inheritdoc/>
public SetProperty<TValue>(ReadOnlySpan<byte> utf8name, TValue value) where TValue  : 
struct , 
...
/// <inheritdoc/>
public RemoveProperty(ReadOnlySpan<char> name)
{
    if (this.ValueKind == JsonValueKind.Object)
    {
        return this.AsObject.RemoveProperty(name);
...
/// <inheritdoc/>
public RemoveProperty(ReadOnlySpan<byte> utf8Name)
{
    if (this.ValueKind == JsonValueKind.Object)
    {
...
private static ImmutableDictionary<string, PropertyValidator<>> CreateLocalPropertyValidators()
{
    ImmutableDictionary<string, PropertyValidator<>>.Builder builder = ImmutableDictionary.CreateBuilder<string, PropertyValidator<>>();
    builder.Add(EmbeddedJsonPropertyName, __MenesValidateEmbedded);
    return builder.ToImmutable();
}

private static ValidationContext __MenesValidateEmbedded(in that, in ValidationContext validationContext, ValidationLevel level)
{
    Marain.LineOfBusiness..EmbeddedValue property = that.Embedded;
...
private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
{
    ...
    foreach (Property property in this.EnumerateObject())
    {
        ...
        if (__MenesLocalProperties.TryGetValue(propertyName, out PropertyValidator<>? propertyValidator))
        {
...
public readonly struct EmbeddedValue : IJsonObject<EmbeddedValue>, IEquatable<EmbeddedValue>
{
    ...
    /// {Property examples}.
    /// </example>
    public Marain.LineOfBusiness..PersonResourceArray Items
    {
        get
        {
            if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
            ...
            if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
            {
                ...
                {
                    return new Marain.LineOfBusiness..PersonResourceArray(result);
                }
            }
    ...
    /// </summary>
    public static EmbeddedValue Create(Marain.LineOfBusiness..PersonResourceArray? items = null)
    {
        var builder = ImmutableDictionary.CreateBuilder<string, JsonAny>();
        if (items is Marain.LineOfBusiness..PersonResourceArray items__)
        {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public EmbeddedValue WithItems(Marain.LineOfBusiness..PersonResourceArray value)
    {
    ...
    {
        Marain.LineOfBusiness..PersonResourceArray property = that.Items;
        return property.Validate(validationContext, level);
    }
