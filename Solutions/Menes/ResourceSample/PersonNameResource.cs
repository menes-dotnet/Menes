...
namespace Marain.LineOfBusiness
{
    ...
    /// </summary>
    public readonly struct PersonNameResource :
            IJsonObject<PersonNameResource>,
                    IEquatable<PersonNameResource>
    {
        ...
        public PersonNameResource(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonEncodedText, JsonAny>(PersonNameResource value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator PersonNameResource(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
            return new PersonNameResource(value);
        }
        ...
        /// </summary>
        public static PersonNameResource Create(
                   Marain.LineOfBusiness.LinksProperty links
        ...
        , Marain.LineOfBusiness.EmbeddedProperty? embedded = null
        ...
        /// <inheritdoc/>
        public PersonNameResource SetProperty<TValue>(JsonEncodedText name, TValue value)
        ...
        /// <inheritdoc/>
        public PersonNameResource RemoveProperty(JsonEncodedText name)
        {
