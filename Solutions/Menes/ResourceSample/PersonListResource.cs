...
namespace Marain.LineOfBusiness
{
    ...
    public readonly struct PersonListResource : IJsonObject<PersonListResource>, IEquatable<PersonListResource>
    {
        ...
        private static readonly ImmutableDictionary<string, Func<PersonListResource, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        private static ImmutableDictionary<string, Func<PersonListResource, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, Func<PersonListResource, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<PersonListResource, ValidationContext, ValidationLevel, ValidationContext>>();
        ...
        private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (Property property in this.EnumerateObject())
            {
                ...
                if (__MenesLocalProperties.TryGetValue(propertyName, out Func<PersonListResource, ValidationContext, ValidationLevel, ValidationContext>? propertyValidator))
                {
        ...
        public readonly struct EmbeddedValue : IJsonObject<EmbeddedValue>, IEquatable<EmbeddedValue>
        {
            ...
            private static readonly ImmutableDictionary<string, Func<EmbeddedValue, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
            private readonly JsonElement jsonElementBacking;
            private readonly ImmutableDictionary<string, JsonAny>? objectBacking;
            /// <summary>
            ...
            {
                ImmutableDictionary<string, Func<EmbeddedValue, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<EmbeddedValue, ValidationContext, ValidationLevel, ValidationContext>>();
            ...
            private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                {
                    string propertyName = property.Name;
                    if (__MenesLocalProperties.TryGetValue(propertyName, out Func<EmbeddedValue, ValidationContext, ValidationLevel, ValidationContext>? propertyValidator))
                    {
                        result = result.WithLocalProperty(propertyName);
                        var propertyResult = propertyValidator(this, result, level);
                        result = result.MergeResults(propertyResult.IsValid, level, propertyResult);
        ...
        public readonly struct PersonResourceArray : IJsonArray<PersonResourceArray>, IEquatable<PersonResourceArray>
        {
            ...
            {
                return new PersonResourceArray(items.Select(i => (JsonAny)i).ToImmutableList());
            }
