...
namespace Marain.LineOfBusiness
{
    ...
    public readonly struct PagedListResource : IJsonObject<PagedListResource>, IEquatable<PagedListResource>
    {
        ...
        private static readonly ImmutableDictionary<string, Func<PagedListResource, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        private static ImmutableDictionary<string, Func<PagedListResource, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, Func<PagedListResource, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<PagedListResource, ValidationContext, ValidationLevel, ValidationContext>>();
        ...
        private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (Property property in this.EnumerateObject())
            {
                ...
                if (__MenesLocalProperties.TryGetValue(propertyName, out Func<PagedListResource, ValidationContext, ValidationLevel, ValidationContext>? propertyValidator))
                {
        ...
        public readonly struct LinksValue : IJsonObject<LinksValue>, IEquatable<LinksValue>
        {
            ...
            private static readonly ImmutableDictionary<string, Func<LinksValue, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
            private readonly JsonElement jsonElementBacking;
            private readonly ImmutableDictionary<string, JsonAny>? objectBacking;
            /// <summary>
            ...
            {
                ImmutableDictionary<string, Func<LinksValue, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<LinksValue, ValidationContext, ValidationLevel, ValidationContext>>();
                builder.Add(ItemsJsonPropertyName, (that, validationContext, level) =>
                {
                    Marain.LineOfBusiness.LinkArray property = that.Items;
                    return property.Validate(validationContext, level);
                });
                builder.Add(NextJsonPropertyName, (that, validationContext, level) =>
                {
                    Marain.LineOfBusiness.Link property = that.Next;
                    return property.Validate(validationContext, level);
                });
                builder.Add(PrevJsonPropertyName, (that, validationContext, level) =>
                {
            ...
            private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                {
                    string propertyName = property.Name;
                    if (__MenesLocalProperties.TryGetValue(propertyName, out Func<LinksValue, ValidationContext, ValidationLevel, ValidationContext>? propertyValidator))
                    {
                        result = result.WithLocalProperty(propertyName);
                        var propertyResult = propertyValidator(this, result, level);
                        result = result.MergeResults(propertyResult.IsValid, level, propertyResult);
