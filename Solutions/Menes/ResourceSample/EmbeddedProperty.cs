...
namespace Marain.LineOfBusiness
{
    ...
    /// </summary>
    public readonly struct EmbeddedProperty : IJsonObject<EmbeddedProperty>, IEquatable<EmbeddedProperty>
    {
        ...
        public EmbeddedProperty(JsonElement value)
        {
        ...
        public EmbeddedProperty(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
        ...
        public EmbeddedProperty(JsonObject jsonObject)
        {
        ...
        public static implicit operator EmbeddedProperty(JsonAny value)
        {
            ...
            {
                return new EmbeddedProperty(value.AsJsonElement);
            }

            return value.As<EmbeddedProperty>();
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator JsonAny(EmbeddedProperty value)
        {
            return value.AsAny;
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EmbeddedProperty(JsonObject value)
        {
            return new EmbeddedProperty(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator JsonObject(EmbeddedProperty value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonEncodedText, JsonAny>(EmbeddedProperty value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EmbeddedProperty(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
            return new EmbeddedProperty(value);
        }
        ...
        /// <inheritdoc/>
        public EmbeddedProperty SetProperty<TValue>(JsonEncodedText name, TValue value)
        ...
        /// <inheritdoc/>
        public EmbeddedProperty SetProperty<TValue>(string name, TValue value)
            where TValue : IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Object || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public EmbeddedProperty SetProperty<TValue>(ReadOnlySpan<char> name, TValue value)
            where TValue : IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Object || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public EmbeddedProperty SetProperty<TValue>(ReadOnlySpan<byte> utf8name, TValue value)
            where TValue : IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Object || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public EmbeddedProperty RemoveProperty(JsonEncodedText name)
        {
        ...
        /// <inheritdoc/>
        public EmbeddedProperty RemoveProperty(string name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
                return this.AsObject.RemoveProperty(name);
        ...
        /// <inheritdoc/>
        public EmbeddedProperty RemoveProperty(ReadOnlySpan<char> name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
                return this.AsObject.RemoveProperty(name);
        ...
        /// <inheritdoc/>
        public EmbeddedProperty RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
        ...
        public T As<T>()
            where T : struct, IJsonValue
        {
            return this.As<EmbeddedProperty, T>();
        }
