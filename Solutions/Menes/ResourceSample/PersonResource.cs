...
namespace Marain.LineOfBusiness
{
    ...
    public readonly struct PersonResource : IJsonObject<PersonResource>, IEquatable<PersonResource>
    {
        ...
        {
            ImmutableDictionary<JsonEncodedText, Func<PersonResource, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<PersonResource, ValidationContext, ValidationLevel, ValidationContext>>();
        ...
        public readonly struct LinksValue : IJsonObject<LinksValue>, IEquatable<LinksValue>
        {
            ...
            {
                ImmutableDictionary<JsonEncodedText, Func<LinksValue, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<LinksValue, ValidationContext, ValidationLevel, ValidationContext>>();
                builder.Add(PrimaryNameJsonPropertyName, (that, validationContext, level) =>
                {
                    Link property = that.PrimaryName;
                    return property.Validate(validationContext, level);
                });
                builder.Add(NamesJsonPropertyName, (that, validationContext, level) =>
                {
                    LinkArray property = that.Names;
                    return property.Validate(validationContext, level);
                });
                builder.Add(AddressesJsonPropertyName, (that, validationContext, level) =>
                {
                    LinkArray property = that.Addresses;
                    return property.Validate(validationContext, level);
                });
                builder.Add(TelephoneNumbersJsonPropertyName, (that, validationContext, level) =>
                {
                    LinkArray property = that.TelephoneNumbers;
                    return property.Validate(validationContext, level);
                });
                builder.Add(EmailAddressesJsonPropertyName, (that, validationContext, level) =>
                {
        ...
        public readonly struct EmbeddedValue : IJsonObject<EmbeddedValue>, IEquatable<EmbeddedValue>
        {
            ...
            {
                ImmutableDictionary<JsonEncodedText, Func<EmbeddedValue, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<EmbeddedValue, ValidationContext, ValidationLevel, ValidationContext>>();
                builder.Add(PrimaryNameJsonPropertyName, (that, validationContext, level) =>
                {
