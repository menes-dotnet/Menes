...
namespace Marain.LineOfBusiness
{
    ...
    /// </summary>
    public readonly struct PersonResource :
            IJsonObject<PersonResource>,
                    IEquatable<PersonResource>
    {
        ...
        public static readonly JsonEncodedText EmbeddedJsonPropertyName = JsonEncodedText.Encode( EmbeddedUtf8JsonPropertyName.Span);
            ...
            private static readonly ImmutableDictionary<JsonEncodedText, Func<PersonResource, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        public PersonResource(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonEncodedText, JsonAny>(PersonResource  value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator PersonResource (ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
            return new PersonResource (value);
        }
        ...
        /// </summary>
        public static PersonResource Create(
                            Marain.LineOfBusiness.PersonResource.LinksValue? links = null
        ,             Menes.Json.JsonString? contentType = null
        ,             Marain.LineOfBusiness.PersonResource.EmbeddedValue? embedded = null
                )
        {
        ...
        /// <inheritdoc/>
        public PersonResource SetProperty<TValue>(JsonEncodedText name, TValue value)
        ...
        /// <inheritdoc/>
        public PersonResource RemoveProperty(JsonEncodedText name)
        {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<PersonResource, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<PersonResource, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<PersonResource, ValidationContext, ValidationLevel, ValidationContext>>();

                    builder.Add(
                LinksJsonPropertyName,
                (that, validationContext, level) =>
                {
                    LinksValue property = that.Links;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                EmbeddedJsonPropertyName,
                (that, validationContext, level) =>
                {
                    EmbeddedValue property = that.Embedded;
                    return property.Validate(validationContext, level);
                });
            ...
            private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (Property property in this.EnumerateObject())
            {
                JsonEncodedText propertyName = property.NameAsJsonEncodedText;
                        ...
                        if (__MenesLocalProperties.TryGetValue(propertyName, out Func<PersonResource, ValidationContext, ValidationLevel, ValidationContext>? propertyValidator))
                {
    ...
    /// A type generated from a JsonSchema specification.
    /// </summary>
    public readonly struct LinksValue :
            IJsonObject<LinksValue>,
                    IEquatable<LinksValue>
    {
        ...
        /// JSON property name for <see cref="PrimaryName"/>.
        /// </summary>
        public static readonly JsonEncodedText PrimaryNameJsonPropertyName = JsonEncodedText.Encode( PrimaryNameUtf8JsonPropertyName.Span);
        ...
        /// JSON property name for <see cref="Self"/>.
        /// </summary>
        public static readonly JsonEncodedText SelfJsonPropertyName = JsonEncodedText.Encode( SelfUtf8JsonPropertyName.Span);
        ...
        /// JSON property name for <see cref="Names"/>.
        /// </summary>
        public static readonly JsonEncodedText NamesJsonPropertyName = JsonEncodedText.Encode( NamesUtf8JsonPropertyName.Span);
        ...
        /// JSON property name for <see cref="Addresses"/>.
        /// </summary>
        public static readonly JsonEncodedText AddressesJsonPropertyName = JsonEncodedText.Encode( AddressesUtf8JsonPropertyName.Span);
        ...
        /// JSON property name for <see cref="TelephoneNumbers"/>.
        /// </summary>
        public static readonly JsonEncodedText TelephoneNumbersJsonPropertyName = JsonEncodedText.Encode( TelephoneNumbersUtf8JsonPropertyName.Span);
        ...
        /// JSON property name for <see cref="EmailAddresses"/>.
        /// </summary>
        public static readonly JsonEncodedText EmailAddressesJsonPropertyName = JsonEncodedText.Encode( EmailAddressesUtf8JsonPropertyName.Span);
            ...
            private static readonly ImmutableDictionary<JsonEncodedText, Func<LinksValue, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        /// </summary>
        public static LinksValue Create(
                   Marain.LineOfBusiness.Link primaryName
        ,            Marain.LineOfBusiness.Link self
                ,             Marain.LineOfBusiness.LinkArray? names = null
        ,             Marain.LineOfBusiness.LinkArray? addresses = null
        ,             Marain.LineOfBusiness.LinkArray? telephoneNumbers = null
        ,             Marain.LineOfBusiness.LinkArray? emailAddresses = null
                )
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, JsonAny>();
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<LinksValue, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<LinksValue, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<LinksValue, ValidationContext, ValidationLevel, ValidationContext>>();

                    builder.Add(
                PrimaryNameJsonPropertyName,
                (that, validationContext, level) =>
                {
                    Link property = that.PrimaryName;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                NamesJsonPropertyName,
                (that, validationContext, level) =>
                {
                    LinkArray property = that.Names;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                AddressesJsonPropertyName,
                (that, validationContext, level) =>
                {
                    LinkArray property = that.Addresses;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                TelephoneNumbersJsonPropertyName,
                (that, validationContext, level) =>
                {
                    LinkArray property = that.TelephoneNumbers;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                EmailAddressesJsonPropertyName,
                (that, validationContext, level) =>
                {
                    LinkArray property = that.EmailAddresses;
                    return property.Validate(validationContext, level);
                });
    ...
    /// A type generated from a JsonSchema specification.
    /// </summary>
    public readonly struct EmbeddedValue :
            IJsonObject<EmbeddedValue>,
                    IEquatable<EmbeddedValue>
    {
        ...
        public static readonly JsonEncodedText PrimaryNameJsonPropertyName = JsonEncodedText.Encode( PrimaryNameUtf8JsonPropertyName.Span);
            ...
            private static readonly ImmutableDictionary<JsonEncodedText, Func<EmbeddedValue, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        /// </summary>
        /// <param name="value">A property dictionary.</param>
        public EmbeddedValue(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.objectBacking = value;
                                        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonEncodedText, JsonAny>(EmbeddedValue  value)
        {
            return value.AsObject.AsPropertyDictionary;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator EmbeddedValue (ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
            return new EmbeddedValue (value);
        }
        ...
        /// </summary>
        public static EmbeddedValue Create(
                   Marain.LineOfBusiness.PersonNameResource primaryName
                        )
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, JsonAny>();
                    builder.Add(PrimaryNameJsonPropertyName, primaryName);
        ...
        /// <inheritdoc/>
        public EmbeddedValue SetProperty<TValue>(JsonEncodedText name, TValue value)
            where TValue : IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Object || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public EmbeddedValue RemoveProperty(JsonEncodedText name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
                return this.AsObject.RemoveProperty(name);
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<EmbeddedValue, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<EmbeddedValue, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<EmbeddedValue, ValidationContext, ValidationLevel, ValidationContext>>();

                    builder.Add(
                PrimaryNameJsonPropertyName,
                (that, validationContext, level) =>
                {
                    PersonNameResource property = that.PrimaryName;
                    return property.Validate(validationContext, level);
                });
