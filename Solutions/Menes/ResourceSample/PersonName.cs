...
namespace Marain.LineOfBusiness
{
    ...
    public readonly struct PersonName :
            IJsonObject<PersonName>,
                    IEquatable<PersonName>
    {
        ...
        /// JSON property name for <see cref="GivenName"/>.
        /// </summary>
        public static readonly JsonEncodedText GivenNameJsonPropertyName = JsonEncodedText.Encode( GivenNameUtf8JsonPropertyName.Span);
        ...
        /// JSON property name for <see cref="FamilyName"/>.
        /// </summary>
        public static readonly JsonEncodedText FamilyNameJsonPropertyName = JsonEncodedText.Encode( FamilyNameUtf8JsonPropertyName.Span);
        ...
        /// JSON property name for <see cref="OtherNames"/>.
        /// </summary>
        public static readonly JsonEncodedText OtherNamesJsonPropertyName = JsonEncodedText.Encode( OtherNamesUtf8JsonPropertyName.Span);
        ...
        /// JSON property name for <see cref="Suffix"/>.
        /// </summary>
        public static readonly JsonEncodedText SuffixJsonPropertyName = JsonEncodedText.Encode( SuffixUtf8JsonPropertyName.Span);
            ...
            private static readonly ImmutableDictionary<JsonEncodedText, Func<PersonName, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        public PersonName(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonEncodedText, JsonAny>(PersonName  value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator PersonName (ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
            return new PersonName (value);
        }
        ...
        public static PersonName Create(
                   Marain.LineOfBusiness.PersonName.GivenNameValue givenName
        ,            Marain.LineOfBusiness.PersonName.FamilyNameValue familyName
        ,            Marain.LineOfBusiness.PersonName.OtherNamesValueArray otherNames
                ,             Marain.LineOfBusiness.PersonName.TitleValue? title = null
        ,             Menes.Json.JsonString? suffix = null
                )
        {
        ...
        /// <inheritdoc/>
        public PersonName SetProperty<TValue>(JsonEncodedText name, TValue value)
        ...
        /// <inheritdoc/>
        public PersonName RemoveProperty(JsonEncodedText name)
        {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<PersonName, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<PersonName, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<PersonName, ValidationContext, ValidationLevel, ValidationContext>>();

                    builder.Add(
                GivenNameJsonPropertyName,
                (that, validationContext, level) =>
                {
                    GivenNameValue property = that.GivenName;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                FamilyNameJsonPropertyName,
                (that, validationContext, level) =>
                {
                    FamilyNameValue property = that.FamilyName;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                OtherNamesJsonPropertyName,
                (that, validationContext, level) =>
                {
                    OtherNamesValueArray property = that.OtherNames;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    TitleValue property = that.Title;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                SuffixJsonPropertyName,
                (that, validationContext, level) =>
                {
                    JsonString property = that.Suffix;
                    return property.Validate(validationContext, level);
                });
            ...
            private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (Property property in this.EnumerateObject())
            {
                JsonEncodedText propertyName = property.NameAsJsonEncodedText;
                        ...
                        if (__MenesLocalProperties.TryGetValue(propertyName, out Func<PersonName, ValidationContext, ValidationLevel, ValidationContext>? propertyValidator))
                {
                ...
                if (OtherNamesJsonPropertyName.Equals(propertyName))
                {
            ...
            IEquatable<TitleValue>
    {
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public TitleValue(JsonEncodedText value)
        {
            this.jsonElementBacking = default;
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator TitleValue(JsonEncodedText value)
        {
            return new TitleValue(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(TitleValue value)
        {
    ...
    /// A type generated from a JsonSchema specification.
    /// </summary>
    public readonly struct GivenNameValue :
                    IJsonValue,
            IEquatable<GivenNameValue>
    {
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public GivenNameValue(JsonEncodedText value)
        {
            this.jsonElementBacking = default;
                                            this.stringBacking = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator GivenNameValue(JsonEncodedText value)
        {
            return new GivenNameValue(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(GivenNameValue value)
        {
            return value.AsString.GetJsonEncodedText();
        }
    ...
    /// A type generated from a JsonSchema specification.
    /// </summary>
    public readonly struct FamilyNameValue :
                    IJsonValue,
            IEquatable<FamilyNameValue>
    {
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public FamilyNameValue(JsonEncodedText value)
        {
            this.jsonElementBacking = default;
                                            this.stringBacking = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator FamilyNameValue(JsonEncodedText value)
        {
            return new FamilyNameValue(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(FamilyNameValue value)
        {
            return value.AsString.GetJsonEncodedText();
        }
    ...
    /// A type generated from a JsonSchema specification.
    /// </summary>
    public readonly struct OtherNamesValueArray :
                IJsonArray<OtherNamesValueArray>,
                IEquatable<OtherNamesValueArray>
    {
        ...
        {
            return new OtherNamesValueArray(items.Select(i => (JsonAny)i).ToImmutableList());
        }
    ...
    /// A type generated from a JsonSchema specification.
    /// </summary>
    public readonly struct OtherNamesValue :
                    IJsonValue,
            IEquatable<OtherNamesValue>
    {
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public OtherNamesValue(JsonEncodedText value)
        {
            this.jsonElementBacking = default;
                                            this.stringBacking = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OtherNamesValue(JsonEncodedText value)
        {
            return new OtherNamesValue(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(OtherNamesValue value)
        {
            return value.AsString.GetJsonEncodedText();
        }
