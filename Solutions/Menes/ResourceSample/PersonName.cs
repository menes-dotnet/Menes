...
namespace Marain.LineOfBusiness
{
    ...
    public readonly struct PersonName : IJsonObject<PersonName>, IEquatable<PersonName>
    {
        ...
        private static readonly ImmutableDictionary<string, Func<PersonName, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        {
            ImmutableDictionary<string, Func<PersonName, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<PersonName, ValidationContext, ValidationLevel, ValidationContext>>();
        ...
        public readonly struct GivenNameValue : IJsonValue, IEquatable<GivenNameValue>
        {
            ...
            public override bool Equals(object? obj)
            {
                if (obj is GivenNameValue entity)
                {
                    return this.Equals(entity);
                }
        ...
        public readonly struct FamilyNameValue : IJsonValue, IEquatable<FamilyNameValue>
        {
            ...
            public override bool Equals(object? obj)
            {
                if (obj is FamilyNameValue entity)
                {
                    return this.Equals(entity);
                }
        ...
        public readonly struct OtherNamesValueArray : IJsonArray<OtherNamesValueArray>, IEquatable<OtherNamesValueArray>
        {
            ...
            public override bool Equals(object? obj)
            {
                if (obj is OtherNamesValueArray entity)
                {
                    return this.Equals(entity);
                }
        ...
        public readonly struct OtherNamesValue : IJsonValue, IEquatable<OtherNamesValue>
        {
            ...
            public override bool Equals(object? obj)
            {
                if (obj is OtherNamesValue entity)
                {
                    return this.Equals(entity);
                }
