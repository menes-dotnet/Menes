...
namespace Marain.LineOfBusiness
{
    ...
    public readonly struct PersonName : IJsonObject<PersonName>, IEquatable<PersonName>
    {
        ...
        {
            ImmutableDictionary<JsonEncodedText, Func<PersonName, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<PersonName, ValidationContext, ValidationLevel, ValidationContext>>();
            builder.Add(GivenNameJsonPropertyName, (that, validationContext, level) =>
            {
                GivenNameValue property = that.GivenName;
                return property.Validate(validationContext, level);
            });
            builder.Add(FamilyNameJsonPropertyName, (that, validationContext, level) =>
            {
                FamilyNameValue property = that.FamilyName;
                return property.Validate(validationContext, level);
            });
            builder.Add(OtherNamesJsonPropertyName, (that, validationContext, level) =>
            {
            ...
            builder.Add(SuffixJsonPropertyName, (that, validationContext, level) =>
            {
