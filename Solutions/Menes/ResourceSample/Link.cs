...
namespace Marain.LineOfBusiness
{
    ...
    public readonly struct Link : IJsonObject<Link>, IEquatable<Link>
    {
        ...
        {
            ImmutableDictionary<JsonEncodedText, Func<Link, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<Link, ValidationContext, ValidationLevel, ValidationContext>>();
