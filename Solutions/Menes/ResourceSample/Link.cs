...
namespace Marain.LineOfBusiness
{
    ...
    public readonly struct Link : IJsonObject<Link>, IEquatable<Link>
    {
        ...
        private static readonly ImmutableDictionary<string, PropertyValidator<Link>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        private static ImmutableDictionary<string, PropertyValidator<Link>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, PropertyValidator<Link>>.Builder builder = ImmutableDictionary.CreateBuilder<string, PropertyValidator<Link>>();
            builder.Add(HrefJsonPropertyName, __MenesValidateHref);
            builder.Add(TemplatedJsonPropertyName, __MenesValidateTemplated);
            builder.Add(TypeJsonPropertyName, __MenesValidateType);
            builder.Add(NameJsonPropertyName, __MenesValidateName);
            builder.Add(ProfileJsonPropertyName, __MenesValidateProfile);
            builder.Add(DescriptionJsonPropertyName, __MenesValidateDescription);
            builder.Add(HreflangJsonPropertyName, __MenesValidateHreflang);
            return builder.ToImmutable();
        }

        private static ValidationContext __MenesValidateHref(in Link that, in ValidationContext validationContext, ValidationLevel level)
        {
            Menes.Json.JsonString property = that.Href;
            return property.Validate(validationContext, level);
        }

        private static ValidationContext __MenesValidateTemplated(in Link that, in ValidationContext validationContext, ValidationLevel level)
        {
            Marain.LineOfBusiness.Link.TemplatedValue property = that.Templated;
            return property.Validate(validationContext, level);
        }

        private static ValidationContext __MenesValidateType(in Link that, in ValidationContext validationContext, ValidationLevel level)
        {
            Marain.LineOfBusiness.Link.TypeValue property = that.Type;
            return property.Validate(validationContext, level);
        }

        private static ValidationContext __MenesValidateName(in Link that, in ValidationContext validationContext, ValidationLevel level)
        {
            Menes.Json.JsonString property = that.Name;
            return property.Validate(validationContext, level);
        }

        private static ValidationContext __MenesValidateProfile(in Link that, in ValidationContext validationContext, ValidationLevel level)
        {
            Menes.Json.JsonUri property = that.Profile;
            return property.Validate(validationContext, level);
        }

        private static ValidationContext __MenesValidateDescription(in Link that, in ValidationContext validationContext, ValidationLevel level)
        {
            Menes.Json.JsonString property = that.Description;
            return property.Validate(validationContext, level);
        }

        private static ValidationContext __MenesValidateHreflang(in Link that, in ValidationContext validationContext, ValidationLevel level)
        {
        ...
        private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (Property property in this.EnumerateObject())
            {
                ...
                if (__MenesLocalProperties.TryGetValue(propertyName, out PropertyValidator<Link>? propertyValidator))
                {
