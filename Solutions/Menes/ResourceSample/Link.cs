...
namespace Marain.LineOfBusiness
{
                    ...
                    IEquatable<Link>
    {
        ...
        /// JSON property name for <see cref="Href"/>.
        /// </summary>
        public static readonly JsonEncodedText HrefJsonPropertyName = JsonEncodedText.Encode(HrefUtf8JsonPropertyName.Span);
        ...
        /// JSON property name for <see cref="Templated"/>.
        /// </summary>
        public static readonly JsonEncodedText TemplatedJsonPropertyName = JsonEncodedText.Encode(TemplatedUtf8JsonPropertyName.Span);
        ...
        /// JSON property name for <see cref="Profile"/>.
        /// </summary>
        public static readonly JsonEncodedText ProfileJsonPropertyName = JsonEncodedText.Encode(ProfileUtf8JsonPropertyName.Span);
        ...
        /// JSON property name for <see cref="Hreflang"/>.
        /// </summary>
        public static readonly JsonEncodedText HreflangJsonPropertyName = JsonEncodedText.Encode(HreflangUtf8JsonPropertyName.Span);
        ...
        private static readonly ImmutableDictionary<JsonEncodedText, Func<Link, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        public Link(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonEncodedText, JsonAny>(Link value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Link(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
            return new Link(value);
        }
        ...
        public static Link Create(
                   Menes.Json.JsonString href
                , Marain.LineOfBusiness.Link.TemplatedValue? templated = null
        , Marain.LineOfBusiness.Link.TypeValue? type = null
        , Menes.Json.JsonString? name = null
        , Menes.Json.JsonUri? profile = null
        , Menes.Json.JsonString? description = null
        , Marain.LineOfBusiness.Link.HreflangValue? hreflang = null
                )
        {
        ...
        /// <inheritdoc/>
        public Link SetProperty<TValue>(JsonEncodedText name, TValue value)
        ...
        /// <inheritdoc/>
        public Link RemoveProperty(JsonEncodedText name)
        {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<Link, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<Link, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<Link, ValidationContext, ValidationLevel, ValidationContext>>();

            builder.Add(
        HrefJsonPropertyName,
        (that, validationContext, level) =>
        {
            JsonString property = that.Href;
            return property.Validate(validationContext, level);
        });
            builder.Add(
        TemplatedJsonPropertyName,
        (that, validationContext, level) =>
        {
            TemplatedValue property = that.Templated;
            return property.Validate(validationContext, level);
        });
            builder.Add(
        ...
        (that, validationContext, level) =>
        {
            JsonString property = that.Name;
            return property.Validate(validationContext, level);
        });
            builder.Add(
        ProfileJsonPropertyName,
        (that, validationContext, level) =>
        {
            JsonUri property = that.Profile;
            return property.Validate(validationContext, level);
        });
            builder.Add(
        ...
        (that, validationContext, level) =>
        {
            ...
            builder.Add(
        HreflangJsonPropertyName,
        (that, validationContext, level) =>
        {
            HreflangValue property = that.Hreflang;
            return property.Validate(validationContext, level);
        });
        ...
        private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            if (!foundHref
            && !HasDefault(HrefJsonPropertyName)
            )
            {
        ...
        /// A type generated from a JsonSchema specification.
        /// </summary>
        public readonly struct TemplatedValue :
                        IJsonValue,
                IEquatable<TemplatedValue>
        {
                ...
                IEquatable<TypeValue>
        {
            ...
            /// </summary>
            /// <param name="value">A string value.</param>
            public TypeValue(JsonEncodedText value)
            {
                this.jsonElementBacking = default;
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator TypeValue(JsonEncodedText value)
            {
                return new TypeValue(value);
            }
            ...
            /// </summary>
            /// <param name="value">The number from which to convert.</param>
            public static implicit operator JsonEncodedText(TypeValue value)
            {
        ...
        /// A type generated from a JsonSchema specification.
        /// </summary>
        public readonly struct HreflangValue :
                        IJsonValue,
                IEquatable<HreflangValue>
        {
            ...
            /// </summary>
            /// <param name="value">A string value.</param>
            public HreflangValue(JsonEncodedText value)
            {
                this.jsonElementBacking = default;
                this.stringBacking = value;
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator HreflangValue(JsonEncodedText value)
            {
                return new HreflangValue(value);
            }
            ...
            /// </summary>
            /// <param name="value">The number from which to convert.</param>
            public static implicit operator JsonEncodedText(HreflangValue value)
            {
                return value.AsString.GetJsonEncodedText();
            }
