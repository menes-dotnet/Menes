...
namespace Marain.LineOfBusiness
{
    ...
    public readonly struct Resource : IJsonObject<Resource>, IEquatable<Resource>
    {
        ...
        private static readonly ImmutableDictionary<string, PropertyValidator<Resource>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        private static ImmutableDictionary<string, PropertyValidator<Resource>> CreateLocalPropertyValidators()
        {
            ...
            builder.Add(ContentTypeJsonPropertyName, __MenesValidateContentType);
            builder.Add(EmbeddedJsonPropertyName, __MenesValidateEmbedded);
            return builder.ToImmutable();
        }

        private static ValidationContext __MenesValidateLinks(in Resource that, in ValidationContext validationContext, ValidationLevel level)
        {
            Marain.LineOfBusiness.LinksProperty property = that.Links;
            return property.Validate(validationContext, level);
        }

        private static ValidationContext __MenesValidateContentType(in Resource that, in ValidationContext validationContext, ValidationLevel level)
        {
            Menes.Json.JsonString property = that.ContentType;
            return property.Validate(validationContext, level);
        }

        private static ValidationContext __MenesValidateEmbedded(in Resource that, in ValidationContext validationContext, ValidationLevel level)
        {
        ...
        private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (Property property in this.EnumerateObject())
            {
                ...
                if (__MenesLocalProperties.TryGetValue(propertyName, out PropertyValidator<Resource>? propertyValidator))
                {
