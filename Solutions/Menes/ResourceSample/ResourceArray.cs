...
namespace Marain.LineOfBusiness
{
    ...
    /// </summary>
    public readonly struct ResourceArray : IJsonArray<ResourceArray>, IEquatable<ResourceArray>
    {
        ...
        public ResourceArray(JsonElement value)
        {
        ...
        public ResourceArray(JsonArray jsonArray)
        {
        ...
        public static implicit operator ResourceArray(JsonAny value)
        {
            ...
            {
                return new ResourceArray(value.AsJsonElement);
            }

            return value.As<ResourceArray>();
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator JsonAny(ResourceArray value)
        {
            return value.AsAny;
        }
        ...
        {
            return new ResourceArray(value);
        }
        ...
        public static bool operator ==(ResourceArray lhs, ResourceArray rhs)
        {
        ...
        public static ResourceArray From(params Marain.LineOfBusiness.Resource[] items)
        {
            return new ResourceArray(items.Select(i => (JsonAny)i).ToImmutableList());
        }
        ...
        /// <returns>The new array created from the items.</returns>
        public static ResourceArray From(Marain.LineOfBusiness.Resource item1)
        {
            return new ResourceArray(ImmutableList.Create((JsonAny)item1));
        }
        ...
        /// <returns>The new array created from the items.</returns>
        public static ResourceArray From(Marain.LineOfBusiness.Resource item1, Marain.LineOfBusiness.Resource item2)
        {
            return new ResourceArray(ImmutableList.Create((JsonAny)item1, (JsonAny)item2));
        }
        ...
        /// <returns>The new array created from the items.</returns>
        public static ResourceArray From(Marain.LineOfBusiness.Resource item1, Marain.LineOfBusiness.Resource item2, Marain.LineOfBusiness.Resource item3)
        {
            return new ResourceArray(ImmutableList.Create((JsonAny)item1, (JsonAny)item2, (JsonAny)item3));
        }
        ...
        /// <returns>The new array created from the items.</returns>
        public static ResourceArray From(Marain.LineOfBusiness.Resource item1, Marain.LineOfBusiness.Resource item2, Marain.LineOfBusiness.Resource item3, Marain.LineOfBusiness.Resource item4)
        {
            return new ResourceArray(ImmutableList.Create((JsonAny)item1, (JsonAny)item2, (JsonAny)item3, (JsonAny)item4));
        }

        /// <inheritdoc/>
        public override bool Equals(object? obj)
        {
            if (obj is ResourceArray entity)
            {
        ...
        /// <summary>
        /// Enumerate the items in the array as a <see cref = "Marain.LineOfBusiness.Resource"/>.
        /// </summary>
        public JsonArrayEnumerator<Marain.LineOfBusiness.Resource> EnumerateItems()
        {
            if (this.arrayBacking is ImmutableList<JsonAny> items)
            {
                return new JsonArrayEnumerator<Marain.LineOfBusiness.Resource>(items);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
            {
                return new JsonArrayEnumerator<Marain.LineOfBusiness.Resource>(this.jsonElementBacking);
            }
        ...
        /// <inheritdoc/>
        public ResourceArray Add<TItem>(TItem item)
        ...
        /// <inheritdoc/>
        public ResourceArray Insert<TItem>(int index, TItem item)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public ResourceArray Replace<TItem>(TItem oldValue, TItem newValue)
            where TItem : struct, IJsonValue
        {
        ...
        /// <inheritdoc/>
        public ResourceArray SetItem<TItem>(int index, TItem value)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array)
            {
        ...
        public T As<T>()
            where T : struct, IJsonValue
        {
            return this.As<ResourceArray, T>();
        }
        ...
        private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            {
                result = arrayEnumerator.Current.As<Marain.LineOfBusiness.Resource>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
