...
namespace Marain.LineOfBusiness
{
    ...
    /// </summary>
    public readonly struct LinkArray : IJsonArray<LinkArray>, IEquatable<LinkArray>
    {
        ...
        public LinkArray(JsonElement value)
        {
        ...
        public LinkArray(JsonArray jsonArray)
        {
        ...
        public static implicit operator LinkArray(JsonAny value)
        {
            ...
            {
                return new LinkArray(value.AsJsonElement);
            }

            return value.As<LinkArray>();
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator JsonAny(LinkArray value)
        {
            return value.AsAny;
        }
        ...
        public static bool operator ==(LinkArray lhs, LinkArray rhs)
        {
        ...
        public static LinkArray From(params Marain.LineOfBusiness.Link[] items)
        {
            return new LinkArray(items.Select(i => (JsonAny)i).ToImmutableList());
        }
        ...
        /// <returns>The new array created from the items.</returns>
        public static LinkArray From(Marain.LineOfBusiness.Link item1)
        {
            return new LinkArray(ImmutableList.Create((JsonAny)item1));
        }
        ...
        /// <returns>The new array created from the items.</returns>
        public static LinkArray From(Marain.LineOfBusiness.Link item1, Marain.LineOfBusiness.Link item2)
        {
            return new LinkArray(ImmutableList.Create((JsonAny)item1, (JsonAny)item2));
        }
        ...
        /// <returns>The new array created from the items.</returns>
        public static LinkArray From(Marain.LineOfBusiness.Link item1, Marain.LineOfBusiness.Link item2, Marain.LineOfBusiness.Link item3)
        {
            return new LinkArray(ImmutableList.Create((JsonAny)item1, (JsonAny)item2, (JsonAny)item3));
        }
        ...
        /// <returns>The new array created from the items.</returns>
        public static LinkArray From(Marain.LineOfBusiness.Link item1, Marain.LineOfBusiness.Link item2, Marain.LineOfBusiness.Link item3, Marain.LineOfBusiness.Link item4)
        {
            return new LinkArray(ImmutableList.Create((JsonAny)item1, (JsonAny)item2, (JsonAny)item3, (JsonAny)item4));
        }

        /// <inheritdoc/>
        public override bool Equals(object? obj)
        {
            if (obj is LinkArray entity)
            {
        ...
        /// <summary>
        /// Enumerate the items in the array as a <see cref = "Marain.LineOfBusiness.Link"/>.
        /// </summary>
        public JsonArrayEnumerator<Marain.LineOfBusiness.Link> EnumerateItems()
        {
            if (this.arrayBacking is ImmutableList<JsonAny> items)
            {
                return new JsonArrayEnumerator<Marain.LineOfBusiness.Link>(items);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
            {
                return new JsonArrayEnumerator<Marain.LineOfBusiness.Link>(this.jsonElementBacking);
            }
        ...
        /// <inheritdoc/>
        public LinkArray Add<TItem>(TItem item)
        ...
        /// <inheritdoc/>
        public LinkArray Insert<TItem>(int index, TItem item)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public LinkArray Replace<TItem>(TItem oldValue, TItem newValue)
            where TItem : struct, IJsonValue
        {
        ...
        /// <inheritdoc/>
        public LinkArray SetItem<TItem>(int index, TItem value)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array)
            {
        ...
        private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            {
                result = arrayEnumerator.Current.As<Marain.LineOfBusiness.Link>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
