...
namespace Marain.LineOfBusiness
{
    ...
    public readonly struct LinksProperty : IJsonObject<LinksProperty>, IEquatable<LinksProperty>
    {
        ...
        {
            ImmutableDictionary<JsonEncodedText, Func<LinksProperty, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<LinksProperty, ValidationContext, ValidationLevel, ValidationContext>>();
