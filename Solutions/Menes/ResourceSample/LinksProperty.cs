...
namespace Marain.LineOfBusiness
{
    ...
    /// </summary>
    public readonly struct LinksProperty :
            IJsonObject<LinksProperty>,
                    IEquatable<LinksProperty>
    {
        ...
        public static readonly JsonEncodedText SelfJsonPropertyName = JsonEncodedText.Encode( SelfUtf8JsonPropertyName.Span);
            ...
            private static readonly ImmutableDictionary<JsonEncodedText, Func<LinksProperty, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        public LinksProperty(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonEncodedText, JsonAny>(LinksProperty  value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator LinksProperty (ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
            return new LinksProperty (value);
        }
        ...
        /// </summary>
        public static LinksProperty Create(
        ...
        /// <inheritdoc/>
        public LinksProperty SetProperty<TValue>(JsonEncodedText name, TValue value)
        ...
        /// <inheritdoc/>
        public LinksProperty RemoveProperty(JsonEncodedText name)
        {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<LinksProperty, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<LinksProperty, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<LinksProperty, ValidationContext, ValidationLevel, ValidationContext>>();

                    builder.Add(
                SelfJsonPropertyName,
                (that, validationContext, level) =>
                {
                    Link property = that.Self;
