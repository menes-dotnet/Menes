// <copyright file="unevaluatedProperties004.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.UnevaluatedProperties004
{
public readonly struct TestSchema : Menes.IJsonObject, System.IEquatable<TestSchema>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
{
    ...
    private static readonly System.Text.RegularExpressions.Regex PatternPropertyRegex0 = new System.Text.RegularExpressions.Regex("^foo", System.Text.RegularExpressions.RegexOptions.Compiled);
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        if (this.HasJsonElement)
        {
            ...
            while (unevaluatedPropertyEnumerator.MoveNext())
            {
                ...
                if (matchedProperties.Contains(unevaluatedPropertyName))
                {
                    continue;
                }
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UnevaluatedProperties004.Tests.Test0: with no unevaluated properties");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed UnevaluatedProperties004.Tests.Test1: with unevaluated properties");
