// <copyright file="minContains000.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.MinContains000
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MinContains000.Tests.Test0: one item valid against lone minContains");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MinContains000.Tests.Test1: zero items still valid against lone minContains");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
