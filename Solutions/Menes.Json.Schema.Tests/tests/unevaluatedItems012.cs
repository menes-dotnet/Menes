// <copyright file="unevaluatedItems012.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.UnevaluatedItems012
{
public readonly struct TestSchema : Menes.IJsonValue, System.Collections.Generic.IEnumerable<Menes.JsonAny>, System.Collections.IEnumerable, System.IEquatable<TestSchema>, System.IEquatable<Menes.JsonArray<Menes.JsonAny>>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        {
            context = Menes.Validation.ValidateProperty(context, Menes.JsonAny.From(itemsValidationEnumerator.Current).As<TestSchema.ItemsValidationItem1Value>(), $"[0]");
        }
        int extraIndex = 0;
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[\"foo\", \"bar\", \"then\"]");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UnevaluatedItems012.Tests.Test0: when if matches and it has no unevaluated items");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[\"foo\", \"bar\", \"then\", \"else\"]");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed UnevaluatedItems012.Tests.Test1: when if matches and it has unevaluated items");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[\"foo\", 42, 42, \"else\"]");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UnevaluatedItems012.Tests.Test2: when if doesn't match and it has no unevaluated items");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[\"foo\", 42, 42, \"else\", 42]");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed UnevaluatedItems012.Tests.Test3: when if doesn't match and it has unevaluated items");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
