// <copyright file="const001.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Const001
{
public readonly struct Schema : Menes.IJsonValue, System.IEquatable<Schema>
{
    ...
    {
        using var document = System.Text.Json.JsonDocument.Parse("{\"foo\":\"bar\",\"baz\":\"bax\"}");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"foo\": \"bar\", \"baz\": \"bax\"}");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Const001.Tests.Test0: same object is valid");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"baz\": \"bax\", \"foo\": \"bar\"}");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Const001.Tests.Test1: same object with different property order is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const001.Tests.Test2: another object is invalid");
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const001.Tests.Test3: another type is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
