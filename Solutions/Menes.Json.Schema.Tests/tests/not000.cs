// <copyright file="not000.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Not000
{
public readonly struct Schema : Menes.IJsonValue, System.IEquatable<Schema>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        context = Menes.Validation.ValidateNot<Menes.JsonAny, Menes.JsonInteger>(context, this);
        return context;
    }
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Not000.Tests.Test0: allowed");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Not000.Tests.Test1: disallowed");
