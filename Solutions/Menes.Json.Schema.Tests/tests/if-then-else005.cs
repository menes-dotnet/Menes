// <copyright file="if-then-else005.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.IfThenElse005
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse005.Tests.Test0: valid through then");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse005.Tests.Test1: invalid through then");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse005.Tests.Test2: valid through else");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse005.Tests.Test3: invalid through else");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
