...
public readonly struct Schema : Menes.IJsonValue, System.IEquatable<Schema>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        context = Menes.Validation.ValidateOneOf(context, ("Menes.JsonAny", oneOfValidationContext1), ("Menes.JsonNotAny", oneOfValidationContext2), ("Menes.JsonNotAny", oneOfValidationContext3));
        return context;
    }
