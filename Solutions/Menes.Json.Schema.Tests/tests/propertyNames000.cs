// <copyright file="propertyNames000.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.PropertyNames000
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed PropertyNames000.Tests.Test0: all property names valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed PropertyNames000.Tests.Test1: some property names invalid");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed PropertyNames000.Tests.Test2: object without properties is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed PropertyNames000.Tests.Test3: ignores arrays");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test4()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed PropertyNames000.Tests.Test4: ignores strings");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test5()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed PropertyNames000.Tests.Test5: ignores other non-objects");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
