// <copyright file="oneOf005.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.OneOf005
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed OneOf005.Tests.Test0: any value is invalid");
