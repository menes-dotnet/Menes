...
public readonly struct TestSchema : Menes.IJsonValue, System.Collections.Generic.IEnumerable<Menes.JsonAny>, System.Collections.IEnumerable, System.IEquatable<TestSchema>, System.IEquatable<Menes.JsonArray<Menes.JsonAny>>
{
    ...
    public readonly struct NotTypeValidationValue : Menes.IJsonValue, System.IEquatable<NotTypeValidationValue>
    {
        ...
        public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
        {
            ...
            context = Menes.Validation.ValidateNot<Menes.JsonAny, TestSchema.NotTypeValidationValue.NotTypeValidationValueChild>(context, this);
            return context;
        }
        public void WriteTo(System.Text.Json.Utf8JsonWriter writer)
        {
        ...
        public readonly struct NotTypeValidationValueChild : Menes.IJsonValue, System.Collections.Generic.IEnumerable<Menes.JsonAny>, System.Collections.IEnumerable, System.IEquatable<NotTypeValidationValueChild>, System.IEquatable<Menes.JsonArray<Menes.JsonAny>>
        {
            ...
            public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
            {
                ...
                if (this.HasJsonElement && IsConvertibleFrom(this.JsonElement))
                {
                    ...
                    if (itemsValidationEnumerator.MoveNext())
                    {
                        context = Menes.Validation.ValidateProperty(context, Menes.JsonAny.From(itemsValidationEnumerator.Current).As<TestSchema.NotTypeValidationValue.NotTypeValidationValueChild.ItemsValidationItem1Value>(), $"[1]");
                    }
                    int extraIndex = 0;
                    while (itemsValidationEnumerator.MoveNext())
                    {
