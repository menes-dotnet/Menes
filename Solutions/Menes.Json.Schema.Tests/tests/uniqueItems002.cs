// <copyright file="uniqueItems002.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.UniqueItems002
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems002.Tests.Test0: [false, true] from items array is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems002.Tests.Test1: [true, false] from items array is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems002.Tests.Test2: [false, false] from items array is not valid");
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems002.Tests.Test3: [true, true] from items array is not valid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[false, true, null]");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems002.Tests.Test4: extra items are invalid even if unique");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
