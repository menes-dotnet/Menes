// <copyright file="unevaluatedProperties005.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.UnevaluatedProperties005
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UnevaluatedProperties005.Tests.Test0: with no additional properties");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UnevaluatedProperties005.Tests.Test1: with additional properties");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
