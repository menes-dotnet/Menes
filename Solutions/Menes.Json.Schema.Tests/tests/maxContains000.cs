// <copyright file="maxContains000.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.MaxContains000
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MaxContains000.Tests.Test0: one item valid against lone maxContains");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MaxContains000.Tests.Test1: two items still valid against lone maxContains");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
