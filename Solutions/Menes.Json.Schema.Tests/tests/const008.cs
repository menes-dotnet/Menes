// <copyright file="const008.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Const008
{
public readonly struct Schema : Menes.IJsonValue, System.IEquatable<Schema>
{
    ...
    {
        using var document = System.Text.Json.JsonDocument.Parse("{\"a\":false}");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"a\": false}");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Const008.Tests.Test0: {\"a\": false} is valid");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"a\": 0}");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const008.Tests.Test1: {\"a\": 0} is invalid");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"a\": 0.0}");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const008.Tests.Test2: {\"a\": 0.0} is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
