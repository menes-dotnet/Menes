// <copyright file="minContains002.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.MinContains002
{
public readonly struct TestSchema : Menes.IJsonValue, System.Collections.Generic.IEnumerable<Menes.JsonAny>, System.Collections.IEnumerable, System.IEquatable<TestSchema>, System.IEquatable<Menes.JsonArray<Menes.JsonAny>>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        {
            context = array.ValidateRangeContains<TestSchema.ContainsValidationValue>(context, 2, 2147483647, false, true);
        }
        return context;
    }
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed MinContains002.Tests.Test0: empty data");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed MinContains002.Tests.Test1: all elements match, invalid minContains");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed MinContains002.Tests.Test2: some elements match, invalid minContains");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MinContains002.Tests.Test3: all elements match, valid minContains (exactly as needed)");
...
/// </summary>
    public static bool Test4()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MinContains002.Tests.Test4: all elements match, valid minContains (more than needed)");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[ 1, 2, 1 ]");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MinContains002.Tests.Test5: some elements match, valid minContains");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
