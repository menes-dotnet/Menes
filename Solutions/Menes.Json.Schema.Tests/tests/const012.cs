// <copyright file="const012.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Const012
{
public readonly struct Schema : Menes.IJsonValue, System.IEquatable<Schema>
{
    ...
    {
        using var document = System.Text.Json.JsonDocument.Parse("-2.0");
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Const012.Tests.Test0: integer -2 is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const012.Tests.Test1: integer 2 is invalid");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Const012.Tests.Test2: float -2.0 is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const012.Tests.Test3: float 2.0 is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("-2.00001");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const012.Tests.Test4: float -2.00001 is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
