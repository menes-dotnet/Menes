// <copyright file="uniqueItems004.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.UniqueItems004
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems004.Tests.Test0: [false, true] from items array is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems004.Tests.Test1: [true, false] from items array is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems004.Tests.Test2: [false, false] from items array is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems004.Tests.Test3: [true, true] from items array is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test4()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems004.Tests.Test4: unique array extended from [false, true] is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test5()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems004.Tests.Test5: unique array extended from [true, false] is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test6()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems004.Tests.Test6: non-unique array extended from [false, true] is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test7()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UniqueItems004.Tests.Test7: non-unique array extended from [true, false] is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
