// <copyright file="if-then-else007.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.IfThenElse007
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse007.Tests.Test0: boolean schema true in if always chooses the then path (valid)");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse007.Tests.Test1: boolean schema true in if always chooses the then path (invalid)");
