// <copyright file="const003.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Const003
{
public readonly struct TestSchema : Menes.IJsonValue, System.IEquatable<TestSchema>
{
    ...
    {
        using var document = System.Text.Json.JsonDocument.Parse("null");
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Const003.Tests.Test0: null is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const003.Tests.Test1: not null is invalid");
