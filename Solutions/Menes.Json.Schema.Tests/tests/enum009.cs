// <copyright file="enum009.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Enum009
{
public readonly struct TestSchema : Menes.IJsonValue, System.IEquatable<TestSchema>
{
    ...
    public static readonly TestSchema HelloU0000There = new TestSchema(EnumValues[0]);
    ...
    private static System.Collections.Immutable.ImmutableArray<Menes.JsonAny> BuildEnumValues()
    {
        ...
        using var document = System.Text.Json.JsonDocument.Parse("[\"hello\\u0000there\"]");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("\"hello\\u0000there\"");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Enum009.Tests.Test0: match string with nul");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("\"hellothere\"");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Enum009.Tests.Test1: do not match string lacking nul");
