// <copyright file="properties002.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Properties002
{
public readonly struct TestSchema : Menes.IJsonObject, System.IEquatable<TestSchema>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
{
    ...
    public TestSchema(Menes.JsonAny? foo, Menes.JsonNotAny? bar, Menes.JsonProperties<Menes.JsonAny> additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
    ...
    public TestSchema(Menes.JsonAny? foo, Menes.JsonNotAny? bar, params (string, Menes.JsonAny)[] additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(Menes.JsonAny? foo = null, Menes.JsonNotAny? bar = null)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(Menes.JsonAny? foo, Menes.JsonNotAny? bar, (string, Menes.JsonAny) additionalProperty1)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(Menes.JsonAny? foo, Menes.JsonNotAny? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(Menes.JsonAny? foo, Menes.JsonNotAny? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(Menes.JsonAny? foo, Menes.JsonNotAny? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3, (string, Menes.JsonAny) additionalProperty4)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    private TestSchema(Menes.JsonAny? foo, Menes.JsonNotAny? bar, Menes.JsonProperties<Menes.JsonAny>? additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema WithBar(Menes.JsonNotAny? value)
    {
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Properties002.Tests.Test0: no property present is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Properties002.Tests.Test1: only 'true' property present is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Properties002.Tests.Test2: only 'false' property present is invalid");
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Properties002.Tests.Test3: both properties present is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
