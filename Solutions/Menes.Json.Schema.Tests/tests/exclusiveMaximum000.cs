// <copyright file="exclusiveMaximum000.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.ExclusiveMaximum000
{
public readonly struct Schema : Menes.IJsonValue, System.IEquatable<Schema>
{
    ...
    private static readonly Menes.JsonNumber? ExclusiveMaximum = 3.0;
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("2.2");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed ExclusiveMaximum000.Tests.Test0: below the exclusiveMaximum is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed ExclusiveMaximum000.Tests.Test1: boundary point is invalid");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed ExclusiveMaximum000.Tests.Test2: above the exclusiveMaximum is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed ExclusiveMaximum000.Tests.Test3: ignores non-numbers");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
