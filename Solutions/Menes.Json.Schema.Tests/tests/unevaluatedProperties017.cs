// <copyright file="unevaluatedProperties017.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.UnevaluatedProperties017
{
public readonly struct TestSchema : Menes.IJsonValue, System.IEquatable<TestSchema>
{
    ...
    public readonly struct AllOfValidationItem1Value : Menes.IJsonObject, System.IEquatable<TestSchema.AllOfValidationItem1Value>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
    {
        ...
        public AllOfValidationItem1Value(Menes.JsonAny? foo, Menes.JsonProperties<Menes.JsonAny> additionalPropertiesBacking)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = additionalPropertiesBacking;
        }
        public AllOfValidationItem1Value(Menes.JsonAny? foo, params (string, Menes.JsonAny)[] additionalPropertiesBacking)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalPropertiesBacking);
        }
        public AllOfValidationItem1Value(Menes.JsonAny? foo = null)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = null;
        }
        public AllOfValidationItem1Value(Menes.JsonAny? foo, (string, Menes.JsonAny) additionalProperty1)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1);
        }
        public AllOfValidationItem1Value(Menes.JsonAny? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1, additionalProperty2);
        }
        public AllOfValidationItem1Value(Menes.JsonAny? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3)
        {
            this.foo = foo;
            this.JsonElement = default;
        ...
        public AllOfValidationItem1Value(Menes.JsonAny? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3, (string, Menes.JsonAny) additionalProperty4)
        {
            this.foo = foo;
            this.JsonElement = default;
        ...
        private AllOfValidationItem1Value(Menes.JsonAny? foo, Menes.JsonProperties<Menes.JsonAny>? additionalPropertiesBacking)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = additionalPropertiesBacking;
        ...
        public static TestSchema.AllOfValidationItem1Value FromOptionalProperty(in System.Text.Json.JsonElement parentDocument, System.ReadOnlySpan<byte> utf8PropertyName) =>
           parentDocument.ValueKind == System.Text.Json.JsonValueKind.Object ?
                (parentDocument.TryGetProperty(utf8PropertyName, out System.Text.Json.JsonElement property)
                    ...
                    : Null)
            : Null;
        public TestSchema.AllOfValidationItem1Value WithFoo(Menes.JsonAny? value)
        {
        ...
        {
            return new TestSchema.AllOfValidationItem1Value(this.Foo, newAdditional);
        }
        public TestSchema.AllOfValidationItem1Value ReplaceAll(params (string, Menes.JsonAny)[] newAdditional)
        {
            return new TestSchema.AllOfValidationItem1Value(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional));
        }
        public TestSchema.AllOfValidationItem1Value ReplaceAll((string, Menes.JsonAny) newAdditional1)
        {
            return new TestSchema.AllOfValidationItem1Value(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1));
        }
        ...
        {
            return new TestSchema.AllOfValidationItem1Value(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2));
        }
        ...
        {
            return new TestSchema.AllOfValidationItem1Value(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3));
        }
        ...
        {
            return new TestSchema.AllOfValidationItem1Value(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3, newAdditional4));
        }
        public TestSchema.AllOfValidationItem1Value Add(params (string, Menes.JsonAny)[] newAdditional)
        {
            ...
            return new TestSchema.AllOfValidationItem1Value(this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
        public TestSchema.AllOfValidationItem1Value Add((string name, Menes.JsonAny value) newAdditional1)
        {
            ...
            arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); return new TestSchema.AllOfValidationItem1Value(this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed UnevaluatedProperties017.Tests.Test0: always fails");
