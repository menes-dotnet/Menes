...
public readonly struct Schema : Menes.IJsonValue, System.IEquatable<Schema>
{
    ...
    public readonly struct AllOfValidationItem1Value : Menes.IJsonObject, System.IEquatable<Schema.AllOfValidationItem1Value>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
    {
        ...
        public static Schema.AllOfValidationItem1Value FromOptionalProperty(in System.Text.Json.JsonElement parentDocument, System.ReadOnlySpan<byte> utf8PropertyName) =>
           parentDocument.ValueKind == System.Text.Json.JsonValueKind.Object ?
                (parentDocument.TryGetProperty(utf8PropertyName, out System.Text.Json.JsonElement property)
                    ...
                    : Null)
            : Null;
        public Schema.AllOfValidationItem1Value WithFoo(Menes.JsonAny? value)
        {
        ...
        {
            return new Schema.AllOfValidationItem1Value(this.Foo, newAdditional);
        }
        public Schema.AllOfValidationItem1Value ReplaceAll(params (string, Menes.JsonAny)[] newAdditional)
        {
            return new Schema.AllOfValidationItem1Value(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional));
        }
        public Schema.AllOfValidationItem1Value ReplaceAll((string, Menes.JsonAny) newAdditional1)
        {
            return new Schema.AllOfValidationItem1Value(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1));
        }
        ...
        {
            return new Schema.AllOfValidationItem1Value(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2));
        }
        ...
        {
            return new Schema.AllOfValidationItem1Value(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3));
        }
        ...
        {
            return new Schema.AllOfValidationItem1Value(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3, newAdditional4));
        }
        public Schema.AllOfValidationItem1Value Add(params (string, Menes.JsonAny)[] newAdditional)
        {
            ...
            return new Schema.AllOfValidationItem1Value(this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
        public Schema.AllOfValidationItem1Value Add((string name, Menes.JsonAny value) newAdditional1)
        {
            ...
            arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); return new Schema.AllOfValidationItem1Value(this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
        public Schema.AllOfValidationItem1Value Add((string name, Menes.JsonAny value) newAdditional1, (string name, Menes.JsonAny value) newAdditional2)
        {
            ...
            arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional2.name, newAdditional2.value)); return new Schema.AllOfValidationItem1Value(this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
        ...
        public Schema.AllOfValidationItem1Value Add((string name, Menes.JsonAny value) newAdditional1, (string name, Menes.JsonAny value) newAdditional2, (string name, Menes.JsonAny value) newAdditional3, (string name, Menes.JsonAny value) newAdditional4)
        {
            ...
            arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional2.name, newAdditional2.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional3.name, newAdditional3.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional4.name, newAdditional4.value)); return new Schema.AllOfValidationItem1Value(this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
