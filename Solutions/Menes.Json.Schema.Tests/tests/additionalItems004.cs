// <copyright file="additionalItems004.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.AdditionalItems004
{
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[1, \"foo\", false]");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed AdditionalItems004.Tests.Test0: only the first item is validated");
