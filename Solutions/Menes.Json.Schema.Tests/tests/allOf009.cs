// <copyright file="allOf009.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.AllOf009
{
public readonly struct TestSchema : Menes.IJsonValue, System.IEquatable<TestSchema>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        Menes.JsonNumber jsonNumberAllOfValue0 = Menes.JsonAny.From(value).As<Menes.JsonNumber>();
        allOfValidationContext1 = jsonNumberAllOfValue0.Validate(allOfValidationContext1);
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed AllOf009.Tests.Test0: number is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed AllOf009.Tests.Test1: string is invalid");
