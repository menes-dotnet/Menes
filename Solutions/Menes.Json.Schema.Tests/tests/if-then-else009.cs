// <copyright file="if-then-else009.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.IfThenElse009
{
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("\"yes\"");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse009.Tests.Test0: yes redirects to then and passes");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("\"other\"");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse009.Tests.Test1: other redirects to else and passes");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("\"no\"");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse009.Tests.Test2: no redirects to then and fails");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("\"invalid\"");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse009.Tests.Test3: invalid redirects to else and fails");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
