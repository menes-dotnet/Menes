// <copyright file="if-then-else000.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.IfThenElse000
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse000.Tests.Test0: valid when valid against lone if");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse000.Tests.Test1: valid when invalid against lone if");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
