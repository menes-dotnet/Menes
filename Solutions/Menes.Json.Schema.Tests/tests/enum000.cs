// <copyright file="enum000.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Enum000
{
public readonly struct TestSchema : Menes.IJsonValue, System.IEquatable<TestSchema>
{
    ...
    public static readonly TestSchema Value1 = new TestSchema(EnumValues[0]);
    public static readonly TestSchema Value2 = new TestSchema(EnumValues[1]);
    public static readonly TestSchema Value3 = new TestSchema(EnumValues[2]);
    ...
    private static System.Collections.Immutable.ImmutableArray<Menes.JsonAny> BuildEnumValues()
    {
        ...
        using var document = System.Text.Json.JsonDocument.Parse("[1,2,3]");
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Enum000.Tests.Test0: one of the enum is valid");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("4");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Enum000.Tests.Test1: something else is invalid");
