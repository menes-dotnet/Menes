// <copyright file="enum003.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Enum003
{
public readonly struct TestSchema : Menes.IJsonObject, System.IEquatable<TestSchema>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
{
    ...
    private readonly TestSchema.FooValue? foo;
    private readonly TestSchema.BarValue? bar;
    ...
    public TestSchema(TestSchema.BarValue bar)
    {
        this.foo = null;
        this.bar = bar;
    ...
    public TestSchema(TestSchema.BarValue bar, TestSchema.FooValue? foo, Menes.JsonProperties<Menes.JsonAny> additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(TestSchema.BarValue bar, TestSchema.FooValue? foo, params (string, Menes.JsonAny)[] additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(TestSchema.BarValue bar, TestSchema.FooValue? foo = null)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(TestSchema.BarValue bar, TestSchema.FooValue? foo, (string, Menes.JsonAny) additionalProperty1)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(TestSchema.BarValue bar, TestSchema.FooValue? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(TestSchema.BarValue bar, TestSchema.FooValue? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(TestSchema.BarValue bar, TestSchema.FooValue? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3, (string, Menes.JsonAny) additionalProperty4)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    private TestSchema(TestSchema.BarValue bar, TestSchema.FooValue? foo, Menes.JsonProperties<Menes.JsonAny>? additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema.FooValue? Foo => this.foo ?? TestSchema.FooValue.FromOptionalProperty(this.JsonElement, FooPropertyNameBytes.Span).AsOptional;
    public TestSchema.BarValue Bar => this.bar ?? TestSchema.BarValue.FromOptionalProperty(this.JsonElement, BarPropertyNameBytes.Span);
    ...
    public static TestSchema FromOptionalProperty(in System.Text.Json.JsonElement parentDocument, System.ReadOnlySpan<byte> utf8PropertyName) =>
       parentDocument.ValueKind == System.Text.Json.JsonValueKind.Object ?
            (parentDocument.TryGetProperty(utf8PropertyName, out System.Text.Json.JsonElement property)
                ...
                : Null)
        : Null;
    public TestSchema WithFoo(TestSchema.FooValue? value)
    {
        return new TestSchema(this.Bar, value, this.GetJsonProperties());
    }
    public TestSchema WithBar(TestSchema.BarValue value)
    {
        return new TestSchema(value, this.Foo, this.GetJsonProperties());
    }
    public TestSchema ReplaceAll(Menes.JsonProperties<Menes.JsonAny> newAdditional)
    {
        return new TestSchema(this.Bar, this.Foo, newAdditional);
    }
    public TestSchema ReplaceAll(params (string, Menes.JsonAny)[] newAdditional)
    {
        return new TestSchema(this.Bar, this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional));
    }
    public TestSchema ReplaceAll((string, Menes.JsonAny) newAdditional1)
    {
        return new TestSchema(this.Bar, this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1));
    }
    public TestSchema ReplaceAll((string, Menes.JsonAny) newAdditional1, (string, Menes.JsonAny) newAdditional2)
    {
        return new TestSchema(this.Bar, this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2));
    }
    ...
    {
        return new TestSchema(this.Bar, this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3));
    }
    ...
    {
        return new TestSchema(this.Bar, this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3, newAdditional4));
    }
    public TestSchema Add(params (string, Menes.JsonAny)[] newAdditional)
    {
        ...
        return new TestSchema(this.Bar, this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
    }
    public TestSchema Add((string name, Menes.JsonAny value) newAdditional1)
    {
        ...
        arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); return new TestSchema(this.Bar, this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
    }
    public TestSchema Add((string name, Menes.JsonAny value) newAdditional1, (string name, Menes.JsonAny value) newAdditional2)
    {
        ...
        arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional2.name, newAdditional2.value)); return new TestSchema(this.Bar, this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
    }
    ...
    public TestSchema Add((string name, Menes.JsonAny value) newAdditional1, (string name, Menes.JsonAny value) newAdditional2, (string name, Menes.JsonAny value) newAdditional3, (string name, Menes.JsonAny value) newAdditional4)
    {
        ...
        arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional2.name, newAdditional2.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional3.name, newAdditional3.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional4.name, newAdditional4.value)); return new TestSchema(this.Bar, this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
    }
    ...
    public void WriteTo(System.Text.Json.Utf8JsonWriter writer)
    {
        ...
        else
        {
            ...
            if (this.foo is TestSchema.FooValue foo)
            {
                writer.WritePropertyName(EncodedFooPropertyName);
                foo.WriteTo(writer);
            }
            if (this.bar is TestSchema.BarValue bar)
            {
    ...
    public readonly struct FooValue : Menes.IJsonValue, System.IEquatable<FooValue>
    {
        ...
        public static readonly FooValue Foo = new FooValue(EnumValues[0]);
    ...
    public readonly struct BarValue : Menes.IJsonValue, System.IEquatable<BarValue>
    {
        ...
        public static readonly System.Collections.Immutable.ImmutableArray<Menes.JsonAny> EnumValues = BuildEnumValues();
        public static readonly BarValue Bar = new BarValue(EnumValues[0]);
        private readonly Menes.JsonAny? value;
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"foo\":\"foo\", \"bar\":\"bar\"}");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Enum003.Tests.Test0: both properties are valid");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"foo\":\"foot\", \"bar\":\"bar\"}");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Enum003.Tests.Test1: wrong foo value");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"foo\":\"foo\", \"bar\":\"bart\"}");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Enum003.Tests.Test2: wrong bar value");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"bar\":\"bar\"}");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Enum003.Tests.Test3: missing optional property is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test4()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Enum003.Tests.Test4: missing required property is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test5()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Enum003.Tests.Test5: missing all properties is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
