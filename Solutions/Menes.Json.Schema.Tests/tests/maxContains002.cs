// <copyright file="maxContains002.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.MaxContains002
{
public readonly struct TestSchema : Menes.IJsonValue, System.Collections.Generic.IEnumerable<Menes.JsonAny>, System.Collections.IEnumerable, System.IEquatable<TestSchema>, System.IEquatable<Menes.JsonArray<Menes.JsonAny>>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        {
            context = array.ValidateRangeContains<TestSchema.ContainsValidationValue>(context, 1, 3, false, true);
        }
        return context;
    }
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed MaxContains002.Tests.Test0: actual < minContains < maxContains");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MaxContains002.Tests.Test1: minContains < actual < maxContains");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[ 1, 1, 1, 1 ]");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed MaxContains002.Tests.Test2: minContains < maxContains < actual");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
