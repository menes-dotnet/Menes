// <copyright file="maxProperties001.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.MaxProperties001
{
public readonly struct TestSchema : Menes.IJsonObject, System.IEquatable<TestSchema>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        if (!this.HasJsonElement || IsConvertibleFrom(this.JsonElement))
        {
            ...
            context = Menes.Validation.ValidateObject(context, this, 0, null);
        }
        return context;
    }
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MaxProperties001.Tests.Test0: no properties is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed MaxProperties001.Tests.Test1: one property is invalid");
