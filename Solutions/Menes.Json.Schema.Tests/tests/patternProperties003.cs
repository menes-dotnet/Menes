// <copyright file="patternProperties003.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.PatternProperties003
{
public readonly struct TestSchema : Menes.IJsonObject, System.IEquatable<TestSchema>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
{
    ...
    private static readonly System.Text.RegularExpressions.Regex PatternPropertyRegex0 = new System.Text.RegularExpressions.Regex("f.*", System.Text.RegularExpressions.RegexOptions.Compiled);
    private static readonly System.Text.RegularExpressions.Regex PatternPropertyRegex1 = new System.Text.RegularExpressions.Regex("b.*", System.Text.RegularExpressions.RegexOptions.Compiled);
       ...
       where TItem : struct, IJsonValue
    {
        ...
        if (isMatch1 && anyValue.As<Menes.JsonNotAny>().Validate(Menes.ValidationContext.Root).IsValid)
        {
            return (true, validationContext);
        }
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed PatternProperties003.Tests.Test0: object with property matching schema true is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed PatternProperties003.Tests.Test1: object with property matching schema false is invalid");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed PatternProperties003.Tests.Test2: object with both properties is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"foobar\":1}");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed PatternProperties003.Tests.Test3: object with a property matching both true and false is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test4()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed PatternProperties003.Tests.Test4: empty object is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
