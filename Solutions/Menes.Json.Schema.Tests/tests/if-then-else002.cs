// <copyright file="if-then-else002.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.IfThenElse002
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse002.Tests.Test0: valid when valid against lone else");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse002.Tests.Test1: valid when invalid against lone else");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
