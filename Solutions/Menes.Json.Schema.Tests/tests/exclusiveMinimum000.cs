// <copyright file="exclusiveMinimum000.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.ExclusiveMinimum000
{
public readonly struct Schema : Menes.IJsonValue, System.IEquatable<Schema>
{
    ...
    private static readonly Menes.JsonNumber? ExclusiveMinimum = 1.1;
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed ExclusiveMinimum000.Tests.Test0: above the exclusiveMinimum is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed ExclusiveMinimum000.Tests.Test1: boundary point is invalid");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("0.6");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed ExclusiveMinimum000.Tests.Test2: below the exclusiveMinimum is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed ExclusiveMinimum000.Tests.Test3: ignores non-numbers");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
