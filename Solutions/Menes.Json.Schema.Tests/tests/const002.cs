// <copyright file="const002.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Const002
{
public readonly struct TestSchema : Menes.IJsonValue, System.IEquatable<TestSchema>
{
    ...
    {
        using var document = System.Text.Json.JsonDocument.Parse("[{\"foo\":\"bar\"}]");
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Const002.Tests.Test0: same array is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const002.Tests.Test1: another array item is invalid");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const002.Tests.Test2: array with additional items is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
