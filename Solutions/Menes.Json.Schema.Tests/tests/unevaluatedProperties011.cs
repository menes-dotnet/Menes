...
public readonly struct Schema : Menes.IJsonValue
{
    ...
    public readonly struct SchemaValue : Menes.IJsonObject, System.IEquatable<Schema.SchemaValue>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
    {
        ...
        public SchemaValue(Schema.SchemaValue.BarValue bar, Schema.BazValue baz)
        {
            this.bar = bar;
            this.baz = baz;
            this.JsonElement = default;
        ...
        public SchemaValue(Schema.SchemaValue.BarValue bar, Schema.BazValue baz, params (string, Menes.JsonAny)[] additionalPropertiesBacking)
        {
            this.bar = bar;
            this.baz = baz;
            this.JsonElement = default;
        ...
        public SchemaValue(Schema.SchemaValue.BarValue bar, Schema.BazValue baz, (string, Menes.JsonAny) additionalProperty1)
        {
            this.bar = bar;
            this.baz = baz;
            this.JsonElement = default;
        ...
        public SchemaValue(Schema.SchemaValue.BarValue bar, Schema.BazValue baz, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2)
        {
            this.bar = bar;
            this.baz = baz;
            this.JsonElement = default;
        ...
        public SchemaValue(Schema.SchemaValue.BarValue bar, Schema.BazValue baz, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3)
        {
            this.bar = bar;
            this.baz = baz;
            this.JsonElement = default;
        ...
        public SchemaValue(Schema.SchemaValue.BarValue bar, Schema.BazValue baz, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3, (string, Menes.JsonAny) additionalProperty4)
        {
            this.bar = bar;
            this.baz = baz;
            this.JsonElement = default;
        ...
        private SchemaValue(Schema.SchemaValue.BarValue bar, Schema.BazValue baz, Menes.JsonProperties<Menes.JsonAny>? additionalPropertiesBacking)
        {
            this.bar = bar;
            this.baz = baz;
            this.JsonElement = default;
        ...
        {
            return new Schema.SchemaValue(this.Bar, this.Baz, newAdditional);
        }
        public Schema.SchemaValue ReplaceAll(params (string, Menes.JsonAny)[] newAdditional)
        {
            return new Schema.SchemaValue(this.Bar, this.Baz, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional));
        }
        public Schema.SchemaValue ReplaceAll((string, Menes.JsonAny) newAdditional1)
        {
            return new Schema.SchemaValue(this.Bar, this.Baz, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1));
        }
        public Schema.SchemaValue ReplaceAll((string, Menes.JsonAny) newAdditional1, (string, Menes.JsonAny) newAdditional2)
        {
            return new Schema.SchemaValue(this.Bar, this.Baz, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2));
        }
        ...
        {
            return new Schema.SchemaValue(this.Bar, this.Baz, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3));
        }
        ...
        {
            return new Schema.SchemaValue(this.Bar, this.Baz, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3, newAdditional4));
        }
        public Schema.SchemaValue Add(params (string, Menes.JsonAny)[] newAdditional)
        {
            ...
            return new Schema.SchemaValue(this.Bar, this.Baz, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
        public Schema.SchemaValue Add((string name, Menes.JsonAny value) newAdditional1)
        {
            ...
            arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); return new Schema.SchemaValue(this.Bar, this.Baz, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
        public Schema.SchemaValue Add((string name, Menes.JsonAny value) newAdditional1, (string name, Menes.JsonAny value) newAdditional2)
        {
            ...
            arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional2.name, newAdditional2.value)); return new Schema.SchemaValue(this.Bar, this.Baz, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
        ...
        public Schema.SchemaValue Add((string name, Menes.JsonAny value) newAdditional1, (string name, Menes.JsonAny value) newAdditional2, (string name, Menes.JsonAny value) newAdditional3, (string name, Menes.JsonAny value) newAdditional4)
        {
            ...
            arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional2.name, newAdditional2.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional3.name, newAdditional3.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional4.name, newAdditional4.value)); return new Schema.SchemaValue(this.Bar, this.Baz, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
