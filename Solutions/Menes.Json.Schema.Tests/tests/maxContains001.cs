// <copyright file="maxContains001.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.MaxContains001
{
public readonly struct TestSchema : Menes.IJsonValue, System.Collections.Generic.IEnumerable<Menes.JsonAny>, System.Collections.IEnumerable, System.IEquatable<TestSchema>, System.IEquatable<Menes.JsonArray<Menes.JsonAny>>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        {
            context = array.ValidateRangeContains<TestSchema.ContainsValidationValue>(context, 1, 1, false, true);
        }
        return context;
    }
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed MaxContains001.Tests.Test0: empty data");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MaxContains001.Tests.Test1: all elements match, valid maxContains");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed MaxContains001.Tests.Test2: all elements match, invalid maxContains");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MaxContains001.Tests.Test3: some elements match, valid maxContains");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test4()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed MaxContains001.Tests.Test4: some elements match, invalid maxContains");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
