// <copyright file="pattern001.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Pattern001
{
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("\"xxaayy\"");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Pattern001.Tests.Test0: matches a substring");
