// <copyright file="additionalItems005.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.AdditionalItems005
{
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[ 1, null ]");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed AdditionalItems005.Tests.Test0: items defined in allOf are not examined");
