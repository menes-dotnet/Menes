// <copyright file="items001.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Items001
{
public readonly struct Schema : Menes.IJsonValue, System.Collections.Generic.IEnumerable<Menes.JsonAny>, System.Collections.IEnumerable, System.IEquatable<Schema>, System.IEquatable<Menes.JsonArray<Menes.JsonAny>>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        {
            context = Menes.Validation.ValidateProperty(context, Menes.JsonAny.From(itemsValidationEnumerator.Current).As<Menes.JsonInteger>(), $"[0]");
        }
        if (itemsValidationEnumerator.MoveNext())
        {
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[ 1, \"foo\" ]");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Items001.Tests.Test0: correct types");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Items001.Tests.Test1: wrong types");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Items001.Tests.Test2: incomplete array of items");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Items001.Tests.Test3: array with additional items");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test4()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Items001.Tests.Test4: empty array");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test5()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Items001.Tests.Test5: JavaScript pseudo-array is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
