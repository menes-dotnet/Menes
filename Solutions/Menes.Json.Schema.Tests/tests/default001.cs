...
public readonly struct TestSchema : Menes.IJsonObject, System.IEquatable<TestSchema>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
{
    ...
    public TestSchema(TestSchema.BarValue? bar, Menes.JsonProperties<Menes.JsonAny> additionalPropertiesBacking)
    {
        this.bar = bar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = additionalPropertiesBacking;
    }
    public TestSchema(TestSchema.BarValue? bar, params (string, Menes.JsonAny)[] additionalPropertiesBacking)
    {
        this.bar = bar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalPropertiesBacking);
    }
    public TestSchema(TestSchema.BarValue? bar = null)
    {
        this.bar = bar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = null;
    }
    public TestSchema(TestSchema.BarValue? bar, (string, Menes.JsonAny) additionalProperty1)
    {
        this.bar = bar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1);
    }
    public TestSchema(TestSchema.BarValue? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2)
    {
        this.bar = bar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1, additionalProperty2);
    }
    public TestSchema(TestSchema.BarValue? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3)
    {
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(TestSchema.BarValue? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3, (string, Menes.JsonAny) additionalProperty4)
    {
        this.bar = bar;
        this.JsonElement = default;
    ...
    private TestSchema(TestSchema.BarValue? bar, Menes.JsonProperties<Menes.JsonAny>? additionalPropertiesBacking)
    {
        this.bar = bar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = additionalPropertiesBacking;
    ...
    public TestSchema.BarValue? Bar => this.bar ?? TestSchema.BarValue.FromOptionalProperty(this.JsonElement, BarPropertyNameBytes.Span).AsOptional;
