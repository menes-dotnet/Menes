// <copyright file="not003.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Not003
{
public readonly struct TestSchema : Menes.IJsonObject, System.IEquatable<TestSchema>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
{
    ...
    public TestSchema(TestSchema.FooValue? foo, Menes.JsonProperties<Menes.JsonAny> additionalPropertiesBacking)
    {
        this.foo = foo;
        this.JsonElement = default;
        this.additionalPropertiesBacking = additionalPropertiesBacking;
    }
    public TestSchema(TestSchema.FooValue? foo, params (string, Menes.JsonAny)[] additionalPropertiesBacking)
    {
        this.foo = foo;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalPropertiesBacking);
    }
    public TestSchema(TestSchema.FooValue? foo = null)
    {
        this.foo = foo;
        this.JsonElement = default;
        this.additionalPropertiesBacking = null;
    }
    public TestSchema(TestSchema.FooValue? foo, (string, Menes.JsonAny) additionalProperty1)
    {
        this.foo = foo;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1);
    }
    public TestSchema(TestSchema.FooValue? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2)
    {
        this.foo = foo;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1, additionalProperty2);
    }
    public TestSchema(TestSchema.FooValue? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3)
    {
        this.foo = foo;
        this.JsonElement = default;
    ...
    public TestSchema(TestSchema.FooValue? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3, (string, Menes.JsonAny) additionalProperty4)
    {
        this.foo = foo;
        this.JsonElement = default;
    ...
    private TestSchema(TestSchema.FooValue? foo, Menes.JsonProperties<Menes.JsonAny>? additionalPropertiesBacking)
    {
        this.foo = foo;
        this.JsonElement = default;
        this.additionalPropertiesBacking = additionalPropertiesBacking;
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Not003.Tests.Test0: property present");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"bar\": 1, \"baz\": 2}");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Not003.Tests.Test1: property absent");
