// <copyright file="refRemote006.cs" company="Endjin Limited">
...
public readonly struct HttpLocalhost1234Object : Menes.IJsonObject, System.IEquatable<HttpLocalhost1234Object>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
{
    ...
    private static readonly System.Collections.Immutable.ImmutableArray<System.ReadOnlyMemory<byte>> KnownProperties = System.Collections.Immutable.ImmutableArray.Create(NamePropertyNameBytes);
    private readonly HttpLocalhost1234Object.NameValue? name;
    ...
    public HttpLocalhost1234Object(HttpLocalhost1234Object.NameValue? name, Menes.JsonProperties<Menes.JsonAny> additionalPropertiesBacking)
    {
        this.name = name;
        this.JsonElement = default;
        this.additionalPropertiesBacking = additionalPropertiesBacking;
    }
    public HttpLocalhost1234Object(HttpLocalhost1234Object.NameValue? name, params (string, Menes.JsonAny)[] additionalPropertiesBacking)
    {
        this.name = name;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalPropertiesBacking);
    }
    public HttpLocalhost1234Object(HttpLocalhost1234Object.NameValue? name = null)
    {
        this.name = name;
        this.JsonElement = default;
        this.additionalPropertiesBacking = null;
    }
    public HttpLocalhost1234Object(HttpLocalhost1234Object.NameValue? name, (string, Menes.JsonAny) additionalProperty1)
    {
        this.name = name;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1);
    }
    public HttpLocalhost1234Object(HttpLocalhost1234Object.NameValue? name, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2)
    {
        this.name = name;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1, additionalProperty2);
    }
    public HttpLocalhost1234Object(HttpLocalhost1234Object.NameValue? name, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3)
    {
        this.name = name;
        this.JsonElement = default;
    ...
    public HttpLocalhost1234Object(HttpLocalhost1234Object.NameValue? name, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3, (string, Menes.JsonAny) additionalProperty4)
    {
        this.name = name;
        this.JsonElement = default;
    ...
    private HttpLocalhost1234Object(HttpLocalhost1234Object.NameValue? name, Menes.JsonProperties<Menes.JsonAny>? additionalPropertiesBacking)
    {
        this.name = name;
        this.JsonElement = default;
        this.additionalPropertiesBacking = additionalPropertiesBacking;
    }
    public bool IsNull => (this.JsonElement.ValueKind == System.Text.Json.JsonValueKind.Undefined || this.JsonElement.ValueKind == System.Text.Json.JsonValueKind.Null) && (this.name is null || this.name.Value.IsNull);
    public HttpLocalhost1234Object? AsOptional => this.IsNull ? default(HttpLocalhost1234Object?) : this;
    public HttpLocalhost1234Object.NameValue? Name => this.name ?? HttpLocalhost1234Object.NameValue.FromOptionalProperty(this.JsonElement, NamePropertyNameBytes.Span).AsOptional;
    ...
    public static HttpLocalhost1234Object FromOptionalProperty(in System.Text.Json.JsonElement parentDocument, System.ReadOnlySpan<byte> utf8PropertyName) =>
       parentDocument.ValueKind == System.Text.Json.JsonValueKind.Object ?
            (parentDocument.TryGetProperty(utf8PropertyName, out System.Text.Json.JsonElement property)
                ...
                : Null)
        : Null;
    public HttpLocalhost1234Object WithName(HttpLocalhost1234Object.NameValue? value)
    {
        return new HttpLocalhost1234Object(value, this.GetJsonProperties());
    }
    public HttpLocalhost1234Object ReplaceAll(Menes.JsonProperties<Menes.JsonAny> newAdditional)
    {
        return new HttpLocalhost1234Object(this.Name, newAdditional);
    }
    public HttpLocalhost1234Object ReplaceAll(params (string, Menes.JsonAny)[] newAdditional)
    {
        return new HttpLocalhost1234Object(this.Name, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional));
    }
    public HttpLocalhost1234Object ReplaceAll((string, Menes.JsonAny) newAdditional1)
    {
        return new HttpLocalhost1234Object(this.Name, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1));
    }
    public HttpLocalhost1234Object ReplaceAll((string, Menes.JsonAny) newAdditional1, (string, Menes.JsonAny) newAdditional2)
    {
        return new HttpLocalhost1234Object(this.Name, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2));
    }
    ...
    {
        return new HttpLocalhost1234Object(this.Name, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3));
    }
    ...
    {
        return new HttpLocalhost1234Object(this.Name, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3, newAdditional4));
    }
    public HttpLocalhost1234Object Add(params (string, Menes.JsonAny)[] newAdditional)
    {
        ...
        return new HttpLocalhost1234Object(this.Name, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
    }
    public HttpLocalhost1234Object Add((string name, Menes.JsonAny value) newAdditional1)
    {
        ...
        arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); return new HttpLocalhost1234Object(this.Name, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
    }
    ...
    public void WriteTo(System.Text.Json.Utf8JsonWriter writer)
    {
        ...
        else
        {
            ...
            if (this.name is HttpLocalhost1234Object.NameValue name)
            {
    ...
    public bool Equals(HttpLocalhost1234Object other)
    {
        ...
        return this.Name.Equals(other.Name) && System.Linq.Enumerable.SequenceEqual(this.JsonAdditionalProperties, other.JsonAdditionalProperties);
    }
    ...
    public readonly struct NameValue : Menes.IJsonValue, System.IEquatable<NameValue>
    {
        public static readonly System.Func<System.Text.Json.JsonElement, NameValue> FromJsonElement = e => new NameValue(e);
        public static readonly NameValue Null = new NameValue(default(System.Text.Json.JsonElement));
        private readonly Menes.JsonAny? value;
        public NameValue(Menes.JsonAny value)
        {
        ...
        public NameValue(System.Text.Json.JsonElement jsonElement)
        {
            this.value = null;
            this.JsonElement = jsonElement;
        }
        public bool IsNull => this.value == null && (this.JsonElement.ValueKind == System.Text.Json.JsonValueKind.Undefined || this.JsonElement.ValueKind == System.Text.Json.JsonValueKind.Null);
        public NameValue? AsOptional => this.IsNull ? default(NameValue?) : this;
        public bool HasJsonElement => this.JsonElement.ValueKind != System.Text.Json.JsonValueKind.Undefined;
        public System.Text.Json.JsonElement JsonElement { get; }
        public static implicit operator NameValue(Menes.JsonAny value)
        {
            return new NameValue(value);
        }
        public static implicit operator Menes.JsonAny(NameValue value)
        {
        ...
        public static NameValue FromOptionalProperty(in System.Text.Json.JsonElement parentDocument, System.ReadOnlySpan<char> propertyName) =>
           parentDocument.ValueKind == System.Text.Json.JsonValueKind.Object ?
                (parentDocument.TryGetProperty(propertyName, out System.Text.Json.JsonElement property)
                    ? new NameValue(property)
                    : Null)
                : Null;
        public static NameValue FromOptionalProperty(in System.Text.Json.JsonElement parentDocument, string propertyName) =>
           parentDocument.ValueKind == System.Text.Json.JsonValueKind.Object ?
                (parentDocument.TryGetProperty(propertyName, out System.Text.Json.JsonElement property)
                    ? new NameValue(property)
                    : Null)
                : Null;
        public static NameValue FromOptionalProperty(in System.Text.Json.JsonElement parentDocument, System.ReadOnlySpan<byte> utf8PropertyName) =>
           parentDocument.ValueKind == System.Text.Json.JsonValueKind.Object ?
                (parentDocument.TryGetProperty(utf8PropertyName, out System.Text.Json.JsonElement property)
                    ? new NameValue(property)
                    : Null)
        ...
        public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
        {
            ...
            Menes.JsonString anyOfitem2 = Menes.JsonAny.From(value).As<Menes.JsonString>();
...
/// </summary>
    public static bool Test0()
    {
        ...
        var schema = new HttpLocalhost1234Object(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed RefRemote006.Tests.Test0: string is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed RefRemote006.Tests.Test1: null is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed RefRemote006.Tests.Test2: object is invalid");
