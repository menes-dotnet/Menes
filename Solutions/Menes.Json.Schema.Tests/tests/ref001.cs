// <copyright file="ref001.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Ref001
{
public readonly struct TestSchema : Menes.IJsonObject, System.IEquatable<TestSchema>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
{
    ...
    public TestSchema(Menes.JsonInteger? foo, Menes.JsonInteger? bar, Menes.JsonProperties<Menes.JsonAny> additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
    ...
    public TestSchema(Menes.JsonInteger? foo, Menes.JsonInteger? bar, params (string, Menes.JsonAny)[] additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(Menes.JsonInteger? foo = null, Menes.JsonInteger? bar = null)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(Menes.JsonInteger? foo, Menes.JsonInteger? bar, (string, Menes.JsonAny) additionalProperty1)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(Menes.JsonInteger? foo, Menes.JsonInteger? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(Menes.JsonInteger? foo, Menes.JsonInteger? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public TestSchema(Menes.JsonInteger? foo, Menes.JsonInteger? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3, (string, Menes.JsonAny) additionalProperty4)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    private TestSchema(Menes.JsonInteger? foo, Menes.JsonInteger? bar, Menes.JsonProperties<Menes.JsonAny>? additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public Menes.JsonInteger? Bar => this.bar ?? Menes.JsonInteger.FromOptionalProperty(this.JsonElement, BarPropertyNameBytes.Span).AsOptional;
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"bar\": 3}");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Ref001.Tests.Test0: match");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"bar\": true}");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Ref001.Tests.Test1: mismatch");
