// <copyright file="dependentSchemas001.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.DependentSchemas001
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed DependentSchemas001.Tests.Test0: object with property having schema true is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed DependentSchemas001.Tests.Test1: object with property having schema false is invalid");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed DependentSchemas001.Tests.Test2: object with both properties is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed DependentSchemas001.Tests.Test3: empty object is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
