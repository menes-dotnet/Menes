...
public readonly struct TestSchema : Menes.IJsonValue
{
    ...
    public TestSchema(Menes.JsonNull clrInstance)
    {
        if (clrInstance.HasJsonElement)
        {
            this.JsonElement = clrInstance.JsonElement;
    ...
    public static explicit operator Menes.JsonNull(TestSchema value) => value.AsJsonNull();
    public static implicit operator TestSchema(Menes.JsonNull value) => new TestSchema(value);
