...
public readonly struct Schema : Menes.IJsonObject, System.IEquatable<Schema>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
{
    ...
    public Schema(Menes.JsonInteger? foo, Menes.JsonString? bar, Menes.JsonProperties<Menes.JsonAny> additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
    ...
    public Schema(Menes.JsonInteger? foo, Menes.JsonString? bar, params (string, Menes.JsonAny)[] additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public Schema(Menes.JsonInteger? foo = null, Menes.JsonString? bar = null)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public Schema(Menes.JsonInteger? foo, Menes.JsonString? bar, (string, Menes.JsonAny) additionalProperty1)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public Schema(Menes.JsonInteger? foo, Menes.JsonString? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public Schema(Menes.JsonInteger? foo, Menes.JsonString? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public Schema(Menes.JsonInteger? foo, Menes.JsonString? bar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3, (string, Menes.JsonAny) additionalProperty4)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    private Schema(Menes.JsonInteger? foo, Menes.JsonString? bar, Menes.JsonProperties<Menes.JsonAny>? additionalPropertiesBacking)
    {
        this.foo = foo;
        this.bar = bar;
        this.JsonElement = default;
    ...
    public static Schema FromOptionalProperty(in System.Text.Json.JsonElement parentDocument, System.ReadOnlySpan<byte> utf8PropertyName) =>
       parentDocument.ValueKind == System.Text.Json.JsonValueKind.Object ?
            (parentDocument.TryGetProperty(utf8PropertyName, out System.Text.Json.JsonElement property)
                ...
                : Null)
        : Null;
    public Schema WithFoo(Menes.JsonInteger? value)
    {
        return new Schema(value, this.Bar, this.GetJsonProperties());
    }
    public Schema WithBar(Menes.JsonString? value)
    {
