// <copyright file="additionalItems000.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.AdditionalItems000
{
public readonly struct Schema : Menes.IJsonValue, System.Collections.Generic.IEnumerable<Menes.JsonAny>, System.Collections.IEnumerable, System.IEquatable<Schema>, System.IEquatable<Menes.JsonArray<Menes.JsonAny>>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        {
            context = Menes.Validation.ValidateProperty(context, Menes.JsonAny.From(itemsValidationEnumerator.Current).As<Menes.JsonInteger>(), $"[{extraIndex + 1}]");
            extraIndex++;
        }
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[ null, 2, 3, 4 ]");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed AdditionalItems000.Tests.Test0: additional items match schema");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("[ null, 2, 3, \"foo\" ]");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed AdditionalItems000.Tests.Test1: additional items do not match schema");
