// <copyright file="const009.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Const009
{
public readonly struct Schema : Menes.IJsonValue, System.IEquatable<Schema>
{
    ...
    {
        using var document = System.Text.Json.JsonDocument.Parse("{\"a\":true}");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"a\": true}");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Const009.Tests.Test0: {\"a\": true} is valid");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"a\": 1}");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const009.Tests.Test1: {\"a\": 1} is invalid");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("{\"a\": 1.0}");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const009.Tests.Test2: {\"a\": 1.0} is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
