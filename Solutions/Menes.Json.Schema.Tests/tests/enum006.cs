// <copyright file="enum006.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Enum006
{
public readonly struct TestSchema : Menes.IJsonValue, System.IEquatable<TestSchema>
{
    ...
    public static readonly TestSchema True = new TestSchema(EnumValues[0]);
    ...
    private static System.Collections.Immutable.ImmutableArray<Menes.JsonAny> BuildEnumValues()
    {
        ...
        using var document = System.Text.Json.JsonDocument.Parse("[true]");
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Enum006.Tests.Test0: true is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Enum006.Tests.Test1: integer one is invalid");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Enum006.Tests.Test2: float one is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
