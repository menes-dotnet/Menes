// <copyright file="allOf008.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.AllOf008
{
public readonly struct Schema : Menes.IJsonValue, System.IEquatable<Schema>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        Menes.JsonNumber jsonNumberAllOfValue1 = Menes.JsonAny.From(value).As<Menes.JsonNumber>();
        allOfValidationContext2 = jsonNumberAllOfValue1.Validate(allOfValidationContext2);
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed AllOf008.Tests.Test0: number is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed AllOf008.Tests.Test1: string is invalid");
