// <copyright file="enum005.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Enum005
{
public readonly struct TestSchema : Menes.IJsonValue, System.IEquatable<TestSchema>
{
    ...
    public static readonly TestSchema False = new TestSchema(EnumValues[0]);
    ...
    private static System.Collections.Immutable.ImmutableArray<Menes.JsonAny> BuildEnumValues()
    {
        ...
        using var document = System.Text.Json.JsonDocument.Parse("[false]");
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Enum005.Tests.Test0: false is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Enum005.Tests.Test1: integer zero is invalid");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Enum005.Tests.Test2: float zero is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
