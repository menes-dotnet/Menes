// <copyright file="unevaluatedProperties019.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.UnevaluatedProperties019
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UnevaluatedProperties019.Tests.Test0: with no nested unevaluated properties");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed UnevaluatedProperties019.Tests.Test1: with nested unevaluated properties");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
