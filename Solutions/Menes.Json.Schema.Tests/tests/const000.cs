// <copyright file="const000.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Const000
{
public readonly struct TestSchema : Menes.IJsonValue, System.IEquatable<TestSchema>
{
    ...
    {
        using var document = System.Text.Json.JsonDocument.Parse("2");
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Const000.Tests.Test0: same value is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const000.Tests.Test1: another value is invalid");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Const000.Tests.Test2: another type is invalid");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
