// <copyright file="if-then-else001.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.IfThenElse001
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse001.Tests.Test0: valid when valid against lone then");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("\"hello\"");
        var schema = new TestSchema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed IfThenElse001.Tests.Test1: valid when invalid against lone then");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
