// <copyright file="type003.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Type003
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Type003.Tests.Test0: an integer is not an object");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Type003.Tests.Test1: a float is not an object");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Type003.Tests.Test2: a string is not an object");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test3()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Type003.Tests.Test3: an object is an object");
...
/// </summary>
    public static bool Test4()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Type003.Tests.Test4: an array is not an object");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test5()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Type003.Tests.Test5: a boolean is not an object");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
...
/// </summary>
    public static bool Test6()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Type003.Tests.Test6: null is not an object");
            System.Console.WriteLine("Expected: invalid but was valid");
            return false;
        }
            return true;
