...
public readonly struct TestSchema : Menes.IJsonObject, System.IEquatable<TestSchema>, Menes.IJsonAdditionalProperties<Menes.JsonBoolean>
{
    ...
    public TestSchema(params (string, Menes.JsonBoolean)[] additionalPropertiesBacking)
    {
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonBoolean>.FromValues(additionalPropertiesBacking);
    }
    public TestSchema((string, Menes.JsonBoolean) additionalProperty1)
    {
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonBoolean>.FromValues(additionalProperty1);
    }
    public TestSchema((string, Menes.JsonBoolean) additionalProperty1, (string, Menes.JsonBoolean) additionalProperty2)
    {
        this.JsonElement = default;
    ...
    public TestSchema((string, Menes.JsonBoolean) additionalProperty1, (string, Menes.JsonBoolean) additionalProperty2, (string, Menes.JsonBoolean) additionalProperty3)
    {
        this.JsonElement = default;
    ...
    public TestSchema((string, Menes.JsonBoolean) additionalProperty1, (string, Menes.JsonBoolean) additionalProperty2, (string, Menes.JsonBoolean) additionalProperty3, (string, Menes.JsonBoolean) additionalProperty4)
    {
        this.JsonElement = default;
    ...
    private TestSchema(Menes.JsonProperties<Menes.JsonBoolean>? additionalPropertiesBacking)
    {
        this.JsonElement = default;
    ...
    {
        return new TestSchema(Menes.JsonProperties<Menes.JsonBoolean>.FromValues(newAdditional));
    }
    public TestSchema ReplaceAll((string, Menes.JsonBoolean) newAdditional1)
    {
        return new TestSchema(Menes.JsonProperties<Menes.JsonBoolean>.FromValues(newAdditional1));
    }
    public TestSchema ReplaceAll((string, Menes.JsonBoolean) newAdditional1, (string, Menes.JsonBoolean) newAdditional2)
    {
        return new TestSchema(Menes.JsonProperties<Menes.JsonBoolean>.FromValues(newAdditional1, newAdditional2));
    }
    ...
    {
        return new TestSchema(Menes.JsonProperties<Menes.JsonBoolean>.FromValues(newAdditional1, newAdditional2, newAdditional3));
    }
    ...
    {
        return new TestSchema(Menes.JsonProperties<Menes.JsonBoolean>.FromValues(newAdditional1, newAdditional2, newAdditional3, newAdditional4));
    }
    public TestSchema Add(params (string, Menes.JsonBoolean)[] newAdditional)
    {
        ...
        return new TestSchema(new Menes.JsonProperties<Menes.JsonBoolean>(arrayBuilder.ToImmutable()));
    }
    public TestSchema Add((string name, Menes.JsonBoolean value) newAdditional1)
    {
        ...
        arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonBoolean>.From(newAdditional1.name, newAdditional1.value)); return new TestSchema(new Menes.JsonProperties<Menes.JsonBoolean>(arrayBuilder.ToImmutable()));
    }
    public TestSchema Add((string name, Menes.JsonBoolean value) newAdditional1, (string name, Menes.JsonBoolean value) newAdditional2)
    {
        ...
        arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonBoolean>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonBoolean>.From(newAdditional2.name, newAdditional2.value)); return new TestSchema(new Menes.JsonProperties<Menes.JsonBoolean>(arrayBuilder.ToImmutable()));
    }
    ...
    public TestSchema Add((string name, Menes.JsonBoolean value) newAdditional1, (string name, Menes.JsonBoolean value) newAdditional2, (string name, Menes.JsonBoolean value) newAdditional3, (string name, Menes.JsonBoolean value) newAdditional4)
    {
        ...
        arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonBoolean>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonBoolean>.From(newAdditional2.name, newAdditional2.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonBoolean>.From(newAdditional3.name, newAdditional3.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonBoolean>.From(newAdditional4.name, newAdditional4.value)); return new TestSchema(new Menes.JsonProperties<Menes.JsonBoolean>(arrayBuilder.ToImmutable()));
    }
    ...
    public readonly struct TestSchemaValue : Menes.IJsonObject, System.IEquatable<TestSchema.TestSchemaValue>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
    {
        ...
        public TestSchemaValue(Menes.JsonAny? foo, Menes.JsonProperties<Menes.JsonAny> additionalPropertiesBacking)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = additionalPropertiesBacking;
        }
        public TestSchemaValue(Menes.JsonAny? foo, params (string, Menes.JsonAny)[] additionalPropertiesBacking)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalPropertiesBacking);
        }
        public TestSchemaValue(Menes.JsonAny? foo = null)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = null;
        }
        public TestSchemaValue(Menes.JsonAny? foo, (string, Menes.JsonAny) additionalProperty1)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1);
        }
        public TestSchemaValue(Menes.JsonAny? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1, additionalProperty2);
        }
        public TestSchemaValue(Menes.JsonAny? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3)
        {
            this.foo = foo;
            this.JsonElement = default;
        ...
        public TestSchemaValue(Menes.JsonAny? foo, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3, (string, Menes.JsonAny) additionalProperty4)
        {
            this.foo = foo;
            this.JsonElement = default;
        ...
        private TestSchemaValue(Menes.JsonAny? foo, Menes.JsonProperties<Menes.JsonAny>? additionalPropertiesBacking)
        {
            this.foo = foo;
            this.JsonElement = default;
            this.additionalPropertiesBacking = additionalPropertiesBacking;
        ...
        public static TestSchema.TestSchemaValue FromOptionalProperty(in System.Text.Json.JsonElement parentDocument, System.ReadOnlySpan<byte> utf8PropertyName) =>
           parentDocument.ValueKind == System.Text.Json.JsonValueKind.Object ?
                (parentDocument.TryGetProperty(utf8PropertyName, out System.Text.Json.JsonElement property)
                    ...
                    : Null)
            : Null;
        public TestSchema.TestSchemaValue WithFoo(Menes.JsonAny? value)
        {
        ...
        {
            return new TestSchema.TestSchemaValue(this.Foo, newAdditional);
        }
        public TestSchema.TestSchemaValue ReplaceAll(params (string, Menes.JsonAny)[] newAdditional)
        {
            return new TestSchema.TestSchemaValue(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional));
        }
        public TestSchema.TestSchemaValue ReplaceAll((string, Menes.JsonAny) newAdditional1)
        {
            return new TestSchema.TestSchemaValue(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1));
        }
        public TestSchema.TestSchemaValue ReplaceAll((string, Menes.JsonAny) newAdditional1, (string, Menes.JsonAny) newAdditional2)
        {
            return new TestSchema.TestSchemaValue(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2));
        }
        ...
        {
            return new TestSchema.TestSchemaValue(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3));
        }
        ...
        {
            return new TestSchema.TestSchemaValue(this.Foo, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3, newAdditional4));
        }
        public TestSchema.TestSchemaValue Add(params (string, Menes.JsonAny)[] newAdditional)
        {
            ...
            return new TestSchema.TestSchemaValue(this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
        public TestSchema.TestSchemaValue Add((string name, Menes.JsonAny value) newAdditional1)
        {
            ...
            arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); return new TestSchema.TestSchemaValue(this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
        public TestSchema.TestSchemaValue Add((string name, Menes.JsonAny value) newAdditional1, (string name, Menes.JsonAny value) newAdditional2)
        {
            ...
            arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional2.name, newAdditional2.value)); return new TestSchema.TestSchemaValue(this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
        ...
        public TestSchema.TestSchemaValue Add((string name, Menes.JsonAny value) newAdditional1, (string name, Menes.JsonAny value) newAdditional2, (string name, Menes.JsonAny value) newAdditional3, (string name, Menes.JsonAny value) newAdditional4)
        {
            ...
            arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional2.name, newAdditional2.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional3.name, newAdditional3.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional4.name, newAdditional4.value)); return new TestSchema.TestSchemaValue(this.Foo, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
        }
