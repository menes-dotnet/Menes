// <copyright file="multipleOf000.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.MultipleOf000
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MultipleOf000.Tests.Test0: int by int");
...
/// </summary>
    ...
    {
        using var doc = System.Text.Json.JsonDocument.Parse("7");
        var schema = new Schema(doc.RootElement);
        var context = schema.Validate(Menes.ValidationContext.Root);
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed MultipleOf000.Tests.Test1: int by int fail");
...
/// </summary>
    public static bool Test2()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed MultipleOf000.Tests.Test2: ignores non-numbers");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
