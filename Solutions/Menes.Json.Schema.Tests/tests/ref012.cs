// <copyright file="ref012.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.Ref012
{
public readonly struct TestSchema : Menes.IJsonObject, System.IEquatable<TestSchema>, Menes.IJsonAdditionalProperties<Menes.JsonAny>
{
    ...
    private const string FooBarPropertyNamePath = ".foo\"bar";
    private static readonly System.ReadOnlyMemory<byte> FooBarPropertyNameBytes = new byte[] { 102, 111, 111, 34, 98, 97, 114 };
    ...
    private static readonly System.Collections.Immutable.ImmutableArray<System.ReadOnlyMemory<byte>> KnownProperties = System.Collections.Immutable.ImmutableArray.Create(FooBarPropertyNameBytes);
    ...
    public TestSchema(Menes.JsonNumber? fooBar, Menes.JsonProperties<Menes.JsonAny> additionalPropertiesBacking)
    {
        this.fooBar = fooBar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = additionalPropertiesBacking;
    }
    public TestSchema(Menes.JsonNumber? fooBar, params (string, Menes.JsonAny)[] additionalPropertiesBacking)
    {
        this.fooBar = fooBar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalPropertiesBacking);
    }
    public TestSchema(Menes.JsonNumber? fooBar = null)
    {
        this.fooBar = fooBar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = null;
    }
    public TestSchema(Menes.JsonNumber? fooBar, (string, Menes.JsonAny) additionalProperty1)
    {
        this.fooBar = fooBar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1);
    }
    public TestSchema(Menes.JsonNumber? fooBar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2)
    {
        this.fooBar = fooBar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = Menes.JsonProperties<Menes.JsonAny>.FromValues(additionalProperty1, additionalProperty2);
    }
    public TestSchema(Menes.JsonNumber? fooBar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3)
    {
        this.fooBar = fooBar;
        this.JsonElement = default;
    ...
    public TestSchema(Menes.JsonNumber? fooBar, (string, Menes.JsonAny) additionalProperty1, (string, Menes.JsonAny) additionalProperty2, (string, Menes.JsonAny) additionalProperty3, (string, Menes.JsonAny) additionalProperty4)
    {
        this.fooBar = fooBar;
        this.JsonElement = default;
    ...
    private TestSchema(Menes.JsonNumber? fooBar, Menes.JsonProperties<Menes.JsonAny>? additionalPropertiesBacking)
    {
        this.fooBar = fooBar;
        this.JsonElement = default;
        this.additionalPropertiesBacking = additionalPropertiesBacking;
    }
    public bool IsNull => (this.JsonElement.ValueKind == System.Text.Json.JsonValueKind.Undefined || this.JsonElement.ValueKind == System.Text.Json.JsonValueKind.Null) && (this.fooBar is null || this.fooBar.Value.IsNull);
    ...
    {
        return new TestSchema(this.FooBar, newAdditional);
    }
    public TestSchema ReplaceAll(params (string, Menes.JsonAny)[] newAdditional)
    {
        return new TestSchema(this.FooBar, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional));
    }
    public TestSchema ReplaceAll((string, Menes.JsonAny) newAdditional1)
    {
        return new TestSchema(this.FooBar, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1));
    }
    public TestSchema ReplaceAll((string, Menes.JsonAny) newAdditional1, (string, Menes.JsonAny) newAdditional2)
    {
        return new TestSchema(this.FooBar, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2));
    }
    ...
    {
        return new TestSchema(this.FooBar, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3));
    }
    ...
    {
        return new TestSchema(this.FooBar, Menes.JsonProperties<Menes.JsonAny>.FromValues(newAdditional1, newAdditional2, newAdditional3, newAdditional4));
    }
    public TestSchema Add(params (string, Menes.JsonAny)[] newAdditional)
    {
        ...
        return new TestSchema(this.FooBar, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
    }
    public TestSchema Add((string name, Menes.JsonAny value) newAdditional1)
    {
        ...
        arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); return new TestSchema(this.FooBar, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
    }
    public TestSchema Add((string name, Menes.JsonAny value) newAdditional1, (string name, Menes.JsonAny value) newAdditional2)
    {
        ...
        arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional2.name, newAdditional2.value)); return new TestSchema(this.FooBar, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
    }
    ...
    public TestSchema Add((string name, Menes.JsonAny value) newAdditional1, (string name, Menes.JsonAny value) newAdditional2, (string name, Menes.JsonAny value) newAdditional3, (string name, Menes.JsonAny value) newAdditional4)
    {
        ...
        arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional1.name, newAdditional1.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional2.name, newAdditional2.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional3.name, newAdditional3.value)); arrayBuilder.Add(Menes.JsonPropertyReference<Menes.JsonAny>.From(newAdditional4.name, newAdditional4.value)); return new TestSchema(this.FooBar, new Menes.JsonProperties<Menes.JsonAny>(arrayBuilder.ToImmutable()));
    }
    ...
    public bool Equals(TestSchema other)
    {
        ...
        return this.FooBar.Equals(other.FooBar) && System.Linq.Enumerable.SequenceEqual(this.JsonAdditionalProperties, other.JsonAdditionalProperties);
    }
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed Ref012.Tests.Test0: object with numbers is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed Ref012.Tests.Test1: object with strings is invalid");
