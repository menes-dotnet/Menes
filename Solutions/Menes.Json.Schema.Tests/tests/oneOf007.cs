// <copyright file="oneOf007.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.OneOf007
{
public readonly struct Schema : Menes.IJsonValue, System.IEquatable<Schema>
{
    ...
    public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext)
    {
        ...
        Menes.JsonNumber jsonNumberOneOfValue0 = Menes.JsonAny.From(value).As<Menes.JsonNumber>();
        oneOfValidationContext1 = jsonNumberOneOfValue0.Validate(oneOfValidationContext1);
        ...
        context = Menes.Validation.ValidateOneOf(context, ("Menes.JsonNumber", oneOfValidationContext1), ("Menes.JsonAny", oneOfValidationContext2));
        return context;
    }
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed OneOf007.Tests.Test0: one valid - valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (context.IsValid)
        {
            System.Console.WriteLine("Failed OneOf007.Tests.Test1: both valid - invalid");
