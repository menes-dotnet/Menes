// <copyright file="propertyNames001.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace Menes.Json.Schema.Tests.PropertyNames001
{
...
/// </summary>
    public static bool Test0()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed PropertyNames001.Tests.Test0: object with any properties is valid");
...
/// </summary>
    public static bool Test1()
    {
        ...
        if (!context.IsValid)
        {
            System.Console.WriteLine("Failed PropertyNames001.Tests.Test1: empty object is valid");
            System.Console.WriteLine("Expected: valid but was invalid");
            return false;
        }
            return true;
