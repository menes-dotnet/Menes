...
namespace Menes.JsonSchema
{
    public readonly struct Draft201909Schema : Menes.IJsonObject<Draft201909Schema>
    {
        ...
        public Draft201909Schema(Draft201909MetaCore.IdValue? id = null, Menes.JsonUri? schema = null, Draft201909MetaCore.AnchorValue? anchor = null, Menes.JsonUriReference? @ref = null, Menes.JsonUriReference? recursiveRef = null, Menes.JsonBoolean? recursiveAnchor = null, Draft201909MetaCore.VocabularyEntity? vocabulary = null, Menes.JsonString? comment = null, Draft201909MetaCore.DefsEntity? defs = null, Draft201909Schema? additionalItems = null, Draft201909Schema? unevaluatedItems = null, Draft201909MetaApplicator.ItemsEntity? items = null, Draft201909Schema? contains = null, Draft201909Schema? additionalProperties = null, Draft201909Schema? unevaluatedProperties = null, Draft201909MetaApplicator.PropertiesEntity? properties = null, Draft201909MetaApplicator.PatternPropertiesEntity? patternProperties = null, Draft201909MetaApplicator.DependentSchemasEntity? dependentSchemas = null, Draft201909Schema? propertyNames = null, Draft201909Schema? @if = null, Draft201909Schema? then = null, Draft201909Schema? @else = null, Draft201909MetaApplicator.ItemsEntity.SchemaArray? allOf = null, Draft201909MetaApplicator.ItemsEntity.SchemaArray? anyOf = null, Draft201909MetaApplicator.ItemsEntity.SchemaArray? oneOf = null, Draft201909Schema? not = null, Draft201909MetaValidation.MultipleOfValue? multipleOf = null, Menes.JsonNumber? maximum = null, Menes.JsonNumber? exclusiveMaximum = null, Menes.JsonNumber? minimum = null, Menes.JsonNumber? exclusiveMinimum = null, Draft201909MetaValidation.NonNegativeIntegerValue? maxLength = null, Draft201909MetaValidation.NonNegativeIntegerValue? minLength = null, Menes.JsonRegex? pattern = null, Draft201909MetaValidation.NonNegativeIntegerValue? maxItems = null, Draft201909MetaValidation.NonNegativeIntegerValue? minItems = null, Menes.JsonBoolean? uniqueItems = null, Draft201909MetaValidation.NonNegativeIntegerValue? maxContains = null, Draft201909MetaValidation.NonNegativeIntegerValue? minContains = null, Draft201909MetaValidation.NonNegativeIntegerValue? maxProperties = null, Draft201909MetaValidation.NonNegativeIntegerValue? minProperties = null, Draft201909MetaValidation.StringArray? required = null, Draft201909MetaValidation.DependentRequiredEntity? dependentRequired = null, Menes.JsonAny? @const = null, Draft201909MetaValidation.EnumArray? @enum = null, Draft201909MetaValidation.TypeEntity? type = null, Menes.JsonString? title = null, Menes.JsonString? description = null, Menes.JsonAny? @default = null, Menes.JsonBoolean? deprecated = null, Menes.JsonBoolean? readOnly = null, Menes.JsonBoolean? writeOnly = null, Draft201909MetaMetaData.ExamplesArray? examples = null, Menes.JsonString? format = null, Menes.JsonString? contentMediaType = null, Menes.JsonString? contentEncoding = null, Draft201909Schema? contentSchema = null, Draft201909Schema.DefinitionsEntity? definitions = null, Draft201909Schema.DependenciesEntity? dependencies = null)
        {
            ...
            this.allOf = Menes.JsonValueBacking.From<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(allOf);
            this.anyOf = Menes.JsonValueBacking.From<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(anyOf);
            this.oneOf = Menes.JsonValueBacking.From<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(oneOf);
        ...
        public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
        {
            ...
            return result;
            Menes.ValidationContext ValidateAllOf(in Draft201909Schema that, in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
            {
                Menes.ValidationContext result = validationContext;
                var allOf0 = that.AsDraft201909MetaCore();
                var allOfResult0 = level == Menes.ValidationLevel.Flag ? allOf0.Validate(validationContext.CreateChildContext("https://json-schema.org/draft/2019-09/schema#/allOf/0"), level) : allOf0.Validate(validationContext.CreateChildContext(), level);
                ...
                var allOfResult1 = level == Menes.ValidationLevel.Flag ? allOf1.Validate(validationContext.CreateChildContext("https://json-schema.org/draft/2019-09/schema#/allOf/1"), level) : allOf1.Validate(validationContext.CreateChildContext(), level);
                ...
                var allOfResult2 = level == Menes.ValidationLevel.Flag ? allOf2.Validate(validationContext.CreateChildContext("https://json-schema.org/draft/2019-09/schema#/allOf/2"), level) : allOf2.Validate(validationContext.CreateChildContext(), level);
                ...
                var allOfResult3 = level == Menes.ValidationLevel.Flag ? allOf3.Validate(validationContext.CreateChildContext("https://json-schema.org/draft/2019-09/schema#/allOf/3"), level) : allOf3.Validate(validationContext.CreateChildContext(), level);
                if (level == Menes.ValidationLevel.Flag && !allOfResult3.IsValid)
                {
                ...
                var allOfResult4 = level == Menes.ValidationLevel.Flag ? allOf4.Validate(validationContext.CreateChildContext("https://json-schema.org/draft/2019-09/schema#/allOf/4"), level) : allOf4.Validate(validationContext.CreateChildContext(), level);
                if (level == Menes.ValidationLevel.Flag && !allOfResult4.IsValid)
                {
                ...
                var allOfResult5 = level == Menes.ValidationLevel.Flag ? allOf5.Validate(validationContext.CreateChildContext("https://json-schema.org/draft/2019-09/schema#/allOf/5"), level) : allOf5.Validate(validationContext.CreateChildContext(), level);
                if (level == Menes.ValidationLevel.Flag && !allOfResult5.IsValid)
                {
        ...
        {
            return new Draft201909Schema(this.id, this.schema, this.anchor, this.@ref, this.recursiveRef, this.recursiveAnchor, this.vocabulary, this.comment, this.defs, this.additionalItems, this.unevaluatedItems, this.items, this.contains, this.additionalProperties, this.unevaluatedProperties, this.properties, this.patternProperties, this.dependentSchemas, this.propertyNames, this.@if, this.then, this.@else, Menes.JsonValueBacking.From<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(value), this.anyOf, this.oneOf, this.not, this.multipleOf, this.maximum, this.exclusiveMaximum, this.minimum, this.exclusiveMinimum, this.maxLength, this.minLength, this.pattern, this.maxItems, this.minItems, this.uniqueItems, this.maxContains, this.minContains, this.maxProperties, this.minProperties, this.required, this.dependentRequired, this.@const, this.@enum, this.type, this.title, this.description, this.@default, this.deprecated, this.readOnly, this.writeOnly, this.examples, this.format, this.contentMediaType, this.contentEncoding, this.contentSchema, this.definitions, this.dependencies, this._menesBooleanTypeBacking, this._menesAdditionalPropertiesBacking);
        }
        public Draft201909Schema WithAnyOf(Draft201909MetaApplicator.ItemsEntity.SchemaArray value)
        {
            return new Draft201909Schema(this.id, this.schema, this.anchor, this.@ref, this.recursiveRef, this.recursiveAnchor, this.vocabulary, this.comment, this.defs, this.additionalItems, this.unevaluatedItems, this.items, this.contains, this.additionalProperties, this.unevaluatedProperties, this.properties, this.patternProperties, this.dependentSchemas, this.propertyNames, this.@if, this.then, this.@else, this.allOf, Menes.JsonValueBacking.From<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(value), this.oneOf, this.not, this.multipleOf, this.maximum, this.exclusiveMaximum, this.minimum, this.exclusiveMinimum, this.maxLength, this.minLength, this.pattern, this.maxItems, this.minItems, this.uniqueItems, this.maxContains, this.minContains, this.maxProperties, this.minProperties, this.required, this.dependentRequired, this.@const, this.@enum, this.type, this.title, this.description, this.@default, this.deprecated, this.readOnly, this.writeOnly, this.examples, this.format, this.contentMediaType, this.contentEncoding, this.contentSchema, this.definitions, this.dependencies, this._menesBooleanTypeBacking, this._menesAdditionalPropertiesBacking);
        }
        public Draft201909Schema WithOneOf(Draft201909MetaApplicator.ItemsEntity.SchemaArray value)
        {
            return new Draft201909Schema(this.id, this.schema, this.anchor, this.@ref, this.recursiveRef, this.recursiveAnchor, this.vocabulary, this.comment, this.defs, this.additionalItems, this.unevaluatedItems, this.items, this.contains, this.additionalProperties, this.unevaluatedProperties, this.properties, this.patternProperties, this.dependentSchemas, this.propertyNames, this.@if, this.then, this.@else, this.allOf, this.anyOf, Menes.JsonValueBacking.From<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(value), this.not, this.multipleOf, this.maximum, this.exclusiveMaximum, this.minimum, this.exclusiveMinimum, this.maxLength, this.minLength, this.pattern, this.maxItems, this.minItems, this.uniqueItems, this.maxContains, this.minContains, this.maxProperties, this.minProperties, this.required, this.dependentRequired, this.@const, this.@enum, this.type, this.title, this.description, this.@default, this.deprecated, this.readOnly, this.writeOnly, this.examples, this.format, this.contentMediaType, this.contentEncoding, this.contentSchema, this.definitions, this.dependencies, this._menesBooleanTypeBacking, this._menesAdditionalPropertiesBacking);
        }
        ...
        public readonly struct DependenciesEntity : Menes.IJsonObject<DependenciesEntity>
        {
            ...
            public readonly struct AdditionalPropertiesEntity : Menes.IJsonValue
            {
                ...
                public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
                {
                    ...
                    return result;
                    Menes.ValidationContext ValidateAnyOf(in Draft201909Schema.DependenciesEntity.AdditionalPropertiesEntity that, in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
                    {
                        Menes.ValidationContext result = validationContext;
