...
namespace Menes.JsonSchema
{
    ...
    public partial class SchemaVisitor
    {
        ...
        protected virtual ValueTask<(bool, Schema.NonNegativeInteger?)> VisitMinItems(Schema.NonNegativeInteger? minItemsToUpdate)
        {
            return new ValueTask<(bool, Schema.NonNegativeInteger?)>((false, minItemsToUpdate));
        }
    }
}
