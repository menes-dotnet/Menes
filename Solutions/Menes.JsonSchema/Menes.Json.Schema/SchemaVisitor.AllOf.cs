...
namespace Menes.Json.Schema
{
    ...
    public partial class SchemaVisitor
    {
        ...
        protected virtual async Task<(bool, JsonSchema.ValidatedArrayOfSchemaOrReference?)> VisitAllOf(JsonSchema.ValidatedArrayOfSchemaOrReference? arrayOfSchemaOrReferenceToUpdate)
        {
