...
namespace Menes.Json.Schema
{
    ...
    public partial class SchemaVisitor
    {
        ...
        protected virtual Task<(bool, JsonSchema.NonNegativeInteger?)> VisitMinContains(JsonSchema.NonNegativeInteger? minContainsToUpdate)
        {
            return Task.FromResult<(bool, JsonSchema.NonNegativeInteger?)>((false, minContainsToUpdate));
        }
    }
}
