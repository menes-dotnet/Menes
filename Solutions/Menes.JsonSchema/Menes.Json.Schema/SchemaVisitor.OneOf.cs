...
namespace Menes.Json.Schema
{
    ...
    public partial class SchemaVisitor
    {
        ...
        protected virtual async ValueTask<(bool, JsonSchema.ValidatedArrayOfSchemaOrReference?)> VisitOneOf(JsonSchema.ValidatedArrayOfSchemaOrReference? arrayOfSchemaOrReferenceToUpdate)
        {
