...
namespace Menes.Json.Schema
{
    ...
    public partial class SchemaVisitor
    {
        ...
        protected virtual ValueTask<(bool, JsonSchema.NonNegativeInteger?)> VisitMaxLength(JsonSchema.NonNegativeInteger? maxLengthToUpdate)
        {
            return new ValueTask<(bool, JsonSchema.NonNegativeInteger?)>((false, maxLengthToUpdate));
        }
    }
}
