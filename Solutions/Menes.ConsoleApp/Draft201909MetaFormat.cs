...
{
public readonly struct Draft201909MetaFormat : Menes.IJsonObject<Draft201909MetaFormat>
{
...
{
    aklPush0.Push("https://json-schema.org/draft/2019-09/meta/format#/format");
}
    evaluatedProperties?.Add("format");
    if (this.TryGetProperty<Menes.JsonString>(_MenesFormatJsonPropertyName.Span, out Menes.JsonString value0))
    {
...
{
    var rc = this.TryGetPropertyAtIndex(index, out Menes.Property<Draft201909MetaFormat> prop);
    result = prop;
    return rc;
}
...
private Draft201909MetaFormat WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> value)
{
...
public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.Property<Draft201909MetaFormat>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.Property<Draft201909MetaFormat>>, System.Collections.IEnumerator
{
    ...
    public Menes.Property<Draft201909MetaFormat> Current
    {
        get
        {
            ...
            {
                if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.Property<Draft201909MetaFormat> result))
                {
                    return result;
                }
