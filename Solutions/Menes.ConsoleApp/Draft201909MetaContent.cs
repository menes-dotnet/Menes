    ...
    public readonly struct Draft201909MetaContent : Menes.IJsonObject<Draft201909MetaContent>
    {
        ...
        public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
        {
            ...
            if (this.IsObject)
            {
                ...
                {
                    aklPush0.Push("https://json-schema.org/draft/2019-09/meta/content#/contentMediaType");
                }
                evaluatedProperties?.Add("contentMediaType");
                ...
                {
                    aklPush1.Push("https://json-schema.org/draft/2019-09/meta/content#/contentEncoding");
                }
                evaluatedProperties?.Add("contentEncoding");
                ...
                {
                    aklPush2.Push("https://json-schema.org/draft/2019-09/meta/content#/contentSchema");
                }
                evaluatedProperties?.Add("contentSchema");
                if (this.TryGetProperty<Draft201909MetaContent>(_MenesContentSchemaJsonPropertyName.Span, out Draft201909MetaContent value2))
                {
