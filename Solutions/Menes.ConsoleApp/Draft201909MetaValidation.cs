    ...
    public readonly struct Draft201909MetaValidation : Menes.IJsonObject<Draft201909MetaValidation>
    {
        ...
        public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
        {
            ...
            if (this.IsObject)
            {
                ...
                {
                    aklPush0.Push("https://json-schema.org/draft/2019-09/meta/validation#/multipleOf");
                }
                evaluatedProperties?.Add("multipleOf");
                ...
                {
                    result = value0.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                {
                    aklPush1.Push("https://json-schema.org/draft/2019-09/meta/validation#/maximum");
                }
                evaluatedProperties?.Add("maximum");
                if (this.TryGetProperty<Menes.JsonNumber>(_MenesMaximumJsonPropertyName.Span, out Menes.JsonNumber value1))
                {
                    result = value1.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                {
                    aklPush2.Push("https://json-schema.org/draft/2019-09/meta/validation#/exclusiveMaximum");
                }
                evaluatedProperties?.Add("exclusiveMaximum");
                if (this.TryGetProperty<Menes.JsonNumber>(_MenesExclusiveMaximumJsonPropertyName.Span, out Menes.JsonNumber value2))
                {
                    result = value2.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                {
                    aklPush3.Push("https://json-schema.org/draft/2019-09/meta/validation#/minimum");
                }
                evaluatedProperties?.Add("minimum");
                if (this.TryGetProperty<Menes.JsonNumber>(_MenesMinimumJsonPropertyName.Span, out Menes.JsonNumber value3))
                {
                    result = value3.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                {
                    aklPush4.Push("https://json-schema.org/draft/2019-09/meta/validation#/exclusiveMinimum");
                }
                evaluatedProperties?.Add("exclusiveMinimum");
                if (this.TryGetProperty<Menes.JsonNumber>(_MenesExclusiveMinimumJsonPropertyName.Span, out Menes.JsonNumber value4))
                {
                    result = value4.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                {
                    aklPush5.Push("https://json-schema.org/draft/2019-09/meta/validation#/maxLength");
                }
                evaluatedProperties?.Add("maxLength");
                ...
                {
                    result = value5.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush6)
                {
                    aklPush6.Push("https://json-schema.org/draft/2019-09/meta/validation#/minLength");
                }
                evaluatedProperties?.Add("minLength");
                ...
                {
                    result = value6.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop6)
                {
                    aklPop6.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush7)
                {
                    aklPush7.Push("https://json-schema.org/draft/2019-09/meta/validation#/pattern");
                }
                evaluatedProperties?.Add("pattern");
                if (this.TryGetProperty<Menes.JsonRegex>(_MenesPatternJsonPropertyName.Span, out Menes.JsonRegex value7))
                {
                    result = value7.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop7)
                {
                    aklPop7.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush8)
                {
                    aklPush8.Push("https://json-schema.org/draft/2019-09/meta/validation#/maxItems");
                }
                evaluatedProperties?.Add("maxItems");
                ...
                {
                    result = value8.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop8)
                {
                    aklPop8.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush9)
                {
                    aklPush9.Push("https://json-schema.org/draft/2019-09/meta/validation#/minItems");
                }
                evaluatedProperties?.Add("minItems");
                ...
                {
                    result = value9.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop9)
                {
                    aklPop9.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush10)
                {
                    aklPush10.Push("https://json-schema.org/draft/2019-09/meta/validation#/uniqueItems");
                }
                evaluatedProperties?.Add("uniqueItems");
                if (this.TryGetProperty<Menes.JsonBoolean>(_MenesUniqueItemsJsonPropertyName.Span, out Menes.JsonBoolean value10))
                {
                    result = value10.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop10)
                {
                    aklPop10.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush11)
                {
                    aklPush11.Push("https://json-schema.org/draft/2019-09/meta/validation#/maxContains");
                }
                evaluatedProperties?.Add("maxContains");
                ...
                {
                    result = value11.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop11)
                {
                    aklPop11.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush12)
                {
                    aklPush12.Push("https://json-schema.org/draft/2019-09/meta/validation#/minContains");
                }
                evaluatedProperties?.Add("minContains");
                ...
                {
                    result = value12.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop12)
                {
                    aklPop12.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush13)
                {
                    aklPush13.Push("https://json-schema.org/draft/2019-09/meta/validation#/maxProperties");
                }
                evaluatedProperties?.Add("maxProperties");
                ...
                {
                    result = value13.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop13)
                {
                    aklPop13.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush14)
                {
                    aklPush14.Push("https://json-schema.org/draft/2019-09/meta/validation#/minProperties");
                }
                evaluatedProperties?.Add("minProperties");
                ...
                {
                    result = value14.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop14)
                {
                    aklPop14.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush15)
                {
                    aklPush15.Push("https://json-schema.org/draft/2019-09/meta/validation#/required");
                }
                evaluatedProperties?.Add("required");
                ...
                {
                    result = value15.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop15)
                {
                    aklPop15.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush16)
                {
                    aklPush16.Push("https://json-schema.org/draft/2019-09/meta/validation#/dependentRequired");
                }
                evaluatedProperties?.Add("dependentRequired");
                ...
                {
                    result = value16.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop16)
                {
                    aklPop16.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush17)
                {
                    aklPush17.Push("https://json-schema.org/draft/2019-09/meta/validation#/const");
                }
                evaluatedProperties?.Add("const");
                if (this.TryGetProperty<Menes.JsonAny>(_MenesConstJsonPropertyName.Span, out Menes.JsonAny value17))
                {
                    result = value17.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop17)
                {
                    aklPop17.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush18)
                {
                    aklPush18.Push("https://json-schema.org/draft/2019-09/meta/validation#/enum");
                }
                evaluatedProperties?.Add("enum");
                ...
                {
                    result = value18.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop18)
                {
                    aklPop18.Pop();
                }
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush19)
                {
                    aklPush19.Push("https://json-schema.org/draft/2019-09/meta/validation#/type");
                }
                evaluatedProperties?.Add("type");
                ...
                {
                    result = value19.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPop19)
                {
                    aklPop19.Pop();
                }
            }
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                if (!this.IsNumber)
                {
                    if (level >= Menes.ValidationLevel.Basic)
                    {
                        ...
                        instanceLocation?.TryPeek(out il);
                        absoluteKeywordLocation?.TryPeek(out akl);
                        result.AddResult(valid: false, message: "6.1.1.  type - item must be one of number", instanceLocation: il, absoluteKeywordLocation: akl);
                    }
                    else
                    {
                        result.SetValid(false);
                ...
                if (this.IsNumber)
                {
                    ...
                    if (number <= (double)0)
                    {
                        if (level >= Menes.ValidationLevel.Basic)
                        {
                            ...
                            instanceLocation?.TryPeek(out il);
                            absoluteKeywordLocation?.TryPeek(out akl);
                            result.AddResult(valid: false, message: "6.2.3.  exclusiveMinimum - item must be greater then 0", instanceLocation: il, absoluteKeywordLocation: akl);
                        }
                        else
                        {
                            result.SetValid(false);
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                if (!this.IsInteger)
                {
                    if (level >= Menes.ValidationLevel.Basic)
                    {
                        ...
                        instanceLocation?.TryPeek(out il);
                        absoluteKeywordLocation?.TryPeek(out akl);
                        result.AddResult(valid: false, message: "6.1.1.  type - item must be one of integer", instanceLocation: il, absoluteKeywordLocation: akl);
                    }
                    else
                    {
                        result.SetValid(false);
                ...
                if (this.IsNumber)
                {
                    ...
                    if (number < (double)0)
                    {
                        if (level >= Menes.ValidationLevel.Basic)
                        {
                            ...
                            instanceLocation?.TryPeek(out il);
                            absoluteKeywordLocation?.TryPeek(out akl);
                            result.AddResult(valid: false, message: "6.2.4.  minimum - item must be greater than or equal to 0", instanceLocation: il, absoluteKeywordLocation: akl);
                        }
                        else
                        {
                            result.SetValid(false);
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                if (!this.IsArray)
                {
                    if (level >= Menes.ValidationLevel.Basic)
                    {
                        ...
                        instanceLocation?.TryPeek(out il);
                        absoluteKeywordLocation?.TryPeek(out akl);
                        result.AddResult(valid: false, message: "6.1.1.  type - item must be one of array", instanceLocation: il, absoluteKeywordLocation: akl);
                    }
                    else
                    {
                        result.SetValid(false);
                ...
                if (!this.IsArray)
                {
                    if (level >= Menes.ValidationLevel.Basic)
                    {
                        ...
                        instanceLocation?.TryPeek(out il);
                        absoluteKeywordLocation?.TryPeek(out akl);
                        result.AddResult(valid: false, message: "6.1.1. type - expected an array type.", instanceLocation: il, absoluteKeywordLocation: akl);
                    }
                    else
                    {
                        result.SetValid(false);
                ...
                if (this.IsArray)
                {
                    ...
                    {
                        result = arrayEnumerator.Current.As<Menes.JsonString>().Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                        if (level == Menes.ValidationLevel.Flag && !result.Valid)
                        {
                            return result;
                        }
                        composedEvaluatedIndices.Add(arrayLength);
                        arrayLength++;
                    }
                }
                return result;
                ...
                if (this.IsObject)
                {
                    foreach (var property in this.EnumerateObject())
                    {
                        if (!evaluatedProperties?.Contains(property.Name) ?? true)
                        {
                            ...
                            result = property.Value<Draft201909MetaValidation.StringArrayEntity>().Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                            if (level == Menes.ValidationLevel.Flag && !result.Valid)
                            {
                                return result;
                            }
        ...
        public readonly struct EnumArray : Menes.IJsonValue, Menes.IJsonArray<EnumArray, Menes.JsonAny>
        {
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                if (this.IsArray)
                {
                    ...
                    while (arrayEnumerator.MoveNext())
                    {
                        result = arrayEnumerator.Current.As<Menes.JsonAny>().Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                        if (level == Menes.ValidationLevel.Flag && !result.Valid)
                        {
                            return result;
                        }
        ...
        public readonly struct TypeEntity : Menes.IJsonValue
        {
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                Menes.ValidationResult ValidateAnyOf(in Draft201909MetaValidation.TypeEntity that, Menes.ValidationResult validationResult, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
                {
                    ...
                    Menes.ValidationResult? preResult = null;
                    if (level == Menes.ValidationLevel.Flag && !that.HasJsonElement)
                    {
                        localEvaluatedProperties.Clear();
                        if (that._menesDraft201909MetaValidationTypeEntitySimpleTypesEntityAnyOfBacking is Draft201909MetaValidation.TypeEntity.SimpleTypesEntity anyOfBacking0)
                        {
                            preResult = anyOfBacking0.Validate(result, level, localEvaluatedProperties, absoluteKeywordLocation, instanceLocation);
                            if (preResult.Valid)
                            {
                        ...
                        localEvaluatedProperties.Clear();
                        if (that._menesDraft201909MetaValidationTypeEntityAnyOf1ArrayAnyOfBacking is Draft201909MetaValidation.TypeEntity.AnyOf1Array anyOfBacking1)
                        {
                            preResult = anyOfBacking1.Validate(result, level, localEvaluatedProperties, absoluteKeywordLocation, instanceLocation);
                            if (preResult.Valid)
                            {
                                foreach (var item in localEvaluatedProperties)
                                {
                        ...
                        if (level >= Menes.ValidationLevel.Basic)
                        {
                            ...
                            instanceLocation?.TryPeek(out il);
                            absoluteKeywordLocation?.TryPeek(out akl);
                            result.AddResult(valid: false, message: "9.2.1.2. anyOf - none of the provided types matched.", instanceLocation: il, absoluteKeywordLocation: akl);
                        }
                        else
                        {
                            result.SetValid(false);
            ...
            public readonly struct SimpleTypesEntity : Menes.IJsonValue
            {
                ...
                public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
                {
                    ...
                    if (!foundMatch)
                    {
                        if (level >= Menes.ValidationLevel.Basic)
                        {
                            ...
                            instanceLocation?.TryPeek(out il);
                            absoluteKeywordLocation?.TryPeek(out akl);
                            result.AddResult(valid: false, message: "6.1.2. enum - does not match enum values \"array\", \"boolean\", \"integer\", \"null\", \"number\", \"object\", \"string\"", instanceLocation: il, absoluteKeywordLocation: akl);
                        }
                        else
                        {
                            result.SetValid(false);
                ...
                {
                    public static readonly Menes.JsonString Item0 = new Menes.JsonString("array");
                    public static readonly Menes.JsonString Array = new Menes.JsonString("array");
                    public static readonly Menes.JsonString Item1 = new Menes.JsonString("boolean");
                    public static readonly Menes.JsonString Boolean = new Menes.JsonString("boolean");
                    public static readonly Menes.JsonString Item2 = new Menes.JsonString("integer");
                    public static readonly Menes.JsonString Integer = new Menes.JsonString("integer");
                    public static readonly Menes.JsonString Item3 = new Menes.JsonString("null");
                    public static readonly Menes.JsonString Null = new Menes.JsonString("null");
                    public static readonly Menes.JsonString Item4 = new Menes.JsonString("number");
                    public static readonly Menes.JsonString Number = new Menes.JsonString("number");
                    public static readonly Menes.JsonString Item5 = new Menes.JsonString("object");
                    public static readonly Menes.JsonString Object = new Menes.JsonString("object");
                    public static readonly Menes.JsonString Item6 = new Menes.JsonString("string");
            ...
            public readonly struct AnyOf1Array : Menes.IJsonValue, Menes.IJsonArray<AnyOf1Array, Draft201909MetaValidation.TypeEntity.SimpleTypesEntity>
            {
                ...
                public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
                {
                    ...
                    if (this.IsArray)
                    {
                        ...
                        while (arrayEnumerator.MoveNext())
                        {
                            result = arrayEnumerator.Current.As<Draft201909MetaValidation.TypeEntity.SimpleTypesEntity>().Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                            if (level == Menes.ValidationLevel.Flag && !result.Valid)
                            {
                                return result;
                            }
                        ...
                        if (arrayLength < 1)
                        {
                            if (level >= Menes.ValidationLevel.Basic)
                            {
                                ...
                                instanceLocation?.TryPeek(out il);
                                absoluteKeywordLocation?.TryPeek(out akl);
                                result.AddResult(valid: false, message: "6.4.2.  minItems - expected a minimum of 1 items", instanceLocation: il, absoluteKeywordLocation: akl);
                            }
                            else
                            {
                                result.SetValid(false);
