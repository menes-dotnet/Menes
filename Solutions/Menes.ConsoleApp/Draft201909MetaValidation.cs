...
namespace TestSpace
{
    public readonly struct Draft201909MetaValidation : Menes.IJsonObject<Draft201909MetaValidation>
    {
        ...
        System.Collections.Generic.IEnumerator<Menes.Property<Draft201909MetaValidation>> System.Collections.Generic.IEnumerable<Menes.Property<Draft201909MetaValidation>>.GetEnumerator() { return this.GetEnumerator(); }
        ...
        public readonly struct StringArrayEntity : Menes.IJsonValue, Menes.IJsonArray<StringArrayEntity, Menes.JsonString>
        {
            ...
            public Draft201909MetaValidation.StringArrayEntity.MenesArrayEnumerator GetEnumerator() { return new Draft201909MetaValidation.StringArrayEntity.MenesArrayEnumerator(this); }
            System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() { return this.GetEnumerator(); }
            System.Collections.Generic.IEnumerator<Menes.JsonString> System.Collections.Generic.IEnumerable<Menes.JsonString>.GetEnumerator() { return this.GetEnumerator(); }/// <inheritdoc />
        ...
        public readonly struct DependentRequiredEntity : Menes.IJsonObject<DependentRequiredEntity>
        {
            ...
            System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() { return this.GetEnumerator(); }
            System.Collections.Generic.IEnumerator<Menes.Property<Draft201909MetaValidation.DependentRequiredEntity>> System.Collections.Generic.IEnumerable<Menes.Property<Draft201909MetaValidation.DependentRequiredEntity>>.GetEnumerator() { return this.GetEnumerator(); }
            private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
where TPropertyValue : struct, Menes.IJsonValue
            {
                return this.GetOptionalPropertyFromJsonElement<TPropertyValue>(propertyName) ?? default;
        ...
        public readonly struct EnumArray : Menes.IJsonValue, Menes.IJsonArray<EnumArray, Draft201909MetaValidation.EnumArray.ItemsEntity>
        {
            ...
            public Draft201909MetaValidation.EnumArray.MenesArrayEnumerator GetEnumerator() { return new Draft201909MetaValidation.EnumArray.MenesArrayEnumerator(this); }
            System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() { return this.GetEnumerator(); }
            System.Collections.Generic.IEnumerator<Draft201909MetaValidation.EnumArray.ItemsEntity> System.Collections.Generic.IEnumerable<Draft201909MetaValidation.EnumArray.ItemsEntity>.GetEnumerator() { return this.GetEnumerator(); }/// <inheritdoc />
            public int GetArrayLength()
            {
                if (this.HasJsonElement)
                {
        ...
        public readonly struct TypeEntity : Menes.IJsonValue
        {
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                Menes.ValidationResult ValidateAnyOf(in Draft201909MetaValidation.TypeEntity that, Menes.ValidationResult validationResult, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
                {
                    ...
                    if (level == Menes.ValidationLevel.Flag)
                    {
                        ...
                        {
                            foundIndex = 0;
                            preResult = anyOfBacking0.Validate(result, level, absoluteKeywordLocation: absoluteKeywordLocation, instanceLocation: instanceLocation);
                            if (preResult.Valid)
                            {
                                return result;
                            }
                        ...
                        {
                            foundIndex = 1;
                            preResult = anyOfBacking1.Validate(result, level, absoluteKeywordLocation: absoluteKeywordLocation, instanceLocation: instanceLocation);
                            if (preResult.Valid)
                            {
                                return result;
                            }
                    ...
                    if (foundIndex == 0)
                    {
                        anyOfResult0 = preResult;
                    }
                    else
                    {
                        var anyOf0 = that.AsSimpleTypesEntity();
                        anyOfResult0 = anyOf0.Validate(result, level, absoluteKeywordLocation: absoluteKeywordLocation, instanceLocation: instanceLocation);
                    ...
                    if (foundIndex == 1)
                    {
                        anyOfResult1 = preResult;
                    }
                    else
                    {
                        var anyOf1 = that.AsAnyOf1Array();
                        anyOfResult1 = anyOf1.Validate(result, level, absoluteKeywordLocation: absoluteKeywordLocation, instanceLocation: instanceLocation);
            ...
            public readonly struct AnyOf1Array : Menes.IJsonValue, Menes.IJsonArray<AnyOf1Array, Draft201909MetaValidation.TypeEntity.SimpleTypesEntity>
            {
                ...
                public Draft201909MetaValidation.TypeEntity.AnyOf1Array.MenesArrayEnumerator GetEnumerator() { return new Draft201909MetaValidation.TypeEntity.AnyOf1Array.MenesArrayEnumerator(this); }
                System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() { return this.GetEnumerator(); }
                System.Collections.Generic.IEnumerator<Draft201909MetaValidation.TypeEntity.SimpleTypesEntity> System.Collections.Generic.IEnumerable<Draft201909MetaValidation.TypeEntity.SimpleTypesEntity>.GetEnumerator() { return this.GetEnumerator(); }/// <inheritdoc />
                public int GetArrayLength()
                {
                    if (this.HasJsonElement)
                    {
