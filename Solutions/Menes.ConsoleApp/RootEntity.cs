    ...
    public readonly struct RootEntity : Menes.IJsonObject<RootEntity>
    {
        ...
        public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
        {
            ...
            Menes.ValidationResult ValidateAnyOf(in RootEntity that, Menes.ValidationResult validationResult, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                {
                    aklPush2.Push("#/anyOf/2");
                }
                localEvaluatedProperties.Clear();
                Menes.ValidationResult anyOfResult2;
                var anyOf2 = that.AsAnyOf2Entity();
                anyOfResult2 = anyOf2.Validate(null, level, localEvaluatedProperties, absoluteKeywordLocation, instanceLocation);
                foreach (var item in localEvaluatedProperties)
                {
                    evaluatedProperties.Add(item);
                }
                ...
                if (!anyOfResult0.Valid && !anyOfResult1.Valid && !anyOfResult2.Valid)
                {
                    if (level >= Menes.ValidationLevel.Basic)
                    {
                        string? il = null;
                ...
                if (this.IsObject)
                {
                    ...
                    else
                    {
                        if (level >= Menes.ValidationLevel.Basic)
                        {
                            ...
                            instanceLocation?.TryPeek(out il);
                            absoluteKeywordLocation?.TryPeek(out akl);
                            result.AddResult(valid: false, message: "6.5.3. required - required property not present.", instanceLocation: il, absoluteKeywordLocation: akl);
                        }
                        else
                        {
                            result.SetValid(false);
                ...
                public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
                {
                    ...
                    if (!this.IsString)
                    {
                        if (level >= Menes.ValidationLevel.Basic)
                        {
                            ...
                            instanceLocation?.TryPeek(out il);
                            absoluteKeywordLocation?.TryPeek(out akl);
                            result.AddResult(valid: false, message: "6.1.3. const - does not match const value \"bar\"", instanceLocation: il, absoluteKeywordLocation: akl);
                        }
                        else
                        {
                            result.SetValid(false);
        ...
        public readonly struct AnyOf1Entity : Menes.IJsonObject<AnyOf1Entity>
        {
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                if (this.IsObject)
                {
                    if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush0)
                    {
                        aklPush0.Push("#/anyOf/1/baz");
                    }
                    evaluatedProperties?.Add("baz");
                ...
                public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
                {
                    ...
                    if (!this.IsString)
                    {
                        if (level >= Menes.ValidationLevel.Basic)
                        {
                            ...
                            instanceLocation?.TryPeek(out il);
                            absoluteKeywordLocation?.TryPeek(out akl);
                            result.AddResult(valid: false, message: "6.1.3. const - does not match const value \"baz\"", instanceLocation: il, absoluteKeywordLocation: akl);
                        }
                        else
                        {
                            result.SetValid(false);
        ...
        public readonly struct AnyOf2Entity : Menes.IJsonObject<AnyOf2Entity>
        {
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                if (this.IsObject)
                {
                    if (absoluteKeywordLocation is System.Collections.Generic.Stack<string> aklPush0)
                    {
                        aklPush0.Push("#/anyOf/2/quux");
                    }
                    evaluatedProperties?.Add("quux");
                ...
                public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
                {
                    ...
                    if (!this.IsString)
                    {
                        if (level >= Menes.ValidationLevel.Basic)
                        {
                            ...
                            instanceLocation?.TryPeek(out il);
                            absoluteKeywordLocation?.TryPeek(out akl);
                            result.AddResult(valid: false, message: "6.1.3. const - does not match const value \"quux\"", instanceLocation: il, absoluteKeywordLocation: akl);
                        }
                        else
                        {
                            result.SetValid(false);
