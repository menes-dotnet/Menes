    ...
    public readonly struct Draft201909MetaMetaData : Menes.IJsonObject<Draft201909MetaMetaData>
    {
        ...
        public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
        {
            ...
            if (this.IsObject)
            {
                ...
                {
                    aklPush0.Push("https://json-schema.org/draft/2019-09/meta/meta-data#/title");
                }
                evaluatedProperties?.Add("title");
                ...
                {
                    aklPush1.Push("https://json-schema.org/draft/2019-09/meta/meta-data#/description");
                }
                evaluatedProperties?.Add("description");
                ...
                {
                    aklPush2.Push("https://json-schema.org/draft/2019-09/meta/meta-data#/default");
                }
                evaluatedProperties?.Add("default");
                ...
                {
                    aklPush3.Push("https://json-schema.org/draft/2019-09/meta/meta-data#/deprecated");
                }
                evaluatedProperties?.Add("deprecated");
                ...
                {
                    aklPush4.Push("https://json-schema.org/draft/2019-09/meta/meta-data#/readOnly");
                }
                evaluatedProperties?.Add("readOnly");
                ...
                {
                    aklPush5.Push("https://json-schema.org/draft/2019-09/meta/meta-data#/writeOnly");
                }
                evaluatedProperties?.Add("writeOnly");
                ...
                {
                    aklPush6.Push("https://json-schema.org/draft/2019-09/meta/meta-data#/examples");
                }
                evaluatedProperties?.Add("examples");
