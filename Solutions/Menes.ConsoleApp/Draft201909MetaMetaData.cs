...
public Draft201909MetaMetaData.MenesPropertyEnumerator GetEnumerator(){    return new Draft201909MetaMetaData.MenesPropertyEnumerator(this);}System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator(){    return this.GetEnumerator();}public Draft201909MetaMetaData WithTitle(Menes.JsonString value)
{
...
if (typeof(T) == typeof(DefaultEntity))
{
    ...
    return Menes.JsonValue.As<DefaultEntity, T>(this);
}
/// <inheritdoc />
public bool Is<T>()
    where T : struct, Menes.IJsonValue
...
public Draft201909MetaMetaData.ExamplesArray.MenesArrayEnumerator GetEnumerator(){    return new Draft201909MetaMetaData.ExamplesArray.MenesArrayEnumerator(this);}System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator(){    return this.GetEnumerator();}System.Collections.Generic.IEnumerator<Draft201909MetaMetaData.ExamplesArray.ItemsEntity> System.Collections.Generic.IEnumerable<Draft201909MetaMetaData.ExamplesArray.ItemsEntity>.GetEnumerator(){    return this.GetEnumerator();}public ExamplesArray Add<T1>(T1 item1)
...
arrayBuilder.Add(oldItem);
    ...
    arrayBuilder.Add(item1.As<Draft201909MetaMetaData.ExamplesArray.ItemsEntity>());
...
arrayBuilder.Add(oldItem);
    ...
    arrayBuilder.Add(item1.As<Draft201909MetaMetaData.ExamplesArray.ItemsEntity>());
    arrayBuilder.Add(item2.As<Draft201909MetaMetaData.ExamplesArray.ItemsEntity>());
return new Draft201909MetaMetaData.ExamplesArray(arrayBuilder.ToImmutable());
}
...
arrayBuilder.Add(oldItem);
    ...
    arrayBuilder.Add(item1.As<Draft201909MetaMetaData.ExamplesArray.ItemsEntity>());
    arrayBuilder.Add(item2.As<Draft201909MetaMetaData.ExamplesArray.ItemsEntity>());
    arrayBuilder.Add(item3.As<Draft201909MetaMetaData.ExamplesArray.ItemsEntity>());
return new Draft201909MetaMetaData.ExamplesArray(arrayBuilder.ToImmutable());
}
...
arrayBuilder.Add(oldItem);
    ...
    arrayBuilder.Add(item2.As<Draft201909MetaMetaData.ExamplesArray.ItemsEntity>());
    arrayBuilder.Add(item3.As<Draft201909MetaMetaData.ExamplesArray.ItemsEntity>());
    arrayBuilder.Add(item4.As<Draft201909MetaMetaData.ExamplesArray.ItemsEntity>());
return new Draft201909MetaMetaData.ExamplesArray(arrayBuilder.ToImmutable());
}
