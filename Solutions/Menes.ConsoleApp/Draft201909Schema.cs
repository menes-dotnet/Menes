...
namespace TestSpace
{
public readonly struct Draft201909Schema : Menes.IJsonObject
{
...
public Draft201909Schema.MenesPropertyEnumerator GetEnumerator(){    return new Draft201909Schema.MenesPropertyEnumerator(this);}System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator(){    return this.GetEnumerator();}public Draft201909Schema WithId(Draft201909MetaCore.IdValue value)
{
...
public readonly struct DefinitionsEntity : Menes.IJsonObject
{
...
public readonly struct DependenciesEntity : Menes.IJsonObject
{
...
public Draft201909Schema.DependenciesEntity.MenesPropertyEnumerator GetEnumerator(){    return new Draft201909Schema.DependenciesEntity.MenesPropertyEnumerator(this);}System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator(){    return this.GetEnumerator();}private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
    where TPropertyValue : struct, Menes.IJsonValue
{
    return this.GetOptionalPropertyFromJsonElement<TPropertyValue>(propertyName) ?? default;
}
