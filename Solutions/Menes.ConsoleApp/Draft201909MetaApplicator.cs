    ...
    public readonly struct Draft201909MetaApplicator : Menes.IJsonObject<Draft201909MetaApplicator>
    {
        ...
        public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
        {
            ...
            if (this.IsObject)
            {
                ...
                {
                    aklPush0.Push("https://json-schema.org/draft/2019-09/meta/applicator#/additionalItems");
                }
                evaluatedProperties?.Add("additionalItems");
                if (this.TryGetProperty<Draft201909MetaApplicator>(_MenesAdditionalItemsJsonPropertyName.Span, out Draft201909MetaApplicator value0))
                {
                ...
                {
                    aklPush1.Push("https://json-schema.org/draft/2019-09/meta/applicator#/unevaluatedItems");
                }
                evaluatedProperties?.Add("unevaluatedItems");
                if (this.TryGetProperty<Draft201909MetaApplicator>(_MenesUnevaluatedItemsJsonPropertyName.Span, out Draft201909MetaApplicator value1))
                {
                ...
                {
                    aklPush2.Push("https://json-schema.org/draft/2019-09/meta/applicator#/items");
                }
                evaluatedProperties?.Add("items");
                ...
                {
                    aklPush3.Push("https://json-schema.org/draft/2019-09/meta/applicator#/contains");
                }
                evaluatedProperties?.Add("contains");
                if (this.TryGetProperty<Draft201909MetaApplicator>(_MenesContainsJsonPropertyName.Span, out Draft201909MetaApplicator value3))
                {
                ...
                {
                    aklPush4.Push("https://json-schema.org/draft/2019-09/meta/applicator#/additionalProperties");
                }
                evaluatedProperties?.Add("additionalProperties");
                if (this.TryGetProperty<Draft201909MetaApplicator>(_MenesAdditionalPropertiesJsonPropertyName.Span, out Draft201909MetaApplicator value4))
                {
                ...
                {
                    aklPush5.Push("https://json-schema.org/draft/2019-09/meta/applicator#/unevaluatedProperties");
                }
                evaluatedProperties?.Add("unevaluatedProperties");
                if (this.TryGetProperty<Draft201909MetaApplicator>(_MenesUnevaluatedPropertiesJsonPropertyName.Span, out Draft201909MetaApplicator value5))
                {
                ...
                {
                    aklPush6.Push("https://json-schema.org/draft/2019-09/meta/applicator#/properties");
                }
                evaluatedProperties?.Add("properties");
                ...
                {
                    aklPush7.Push("https://json-schema.org/draft/2019-09/meta/applicator#/patternProperties");
                }
                evaluatedProperties?.Add("patternProperties");
                ...
                {
                    aklPush8.Push("https://json-schema.org/draft/2019-09/meta/applicator#/dependentSchemas");
                }
                evaluatedProperties?.Add("dependentSchemas");
                ...
                {
                    aklPush9.Push("https://json-schema.org/draft/2019-09/meta/applicator#/propertyNames");
                }
                evaluatedProperties?.Add("propertyNames");
                if (this.TryGetProperty<Draft201909MetaApplicator>(_MenesPropertyNamesJsonPropertyName.Span, out Draft201909MetaApplicator value9))
                {
                ...
                {
                    aklPush10.Push("https://json-schema.org/draft/2019-09/meta/applicator#/if");
                }
                evaluatedProperties?.Add("if");
                if (this.TryGetProperty<Draft201909MetaApplicator>(_MenesIfJsonPropertyName.Span, out Draft201909MetaApplicator value10))
                {
                ...
                {
                    aklPush11.Push("https://json-schema.org/draft/2019-09/meta/applicator#/then");
                }
                evaluatedProperties?.Add("then");
                if (this.TryGetProperty<Draft201909MetaApplicator>(_MenesThenJsonPropertyName.Span, out Draft201909MetaApplicator value11))
                {
                ...
                {
                    aklPush12.Push("https://json-schema.org/draft/2019-09/meta/applicator#/else");
                }
                evaluatedProperties?.Add("else");
                if (this.TryGetProperty<Draft201909MetaApplicator>(_MenesElseJsonPropertyName.Span, out Draft201909MetaApplicator value12))
                {
                ...
                {
                    aklPush13.Push("https://json-schema.org/draft/2019-09/meta/applicator#/allOf");
                }
                evaluatedProperties?.Add("allOf");
                ...
                {
                    aklPush14.Push("https://json-schema.org/draft/2019-09/meta/applicator#/anyOf");
                }
                evaluatedProperties?.Add("anyOf");
                ...
                {
                    aklPush15.Push("https://json-schema.org/draft/2019-09/meta/applicator#/oneOf");
                }
                evaluatedProperties?.Add("oneOf");
                ...
                {
                    aklPush16.Push("https://json-schema.org/draft/2019-09/meta/applicator#/not");
                }
                evaluatedProperties?.Add("not");
                if (this.TryGetProperty<Draft201909MetaApplicator>(_MenesNotJsonPropertyName.Span, out Draft201909MetaApplicator value16))
                {
        ...
        public readonly struct ItemsEntity : Menes.IJsonValue
        {
            ...
            {
                return (Draft201909MetaApplicator.ItemsEntity)items;
            }
            /// <inheritdoc />
            public bool IsUndefined => !this.HasJsonElement && this.AllBackingFieldsAreNull();
            /// <inheritdoc />
            ...
            public readonly struct SchemaArrayEntity : Menes.IJsonValue, Menes.IJsonArray<SchemaArrayEntity, Draft201909MetaApplicator>
            {
                ...
                public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
                {
                    ...
                    if (this.IsArray)
                    {
                        ...
                        {
                            result = arrayEnumerator.Current.As<Draft201909MetaApplicator>().Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                            if (level == Menes.ValidationLevel.Flag && !result.Valid)
                            {
                                return result;
                            }
                ...
                if (this.IsObject)
                {
                    foreach (var property in this.EnumerateObject())
                    {
                        if (!evaluatedProperties?.Contains(property.Name) ?? true)
                        {
                            ...
                            result = property.Value<Draft201909MetaApplicator>().Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                            if (level == Menes.ValidationLevel.Flag && !result.Valid)
                            {
                                return result;
                            }
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                if (this.IsObject)
                {
                    foreach (var property in this.EnumerateObject())
                    {
                        ...
                        result = propertyName.Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                        if (level == Menes.ValidationLevel.Flag && !result.Valid)
                        {
                            return result;
                        }
