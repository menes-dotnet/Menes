...
namespace TestSpace
{
    public readonly struct Draft201909MetaCore : Menes.IJsonObject<Draft201909MetaCore>
    {
        ...
        where T : struct, Menes.IJsonValue
        {
            ...
            if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesRefJsonPropertyName.Span))
            {
                return this.WithRef(value.As<Menes.JsonString>());
            }
            if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesRecursiveRefJsonPropertyName.Span))
            {
                return this.WithRecursiveRef(value.As<Menes.JsonString>());
            }
            if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesRecursiveAnchorJsonPropertyName.Span))
            {
        ...
        System.Collections.Generic.IEnumerator<Menes.Property<Draft201909MetaCore>> System.Collections.Generic.IEnumerable<Menes.Property<Draft201909MetaCore>>.GetEnumerator() { return this.GetEnumerator(); }
        ...
        public readonly struct VocabularyEntity : Menes.IJsonObject<VocabularyEntity>
        {
            ...
            System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() { return this.GetEnumerator(); }
            System.Collections.Generic.IEnumerator<Menes.Property<Draft201909MetaCore.VocabularyEntity>> System.Collections.Generic.IEnumerable<Menes.Property<Draft201909MetaCore.VocabularyEntity>>.GetEnumerator() { return this.GetEnumerator(); }
            private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
where TPropertyValue : struct, Menes.IJsonValue
            {
                return this.GetOptionalPropertyFromJsonElement<TPropertyValue>(propertyName) ?? default;
        ...
        public readonly struct DefsEntity : Menes.IJsonObject<DefsEntity>
        {
            ...
            System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() { return this.GetEnumerator(); }
            System.Collections.Generic.IEnumerator<Menes.Property<Draft201909MetaCore.DefsEntity>> System.Collections.Generic.IEnumerable<Menes.Property<Draft201909MetaCore.DefsEntity>>.GetEnumerator() { return this.GetEnumerator(); }
            private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
where TPropertyValue : struct, Menes.IJsonValue
            {
                return this.GetOptionalPropertyFromJsonElement<TPropertyValue>(propertyName) ?? default;
