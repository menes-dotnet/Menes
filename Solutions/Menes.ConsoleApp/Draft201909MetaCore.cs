...
{
    public readonly struct Draft201909MetaCore : Menes.IJsonObject<Draft201909MetaCore>
    {
        ...
        public Draft201909MetaCore(Draft201909MetaCore.IdValue? id = null, Menes.JsonUri? schema = null, Draft201909MetaCore.AnchorValue? anchor = null, Menes.JsonUriReference? @ref = null, Menes.JsonUriReference? recursiveRef = null, Menes.JsonBoolean? recursiveAnchor = null, Draft201909MetaCore.VocabularyEntity? vocabulary = null, Menes.JsonString? comment = null, Draft201909MetaCore.DefsEntity? defs = null)
        {
        ...
        private Draft201909MetaCore(Draft201909MetaCore.IdValue? id, Menes.JsonUri? schema, Draft201909MetaCore.AnchorValue? anchor, Menes.JsonUriReference? @ref, Menes.JsonUriReference? recursiveRef, Menes.JsonBoolean? recursiveAnchor, Draft201909MetaCore.VocabularyEntity? vocabulary, Menes.JsonString? comment, Menes.JsonValueBacking defs, Menes.JsonBoolean? _menesBooleanTypeBacking, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
        {
            this._menesJsonElementBacking = default;
            this.id = id;
            this.schema = schema;
        ...
        public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
        {
            ...
            if (this.IsObject)
            {
                ...
                {
                    aklPush0.Push("https://json-schema.org/draft/2019-09/meta/core#/$id");
                }
                evaluatedProperties?.Add("$id");
                ...
                {
                    aklPush1.Push("https://json-schema.org/draft/2019-09/meta/core#/$schema");
                }
                evaluatedProperties?.Add("$schema");
                if (this.TryGetProperty<Menes.JsonUri>(_MenesSchemaJsonPropertyName.Span, out Menes.JsonUri value1))
                {
                ...
                {
                    aklPush2.Push("https://json-schema.org/draft/2019-09/meta/core#/$anchor");
                }
                evaluatedProperties?.Add("$anchor");
                ...
                {
                    aklPush3.Push("https://json-schema.org/draft/2019-09/meta/core#/$ref");
                }
                evaluatedProperties?.Add("$ref");
                if (this.TryGetProperty<Menes.JsonUriReference>(_MenesRefJsonPropertyName.Span, out Menes.JsonUriReference value3))
                {
                ...
                {
                    aklPush4.Push("https://json-schema.org/draft/2019-09/meta/core#/$recursiveRef");
                }
                evaluatedProperties?.Add("$recursiveRef");
                if (this.TryGetProperty<Menes.JsonUriReference>(_MenesRecursiveRefJsonPropertyName.Span, out Menes.JsonUriReference value4))
                {
                ...
                {
                    aklPush5.Push("https://json-schema.org/draft/2019-09/meta/core#/$recursiveAnchor");
                }
                evaluatedProperties?.Add("$recursiveAnchor");
                if (this.TryGetProperty<Menes.JsonBoolean>(_MenesRecursiveAnchorJsonPropertyName.Span, out Menes.JsonBoolean value5))
                {
                ...
                {
                    aklPush6.Push("https://json-schema.org/draft/2019-09/meta/core#/$vocabulary");
                }
                evaluatedProperties?.Add("$vocabulary");
                ...
                {
                    aklPush7.Push("https://json-schema.org/draft/2019-09/meta/core#/$comment");
                }
                evaluatedProperties?.Add("$comment");
                if (this.TryGetProperty<Menes.JsonString>(_MenesCommentJsonPropertyName.Span, out Menes.JsonString value7))
                {
                ...
                {
                    aklPush8.Push("https://json-schema.org/draft/2019-09/meta/core#/$defs");
                }
                evaluatedProperties?.Add("$defs");
        ...
        {
            var rc = this.TryGetPropertyAtIndex(index, out Menes.Property<Draft201909MetaCore> prop);
            result = prop;
            return rc;
        }
        ...
        public Draft201909MetaCore WithRef(Menes.JsonUriReference value)
        {
        ...
        public Draft201909MetaCore WithRecursiveRef(Menes.JsonUriReference value)
        {
        ...
        private bool TryGetPropertyAtIndex(int index, out Menes.Property<Draft201909MetaCore> result)
        {
            ...
            foreach (var property in this._menesAdditionalPropertiesBacking)
            {
                if (currentIndex == index)
                {
                    result = new Menes.Property<Draft201909MetaCore>(this, property.NameAsMemory);
                    return true;
                }
                currentIndex++;
            }
        ...
        private Draft201909MetaCore WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> value)
        {
        ...
        public readonly struct IdValue : Menes.IJsonValue
        {
            ...
            private readonly System.Text.Json.JsonElement _menesJsonElementBacking;
            private readonly Menes.JsonUriReference? _menesStringTypeBacking;
            ...
            public IdValue(Menes.JsonUriReference value)
            {
                this._menesJsonElementBacking = default;
                this._menesStringTypeBacking = value;
            }
            private IdValue(Menes.JsonUriReference? _menesStringTypeBacking)
            {
                this._menesJsonElementBacking = default;
                this._menesStringTypeBacking = _menesStringTypeBacking;
            }
            public static implicit operator Menes.JsonUriReference(IdValue value)
            {
                return value.As<Menes.JsonUriReference>();
            }
            public static implicit operator IdValue(Menes.JsonUriReference value)
            {
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                if (this.IsString)
                {
                    result = this.As<Menes.JsonUriReference>().Validate(result);
                    if (level == Menes.ValidationLevel.Flag && !result.Valid)
                    {
                        return result;
                    }
                ...
                if (this.IsString)
                {
                    ...
                    if (!_MenesPatternExpression.IsMatch(value))
                    {
                        if (level >= Menes.ValidationLevel.Basic)
                        {
                            ...
                            instanceLocation?.TryPeek(out il);
                            absoluteKeywordLocation?.TryPeek(out akl);
                            result.AddResult(valid: false, message: "6.3.3.  pattern - value must match the regular expression ^[^#]*#?$", instanceLocation: il, absoluteKeywordLocation: akl);
                        }
                        else
                        {
                            result.SetValid(false);
                ...
                if (this.IsString)
                {
                    ...
                    if (!_MenesPatternExpression.IsMatch(value))
                    {
                        if (level >= Menes.ValidationLevel.Basic)
                        {
                            ...
                            instanceLocation?.TryPeek(out il);
                            absoluteKeywordLocation?.TryPeek(out akl);
                            result.AddResult(valid: false, message: "6.3.3.  pattern - value must match the regular expression ^[A-Za-z][-A-Za-z0-9.:_]*$", instanceLocation: il, absoluteKeywordLocation: akl);
                        }
                        else
                        {
                            result.SetValid(false);
        ...
        public readonly struct VocabularyEntity : Menes.IJsonObject<VocabularyEntity>
        {
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                if (this.IsObject)
                {
                    foreach (var property in this.EnumerateObject())
                    {
                        var propertyName = new Menes.JsonString(property.NameAsMemory).As<Menes.JsonUri>();
                        ...
                        if (!evaluatedProperties?.Contains(property.Name) ?? true)
                        {
                            ...
                            result = property.Value<Menes.JsonBoolean>().Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                            if (level == Menes.ValidationLevel.Flag && !result.Valid)
                            {
                                return result;
                            }
            ...
            public bool TryGetPropertyAtIndex(int index, out Menes.IProperty result)
            {
                var rc = this.TryGetPropertyAtIndex(index, out Menes.Property<VocabularyEntity> prop);
                result = prop;
                return rc;
            }
            ...
            {
                var propertyName = System.MemoryExtensions.AsSpan(name);
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.AdditionalProperty<Menes.JsonBoolean>>();
                bool added = false;
                foreach (var property in this._menesAdditionalPropertiesBacking)
                {
                    if (!property.NameEquals(propertyName))
                    ...
                    {
                        arrayBuilder.Add(new Menes.AdditionalProperty<Menes.JsonBoolean>(propertyName, value.As<Menes.JsonBoolean>()));
                        added = true;
                    }
                }
                if (!added)
            ...
            System.Collections.Generic.IEnumerator<Menes.Property<Draft201909MetaCore.VocabularyEntity>> System.Collections.Generic.IEnumerable<Menes.Property<Draft201909MetaCore.VocabularyEntity>>.GetEnumerator()
            {
                return this.GetEnumerator();
            }
            private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
            ...
            private bool TryGetPropertyAtIndex(int index, out Menes.Property<VocabularyEntity> result)
            {
                ...
                foreach (var property in this._menesAdditionalPropertiesBacking)
                {
                    if (currentIndex == index)
                    {
                        result = new Menes.Property<VocabularyEntity>(this, property.NameAsMemory);
                        return true;
                    }
                    currentIndex++;
                }
            ...
            private VocabularyEntity WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonBoolean>> value)
            {
            ...
            public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.Property<VocabularyEntity>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.Property<VocabularyEntity>>, System.Collections.IEnumerator
            {
                ...
                public Menes.Property<VocabularyEntity> Current
                {
                    get
                    {
                        ...
                        {
                            if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.Property<VocabularyEntity> result))
                            {
                                return result;
                            }
        ...
        public readonly struct DefsEntity : Menes.IJsonObject<DefsEntity>
        {
            ...
            public Menes.ValidationResult Validate(Menes.ValidationResult? validationResult = null, Menes.ValidationLevel level = Menes.ValidationLevel.Flag, System.Collections.Generic.HashSet<string>? evaluatedProperties = null, System.Collections.Generic.Stack<string>? absoluteKeywordLocation = null, System.Collections.Generic.Stack<string>? instanceLocation = null)
            {
                ...
                if (this.IsObject)
                {
                    foreach (var property in this.EnumerateObject())
                    {
                        ...
                        {
                            evaluatedProperties?.Add(property.Name);
                            result = property.Value<Draft201909MetaCore>().Validate(result, level, null, absoluteKeywordLocation, instanceLocation);
                            if (level == Menes.ValidationLevel.Flag && !result.Valid)
                            {
                                return result;
                            }
            ...
            public bool TryGetPropertyAtIndex(int index, out Menes.IProperty result)
            {
                var rc = this.TryGetPropertyAtIndex(index, out Menes.Property<DefsEntity> prop);
                result = prop;
                return rc;
            }
            ...
            where T : struct, Menes.IJsonValue
            {
                ...
                foreach (var property in this._menesAdditionalPropertiesBacking)
                {
                    ...
                    {
                        arrayBuilder.Add(new Menes.AdditionalProperty(propertyName, Menes.JsonValueBacking.From<Draft201909MetaCore>(value.As<Draft201909MetaCore>())));
                        added = true;
                    }
                }
                if (!added)
            ...
            System.Collections.Generic.IEnumerator<Menes.Property<Draft201909MetaCore.DefsEntity>> System.Collections.Generic.IEnumerable<Menes.Property<Draft201909MetaCore.DefsEntity>>.GetEnumerator()
            {
                return this.GetEnumerator();
            }
            private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
            ...
            private bool TryGetPropertyAtIndex(int index, out Menes.Property<DefsEntity> result)
            {
                ...
                foreach (var property in this._menesAdditionalPropertiesBacking)
                {
                    if (currentIndex == index)
                    {
                        result = new Menes.Property<DefsEntity>(this, property.NameAsMemory);
                        return true;
                    }
                    currentIndex++;
                }
            ...
            private DefsEntity WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty> value)
            {
            ...
            public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.Property<DefsEntity>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.Property<DefsEntity>>, System.Collections.IEnumerator
            {
                ...
                public Menes.Property<DefsEntity> Current
                {
                    get
                    {
                        ...
                        {
                            if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.Property<DefsEntity> result))
                            {
                                return result;
                            }
                            throw new System.InvalidOperationException("Unable to get the property in the enumeration. The collection has been modified.");
        ...
        public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.Property<Draft201909MetaCore>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.Property<Draft201909MetaCore>>, System.Collections.IEnumerator
        {
            ...
            public Menes.Property<Draft201909MetaCore> Current
            {
                get
                {
                    ...
                    {
                        if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.Property<Draft201909MetaCore> result))
                        {
                            return result;
                        }
                        throw new System.InvalidOperationException("Unable to get the property in the enumeration. The collection has been modified.");
