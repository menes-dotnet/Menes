...
public Draft201909MetaCore.MenesPropertyEnumerator GetEnumerator(){    return new Draft201909MetaCore.MenesPropertyEnumerator(this);}System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator(){    return this.GetEnumerator();}public Draft201909MetaCore WithId(Draft201909MetaCore.IdValue value)
{
...
public Draft201909MetaCore.VocabularyEntity.MenesPropertyEnumerator GetEnumerator(){    return new Draft201909MetaCore.VocabularyEntity.MenesPropertyEnumerator(this);}System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator(){    return this.GetEnumerator();}private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
    where TPropertyValue : struct, Menes.IJsonValue
{
    return this.GetOptionalPropertyFromJsonElement<TPropertyValue>(propertyName) ?? default;
}
...
public Draft201909MetaCore.DefsEntity.MenesPropertyEnumerator GetEnumerator(){    return new Draft201909MetaCore.DefsEntity.MenesPropertyEnumerator(this);}System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator(){    return this.GetEnumerator();}private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
    where TPropertyValue : struct, Menes.IJsonValue
{
    return this.GetOptionalPropertyFromJsonElement<TPropertyValue>(propertyName) ?? default;
}
