...
namespace Menes.JsonSchema
{
    ...
    public readonly struct JsonNull : IJsonValue, IJsonObject, IJsonArray
    {
            ...
            where T : struct, IJsonValue
        {
            ...
            return JsonValue.As<JsonNull, T>(this).Validate(ValidationContext.ValidContext).IsValid;
        }
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            if (!this.IsNull)
            {
                ...
                {
                    return validationContext.WithResult(isValid: false, message: $"6.1.1.  type - should have been 'null'.");
                }
                else
                {
        ...
        {
            private readonly JsonNull instance;
