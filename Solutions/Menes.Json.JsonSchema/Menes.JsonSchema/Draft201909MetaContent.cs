...
{
    public readonly struct Draft201909MetaContent : Menes.JsonSchema.IJsonObject<Draft201909MetaContent>
    {
        ...
        public Draft201909MetaContent(Menes.JsonSchema.JsonString? contentMediaType = null, Menes.JsonSchema.JsonString? contentEncoding = null, Draft201909Schema? contentSchema = null)
        {
        ...
        public Draft201909MetaContent(Menes.JsonSchema.JsonBoolean value)
        {
            this._menesJsonElementBacking = default;
        ...
        public static implicit operator Menes.JsonSchema.JsonBoolean(Draft201909MetaContent value)
        {
            return value.As<Menes.JsonSchema.JsonBoolean>();
        }
        public static implicit operator Draft201909MetaContent(Menes.JsonSchema.JsonBoolean value)
        {
        ...
        {
            return (Draft201909MetaContent)(Menes.JsonSchema.JsonBoolean)value;
        }
        /// <inheritdoc />
        ...
        public Menes.JsonSchema.ValidationContext Validate(in Menes.JsonSchema.ValidationContext validationContext, Menes.JsonSchema.ValidationLevel level = Menes.JsonSchema.ValidationLevel.Flag)
        {
            ...
            if (this.IsObject)
            {
                ...
                if (this.TryGetProperty<Menes.JsonSchema.JsonString>(_MenesContentMediaTypeJsonPropertyName.Span, out Menes.JsonSchema.JsonString value0))
                {
                ...
                if (this.TryGetProperty<Menes.JsonSchema.JsonString>(_MenesContentEncodingJsonPropertyName.Span, out Menes.JsonSchema.JsonString value1))
                {
            ...
            where T : struct, Menes.JsonSchema.IJsonValue
        {
            ...
            return Menes.JsonSchema.JsonValue.As<Draft201909MetaContent, T>(this);
        }
        /// <inheritdoc />
        public bool Is<T>()
            where T : struct, Menes.JsonSchema.IJsonValue
        ...
        {
            var rc = this.TryGetPropertyAtIndex(index, out Menes.JsonSchema.Property<Draft201909MetaContent> prop);
            result = prop;
            return rc;
        }
        ...
        System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<Draft201909MetaContent>> System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<Draft201909MetaContent>>.GetEnumerator()
        {
            return this.GetEnumerator();
        }
        public Draft201909MetaContent WithContentMediaType(Menes.JsonSchema.JsonString value)
        {
        ...
        public Draft201909MetaContent WithContentEncoding(Menes.JsonSchema.JsonString value)
        {
        ...
        /// <inheritdoc />
        private bool TryGetPropertyAtIndex(int index, out Menes.JsonSchema.Property<Draft201909MetaContent> result)
        {
            if (this.HasJsonElement)
            {
                int jsonPropertyIndex = 0;
                foreach (var property in this.JsonElement.EnumerateObject())
                {
                    ...
                    {
                        result = new Menes.JsonSchema.Property<Draft201909MetaContent>(property);
                        return true;
                    }
                    jsonPropertyIndex++;
                }
            ...
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaContent>(this, _MenesContentMediaTypeJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaContent>(this, _MenesContentEncodingJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaContent>(this, _MenesContentSchemaJsonPropertyName);
                return true;
            }
            currentIndex++;
            foreach (var property in this._menesAdditionalPropertiesBacking)
            {
                if (currentIndex == index)
                {
                    result = new Menes.JsonSchema.Property<Draft201909MetaContent>(this, property.NameAsMemory);
                    return true;
                }
                currentIndex++;
            }
        ...
        private Draft201909MetaContent WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.AdditionalProperty<Menes.JsonSchema.JsonAny>> value)
        {
        ...
        /// </summary>
        public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<Draft201909MetaContent>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<Draft201909MetaContent>>, System.Collections.IEnumerator
        {
            ...
            /// <inheritdoc/>
            public Menes.JsonSchema.Property<Draft201909MetaContent> Current
            {
                get
                {
                    if (this.hasJsonEnumerator)
                    {
                        return new Menes.JsonSchema.Property<Draft201909MetaContent>(this.jsonEnumerator.Current);
                    }
                    else if (this.index >= 0)
                    {
                        if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.JsonSchema.Property<Draft201909MetaContent> result))
                        {
                            return result;
                        }
                    ...
                    return new Menes.JsonSchema.Property<Draft201909MetaContent>(this.instance, default);
                }
            }
            /// <inheritdoc/>
