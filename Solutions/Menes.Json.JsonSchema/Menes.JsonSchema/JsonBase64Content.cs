...
namespace Menes.JsonSchema
{
    ...
    public readonly struct JsonBase64Content : IJsonValue
    {
        ...
        {
            return value.GetBase64EncodedString().AsSpan();
        }
        ...
        /// </summary>
        /// <param name="value">The bool value from which to convert.</param>
        public static implicit operator ReadOnlyMemory<char>(JsonBase64Content value)
        {
            return value.GetBase64EncodedString().AsMemory();
        }
        ...
        /// </summary>
        /// <param name="value">The bool value from which to convert.</param>
        public static implicit operator JsonBase64Content(ReadOnlyMemory<char> value)
        {
            return new JsonBase64Content(value.Span);
        }
