...
{
    public readonly struct Draft201909MetaMetaData : Menes.JsonSchema.IJsonObject<Draft201909MetaMetaData>
    {
        ...
        public Draft201909MetaMetaData(Menes.JsonSchema.JsonBoolean value)
        {
            this._menesJsonElementBacking = default;
        ...
        public static implicit operator Menes.JsonSchema.JsonBoolean(Draft201909MetaMetaData value)
        {
            return value.As<Menes.JsonSchema.JsonBoolean>();
        }
        public static implicit operator Draft201909MetaMetaData(Menes.JsonSchema.JsonBoolean value)
        {
        ...
        {
            return (Draft201909MetaMetaData)(Menes.JsonSchema.JsonBoolean)value;
        }
        /// <inheritdoc />
        ...
        public Menes.JsonSchema.ValidationContext Validate(in Menes.JsonSchema.ValidationContext validationContext, Menes.JsonSchema.ValidationLevel level = Menes.JsonSchema.ValidationLevel.Flag)
        {
            ...
            if (this.IsObject)
            {
                ...
                if (this.TryGetProperty<Menes.JsonSchema.JsonString>(_MenesTitleJsonPropertyName.Span, out Menes.JsonSchema.JsonString value0))
                {
                ...
                if (this.TryGetProperty<Menes.JsonSchema.JsonString>(_MenesDescriptionJsonPropertyName.Span, out Menes.JsonSchema.JsonString value1))
                {
                ...
                if (this.TryGetProperty<Menes.JsonSchema.JsonAny>(_MenesDefaultJsonPropertyName.Span, out Menes.JsonSchema.JsonAny value2))
                {
                ...
                if (this.TryGetProperty<Menes.JsonSchema.JsonBoolean>(_MenesDeprecatedJsonPropertyName.Span, out Menes.JsonSchema.JsonBoolean value3))
                {
                ...
                if (this.TryGetProperty<Menes.JsonSchema.JsonBoolean>(_MenesReadOnlyJsonPropertyName.Span, out Menes.JsonSchema.JsonBoolean value4))
                {
                ...
                if (this.TryGetProperty<Menes.JsonSchema.JsonBoolean>(_MenesWriteOnlyJsonPropertyName.Span, out Menes.JsonSchema.JsonBoolean value5))
                {
            ...
            where T : struct, Menes.JsonSchema.IJsonValue
        {
            ...
            return Menes.JsonSchema.JsonValue.As<Draft201909MetaMetaData, T>(this);
        }
        /// <inheritdoc />
        public bool Is<T>()
            where T : struct, Menes.JsonSchema.IJsonValue
        ...
        {
            var rc = this.TryGetPropertyAtIndex(index, out Menes.JsonSchema.Property<Draft201909MetaMetaData> prop);
            result = prop;
            return rc;
        }
        ...
        System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<Draft201909MetaMetaData>> System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<Draft201909MetaMetaData>>.GetEnumerator()
        {
            return this.GetEnumerator();
        }
        public Draft201909MetaMetaData WithTitle(Menes.JsonSchema.JsonString value)
        {
        ...
        public Draft201909MetaMetaData WithDescription(Menes.JsonSchema.JsonString value)
        {
        ...
        public Draft201909MetaMetaData WithDefault(Menes.JsonSchema.JsonAny value)
        {
        ...
        public Draft201909MetaMetaData WithDeprecated(Menes.JsonSchema.JsonBoolean value)
        {
        ...
        public Draft201909MetaMetaData WithReadOnly(Menes.JsonSchema.JsonBoolean value)
        {
        ...
        public Draft201909MetaMetaData WithWriteOnly(Menes.JsonSchema.JsonBoolean value)
        {
        ...
        /// <inheritdoc />
        private bool TryGetPropertyAtIndex(int index, out Menes.JsonSchema.Property<Draft201909MetaMetaData> result)
        {
            if (this.HasJsonElement)
            {
                int jsonPropertyIndex = 0;
                foreach (var property in this.JsonElement.EnumerateObject())
                {
                    ...
                    {
                        result = new Menes.JsonSchema.Property<Draft201909MetaMetaData>(property);
                        return true;
                    }
                    jsonPropertyIndex++;
                }
            ...
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaMetaData>(this, _MenesTitleJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaMetaData>(this, _MenesDescriptionJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaMetaData>(this, _MenesDefaultJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaMetaData>(this, _MenesDeprecatedJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaMetaData>(this, _MenesReadOnlyJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaMetaData>(this, _MenesWriteOnlyJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaMetaData>(this, _MenesExamplesJsonPropertyName);
                return true;
            }
            currentIndex++;
            foreach (var property in this._menesAdditionalPropertiesBacking)
            {
                if (currentIndex == index)
                {
                    result = new Menes.JsonSchema.Property<Draft201909MetaMetaData>(this, property.NameAsMemory);
                    return true;
                }
                currentIndex++;
            }
        ...
        private Draft201909MetaMetaData WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.AdditionalProperty<Menes.JsonSchema.JsonAny>> value)
        {
        ...
        public readonly struct ExamplesArray : Menes.JsonSchema.IJsonValue, Menes.JsonSchema.IJsonArray<ExamplesArray, Menes.JsonSchema.JsonAny>
        {
            ...
            public ExamplesArray(System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.JsonAny> value)
            {
                this._menesArrayValueBacking = value;
                this._menesJsonElementBacking = default;
            }
            public static implicit operator ExamplesArray(System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.JsonAny> items)
            {
                ...
                where T : struct, Menes.JsonSchema.IJsonValue
            {
                ...
                return Menes.JsonSchema.JsonValue.As<ExamplesArray, T>(this);
            }
            /// <inheritdoc />
            public bool Is<T>()
                where T : struct, Menes.JsonSchema.IJsonValue
            ...
            public ExamplesArray RemoveIf(System.Predicate<Menes.JsonSchema.JsonAny> condition)
            {
        ...
        /// </summary>
        public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<Draft201909MetaMetaData>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<Draft201909MetaMetaData>>, System.Collections.IEnumerator
        {
            ...
            /// <inheritdoc/>
            public Menes.JsonSchema.Property<Draft201909MetaMetaData> Current
            {
                get
                {
                    if (this.hasJsonEnumerator)
                    {
                        return new Menes.JsonSchema.Property<Draft201909MetaMetaData>(this.jsonEnumerator.Current);
                    }
                    else if (this.index >= 0)
                    {
                        if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.JsonSchema.Property<Draft201909MetaMetaData> result))
                        {
                            return result;
                        }
                    ...
                    return new Menes.JsonSchema.Property<Draft201909MetaMetaData>(this.instance, default);
                }
            }
            /// <inheritdoc/>
            object System.Collections.IEnumerator.Current => this.Current;
