...
{
    public readonly struct Draft201909MetaApplicator : Menes.JsonSchema.IJsonObject<Draft201909MetaApplicator>
    {
        ...
        private readonly Draft201909MetaApplicator.ItemsEntity.SchemaArray? allOf;
        private readonly Draft201909MetaApplicator.ItemsEntity.SchemaArray? anyOf;
        private readonly Draft201909MetaApplicator.ItemsEntity.SchemaArray? oneOf;
        ...
        public Draft201909MetaApplicator(Menes.JsonSchema.JsonBoolean value)
        {
            this._menesJsonElementBacking = default;
        ...
        public static implicit operator Menes.JsonSchema.JsonBoolean(Draft201909MetaApplicator value)
        {
            return value.As<Menes.JsonSchema.JsonBoolean>();
        }
        public static implicit operator Draft201909MetaApplicator(Menes.JsonSchema.JsonBoolean value)
        {
        ...
        {
            return (Draft201909MetaApplicator)(Menes.JsonSchema.JsonBoolean)value;
        }
        /// <inheritdoc />
        ...
        public Draft201909MetaApplicator.ItemsEntity.SchemaArray? AllOf => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(_MenesAllOfUtf8JsonPropertyName.Span) : this.allOf;
        public Draft201909MetaApplicator.ItemsEntity.SchemaArray? AnyOf => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(_MenesAnyOfUtf8JsonPropertyName.Span) : this.anyOf;
        public Draft201909MetaApplicator.ItemsEntity.SchemaArray? OneOf => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(_MenesOneOfUtf8JsonPropertyName.Span) : this.oneOf;
        ...
        public Menes.JsonSchema.ValidationContext Validate(in Menes.JsonSchema.ValidationContext validationContext, Menes.JsonSchema.ValidationLevel level = Menes.JsonSchema.ValidationLevel.Flag)
        {
            ...
            if (this.IsObject)
            {
                ...
                if (this.TryGetProperty<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(_MenesAllOfJsonPropertyName.Span, out Draft201909MetaApplicator.ItemsEntity.SchemaArray value13))
                {
                ...
                if (this.TryGetProperty<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(_MenesAnyOfJsonPropertyName.Span, out Draft201909MetaApplicator.ItemsEntity.SchemaArray value14))
                {
                ...
                if (this.TryGetProperty<Draft201909MetaApplicator.ItemsEntity.SchemaArray>(_MenesOneOfJsonPropertyName.Span, out Draft201909MetaApplicator.ItemsEntity.SchemaArray value15))
                {
        ...
        public void WriteTo(System.Text.Json.Utf8JsonWriter writer)
        {
            ...
            if (this.allOf is Draft201909MetaApplicator.ItemsEntity.SchemaArray allOf)
            {
                writer.WritePropertyName(_MenesAllOfEncodedJsonPropertyName);
                allOf.WriteTo(writer);
            }
            if (this.anyOf is Draft201909MetaApplicator.ItemsEntity.SchemaArray anyOf)
            {
                writer.WritePropertyName(_MenesAnyOfEncodedJsonPropertyName);
                anyOf.WriteTo(writer);
            }
            if (this.oneOf is Draft201909MetaApplicator.ItemsEntity.SchemaArray oneOf)
            {
            ...
            where T : struct, Menes.JsonSchema.IJsonValue
        {
            ...
            return Menes.JsonSchema.JsonValue.As<Draft201909MetaApplicator, T>(this);
        }
        /// <inheritdoc />
        public bool Is<T>()
            where T : struct, Menes.JsonSchema.IJsonValue
        ...
        {
            var rc = this.TryGetPropertyAtIndex(index, out Menes.JsonSchema.Property<Draft201909MetaApplicator> prop);
            result = prop;
            return rc;
        }
        ...
        System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<Draft201909MetaApplicator>> System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<Draft201909MetaApplicator>>.GetEnumerator()
        {
            return this.GetEnumerator();
        }
        ...
        public Draft201909MetaApplicator WithAllOf(Draft201909MetaApplicator.ItemsEntity.SchemaArray value)
        {
        ...
        public Draft201909MetaApplicator WithAnyOf(Draft201909MetaApplicator.ItemsEntity.SchemaArray value)
        {
        ...
        public Draft201909MetaApplicator WithOneOf(Draft201909MetaApplicator.ItemsEntity.SchemaArray value)
        {
        ...
        /// <inheritdoc />
        private bool TryGetPropertyAtIndex(int index, out Menes.JsonSchema.Property<Draft201909MetaApplicator> result)
        {
            if (this.HasJsonElement)
            {
                int jsonPropertyIndex = 0;
                foreach (var property in this.JsonElement.EnumerateObject())
                {
                    ...
                    {
                        result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(property);
                        return true;
                    }
                    jsonPropertyIndex++;
                }
            ...
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesAdditionalItemsJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesUnevaluatedItemsJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesItemsJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesContainsJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesAdditionalPropertiesJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesUnevaluatedPropertiesJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesPropertiesJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesPatternPropertiesJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesDependentSchemasJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesPropertyNamesJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesIfJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesThenJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesElseJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesAllOfJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesAnyOfJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesOneOfJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, _MenesNotJsonPropertyName);
                return true;
            }
            currentIndex++;
            foreach (var property in this._menesAdditionalPropertiesBacking)
            {
                if (currentIndex == index)
                {
                    result = new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this, property.NameAsMemory);
                    return true;
                }
                currentIndex++;
            }
        ...
        private Draft201909MetaApplicator WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.AdditionalProperty<Menes.JsonSchema.JsonAny>> value)
        {
        ...
        public readonly struct ItemsEntity : Menes.JsonSchema.IJsonValue
        {
            ...
            public static implicit operator Draft201909MetaApplicator.ItemsEntity.SchemaArray(ItemsEntity value)
            {
                return value.As<Draft201909MetaApplicator.ItemsEntity.SchemaArray>();
            }
            public static implicit operator ItemsEntity(Draft201909MetaApplicator.ItemsEntity.SchemaArray value)
            {
                return value.As<Draft201909MetaApplicator.ItemsEntity>();
            }
            public static implicit operator ItemsEntity(System.Collections.Immutable.ImmutableArray<Draft201909Schema> items)
            {
                ...
                return (ItemsEntity)(Draft201909MetaApplicator.ItemsEntity.SchemaArray)arrayBuilder.ToImmutable();
            }
            /// <inheritdoc />
            public bool IsUndefined => !this.HasJsonElement && this.AllBackingFieldsAreNull();
            /// <inheritdoc />
            ...
            public Menes.JsonSchema.ValidationContext Validate(in Menes.JsonSchema.ValidationContext validationContext, Menes.JsonSchema.ValidationLevel level = Menes.JsonSchema.ValidationLevel.Flag)
            {
                ...
                return result;
                Menes.JsonSchema.ValidationContext ValidateAnyOf(in Draft201909MetaApplicator.ItemsEntity that, in Menes.JsonSchema.ValidationContext validationContext, Menes.JsonSchema.ValidationLevel level = Menes.JsonSchema.ValidationLevel.Flag)
                {
                    Menes.JsonSchema.ValidationContext result = validationContext;
                ...
                where T : struct, Menes.JsonSchema.IJsonValue
            {
                ...
                return Menes.JsonSchema.JsonValue.As<ItemsEntity, T>(this);
            }
            /// <inheritdoc />
            public bool Is<T>()
                where T : struct, Menes.JsonSchema.IJsonValue
            ...
            public readonly Draft201909MetaApplicator.ItemsEntity.SchemaArray AsSchemaArray()
            {
                return this.As<Draft201909MetaApplicator.ItemsEntity.SchemaArray>();
            }
            /// <inheritdoc/>
            public bool Equals<T>(in T other)
                where T : struct, Menes.JsonSchema.IJsonValue
            ...
            public readonly struct SchemaArray : Menes.JsonSchema.IJsonValue, Menes.JsonSchema.IJsonArray<SchemaArray, Draft201909Schema>
            {
                public static readonly SchemaArray Null = default(SchemaArray);
                private readonly System.Text.Json.JsonElement _menesJsonElementBacking;
                private readonly System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.JsonArrayValueBacking>? _menesArrayValueBacking;
                public SchemaArray(System.Text.Json.JsonElement jsonElement)
                {
                    this._menesJsonElementBacking = jsonElement;
                    this._menesArrayValueBacking = default;
                }
                public SchemaArray(System.Collections.Immutable.ImmutableArray<Draft201909Schema> value)
                {
                    var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonSchema.JsonArrayValueBacking>();
                    foreach (var item in value)
                    {
                        arrayBuilder.Add(Menes.JsonSchema.JsonArrayValueBacking.From<Draft201909Schema>(item));
                    }
                    this._menesArrayValueBacking = arrayBuilder.ToImmutable();
                    this._menesJsonElementBacking = default;
                }
                private SchemaArray(System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.JsonArrayValueBacking> value)
                {
                    this._menesArrayValueBacking = value;
                    this._menesJsonElementBacking = default;
                }
                public static implicit operator SchemaArray(System.Collections.Immutable.ImmutableArray<Draft201909Schema> items)
                {
                    return new Draft201909MetaApplicator.ItemsEntity.SchemaArray(items);
                }
                /// <inheritdoc />
                public bool IsUndefined => !this.HasJsonElement && this.AllBackingFieldsAreNull();
                /// <inheritdoc />
                ...
                public T As<T>()
                    where T : struct, Menes.JsonSchema.IJsonValue
                {
                    if (typeof(T) == typeof(SchemaArray))
                    {
                        return Corvus.Extensions.CastTo<T>.From(this);
                    }
                    return Menes.JsonSchema.JsonValue.As<SchemaArray, T>(this);
                }
                /// <inheritdoc />
                public bool Is<T>()
                    where T : struct, Menes.JsonSchema.IJsonValue
                {
                    if (typeof(T) == typeof(Draft201909MetaApplicator.ItemsEntity.SchemaArray))
                    {
                        return this.Validate(Menes.JsonSchema.ValidationContext.ValidContext).IsValid;
                    }
                    return this.As<T>().Validate(Menes.JsonSchema.ValidationContext.ValidContext).IsValid;
                ...
                public Draft201909MetaApplicator.ItemsEntity.SchemaArray.MenesArrayEnumerator GetEnumerator()
                {
                    return new Draft201909MetaApplicator.ItemsEntity.SchemaArray.MenesArrayEnumerator(this);
                }
                public Draft201909MetaApplicator.ItemsEntity.SchemaArray.MenesArrayEnumerator EnumerateArray()
                {
                    return new Draft201909MetaApplicator.ItemsEntity.SchemaArray.MenesArrayEnumerator(this);
                }
                System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
                ...
                public SchemaArray Add<T1>(T1 item1)
                    where T1 : struct, Menes.JsonSchema.IJsonValue
                {
                    ...
                    arrayBuilder.Add(Menes.JsonSchema.JsonArrayValueBacking.From<Draft201909Schema>(item1.As<Draft201909Schema>()));
                    return new Draft201909MetaApplicator.ItemsEntity.SchemaArray(arrayBuilder.ToImmutable());
                }
                public SchemaArray Add<T1, T2>(T1 item1, T2 item2)
                    where T1 : struct, Menes.JsonSchema.IJsonValue
                    where T2 : struct, Menes.JsonSchema.IJsonValue
                {
                    ...
                    arrayBuilder.Add(Menes.JsonSchema.JsonArrayValueBacking.From<Draft201909Schema>(item1.As<Draft201909Schema>()));
                    arrayBuilder.Add(Menes.JsonSchema.JsonArrayValueBacking.From<Draft201909Schema>(item2.As<Draft201909Schema>()));
                    return new Draft201909MetaApplicator.ItemsEntity.SchemaArray(arrayBuilder.ToImmutable());
                }
                public SchemaArray Add<T1, T2, T3>(T1 item1, T2 item2, T3 item3)
                    where T1 : struct, Menes.JsonSchema.IJsonValue
                    where T2 : struct, Menes.JsonSchema.IJsonValue
                    where T3 : struct, Menes.JsonSchema.IJsonValue
                {
                    ...
                    arrayBuilder.Add(Menes.JsonSchema.JsonArrayValueBacking.From<Draft201909Schema>(item1.As<Draft201909Schema>()));
                    arrayBuilder.Add(Menes.JsonSchema.JsonArrayValueBacking.From<Draft201909Schema>(item2.As<Draft201909Schema>()));
                    arrayBuilder.Add(Menes.JsonSchema.JsonArrayValueBacking.From<Draft201909Schema>(item3.As<Draft201909Schema>()));
                    return new Draft201909MetaApplicator.ItemsEntity.SchemaArray(arrayBuilder.ToImmutable());
                }
                public SchemaArray Add<T1, T2, T3, T4>(T1 item1, T2 item2, T3 item3, T4 item4)
                    where T1 : struct, Menes.JsonSchema.IJsonValue
                    where T2 : struct, Menes.JsonSchema.IJsonValue
                    where T3 : struct, Menes.JsonSchema.IJsonValue
                    where T4 : struct, Menes.JsonSchema.IJsonValue
                {
                    ...
                    arrayBuilder.Add(Menes.JsonSchema.JsonArrayValueBacking.From<Draft201909Schema>(item2.As<Draft201909Schema>()));
                    arrayBuilder.Add(Menes.JsonSchema.JsonArrayValueBacking.From<Draft201909Schema>(item3.As<Draft201909Schema>()));
                    arrayBuilder.Add(Menes.JsonSchema.JsonArrayValueBacking.From<Draft201909Schema>(item4.As<Draft201909Schema>()));
                    return new Draft201909MetaApplicator.ItemsEntity.SchemaArray(arrayBuilder.ToImmutable());
                }
                public SchemaArray Add<T>(params T[] items)
                    where T : struct, Menes.JsonSchema.IJsonValue
                {
                    var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonSchema.JsonArrayValueBacking>();
                    foreach (var oldItem in this._menesArrayValueBacking)
                ...
                public SchemaArray Insert<T>(int index, T item1)
                    where T : struct, Menes.JsonSchema.IJsonValue
                {
                    var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonSchema.JsonArrayValueBacking>();
                    int currentIndex = 0;
                ...
                public SchemaArray Insert<T1, T2>(int index, T1 item1, T2 item2)
                    where T1 : struct, Menes.JsonSchema.IJsonValue
                    where T2 : struct, Menes.JsonSchema.IJsonValue
                {
                    var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonSchema.JsonArrayValueBacking>();
                ...
                public SchemaArray Insert<T1, T2, T3>(int index, T1 item1, T2 item2, T3 item3)
                    where T1 : struct, Menes.JsonSchema.IJsonValue
                    where T2 : struct, Menes.JsonSchema.IJsonValue
                    where T3 : struct, Menes.JsonSchema.IJsonValue
                {
                ...
                public SchemaArray Insert<T1, T2, T3, T4>(int index, T1 item1, T2 item2, T3 item3, T4 item4)
                    where T1 : struct, Menes.JsonSchema.IJsonValue
                    where T2 : struct, Menes.JsonSchema.IJsonValue
                    where T3 : struct, Menes.JsonSchema.IJsonValue
                    where T4 : struct, Menes.JsonSchema.IJsonValue
                ...
                public SchemaArray Insert<T>(int index, params T[] items)
                    where T : struct, Menes.JsonSchema.IJsonValue
                {
                    var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonSchema.JsonArrayValueBacking>();
                    int currentIndex = 0;
                ...
                public SchemaArray RemoveIf(System.Predicate<Draft201909Schema> condition)
                {
                    return this.RemoveIf<Draft201909Schema>(condition);
                }
                public SchemaArray RemoveIf<T>(System.Predicate<T> condition)
                    where T : struct, Menes.JsonSchema.IJsonValue
                {
                    var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonSchema.JsonArrayValueBacking>();
                    foreach (var item in this._menesArrayValueBacking)
                ...
                /// <summary>
                /// An enumerator for the array values in a <see cref="SchemaArray"/>.
                /// </summary>
                public struct MenesArrayEnumerator : System.Collections.Generic.IEnumerable<Draft201909Schema>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Draft201909Schema>, System.Collections.IEnumerator
                {
                    ...
                    private int index;
                    internal MenesArrayEnumerator(SchemaArray instance)
                    {
                    ...
                    public Draft201909Schema Current
                    {
                        get
                        {
                            ...
                            else if (this.instance._menesArrayValueBacking is System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.JsonArrayValueBacking> array && this.index >= 0 && this.index < array.Length)
                            {
                    ...
                    /// </summary>
                    /// <returns>An enumerator for the array values in a <see cref="SchemaArray"/>.</returns>
                    ...
                    public bool MoveNext()
                    {
                        ...
                        else if (this.instance._menesArrayValueBacking is System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.JsonArrayValueBacking> array && this.index + 1 < array.Length)
                        {
                            this.index++;
                            return true;
                        }
        ...
        public readonly struct PropertiesEntity : Menes.JsonSchema.IJsonObject<PropertiesEntity>
        {
            ...
            private PropertiesEntity(in System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.AdditionalProperty> _menesAdditionalPropertiesBacking)
            {
                this._menesJsonElementBacking = default;
                this._menesAdditionalPropertiesBacking = _menesAdditionalPropertiesBacking;
            }
                ...
                where T : struct, Menes.JsonSchema.IJsonValue
            {
                ...
                return Menes.JsonSchema.JsonValue.As<PropertiesEntity, T>(this);
            }
            /// <inheritdoc />
            public bool Is<T>()
                where T : struct, Menes.JsonSchema.IJsonValue
            ...
            public bool TryGetPropertyAtIndex(int index, out Menes.JsonSchema.IProperty result)
            {
                var rc = this.TryGetPropertyAtIndex(index, out Menes.JsonSchema.Property<PropertiesEntity> prop);
                result = prop;
                return rc;
            }
            ...
            System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<Draft201909MetaApplicator.PropertiesEntity>> System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<Draft201909MetaApplicator.PropertiesEntity>>.GetEnumerator()
            {
                return this.GetEnumerator();
            }
            private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
            ...
            /// <inheritdoc />
            private bool TryGetPropertyAtIndex(int index, out Menes.JsonSchema.Property<PropertiesEntity> result)
            {
                if (this.HasJsonElement)
                {
                    int jsonPropertyIndex = 0;
                    foreach (var property in this.JsonElement.EnumerateObject())
                    {
                        if (jsonPropertyIndex == index)
                        {
                            result = new Menes.JsonSchema.Property<PropertiesEntity>(property);
                            return true;
                        }
                        jsonPropertyIndex++;
                    }
                ...
                foreach (var property in this._menesAdditionalPropertiesBacking)
                {
                    if (currentIndex == index)
                    {
                        result = new Menes.JsonSchema.Property<PropertiesEntity>(this, property.NameAsMemory);
                        return true;
                    }
                    currentIndex++;
                }
            ...
            private PropertiesEntity WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.AdditionalProperty> value)
            {
            ...
            /// </summary>
            public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<PropertiesEntity>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<PropertiesEntity>>, System.Collections.IEnumerator
            {
                ...
                /// <inheritdoc/>
                public Menes.JsonSchema.Property<PropertiesEntity> Current
                {
                    get
                    {
                        if (this.hasJsonEnumerator)
                        {
                            return new Menes.JsonSchema.Property<PropertiesEntity>(this.jsonEnumerator.Current);
                        }
                        else if (this.index >= 0)
                        {
                            if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.JsonSchema.Property<PropertiesEntity> result))
                            {
                                return result;
                            }
                        ...
                        return new Menes.JsonSchema.Property<PropertiesEntity>(this.instance, default);
                    }
                }
                /// <inheritdoc/>
                object System.Collections.IEnumerator.Current => this.Current;
                ...
                /// <inheritdoc/>
                System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<PropertiesEntity>> System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<PropertiesEntity>>.GetEnumerator()
                {
                    return this.GetEnumerator();
                }
                /// <inheritdoc/>
        ...
        public readonly struct PatternPropertiesEntity : Menes.JsonSchema.IJsonObject<PatternPropertiesEntity>
        {
            ...
            private PatternPropertiesEntity(in System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.AdditionalProperty> _menesAdditionalPropertiesBacking)
            {
                this._menesJsonElementBacking = default;
                this._menesAdditionalPropertiesBacking = _menesAdditionalPropertiesBacking;
            }
            ...
            public Menes.JsonSchema.ValidationContext Validate(in Menes.JsonSchema.ValidationContext validationContext, Menes.JsonSchema.ValidationLevel level = Menes.JsonSchema.ValidationLevel.Flag)
            {
                ...
                if (this.IsObject)
                {
                    foreach (var property in this.EnumerateObject())
                    {
                        var propertyName = new Menes.JsonSchema.JsonString(property.NameAsMemory).As<Draft201909MetaApplicator.PatternPropertiesEntity.PropertyNamesEntity>();
                ...
                where T : struct, Menes.JsonSchema.IJsonValue
            {
                ...
                return Menes.JsonSchema.JsonValue.As<PatternPropertiesEntity, T>(this);
            }
            /// <inheritdoc />
            public bool Is<T>()
                where T : struct, Menes.JsonSchema.IJsonValue
            ...
            public bool TryGetPropertyAtIndex(int index, out Menes.JsonSchema.IProperty result)
            {
                var rc = this.TryGetPropertyAtIndex(index, out Menes.JsonSchema.Property<PatternPropertiesEntity> prop);
                result = prop;
                return rc;
            }
            ...
            System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<Draft201909MetaApplicator.PatternPropertiesEntity>> System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<Draft201909MetaApplicator.PatternPropertiesEntity>>.GetEnumerator()
            {
                return this.GetEnumerator();
            }
            private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
            ...
            /// <inheritdoc />
            private bool TryGetPropertyAtIndex(int index, out Menes.JsonSchema.Property<PatternPropertiesEntity> result)
            {
                if (this.HasJsonElement)
                {
                    int jsonPropertyIndex = 0;
                    foreach (var property in this.JsonElement.EnumerateObject())
                    {
                        if (jsonPropertyIndex == index)
                        {
                            result = new Menes.JsonSchema.Property<PatternPropertiesEntity>(property);
                            return true;
                        }
                        jsonPropertyIndex++;
                    }
                ...
                foreach (var property in this._menesAdditionalPropertiesBacking)
                {
                    if (currentIndex == index)
                    {
                        result = new Menes.JsonSchema.Property<PatternPropertiesEntity>(this, property.NameAsMemory);
                        return true;
                    }
                    currentIndex++;
                }
            ...
            private PatternPropertiesEntity WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.AdditionalProperty> value)
            {
                return new PatternPropertiesEntity(value);
            }
            public readonly struct PropertyNamesEntity : Menes.JsonSchema.IJsonValue
            {
                ...
                public Menes.JsonSchema.ValidationContext Validate(in Menes.JsonSchema.ValidationContext validationContext, Menes.JsonSchema.ValidationLevel level = Menes.JsonSchema.ValidationLevel.Flag)
                {
                    ...
                    if (this.IsString)
                    {
                        result = this.As<Menes.JsonSchema.JsonRegex>().Validate(result);
                        if (level == Menes.JsonSchema.ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
                    ...
                    where T : struct, Menes.JsonSchema.IJsonValue
                {
                    ...
                    return Menes.JsonSchema.JsonValue.As<PropertyNamesEntity, T>(this);
                }
                /// <inheritdoc />
                public bool Is<T>()
                    where T : struct, Menes.JsonSchema.IJsonValue
            ...
            /// </summary>
            public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<PatternPropertiesEntity>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<PatternPropertiesEntity>>, System.Collections.IEnumerator
            {
                ...
                /// <inheritdoc/>
                public Menes.JsonSchema.Property<PatternPropertiesEntity> Current
                {
                    get
                    {
                        if (this.hasJsonEnumerator)
                        {
                            return new Menes.JsonSchema.Property<PatternPropertiesEntity>(this.jsonEnumerator.Current);
                        }
                        else if (this.index >= 0)
                        {
                            if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.JsonSchema.Property<PatternPropertiesEntity> result))
                            {
                                return result;
                            }
                            throw new System.InvalidOperationException("Unable to get the property in the enumeration. The collection has been modified.");
                        }
                        return new Menes.JsonSchema.Property<PatternPropertiesEntity>(this.instance, default);
                    }
                }
                /// <inheritdoc/>
                object System.Collections.IEnumerator.Current => this.Current;
                ...
                /// <inheritdoc/>
                System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<PatternPropertiesEntity>> System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<PatternPropertiesEntity>>.GetEnumerator()
                {
                    return this.GetEnumerator();
                }
                /// <inheritdoc/>
        ...
        public readonly struct DependentSchemasEntity : Menes.JsonSchema.IJsonObject<DependentSchemasEntity>
        {
            ...
            private DependentSchemasEntity(in System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.AdditionalProperty> _menesAdditionalPropertiesBacking)
            {
                this._menesJsonElementBacking = default;
                this._menesAdditionalPropertiesBacking = _menesAdditionalPropertiesBacking;
            }
                ...
                where T : struct, Menes.JsonSchema.IJsonValue
            {
                ...
                return Menes.JsonSchema.JsonValue.As<DependentSchemasEntity, T>(this);
            }
            /// <inheritdoc />
            public bool Is<T>()
                where T : struct, Menes.JsonSchema.IJsonValue
            ...
            public bool TryGetPropertyAtIndex(int index, out Menes.JsonSchema.IProperty result)
            {
                var rc = this.TryGetPropertyAtIndex(index, out Menes.JsonSchema.Property<DependentSchemasEntity> prop);
                result = prop;
                return rc;
            }
            ...
            System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<Draft201909MetaApplicator.DependentSchemasEntity>> System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<Draft201909MetaApplicator.DependentSchemasEntity>>.GetEnumerator()
            {
                return this.GetEnumerator();
            }
            private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
            ...
            /// <inheritdoc />
            private bool TryGetPropertyAtIndex(int index, out Menes.JsonSchema.Property<DependentSchemasEntity> result)
            {
                if (this.HasJsonElement)
                {
                    int jsonPropertyIndex = 0;
                    foreach (var property in this.JsonElement.EnumerateObject())
                    {
                        if (jsonPropertyIndex == index)
                        {
                            result = new Menes.JsonSchema.Property<DependentSchemasEntity>(property);
                            return true;
                        }
                        jsonPropertyIndex++;
                    }
                ...
                foreach (var property in this._menesAdditionalPropertiesBacking)
                {
                    if (currentIndex == index)
                    {
                        result = new Menes.JsonSchema.Property<DependentSchemasEntity>(this, property.NameAsMemory);
                        return true;
                    }
                    currentIndex++;
                }
            ...
            private DependentSchemasEntity WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.JsonSchema.AdditionalProperty> value)
            {
            ...
            /// </summary>
            public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<DependentSchemasEntity>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<DependentSchemasEntity>>, System.Collections.IEnumerator
            {
                ...
                /// <inheritdoc/>
                public Menes.JsonSchema.Property<DependentSchemasEntity> Current
                {
                    get
                    {
                        if (this.hasJsonEnumerator)
                        {
                            return new Menes.JsonSchema.Property<DependentSchemasEntity>(this.jsonEnumerator.Current);
                        }
                        else if (this.index >= 0)
                        {
                            if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.JsonSchema.Property<DependentSchemasEntity> result))
                            {
                                return result;
                            }
                            throw new System.InvalidOperationException("Unable to get the property in the enumeration. The collection has been modified.");
                        }
                        return new Menes.JsonSchema.Property<DependentSchemasEntity>(this.instance, default);
                    }
                }
                /// <inheritdoc/>
                object System.Collections.IEnumerator.Current => this.Current;
                ...
                /// <inheritdoc/>
                System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<DependentSchemasEntity>> System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<DependentSchemasEntity>>.GetEnumerator()
                {
                    return this.GetEnumerator();
                }
                /// <inheritdoc/>
        ...
        /// </summary>
        public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.JsonSchema.Property<Draft201909MetaApplicator>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.JsonSchema.Property<Draft201909MetaApplicator>>, System.Collections.IEnumerator
        {
            ...
            /// <inheritdoc/>
            public Menes.JsonSchema.Property<Draft201909MetaApplicator> Current
            {
                get
                {
                    if (this.hasJsonEnumerator)
                    {
                        return new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this.jsonEnumerator.Current);
                    }
                    else if (this.index >= 0)
                    {
                        if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.JsonSchema.Property<Draft201909MetaApplicator> result))
                        {
                            return result;
                        }
                        throw new System.InvalidOperationException("Unable to get the property in the enumeration. The collection has been modified.");
                    }
                    return new Menes.JsonSchema.Property<Draft201909MetaApplicator>(this.instance, default);
                }
            }
            /// <inheritdoc/>
            object System.Collections.IEnumerator.Current => this.Current;
