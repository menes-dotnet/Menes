...
namespace Menes.Json.Draft201909
{
    ...
    public readonly struct Applicator : IJsonObject<Applicator>, IEquatable<Applicator>
    {
        ...
        {
            ImmutableDictionary<string, Func<Applicator, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<Applicator, ValidationContext, ValidationLevel, ValidationContext>>();
            builder.Add(AdditionalItemsJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Schema property = that.AdditionalItems;
                return property.Validate(validationContext, level);
            });
            builder.Add(UnevaluatedItemsJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Schema property = that.UnevaluatedItems;
                return property.Validate(validationContext, level);
            });
            builder.Add(ItemsJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Applicator.PropertiesEntity property = that.Items;
                return property.Validate(validationContext, level);
            });
            builder.Add(ContainsJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Schema property = that.Contains;
                return property.Validate(validationContext, level);
            });
            builder.Add(AdditionalPropertiesJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Schema property = that.AdditionalProperties;
                return property.Validate(validationContext, level);
            });
            builder.Add(UnevaluatedPropertiesJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Schema property = that.UnevaluatedProperties;
                return property.Validate(validationContext, level);
            });
            builder.Add(PropertiesJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Applicator.PropertiesValue property = that.Properties;
                return property.Validate(validationContext, level);
            });
            builder.Add(PatternPropertiesJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Applicator.PatternPropertiesValue property = that.PatternProperties;
                return property.Validate(validationContext, level);
            });
            builder.Add(DependentSchemasJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Applicator.DependentSchemasValue property = that.DependentSchemas;
                return property.Validate(validationContext, level);
            });
            builder.Add(PropertyNamesJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Schema property = that.PropertyNames;
                return property.Validate(validationContext, level);
            });
            builder.Add(IfJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Schema property = that.If;
                return property.Validate(validationContext, level);
            });
            builder.Add(ThenJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Schema property = that.Then;
                return property.Validate(validationContext, level);
            });
            builder.Add(ElseJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Schema property = that.Else;
                return property.Validate(validationContext, level);
            });
            builder.Add(AllOfJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Applicator.SchemaArray property = that.AllOf;
                return property.Validate(validationContext, level);
            });
            builder.Add(AnyOfJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Applicator.SchemaArray property = that.AnyOf;
                return property.Validate(validationContext, level);
            });
            builder.Add(OneOfJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Applicator.SchemaArray property = that.OneOf;
                return property.Validate(validationContext, level);
            });
            builder.Add(NotJsonPropertyName, (that, validationContext, level) =>
            {
        ...
        public readonly struct PatternPropertiesValue : IJsonObject<PatternPropertiesValue>, IEquatable<PatternPropertiesValue>
        {
            ...
            private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                foreach (Property property in this.EnumerateObject())
                {
                    ...
                    result = new JsonString(propertyNameAsString).As<Menes.Json.Draft201909.Applicator.PatternPropertiesValue.PropertyNamesEntity>().Validate(result, level);
                    if (level == ValidationLevel.Flag && !result.IsValid)
                    {
                        return result;
                    }
