...
namespace Menes.Json.Draft201909
{
    ...
    public readonly struct Schema : IJsonObject<Schema>, IEquatable<Schema>
    {
        ...
        {
            ImmutableDictionary<string, PropertyValidator<Schema>>.Builder builder = ImmutableDictionary.CreateBuilder<string, PropertyValidator<Schema>>();
            builder.Add(DefinitionsJsonPropertyName, __MenesValidateDefinitions);
            builder.Add(DependenciesJsonPropertyName, __MenesValidateDependencies);
            return builder.ToImmutable();
        }
