...
namespace Menes.Json.Draft201909
{
    ...
    public readonly struct Validation : IJsonObject<Validation>, IEquatable<Validation>
    {
        ...
        /// </summary>
        public static Validation Create(Menes.Json.Draft201909.Validation.MultipleOfValue? multipleOf = null, Menes.Json.JsonNumber? maximum = null, Menes.Json.JsonNumber? exclusiveMaximum = null, Menes.Json.JsonNumber? minimum = null, Menes.Json.JsonNumber? exclusiveMinimum = null, Menes.Json.Draft201909.Validation.NonNegativeIntegerValue? maxLength = null, Menes.Json.Draft201909.Validation.NonNegativeIntegerDefault0Entity? minLength = null, Menes.Json.JsonRegex? pattern = null, Menes.Json.Draft201909.Validation.NonNegativeIntegerValue? maxItems = null, Menes.Json.Draft201909.Validation.NonNegativeIntegerDefault0Entity? minItems = null, Menes.Json.Draft201909.Validation.UniqueItemsValue? uniqueItems = null, Menes.Json.Draft201909.Validation.NonNegativeIntegerValue? maxContains = null, Menes.Json.Draft201909.Validation.MinContainsEntity? minContains = null, Menes.Json.Draft201909.Validation.NonNegativeIntegerValue? maxProperties = null, Menes.Json.Draft201909.Validation.NonNegativeIntegerDefault0Entity? minProperties = null, Menes.Json.Draft201909.Validation.JsonStringArray? required = null, Menes.Json.Draft201909.Validation.DependentRequiredValue? dependentRequired = null, Menes.Json.JsonAny? @const = null, Menes.Json.Draft201909.Validation.JsonAnyArray? @enum = null, Menes.Json.Draft201909.Validation.TypeEntity? type = null)
        {
        ...
        public Validation WithMultipleOf(Menes.Json.Draft201909.Validation.MultipleOfValue value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithMaxLength(Menes.Json.Draft201909.Validation.NonNegativeIntegerValue value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithMinLength(Menes.Json.Draft201909.Validation.NonNegativeIntegerDefault0Entity value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithMaxItems(Menes.Json.Draft201909.Validation.NonNegativeIntegerValue value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithMinItems(Menes.Json.Draft201909.Validation.NonNegativeIntegerDefault0Entity value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithUniqueItems(Menes.Json.Draft201909.Validation.UniqueItemsValue value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithMaxContains(Menes.Json.Draft201909.Validation.NonNegativeIntegerValue value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithMinContains(Menes.Json.Draft201909.Validation.MinContainsEntity value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithMaxProperties(Menes.Json.Draft201909.Validation.NonNegativeIntegerValue value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithMinProperties(Menes.Json.Draft201909.Validation.NonNegativeIntegerDefault0Entity value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithRequired(Menes.Json.Draft201909.Validation.JsonStringArray value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithDependentRequired(Menes.Json.Draft201909.Validation.DependentRequiredValue value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithEnum(Menes.Json.Draft201909.Validation.JsonAnyArray value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Validation WithType(Menes.Json.Draft201909.Validation.TypeEntity value)
        {
        ...
        {
            ImmutableDictionary<string, Func<Validation, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<Validation, ValidationContext, ValidationLevel, ValidationContext>>();
            builder.Add(MultipleOfJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Validation.MultipleOfValue property = that.MultipleOf;
                return property.Validate(validationContext, level);
            });
            builder.Add(MaximumJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.JsonNumber property = that.Maximum;
                return property.Validate(validationContext, level);
            });
            builder.Add(ExclusiveMaximumJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.JsonNumber property = that.ExclusiveMaximum;
                return property.Validate(validationContext, level);
            });
            builder.Add(MinimumJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.JsonNumber property = that.Minimum;
                return property.Validate(validationContext, level);
            });
            builder.Add(ExclusiveMinimumJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.JsonNumber property = that.ExclusiveMinimum;
                return property.Validate(validationContext, level);
            });
            builder.Add(MaxLengthJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Validation.NonNegativeIntegerValue property = that.MaxLength;
                return property.Validate(validationContext, level);
            });
            builder.Add(MinLengthJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Validation.NonNegativeIntegerDefault0Entity property = that.MinLength;
                return property.Validate(validationContext, level);
            });
            builder.Add(PatternJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.JsonRegex property = that.Pattern;
                return property.Validate(validationContext, level);
            });
            builder.Add(MaxItemsJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Validation.NonNegativeIntegerValue property = that.MaxItems;
                return property.Validate(validationContext, level);
            });
            builder.Add(MinItemsJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Validation.NonNegativeIntegerDefault0Entity property = that.MinItems;
                return property.Validate(validationContext, level);
            });
            builder.Add(UniqueItemsJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Validation.UniqueItemsValue property = that.UniqueItems;
                return property.Validate(validationContext, level);
            });
            builder.Add(MaxContainsJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Validation.NonNegativeIntegerValue property = that.MaxContains;
                return property.Validate(validationContext, level);
            });
            builder.Add(MinContainsJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Validation.MinContainsEntity property = that.MinContains;
                return property.Validate(validationContext, level);
            });
            builder.Add(MaxPropertiesJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Validation.NonNegativeIntegerValue property = that.MaxProperties;
                return property.Validate(validationContext, level);
            });
            builder.Add(MinPropertiesJsonPropertyName, (that, validationContext, level) =>
            {
            ...
            builder.Add(DependentRequiredJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Validation.DependentRequiredValue property = that.DependentRequired;
                return property.Validate(validationContext, level);
            });
            builder.Add(ConstJsonPropertyName, (that, validationContext, level) =>
            {
        ...
        public readonly struct MultipleOfValue : IJsonValue, IEquatable<MultipleOfValue>
        {
            ...
            public ValidationContext Validate(in ValidationContext? validationContext = null, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                result = Menes.Json.Validate.ValidateNumber(this, result, level, null, null, null, null, 0);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
        ...
        public readonly struct NonNegativeIntegerValue : IJsonValue, IEquatable<NonNegativeIntegerValue>
        {
            ...
            public ValidationContext Validate(in ValidationContext? validationContext = null, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                result = Menes.Json.Validate.ValidateNumber(this, result, level, null, null, null, 0, null);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
            ...
            private ValidationContext ValidateType(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                result = result.MergeResults(isValid, level);
                return result;
            }
        }
        ...
        public readonly struct NonNegativeIntegerDefault0Entity : IJsonValue, IEquatable<NonNegativeIntegerDefault0Entity>
        {
            ...
            /// Initializes a new instance of the <see cref = "NonNegativeIntegerDefault0Entity"/> struct.
            /// </summary>
            /// <param name = "conversion">The <see cref = "Menes.Json.Draft201909.Validation.NonNegativeIntegerValue"/> from which to construct the value.</param>
            public NonNegativeIntegerDefault0Entity(Menes.Json.Draft201909.Validation.NonNegativeIntegerValue conversion)
            {
            ...
            /// <summary>
            /// Gets the value as a <see cref = "Menes.Json.Draft201909.Validation.NonNegativeIntegerValue"/>.
            /// </summary>
            public Menes.Json.Draft201909.Validation.NonNegativeIntegerValue AsNonNegativeIntegerValue
            {
                get
                {
                    return this;
            ...
            /// <summary>
            /// Gets a value indicating whether this is a valid <see cref = "Menes.Json.Draft201909.Validation.NonNegativeIntegerValue"/>.
            /// </summary>
            public bool IsNonNegativeIntegerValue
            {
                get
                {
                    return ((Menes.Json.Draft201909.Validation.NonNegativeIntegerValue)this).Validate().IsValid;
                }
            }
            ...
            /// <summary>
            /// Conversion from <see cref = "Menes.Json.Draft201909.Validation.NonNegativeIntegerValue"/>.
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator NonNegativeIntegerDefault0Entity(Menes.Json.Draft201909.Validation.NonNegativeIntegerValue value)
            {
                return new NonNegativeIntegerDefault0Entity(value);
            }

            /// <summary>
            /// Conversion to <see cref = "Menes.Json.Draft201909.Validation.NonNegativeIntegerValue"/>.
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator Menes.Json.Draft201909.Validation.NonNegativeIntegerValue(NonNegativeIntegerDefault0Entity value)
            {
                if (value.ValueKind == JsonValueKind.Number)
                {
                    return new Menes.Json.Draft201909.Validation.NonNegativeIntegerValue(value.AsNumber);
                }
            ...
            {
                ValidationContext result = validationContext;
                ValidationContext refResult = this.As<Menes.Json.Draft201909.Validation.NonNegativeIntegerValue>().Validate(validationContext.CreateChildContext(), level);
        ...
        public readonly struct MinContainsEntity : IJsonValue, IEquatable<MinContainsEntity>
        {
            ...
            /// </summary>
            /// <param name = "conversion">The <see cref = "Menes.Json.Draft201909.Validation.NonNegativeIntegerValue"/> from which to construct the value.</param>
            public MinContainsEntity(Menes.Json.Draft201909.Validation.NonNegativeIntegerValue conversion)
            {
                if (conversion.HasJsonElement)
                {
                    this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator MinContainsEntity(Menes.Json.Draft201909.Validation.NonNegativeIntegerValue value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator Menes.Json.Draft201909.Validation.NonNegativeIntegerValue(MinContainsEntity value)
            {
                if (value.ValueKind == JsonValueKind.Number)
                {
                    return new Menes.Json.Draft201909.Validation.NonNegativeIntegerValue(value.AsNumber);
        ...
        public readonly struct DependentRequiredValue : IJsonObject<DependentRequiredValue>, IEquatable<DependentRequiredValue>
        {
            ...
            /// </summary>
            public JsonObjectEnumerator<Menes.Json.Draft201909.Validation.JsonStringArray> EnumerateProperties()
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
                {
                    return new JsonObjectEnumerator<Menes.Json.Draft201909.Validation.JsonStringArray>(properties);
                }

                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    return new JsonObjectEnumerator<Menes.Json.Draft201909.Validation.JsonStringArray>(this.jsonElementBacking);
                }
            ...
            private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                foreach (Property property in this.EnumerateObject())
                {
                    ...
                    {
                        result = property.ValueAs<Menes.Json.Draft201909.Validation.JsonStringArray>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
        ...
        public readonly struct TypeEntity : IJsonArray<TypeEntity>, IEquatable<TypeEntity>
        {
            ...
            /// Initializes a new instance of the <see cref = "TypeEntity"/> struct.
            /// </summary>
            /// <param name = "conversion">The <see cref = "Menes.Json.Draft201909.Validation.SimpleTypesEntity"/> from which to construct the value.</param>
            public TypeEntity(Menes.Json.Draft201909.Validation.SimpleTypesEntity conversion)
            {
                if (conversion.HasJsonElement)
                {
                    this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// Initializes a new instance of the <see cref = "TypeEntity"/> struct.
            /// </summary>
            /// <param name = "conversion">The <see cref = "Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray"/> from which to construct the value.</param>
            public TypeEntity(Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray conversion)
            {
                if (conversion.HasJsonElement)
                {
                    this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
            /// Gets the value as a <see cref = "Menes.Json.Draft201909.Validation.SimpleTypesEntity"/>.
            /// </summary>
            public Menes.Json.Draft201909.Validation.SimpleTypesEntity AsSimpleTypesEntity
            {
                get
                {
                    return this;
            ...
            /// <summary>
            /// Gets a value indicating whether this is a valid <see cref = "Menes.Json.Draft201909.Validation.SimpleTypesEntity"/>.
            /// </summary>
            public bool IsSimpleTypesEntity
            {
                get
                {
                    return ((Menes.Json.Draft201909.Validation.SimpleTypesEntity)this).Validate().IsValid;
                }
            }

            /// <summary>
            /// Gets the value as a <see cref = "Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray"/>.
            /// </summary>
            public Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray AsSimpleTypesEntityArray
            {
                get
                {
                    return this;
            ...
            /// <summary>
            /// Gets a value indicating whether this is a valid <see cref = "Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray"/>.
            /// </summary>
            public bool IsSimpleTypesEntityArray
            {
                get
                {
                    return ((Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray)this).Validate().IsValid;
                }
            }
            ...
            /// <summary>
            /// Conversion from <see cref = "Menes.Json.Draft201909.Validation.SimpleTypesEntity"/>.
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator TypeEntity(Menes.Json.Draft201909.Validation.SimpleTypesEntity value)
            {
                return new TypeEntity(value);
            }

            /// <summary>
            /// Conversion to <see cref = "Menes.Json.Draft201909.Validation.SimpleTypesEntity"/>.
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator Menes.Json.Draft201909.Validation.SimpleTypesEntity(TypeEntity value)
            {
                if (value.ValueKind == JsonValueKind.String)
                {
                    return new Menes.Json.Draft201909.Validation.SimpleTypesEntity(value.AsString);
                }
            ...
            /// <summary>
            /// Conversion from <see cref = "Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray"/>.
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator TypeEntity(Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray value)
            {
                return new TypeEntity(value);
            }

            /// <summary>
            /// Conversion to <see cref = "Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray"/>.
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray(TypeEntity value)
            {
                if (value.ValueKind == JsonValueKind.Array)
                {
                    return new Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray(value.AsArray);
                }
            ...
            private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext anyOfResult0 = this.As<Menes.Json.Draft201909.Validation.SimpleTypesEntity>().Validate(validationContext.CreateChildContext(), level);
                ...
                ValidationContext anyOfResult1 = this.As<Menes.Json.Draft201909.Validation.TypeEntity.SimpleTypesEntityArray>().Validate(validationContext.CreateChildContext(), level);
            ...
            public readonly struct SimpleTypesEntityArray : IJsonArray<SimpleTypesEntityArray>, IEquatable<SimpleTypesEntityArray>
            {
                ...
                /// <summary>
                /// Enumerate the items in the array as a <see cref = "Menes.Json.Draft201909.Validation.SimpleTypesEntity"/>.
                /// </summary>
                public JsonArrayEnumerator<Menes.Json.Draft201909.Validation.SimpleTypesEntity> EnumerateItems()
                {
                    if (this.arrayBacking is ImmutableList<JsonAny> items)
                    {
                        return new JsonArrayEnumerator<Menes.Json.Draft201909.Validation.SimpleTypesEntity>(items);
                    }

                    if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
                    {
                        return new JsonArrayEnumerator<Menes.Json.Draft201909.Validation.SimpleTypesEntity>(this.jsonElementBacking);
                    }
                ...
                private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
                {
                    ...
                    while (arrayEnumerator.MoveNext())
                    {
                        ...
                        result = arrayEnumerator.Current.As<Menes.Json.Draft201909.Validation.SimpleTypesEntity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
        ...
        public readonly struct SimpleTypesEntity : IJsonValue, IEquatable<SimpleTypesEntity>
        {
            ...
            public ValidationContext Validate(in ValidationContext? validationContext = null, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                result = Menes.Json.Validate.ValidateEnum(this, result, level, EnumValues.Item0, EnumValues.Item1, EnumValues.Item2, EnumValues.Item3, EnumValues.Item4, EnumValues.Item5, EnumValues.Item6);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
