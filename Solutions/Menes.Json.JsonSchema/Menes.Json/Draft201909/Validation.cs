...
namespace Menes.Json.Draft201909
{
    ...
    public readonly struct Validation : IJsonObject<Validation>, IEquatable<Validation>
    {
        ...
        private static ImmutableDictionary<string, PropertyValidator<Validation>> CreateLocalPropertyValidators()
        {
            ...
            builder.Add(MultipleOfJsonPropertyName, __MenesValidateMultipleOf);
            builder.Add(MaximumJsonPropertyName, __MenesValidateMaximum);
            builder.Add(ExclusiveMaximumJsonPropertyName, __MenesValidateExclusiveMaximum);
            builder.Add(MinimumJsonPropertyName, __MenesValidateMinimum);
            builder.Add(ExclusiveMinimumJsonPropertyName, __MenesValidateExclusiveMinimum);
            builder.Add(MaxLengthJsonPropertyName, __MenesValidateMaxLength);
            builder.Add(MinLengthJsonPropertyName, __MenesValidateMinLength);
            builder.Add(PatternJsonPropertyName, __MenesValidatePattern);
            builder.Add(MaxItemsJsonPropertyName, __MenesValidateMaxItems);
            builder.Add(MinItemsJsonPropertyName, __MenesValidateMinItems);
            builder.Add(UniqueItemsJsonPropertyName, __MenesValidateUniqueItems);
            builder.Add(MaxContainsJsonPropertyName, __MenesValidateMaxContains);
            builder.Add(MinContainsJsonPropertyName, __MenesValidateMinContains);
            builder.Add(MaxPropertiesJsonPropertyName, __MenesValidateMaxProperties);
            builder.Add(MinPropertiesJsonPropertyName, __MenesValidateMinProperties);
            builder.Add(RequiredJsonPropertyName, __MenesValidateRequired);
            builder.Add(DependentRequiredJsonPropertyName, __MenesValidateDependentRequired);
            builder.Add(ConstJsonPropertyName, __MenesValidateConst);
            builder.Add(EnumJsonPropertyName, __MenesValidateEnum);
            builder.Add(TypeJsonPropertyName, __MenesValidateType);
            return builder.ToImmutable();
        }
