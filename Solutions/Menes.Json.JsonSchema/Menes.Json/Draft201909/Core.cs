...
namespace Menes.Json.Draft201909
{
    ...
    public readonly struct Core : IJsonObject<Core>, IEquatable<Core>
    {
        ...
        {
            ImmutableDictionary<string, Func<Core, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<Core, ValidationContext, ValidationLevel, ValidationContext>>();
            builder.Add(IdJsonPropertyName, (that, validationContext, level) =>
            {
            ...
            builder.Add(AnchorJsonPropertyName, (that, validationContext, level) =>
            {
            ...
            builder.Add(VocabularyJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.Core.VocabularyValue property = that.Vocabulary;
                return property.Validate(validationContext, level);
            });
            builder.Add(CommentJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.JsonString property = that.Comment;
                return property.Validate(validationContext, level);
            });
            builder.Add(DefsJsonPropertyName, (that, validationContext, level) =>
            {
