...
namespace Menes.Json.Draft201909
{
    ...
    /// </summary>
    public readonly struct Format : IJsonObject<Format>, IEquatable<Format>
    {
        /// <summary>
        ...
        private static readonly ImmutableDictionary<string, Func<Format, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        /// </summary>
        public static Format Create(Menes.Json.JsonString? format1 = null)
        {
        ...
        private static ImmutableDictionary<string, Func<Format, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, Func<Format, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<Format, ValidationContext, ValidationLevel, ValidationContext>>();
            builder.Add(Format1JsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.JsonString property = that.Format1;
