...
namespace Menes.Json.Draft201909
{
    ...
    public readonly struct MetaData : IJsonObject<MetaData>, IEquatable<MetaData>
    {
        ...
        /// </summary>
        public static MetaData Create(Menes.Json.JsonString? title = null, Menes.Json.JsonString? description = null, Menes.Json.JsonAny? @default = null, Menes.Json.Draft201909.MetaData.DeprecatedValue? deprecated = null, Menes.Json.Draft201909.MetaData.ReadOnlyValue? readOnly = null, Menes.Json.Draft201909.MetaData.WriteOnlyValue? writeOnly = null, Menes.Json.Draft201909.MetaData.JsonAnyArray? examples = null)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithDeprecated(Menes.Json.Draft201909.MetaData.DeprecatedValue value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithReadOnly(Menes.Json.Draft201909.MetaData.ReadOnlyValue value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithWriteOnly(Menes.Json.Draft201909.MetaData.WriteOnlyValue value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithExamples(Menes.Json.Draft201909.MetaData.JsonAnyArray value)
        {
        ...
        private static ImmutableDictionary<string, PropertyValidator<MetaData>> CreateLocalPropertyValidators()
        {
            ...
            builder.Add(DescriptionJsonPropertyName, __MenesValidateDescription);
            builder.Add(DefaultJsonPropertyName, __MenesValidateDefault);
            builder.Add(DeprecatedJsonPropertyName, __MenesValidateDeprecated);
            builder.Add(ReadOnlyJsonPropertyName, __MenesValidateReadOnly);
            builder.Add(WriteOnlyJsonPropertyName, __MenesValidateWriteOnly);
            builder.Add(ExamplesJsonPropertyName, __MenesValidateExamples);
            return builder.ToImmutable();
        }
