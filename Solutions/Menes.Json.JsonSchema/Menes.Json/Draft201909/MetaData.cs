...
namespace Menes.Json.Draft201909
{
    ...
    public readonly struct MetaData : IJsonObject<MetaData>, IEquatable<MetaData>
    {
        ...
        {
            ImmutableDictionary<string, Func<MetaData, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<MetaData, ValidationContext, ValidationLevel, ValidationContext>>();
            ...
            builder.Add(ReadOnlyJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.Draft201909.MetaData.ReadOnlyValue property = that.ReadOnly;
                return property.Validate(validationContext, level);
            });
            builder.Add(WriteOnlyJsonPropertyName, (that, validationContext, level) =>
            {
