...
namespace Menes.Json
{
                    ...
                    IEquatable<DependenciesValue>
    {
        ...
        /// Enumerate the object as the given item type
        /// </summary>
        public JsonObjectEnumerator<Menes.Json.Schema.DependenciesValue.AdditionalPropertiesEntity> EnumerateProperties()
        {
            if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
            {
                return new JsonObjectEnumerator<Menes.Json.Schema.DependenciesValue.AdditionalPropertiesEntity>(properties);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
            {
                return new JsonObjectEnumerator<Menes.Json.Schema.DependenciesValue.AdditionalPropertiesEntity>(this.jsonElementBacking);
            }
