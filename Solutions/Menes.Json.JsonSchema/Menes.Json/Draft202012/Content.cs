...
namespace Menes.Json.Draft202012
{
    ...
    public readonly struct Content : IJsonObject<Content>, IEquatable<Content>
    {
        ...
        /// </summary>
        public static Content Create(Menes.Json.JsonString? contentEncoding = null, Menes.Json.JsonString? contentMediaType = null, Menes.Json.Draft202012.Schema? contentSchema = null)
        {
        ...
        private static ImmutableDictionary<string, PropertyValidator<Content>> CreateLocalPropertyValidators()
        {
            ...
            builder.Add(ContentEncodingJsonPropertyName, __MenesValidateContentEncoding);
            builder.Add(ContentMediaTypeJsonPropertyName, __MenesValidateContentMediaType);
            builder.Add(ContentSchemaJsonPropertyName, __MenesValidateContentSchema);
            return builder.ToImmutable();
        }
