...
namespace Menes.Json.Draft202012
{
    ...
    public readonly struct FormatAnnotation : IJsonObject<FormatAnnotation>, IEquatable<FormatAnnotation>
    {
        ...
        /// </summary>
        public static FormatAnnotation Create(Menes.Json.JsonString? format = null)
        {
        ...
        {
            ImmutableDictionary<string, Func<FormatAnnotation, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<FormatAnnotation, ValidationContext, ValidationLevel, ValidationContext>>();
            builder.Add(FormatJsonPropertyName, (that, validationContext, level) =>
            {
