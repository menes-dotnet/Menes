...
namespace Menes.Json.Draft202012
{
    ...
    public readonly struct Applicator : IJsonObject<Applicator>, IEquatable<Applicator>
    {
        ...
        /// </summary>
        public static Applicator Create(Menes.Json.Draft202012.Applicator.SchemaArray? prefixItems = null, Menes.Json.Draft202012.Schema? items = null, Menes.Json.Draft202012.Schema? contains = null, Menes.Json.Draft202012.Schema? additionalProperties = null, Menes.Json.Draft202012.Applicator.PropertiesValue? properties = null, Menes.Json.Draft202012.Applicator.PatternPropertiesValue? patternProperties = null, Menes.Json.Draft202012.Applicator.DependentSchemasValue? dependentSchemas = null, Menes.Json.Draft202012.Schema? propertyNames = null, Menes.Json.Draft202012.Schema? @if = null, Menes.Json.Draft202012.Schema? then = null, Menes.Json.Draft202012.Schema? @else = null, Menes.Json.Draft202012.Applicator.SchemaArray? allOf = null, Menes.Json.Draft202012.Applicator.SchemaArray? anyOf = null, Menes.Json.Draft202012.Applicator.SchemaArray? oneOf = null, Menes.Json.Draft202012.Schema? not = null)
        {
        ...
        private static ImmutableDictionary<string, Func<Applicator, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ...
            builder.Add(PrefixItemsJsonPropertyName, (that, validationContext, level) =>
            {
