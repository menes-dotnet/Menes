...
namespace Menes.Json.Draft202012
{
    ...
    public readonly struct Core : IJsonObject<Core>, IEquatable<Core>
    {
        ...
        /// </summary>
        public static Core Create(Menes.Json.Draft202012.Core.IdEntity? id = null, Menes.Json.JsonUri? schema = null, Menes.Json.JsonUriReference? @ref = null, Menes.Json.Draft202012.Core.AnchorStringValue? anchor = null, Menes.Json.JsonUriReference? dynamicRef = null, Menes.Json.Draft202012.Core.AnchorStringValue? dynamicAnchor = null, Menes.Json.Draft202012.Core.VocabularyValue? vocabulary = null, Menes.Json.JsonString? comment = null, Menes.Json.Draft202012.Core.DefsValue? defs = null)
        {
        ...
        private static ImmutableDictionary<string, Func<Core, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ...
            builder.Add(DynamicRefJsonPropertyName, (that, validationContext, level) =>
            {
                Menes.Json.JsonUriReference property = that.DynamicRef;
                return property.Validate(validationContext, level);
            });
            builder.Add(DynamicAnchorJsonPropertyName, (that, validationContext, level) =>
            {
        ...
        /// A type generated from a JsonSchema specification.
        /// </summary>
        public readonly struct AnchorStringValue : IJsonValue, IEquatable<AnchorStringValue>
        {
        ...
        /// A type generated from a JsonSchema specification.
        /// </summary>
        public readonly struct IdEntity : IJsonValue, IEquatable<IdEntity>
        {
