...
namespace Menes.Json.Draft202012
{
    ...
    /// </summary>
    public readonly struct Unevaluated : IJsonObject<Unevaluated>, IEquatable<Unevaluated>
    {
        /// <summary>
        ...
        /// </summary>
        public static Unevaluated Create(Menes.Json.Draft202012.Schema? unevaluatedItems = null, Menes.Json.Draft202012.Schema? unevaluatedProperties = null)
        {
        ...
        {
            ImmutableDictionary<string, Func<Unevaluated, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder = ImmutableDictionary.CreateBuilder<string, Func<Unevaluated, ValidationContext, ValidationLevel, ValidationContext>>();
