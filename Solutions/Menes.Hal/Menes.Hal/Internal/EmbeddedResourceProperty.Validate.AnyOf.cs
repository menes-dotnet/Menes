...
public readonly partial struct EmbeddedResourceProperty
{
    private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        ValidationContext anyOfResult0 = this.As<Menes.Hal.Resource>().Validate(childContext0.CreateChildContext(), level);
        ...
        ValidationContext anyOfResult1 = this.As<Menes.Hal.ResourceCollection>().Validate(childContext1.CreateChildContext(), level);
