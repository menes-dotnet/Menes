...
/// </summary>
public readonly partial struct ResourceCollection : IJsonArray<ResourceCollection>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    public static readonly ResourceCollection EmptyArray = From(ImmutableList<JsonAny>.Empty);
    /// <summary>
    /// Initializes a new instance of the <see cref = "ResourceCollection"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public ResourceCollection(ImmutableList<JsonAny> value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public ResourceCollection(IEnumerable<JsonAny> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.Array;
    ...
    public static implicit operator JsonArray(ResourceCollection value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator ResourceCollection(JsonArray value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator ImmutableList<JsonAny>(ResourceCollection value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator ResourceCollection(ImmutableList<JsonAny> value)
    {
        return new(value);
    }
    ...
    public static ResourceCollection From(ImmutableList<JsonAny> items)
    {
        return new(items);
    }
    ...
    /// <returns>A ResourceCollection instantiated from the given items.</returns>
    public static ResourceCollection FromItems(in Menes.Hal.Resource value1)
    {
    ...
    /// <returns>A ResourceCollection instantiated from the given items.</returns>
    public static ResourceCollection FromItems(in Menes.Hal.Resource value1, in Menes.Hal.Resource value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
    ...
    /// <returns>A ResourceCollection instantiated from the given items.</returns>
    public static ResourceCollection FromItems(in Menes.Hal.Resource value1, in Menes.Hal.Resource value2, in Menes.Hal.Resource value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
        builder.Add(value2.AsAny);
    ...
    public static ResourceCollection FromItems(params Menes.Hal.Resource[] value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (Menes.Hal.Resource item in value)
        {
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A JsonAny instantiated from the given items.</returns>
    public static ResourceCollection FromRange(IEnumerable<Menes.Hal.Resource> value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (Menes.Hal.Resource item in value)
        {
    ...
    /// </remarks>
    public static ResourceCollection From<T>(IEnumerable<T> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        return new ResourceCollection(builder.ToImmutable());
    }
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static ResourceCollection FromRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static ResourceCollection FromRange<T>(IEnumerable<T> items)
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<Menes.Hal.Resource> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new JsonArrayEnumerator<Menes.Hal.Resource>(this.jsonElementBacking);
        }

        if ((this.backing & Backing.Array) != 0)
        {
            return new JsonArrayEnumerator<Menes.Hal.Resource>(this.arrayBacking);
        }
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator IJsonArray<ResourceCollection>.EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator<TItem> IJsonArray<ResourceCollection>.EnumerateArray<TItem>()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
