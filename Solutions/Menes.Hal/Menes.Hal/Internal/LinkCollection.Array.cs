...
/// </summary>
public readonly partial struct LinkCollection : IJsonArray<LinkCollection>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    public static readonly LinkCollection EmptyArray = From(ImmutableList<JsonAny>.Empty);
    /// <summary>
    /// Initializes a new instance of the <see cref = "LinkCollection"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public LinkCollection(ImmutableList<JsonAny> value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public LinkCollection(IEnumerable<JsonAny> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.Array;
    ...
    public static implicit operator JsonArray(LinkCollection value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator LinkCollection(JsonArray value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator ImmutableList<JsonAny>(LinkCollection value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator LinkCollection(ImmutableList<JsonAny> value)
    {
        return new(value);
    }
    ...
    public static LinkCollection From(ImmutableList<JsonAny> items)
    {
        return new(items);
    }
    ...
    /// <returns>A LinkCollection instantiated from the given items.</returns>
    public static LinkCollection FromItems(in Menes.Hal.Link value1)
    {
    ...
    /// <returns>A LinkCollection instantiated from the given items.</returns>
    public static LinkCollection FromItems(in Menes.Hal.Link value1, in Menes.Hal.Link value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
    ...
    /// <returns>A LinkCollection instantiated from the given items.</returns>
    public static LinkCollection FromItems(in Menes.Hal.Link value1, in Menes.Hal.Link value2, in Menes.Hal.Link value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
        builder.Add(value2.AsAny);
    ...
    public static LinkCollection FromItems(params Menes.Hal.Link[] value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (Menes.Hal.Link item in value)
        {
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A JsonAny instantiated from the given items.</returns>
    public static LinkCollection FromRange(IEnumerable<Menes.Hal.Link> value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (Menes.Hal.Link item in value)
        {
    ...
    /// </remarks>
    public static LinkCollection From<T>(IEnumerable<T> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        return new LinkCollection(builder.ToImmutable());
    }
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static LinkCollection FromRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static LinkCollection FromRange<T>(IEnumerable<T> items)
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<Menes.Hal.Link> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new JsonArrayEnumerator<Menes.Hal.Link>(this.jsonElementBacking);
        }

        if ((this.backing & Backing.Array) != 0)
        {
            return new JsonArrayEnumerator<Menes.Hal.Link>(this.arrayBacking);
        }
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator IJsonArray<LinkCollection>.EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator<TItem> IJsonArray<LinkCollection>.EnumerateArray<TItem>()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
