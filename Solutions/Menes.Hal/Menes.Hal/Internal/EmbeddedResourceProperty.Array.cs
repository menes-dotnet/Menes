...
/// </summary>
public readonly partial struct EmbeddedResourceProperty : IJsonArray<EmbeddedResourceProperty>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    public static readonly EmbeddedResourceProperty EmptyArray = From(ImmutableList<JsonAny>.Empty);
    /// <summary>
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public EmbeddedResourceProperty(IEnumerable<JsonAny> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.Array;
    ...
    public static EmbeddedResourceProperty From(ImmutableList<JsonAny> items)
    {
        return new(items);
    }
    ...
    public static EmbeddedResourceProperty FromItems(params JsonAny[] value)
    {
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A EmbeddedResourceProperty instantiated from the given items.</returns>
    public static EmbeddedResourceProperty FromItems<TItem>(params TItem[] value)
    ...
    /// <returns>A EmbeddedResourceProperty instantiated from the given items.</returns>
    public static EmbeddedResourceProperty FromItems<TItem1>(in TItem1 value1)
    ...
    /// <returns>A EmbeddedResourceProperty instantiated from the given items.</returns>
    public static EmbeddedResourceProperty FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
    ...
    /// <returns>A EmbeddedResourceProperty instantiated from the given items.</returns>
    public static EmbeddedResourceProperty FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
    ...
    /// </remarks>
    public static EmbeddedResourceProperty From<T>(IEnumerable<T> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        return new EmbeddedResourceProperty(builder.ToImmutable());
    }
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static EmbeddedResourceProperty FromRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static EmbeddedResourceProperty FromRange<T>(IEnumerable<T> items)
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static EmbeddedResourceProperty FromRange(IEnumerable<string> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static EmbeddedResourceProperty FromRange(IEnumerable<double> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static EmbeddedResourceProperty FromRange(IEnumerable<float> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static EmbeddedResourceProperty FromRange(IEnumerable<int> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static EmbeddedResourceProperty FromRange(IEnumerable<long> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static EmbeddedResourceProperty FromRange(IEnumerable<bool> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "value1">The first value from which to construct the instance.</param>
    /// <returns>A EmbeddedResourceProperty instantiated from the given items.</returns>
    public static EmbeddedResourceProperty FromItems(in JsonAny value1)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1);
        return new(builder.ToImmutable());
    ...
    /// <param name = "value2">The second value from which to construct the instance.</param>
    /// <returns>A EmbeddedResourceProperty instantiated from the given items.</returns>
    public static EmbeddedResourceProperty FromItems(in JsonAny value1, in JsonAny value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1);
        builder.Add(value2);
    ...
    /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
    /// <returns>A EmbeddedResourceProperty instantiated from the given items.</returns>
    public static EmbeddedResourceProperty FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1);
        builder.Add(value2);
