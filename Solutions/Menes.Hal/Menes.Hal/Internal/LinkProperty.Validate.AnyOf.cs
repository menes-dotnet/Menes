...
public readonly partial struct LinkProperty
{
    private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        ValidationContext anyOfResult0 = this.As<Menes.Hal.Link>().Validate(childContext0.CreateChildContext(), level);
        ...
        ValidationContext anyOfResult1 = this.As<Menes.Hal.LinkCollection>().Validate(childContext1.CreateChildContext(), level);
