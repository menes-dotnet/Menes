...
namespace Examples
{
    public readonly struct JsonObjectExample : Menes.IJsonObject, System.IEquatable<Examples.JsonObjectExample>, Menes.IJsonAdditionalProperties<Menes.JsonString>
    {
        ...
        private static readonly System.Collections.Immutable.ImmutableArray<System.ReadOnlyMemory<byte>> KnownProperties = System.Collections.Immutable.ImmutableArray.Create(FirstPropertyNameBytes, SecondPropertyNameBytes, ThirdPropertyNameBytes, AgePropertyNameBytes, ChildrenPropertyNameBytes);
        ...
        public JsonObjectExample(Menes.JsonString first, Examples.JsonObjectExample.EnumeratedInt32 second, Menes.JsonDuration? third, Examples.JsonObjectExample.PositiveInteger? age, Examples.JsonObjectExample.ValidatedArrayOfJsonObjectExample? children, params (string, Menes.JsonString)[] additionalProperties)
        {
            this.first = first;
            this.second = second;
            this.third = third;
        ...
        public JsonObjectExample(Menes.JsonString first, Examples.JsonObjectExample.EnumeratedInt32 second, Menes.JsonDuration? third, Examples.JsonObjectExample.PositiveInteger? age, Examples.JsonObjectExample.ValidatedArrayOfJsonObjectExample? children, (string, Menes.JsonString) additionalProperty1)
        {
            this.first = first;
            this.second = second;
            this.third = third;
        ...
        public bool IsNull => (this.JsonElement.ValueKind == System.Text.Json.JsonValueKind.Undefined || this.JsonElement.ValueKind == System.Text.Json.JsonValueKind.Null) && (this.first is null || this.first.Value.IsNull) && (this.second is null || this.second.Value.IsNull) && (this.third is null || this.third.Value.IsNull) && (this.age is null || this.age.Value.IsNull) && (this.children is null || this.children.Value.IsNull);
        ...
        {
            return new Examples.JsonObjectExample(value, this.Second, this.Third, this.Age, this.GetChildren(), this.GetJsonProperties());
        }
        public Examples.JsonObjectExample WithSecond(Examples.JsonObjectExample.EnumeratedInt32 value)
        {
            return new Examples.JsonObjectExample(this.First, value, this.Third, this.Age, this.GetChildren(), this.GetJsonProperties());
        }
        public Examples.JsonObjectExample WithThird(Menes.JsonDuration? value)
        {
            return new Examples.JsonObjectExample(this.First, this.Second, value, this.Age, this.GetChildren(), this.GetJsonProperties());
        }
        public Examples.JsonObjectExample WithAge(Examples.JsonObjectExample.PositiveInteger? value)
        {
            return new Examples.JsonObjectExample(this.First, this.Second, this.Third, value, this.GetChildren(), this.GetJsonProperties());
        }
        ...
        public void WriteTo(System.Text.Json.Utf8JsonWriter writer)
        {
            ...
            else
            {
                ...
                if (this.age is Examples.JsonObjectExample.PositiveInteger age)
                {
        ...
        public bool TryGet(string propertyName, [System.Diagnostics.CodeAnalysis.NotNullWhen(true)] out Menes.JsonString value)
        {
            return this.TryGet(System.MemoryExtensions.AsSpan(propertyName), out value);
        }
        public bool TryGet(System.ReadOnlySpan<byte> utf8PropertyName, [System.Diagnostics.CodeAnalysis.NotNullWhen(true)] out Menes.JsonString value)
        {
            foreach (Menes.JsonPropertyReference<Menes.JsonString> property in this.JsonAdditionalProperties)
            {
        ...
        public bool TryGet(System.ReadOnlySpan<char> propertyName, [System.Diagnostics.CodeAnalysis.NotNullWhen(true)] out Menes.JsonString value)
        {
        ...
        private Menes.JsonReference? GetChildren()
        {
            ...
            if (this.HasJsonElement && this.JsonElement.ValueKind == System.Text.Json.JsonValueKind.Object && this.JsonElement.TryGetProperty(ChildrenPropertyNameBytes.Span, out System.Text.Json.JsonElement value))
            {
