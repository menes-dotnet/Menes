// <copyright file="CustomHalDocument.cs" company="Endjin Limited">
...
namespace Menes.Specs.Fakes
{
    ...
    /// </remarks>
    public sealed class CustomHalDocument : IHalDocument
    {
        ...
        public CustomHalDocument(IJsonSerializerSettingsProvider serializerSettingsProvider)
        {
