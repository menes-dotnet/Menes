...
namespace Steps
{
    ...
    public class JsonValuesSteps
    {
        ...
        {
            this.scenarioContext.Set<JsonPointer>(JsonAny.ParseUriValue(value), ValueKey);
        }
        ...
        public void GivenTheDotnetBackedJsonPointer(string value)
        {
            if (value == "null")
            {
                this.scenarioContext.Set((JsonPointer)JsonNull.Instance.AsAny.AsString, ValueKey);
            }
            else
            {
                this.scenarioContext.Set(new JsonPointer((string)JsonAny.ParseUriValue(value)), ValueKey);
            }
        }
        ...
        public void WhenICompareItToThePointer(string expected)
        {
            if (expected != "null")
            {
                this.scenarioContext.Set(this.scenarioContext.Get<JsonPointer>(ValueKey).Equals(new JsonPointer((string)JsonAny.ParseUriValue(expected))), EqualsObjectBackedResultKey);
            }

            this.scenarioContext.Set(this.scenarioContext.Get<JsonPointer>(ValueKey).Equals((JsonPointer)JsonAny.ParseUriValue(expected)), EqualsResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonPointer>(ValueKey) == (JsonPointer)JsonAny.ParseUriValue(expected), EqualityResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonPointer>(ValueKey) != (JsonPointer)JsonAny.ParseUriValue(expected), InequalityResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonPointer>(ValueKey).GetHashCode() == ((JsonPointer)JsonAny.ParseUriValue(expected)).GetHashCode(), HashCodeResultKey);
        }
        ...
        {
            this.scenarioContext.Set(this.scenarioContext.Get<JsonPointer>(ValueKey).Equals(JsonAny.ParseUriValue(expected)), EqualsResultKey);
        }
        ...
        public void WhenICompareThePointerToTheObject(string expected)
        {
            ...
            this.scenarioContext.Set(((object)this.scenarioContext.Get<JsonPointer>(ValueKey)).Equals(obj), EqualsResultKey);
            if (obj is not null)
            {
                this.scenarioContext.Set(((object)this.scenarioContext.Get<JsonPointer>(ValueKey)).GetHashCode() == obj.GetHashCode(), HashCodeResultKey);
            }
        }
        ...
        {
            this.scenarioContext.Set<JsonRelativePointer>(JsonAny.ParseUriValue(value), ValueKey);
        }
        ...
        public void GivenTheDotnetBackedJsonRelativePointer(string value)
        {
            if (value == "null")
            {
                this.scenarioContext.Set((JsonRelativePointer)JsonNull.Instance.AsAny.AsString, ValueKey);
            }
            else
            {
                this.scenarioContext.Set(new JsonRelativePointer((string)JsonAny.ParseUriValue(value)), ValueKey);
            }
        }
        ...
        public void WhenICompareItToTheRelativePointer(string expected)
        {
            if (expected != "null")
            {
                this.scenarioContext.Set(this.scenarioContext.Get<JsonRelativePointer>(ValueKey).Equals(new JsonRelativePointer((string)JsonAny.ParseUriValue(expected))), EqualsObjectBackedResultKey);
            }

            this.scenarioContext.Set(this.scenarioContext.Get<JsonRelativePointer>(ValueKey).Equals((JsonRelativePointer)JsonAny.ParseUriValue(expected)), EqualsResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonRelativePointer>(ValueKey) == (JsonRelativePointer)JsonAny.ParseUriValue(expected), EqualityResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonRelativePointer>(ValueKey) != (JsonRelativePointer)JsonAny.ParseUriValue(expected), InequalityResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonRelativePointer>(ValueKey).GetHashCode() == ((JsonRelativePointer)JsonAny.ParseUriValue(expected)).GetHashCode(), HashCodeResultKey);
        }
        ...
        {
            this.scenarioContext.Set(this.scenarioContext.Get<JsonRelativePointer>(ValueKey).Equals(JsonAny.ParseUriValue(expected)), EqualsResultKey);
        }
        ...
        public void WhenICompareTheRelativePointerToTheObject(string expected)
        {
            ...
            this.scenarioContext.Set(((object)this.scenarioContext.Get<JsonRelativePointer>(ValueKey)).Equals(obj), EqualsResultKey);
            if (obj is not null)
            {
                this.scenarioContext.Set(((object)this.scenarioContext.Get<JsonRelativePointer>(ValueKey)).GetHashCode() == obj.GetHashCode(), HashCodeResultKey);
            }
        }
        ...
        {
            this.scenarioContext.Set<JsonRegex>(JsonAny.ParseUriValue(value), ValueKey);
        }
        ...
        public void GivenTheDotnetBackedJsonRegex(string value)
        {
            if (value == "null")
            {
                this.scenarioContext.Set((JsonRegex)JsonNull.Instance.AsAny.AsString, ValueKey);
            }
            else
            {
                this.scenarioContext.Set(new JsonRegex((string)JsonAny.ParseUriValue(value)), ValueKey);
            }
        }
        ...
        public void WhenICompareItToTheRegex(string expected)
        {
            if (expected != "null")
            {
                this.scenarioContext.Set(this.scenarioContext.Get<JsonRegex>(ValueKey).Equals(new JsonRegex((string)JsonAny.ParseUriValue(expected))), EqualsObjectBackedResultKey);
            }

            this.scenarioContext.Set(this.scenarioContext.Get<JsonRegex>(ValueKey).Equals((JsonRegex)JsonAny.ParseUriValue(expected)), EqualsResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonRegex>(ValueKey) == (JsonRegex)JsonAny.ParseUriValue(expected), EqualityResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonRegex>(ValueKey) != (JsonRegex)JsonAny.ParseUriValue(expected), InequalityResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonRegex>(ValueKey).GetHashCode() == ((JsonRegex)JsonAny.ParseUriValue(expected)).GetHashCode(), HashCodeResultKey);
        }
        ...
        {
            this.scenarioContext.Set(this.scenarioContext.Get<JsonRegex>(ValueKey).Equals(JsonAny.ParseUriValue(expected)), EqualsResultKey);
        }
        ...
        public void WhenICompareTheRegexToTheObject(string expected)
        {
            ...
            this.scenarioContext.Set(((object)this.scenarioContext.Get<JsonRegex>(ValueKey)).Equals(obj), EqualsResultKey);
            if (obj is not null)
            {
                this.scenarioContext.Set(((object)this.scenarioContext.Get<JsonRegex>(ValueKey)).GetHashCode() == obj.GetHashCode(), HashCodeResultKey);
            }
        }
        ...
        {
            this.scenarioContext.Set<JsonUuid>(JsonAny.ParseUriValue(value), ValueKey);
        }
        ...
        public void GivenTheDotnetBackedJsonUuid(string value)
        {
            if (value == "null")
            {
                this.scenarioContext.Set((JsonUuid)JsonNull.Instance.AsAny.AsString, ValueKey);
            }
            else
            {
                this.scenarioContext.Set(new JsonUuid((string)JsonAny.ParseUriValue(value)), ValueKey);
            }
        }
        ...
        public void WhenICompareItToTheUuid(string expected)
        {
            if (expected != "null")
            {
                this.scenarioContext.Set(this.scenarioContext.Get<JsonUuid>(ValueKey).Equals(new JsonUuid((string)JsonAny.ParseUriValue(expected))), EqualsObjectBackedResultKey);
            }

            this.scenarioContext.Set(this.scenarioContext.Get<JsonUuid>(ValueKey).Equals((JsonUuid)JsonAny.ParseUriValue(expected)), EqualsResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonUuid>(ValueKey) == (JsonUuid)JsonAny.ParseUriValue(expected), EqualityResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonUuid>(ValueKey) != (JsonUuid)JsonAny.ParseUriValue(expected), InequalityResultKey);
            this.scenarioContext.Set(this.scenarioContext.Get<JsonUuid>(ValueKey).GetHashCode() == ((JsonUuid)JsonAny.ParseUriValue(expected)).GetHashCode(), HashCodeResultKey);
        }
        ...
        {
            this.scenarioContext.Set(this.scenarioContext.Get<JsonUuid>(ValueKey).Equals(JsonAny.ParseUriValue(expected)), EqualsResultKey);
        }
        ...
        public void WhenICompareTheUuidToTheObject(string expected)
        {
            ...
            this.scenarioContext.Set(((object)this.scenarioContext.Get<JsonUuid>(ValueKey)).Equals(obj), EqualsResultKey);
            if (obj is not null)
            {
                this.scenarioContext.Set(((object)this.scenarioContext.Get<JsonUuid>(ValueKey)).GetHashCode() == obj.GetHashCode(), HashCodeResultKey);
            }
        }
