...
namespace Steps
{
    ...
    public class JsonValueEqualitySteps
    {
        ...
        public void WhenICompareItToTheArray(string expected)
        {
            if (expected != "null")
            {
                this.scenarioContext.Set(this.scenarioContext.Get<JsonArray>(JsonValueSteps.SubjectUnderTest).Equals(new JsonArray(((JsonArray)JsonAny.ParseUriValue(expected)).AsItemsList)), EqualsObjectBackedResultKey);
            }
        ...
        public void WhenICompareItToTheObject(string expected)
        {
            if (expected != "null")
            {
                this.scenarioContext.Set(this.scenarioContext.Get<JsonObject>(JsonValueSteps.SubjectUnderTest).Equals(new JsonObject(((JsonObject)JsonAny.ParseUriValue(expected)).AsPropertyDictionary)), EqualsObjectBackedResultKey);
            }
