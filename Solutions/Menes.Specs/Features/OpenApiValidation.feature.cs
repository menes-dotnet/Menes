...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OpenApiValidation", "\tIn order to diagnose bad requests or responses\r\n\tAs a developer\r\n\tI want to be a" +
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Validate arrays where item schema is used by reference")]
        [NUnit.Framework.CategoryAttribute("perScenarioContainer")]
        [NUnit.Framework.TestCaseAttribute("1", "{\"arrItem\": {\"type\":\"boolean\" }, \"arr\": {\"type\": \"array\", \"items\": {\"$ref\":\"#/com" +
            "ponents/schemas/arrItem\"}}}", "arr", "[1,2,3]", "valid", null)]
        [NUnit.Framework.TestCaseAttribute("2", "{\"arrItem\": {\"type\":\"boolean\" }, \"arr\": {\"type\": \"array\", \"items\": {\"$ref\":\"#/com" +
            "ponents/schemas/arrItem\"}}}", "arr", "[\"a\", \"b\"]", "invalid", null)]
        [NUnit.Framework.TestCaseAttribute("3", "{\"arrItem\": {\"type\":\"boolean\" }, \"arr\": {\"type\": \"array\", \"items\": {\"$ref\":\"#/com" +
            "ponents/schemas/arrItem\"}}}", "arr", "true", "invalid", null)]
        [NUnit.Framework.TestCaseAttribute("4", "{\"arrItem\": {\"type\":\"boolean\" }, \"arr\": {\"type\": \"array\", \"items\": {\"$ref\":\"#/com" +
            "ponents/schemas/arrItem\"}}}", "arr", "\"hello\"", "invalid", null)]
        public virtual void ValidateArraysWhereItemSchemaIsUsedByReference(string iD, string schemas, string schemaName, string payloadJSON, string result, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "perScenarioContainer"};
            if ((exampleTags != null))
            ...
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("ID", iD);
            argumentsOfScenario.Add("Schemas", schemas);
            argumentsOfScenario.Add("SchemaName", schemaName);
            argumentsOfScenario.Add("Payload JSON", payloadJSON);
            argumentsOfScenario.Add("Result", result);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Validate arrays where item schema is used by reference", null, tagsOfScenario, argumentsOfScenario);
#line 47
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
            ...
            else
            {
                this.ScenarioStart();
#line 48
 testRunner.Given(string.Format("an OpenApi document with the schemas section \'{0}\'", schemas), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 49
 testRunner.And(string.Format("I am using the schema \'{0}\' from the OpenApi document", schemaName), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 50
 testRunner.And(string.Format("the payload \'{0}\'", payloadJSON), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
