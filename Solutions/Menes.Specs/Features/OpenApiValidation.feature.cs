...
#line hidden
        ...
        public virtual void ValidateObjectDefinition(string iD, string schemaFragment, string payloadJSON, string result, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Validate object definition", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
...
#line hidden
        ...
        public virtual void ValidateAnyOfAllOfAndOneOf(string iD, string schemaFragment, string payloadJSON, string result, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("Payload JSON", payloadJSON);
            argumentsOfScenario.Add("Result", result);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Validate anyOf allOf and oneOf", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 19
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
