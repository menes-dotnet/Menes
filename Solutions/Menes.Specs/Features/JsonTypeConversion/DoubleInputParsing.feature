...
Scenario: Array body with items of double type
...
Scenario: Array parameter with items of double type
...
Scenario: Array parameter with items of double type via default
    Given I have constructed the OpenAPI specification with a parameter with name 'openApiArray', of type array, containing items of type 'number' and format 'double', and the default value for the parameter is '[1,2,-1234.5678987,4,5]'
    When I try to parse the default value
    Then the parameter openApiArray should be [1,2,-1234.5678987,4,5] of type System.String
...
Scenario: Array parameter with items of array type via default
    Given I have constructed the OpenAPI specification with a parameter with name 'openApiNestedArray', of type array, containing items which are arrays themselves with item type 'number' and format 'double', and the default value for the parameter is '[[1],[2,3],[4,5,6]]'
    When I try to parse the default value
...
Scenario: Object parameter with properties of simple types via default
    Given I have constructed the OpenAPI specification with a parameter with name 'openApiObject', of type object, containing properties in the structure '{ "v1": { "type":"number","format": "double" }, "v2": {"type":"number","format": "double"} }', and the default value for the parameter is '{"v1":-42,"v2":23}'
    When I try to parse the default value
    Then the parameter openApiObject should be {"v1":-42,"v2":23} of type System.String
