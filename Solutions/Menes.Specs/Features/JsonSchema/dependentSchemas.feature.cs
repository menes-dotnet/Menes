...
namespace Features.JsonSchema
{
    ...
    [NUnit.Framework.DescriptionAttribute("dependentSchemas")]
    public partial class DependentSchemasFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/JsonSchema", "dependentSchemas", "    In order to use json-schema\r\n    As a developer\r\n    I want to support depend" +
                    "entSchemas", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
        ...
        public virtual void BooleanSubschemas(string inputDataReference, string valid, string description, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("valid", valid);
            argumentsOfScenario.Add("description", description);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("boolean subschemas", null, tagsOfScenario, argumentsOfScenario);
#line 23
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
