...
namespace Features.JsonSchema.Draft2020212
{
    ...
    [NUnit.Framework.DescriptionAttribute("time draft2020-12")]
    [NUnit.Framework.CategoryAttribute("draft2020-12")]
    public partial class TimeDraft2020_12Feature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/JsonSchema/Draft2020212", "time draft2020-12", "    In order to use json-schema\r\n    As a developer\r\n    I want to support time i" +
        ...
        [NUnit.Framework.TestCaseAttribute("#/000/tests/000/data", "true", "a valid time string", null)]
        [NUnit.Framework.TestCaseAttribute("#/000/tests/001/data", "false", "an invalid time string", null)]
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 12
    testRunner.Given("the input JSON file \"time.json\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 13
