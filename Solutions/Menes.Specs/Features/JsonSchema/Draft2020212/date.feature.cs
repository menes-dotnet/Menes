...
namespace Features.JsonSchema.Draft2020212
{
    ...
    [NUnit.Framework.DescriptionAttribute("date draft2020-12")]
    [NUnit.Framework.CategoryAttribute("draft2020-12")]
    public partial class DateDraft2020_12Feature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/JsonSchema/Draft2020212", "date draft2020-12", "    In order to use json-schema\r\n    As a developer\r\n    I want to support date i" +
        ...
        [NUnit.Framework.TestCaseAttribute("#/000/tests/000/data", "true", "a valid date string", null)]
        [NUnit.Framework.TestCaseAttribute("#/000/tests/001/data", "false", "an invalid date-time string", null)]
        [NUnit.Framework.TestCaseAttribute("#/000/tests/002/data", "false", "only RFC3339 not all of ISO 8601 are valid", null)]
        [NUnit.Framework.TestCaseAttribute("#/000/tests/003/data", "false", "invalidates non-padded month dates", null)]
        [NUnit.Framework.TestCaseAttribute("#/000/tests/004/data", "false", "invalidates non-padded day dates", null)]
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 12
    testRunner.Given("the input JSON file \"date.json\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 13
