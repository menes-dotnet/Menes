...
namespace Features.JsonSchema.Draft2020212
{
    ...
    [NUnit.Framework.DescriptionAttribute("hostname draft2020-12")]
    [NUnit.Framework.CategoryAttribute("draft2020-12")]
    public partial class HostnameDraft2020_12Feature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/JsonSchema/Draft2020212", "hostname draft2020-12", "    In order to use json-schema\r\n    As a developer\r\n    I want to support hostna" +
                    "me in draft2020-12", ProgrammingLanguage.CSharp, new string[] {
                        "draft2020-12"});
