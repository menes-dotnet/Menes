...
namespace Menes
{
    ...
    /// </summary>
    public readonly struct JsonHostName : IJsonValue, IEquatable<JsonHostName>
    {
        /// <summary>
        /// The function that constructs an instance from a JsonElement.
        /// </summary>
        public static readonly Func<JsonElement, JsonHostName> FromJsonElement = e => new JsonHostName(e);

        /// <summary>
        /// A <see cref="JsonHostName"/> representing a null value.
        /// </summary>
        public static readonly JsonHostName Null = new JsonHostName(default(JsonElement));

        private static readonly Regex ValidateHostName = new Regex("^(?=.{1,255}$)[0-9a-z](([0-9a-z]|\\b-){0,61}[0-9a-z])?(\\.[0-9a-z](([0-9a-z]|\\b-){0,61}[0-9a-z])?)*\\.?$", RegexOptions.Compiled);

        private readonly string? clrString;

        /// <summary>
        /// Creates a <see cref="JsonHostName"/> wrapper around a .NET string.
        /// </summary>
        /// <param name="clrString">The .NET string.</param>
        public JsonHostName(string clrString)
        {
        ...
        /// </summary>
        public JsonHostName? AsOptional => this.IsNull ? default(JsonHostName?) : this;
        ...
        public static implicit operator string(JsonHostName value) => value.CreateOrGetClrString();
        ...
        public static implicit operator JsonAny(JsonHostName item) => JsonAny.From(item);
...
#pragma warning restore IDE0060 // Remove unused parameter
        ...
        /// <summary>
        /// Gets a <see cref="JsonHostName"/> from a property in a JSON element, or <see cref="Null"/> if the property is not present.
        /// </summary>
        /// <param name="parentDocument">The parent JSON element.</param>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        /// <returns>A <see cref="JsonHostName"/> or null.</returns>
        public static JsonHostName FromOptionalProperty(in JsonElement parentDocument, ReadOnlySpan<char> propertyName) =>
            parentDocument.ValueKind == JsonValueKind.Object ?
                (parentDocument.TryGetProperty(propertyName, out JsonElement property)
                    ? new JsonHostName(property)
                    : Null)
                : Null;
        ...
        /// </param>
        /// <returns>A <see cref="JsonHostName"/> or null.</returns>
        public static JsonHostName FromOptionalProperty(in JsonElement parentDocument, string propertyName) =>
            parentDocument.ValueKind == JsonValueKind.Object ?
                (parentDocument.TryGetProperty(propertyName, out JsonElement property)
                    ? new JsonHostName(property)
                    : Null)
        ...
        /// </param>
        /// <returns>A <see cref="JsonHostName"/> or null.</returns>
        public static JsonHostName FromOptionalProperty(in JsonElement parentDocument, ReadOnlySpan<byte> utf8PropertyName) =>
            parentDocument.ValueKind == JsonValueKind.Object ?
        ...
        /// <inheritdoc/>
        public bool Equals(JsonHostName other)
        {
        ...
        public ValidationContext Validate(in ValidationContext validationContext)
        {
            ...
            if (!ValidateHostName.IsMatch(value))
            {
                return validationContext.WithError($"6.3.3. pattern: The string should match {ValidateHostName} but was {value}.");
            }
