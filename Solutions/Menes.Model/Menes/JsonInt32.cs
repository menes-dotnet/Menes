...
namespace Menes
{
    ...
    public readonly struct JsonInt32 : IJsonValue, IEquatable<JsonInt32>
    {
        ...
        {
            return this.IsNull ? string.Empty : this.CreateOrGetClrInt32().ToString();
        }
        ...
        public ValidationContext Validate(in ValidationContext validationContext)
        {
            ...
            if (this.HasJsonElement && this.JsonElement.ValueKind == JsonValueKind.Number && !this.JsonElement.TryGetInt32(out _))
            {
                return validationContext.WithError("6.1.1. type: the element is not convertible to an int32.");
            }
