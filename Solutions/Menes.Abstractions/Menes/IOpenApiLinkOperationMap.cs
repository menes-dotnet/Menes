...
namespace Menes
{
    ...
    public interface IOpenApiLinkOperationMap
    {
        ...
        /// </para>
        /// </remarks>
        void MapByContentTypeAndRelationTypeAndOperationId(string contentType, string relationType, string operationId);
        ...
        void MapByContentTypeAndRelationTypeAndOperationId<T>(string relationType, string operationId);
        ...
        /// <param name="operationId">The Id of the operation that will be used to resolve the link.</param>
        void MapByContentTypeAndRelationTypeAndContextAndOperationId(string contentType, string relationType, string context, string operationId);
        ...
        /// <param name="operationId">The Id of the operation that will be used to resolve the link.</param>
        void MapByContentTypeAndRelationTypeAndContextAndOperationId<T>(string relationType, string context, string operationId);
    }
}