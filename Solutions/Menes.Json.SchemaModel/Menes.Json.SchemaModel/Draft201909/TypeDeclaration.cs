...
namespace Menes.Json.SchemaModel.Draft201909
{
    using System;
    using System.Collections.Generic;
    using System.Collections.Immutable;
    using Menes.Json;
    using Menes.Json.Draft201909;
    ...
    {
        private const string BuiltInsLocation = "https://github.com/menes-dotnet/Menes/tree/master/schema/builtins";
        ...
        public void SetDotnetPropertyNames()
        {
            ...
            foreach (PropertyDeclaration property in this.properties)
            {
                ...
                int suffixLength = 0;
                int index = 1;
                string nameString = name.Slice(0, baseName.Length + suffixLength).ToString();
                while (existingNames.Contains(nameString))
                {
                    index.TryFormat(name[baseName.Length..], out suffixLength);
                    index++;
                    nameString = name.Slice(0, baseName.Length + suffixLength).ToString();
                }
        ...
        private class PropertyDeclarationEqualityComparer : IEqualityComparer<PropertyDeclaration>
        {
            ...
            {
                return x.JsonPropertyName == y.JsonPropertyName;
            }
