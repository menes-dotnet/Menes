...
namespace Menes.Json.SchemaModel
{
    ...
    /// <summary>
    /// Interfcace implemented by Json Schema Builders.
    /// </summary>
    public interface IJsonSchemaBuilder
    {
        ...
        Task<(string rootType, ImmutableDictionary<string, (string, string)> generatedTypes)> BuildTypesFor(string reference, string rootNamespace, bool rebase = false, Dictionary<string, string>? baseUriToNamespaceMap = null);
