...
namespace Menes.Json.SchemaModel.Draft202012
{
    ...
    public static class SchemaExtensions
    {
        ...
        {
            return
                draft202012Schema.IsExplicitNumberType() || (draft202012Schema.Type.IsSimpleTypesEntityArray && draft202012Schema.Type.AsSimpleTypesEntityArray.EnumerateItems().Any(type => type.Equals(Validation.SimpleTypesEntity.EnumValues.Number) || type.Equals(Validation.SimpleTypesEntity.EnumValues.Integer))) || draft202012Schema.Minimum.IsNotUndefined() || draft202012Schema.Maximum.IsNotUndefined() || draft202012Schema.ExclusiveMaximum.IsNotUndefined() || draft202012Schema.ExclusiveMinimum.IsNotUndefined() || draft202012Schema.MultipleOf.IsNotUndefined() || draft202012Schema.HasNumberEnum() || draft202012Schema.HasNumberConst();
        }
        ...
        {
            return
                draft202012Schema.IsExplicitBooleanType() || (draft202012Schema.Type.IsSimpleTypesEntityArray && draft202012Schema.Type.AsSimpleTypesEntityArray.EnumerateItems().Any(type => type.Equals(Validation.SimpleTypesEntity.EnumValues.Boolean))) || draft202012Schema.HasBooleanEnum() || draft202012Schema.HasBooleanConst();
        }
        ...
        {
            return
                draft202012Schema.IsExplicitStringType() || (draft202012Schema.Type.IsSimpleTypesEntityArray && draft202012Schema.Type.AsSimpleTypesEntityArray.EnumerateItems().Any(type => type.Equals(Validation.SimpleTypesEntity.EnumValues.String))) || draft202012Schema.MinLength.IsNotUndefined() || draft202012Schema.MaxLength.IsNotUndefined() || draft202012Schema.Pattern.IsNotUndefined() || draft202012Schema.HasStringEnum() || draft202012Schema.HasStringConst();
        }
