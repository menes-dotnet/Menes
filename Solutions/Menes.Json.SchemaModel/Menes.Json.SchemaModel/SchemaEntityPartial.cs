// <copyright file="SchemaEntityPartial.cs" company="Endjin Limited">
...
public partial class SchemaEntity
{
    ...
    public SchemaEntity(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate)
    {
    ...
    {
        var sep = new SchemaEntity(this.Builder, child);
