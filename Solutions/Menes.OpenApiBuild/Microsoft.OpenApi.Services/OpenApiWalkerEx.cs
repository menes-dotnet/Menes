// <auto-generated>
// Original material copyright (c) Microsoft Corporation. All rights reserved.
...
namespace Microsoft.OpenApi.Services
{
    ...
    /// </summary>
    public class OpenApiWalkerEx
    {
        private readonly OpenApiVisitorBaseEx _visitor;
        ...
        /// </summary>
        public OpenApiWalkerEx(OpenApiVisitorBaseEx visitor)
        {
            _visitor = visitor;
        }
        ...
        internal void Walk(OpenApiComponents components)
        {
            ...
            Walk(OpenApiConstants.Schemas, () =>
            {
                ...
                {
                    foreach (var item in components.Schemas.ToDictionary(kvp => kvp.Key, kvp => kvp.Value))
                    {
            ...
            Walk(OpenApiConstants.Callbacks, () =>
            {
                ...
                {
                    foreach (var item in components.Callbacks.ToDictionary(kvp => kvp.Key, kvp => kvp.Value))
                    {
                        Walk(item.Key, () => Walk(item.Value, isComponent: true));
                    }
                }
            ...
            Walk(OpenApiConstants.Parameters, () =>
            {
                ...
                {
                    foreach (var item in components.Parameters.ToDictionary(kvp => kvp.Key, kvp => kvp.Value))
                    {
                        Walk(item.Key, () => Walk(item.Value, isComponent: true));
                    }
                }
            ...
            Walk(OpenApiConstants.Examples, () =>
            {
                ...
                {
                    foreach (var item in components.Examples.ToDictionary(kvp => kvp.Key, kvp => kvp.Value))
                    {
                        Walk(item.Key, () => Walk(item.Value, isComponent: true));
                    }
                }
            ...
            Walk(OpenApiConstants.Headers, () =>
            {
                ...
                {
                    foreach (var item in components.Headers.ToDictionary(kvp => kvp.Key, kvp => kvp.Value))
                    {
                        Walk(item.Key, () => Walk(item.Value, isComponent: true));
                    }
                }
            ...
            Walk(OpenApiConstants.Links, () =>
            {
                ...
                {
                    foreach (var item in components.Links.ToDictionary(kvp => kvp.Key, kvp => kvp.Value))
                    {
                        Walk(item.Key, () => Walk(item.Value, isComponent: true));
                    }
                }
            ...
            Walk(OpenApiConstants.RequestBodies, () =>
            {
                ...
                {
                    foreach (var item in components.RequestBodies.ToDictionary(kvp => kvp.Key, kvp => kvp.Value))
                    {
                        Walk(item.Key, () => Walk(item.Value, isComponent: true));
                    }
                }
            ...
            Walk(OpenApiConstants.Responses, () =>
            {
                ...
                {
                    foreach (var item in components.Responses.ToDictionary(kvp => kvp.Key, kvp => kvp.Value))
                    {
                        Walk(item.Key, () => Walk(item.Value, isComponent: true));
                    }
                }
