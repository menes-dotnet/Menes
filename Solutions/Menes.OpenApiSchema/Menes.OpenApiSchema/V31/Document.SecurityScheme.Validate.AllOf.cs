...
public readonly partial struct Document
{
    ...
    public readonly partial struct SecurityScheme
    {
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<Menes.OpenApiSchema.V31.Document.SpecificationExtensions>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext allOfResult1 = this.As<Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeApikeyEntity>().Validate(childContext1.CreateChildContext(), level);
            ...
            ValidationContext allOfResult2 = this.As<Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeHttpEntity>().Validate(childContext2.CreateChildContext(), level);
            ...
            ValidationContext allOfResult3 = this.As<Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeHttpBearerEntity>().Validate(childContext3.CreateChildContext(), level);
            ...
            ValidationContext allOfResult4 = this.As<Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeOauth2Entity>().Validate(childContext4.CreateChildContext(), level);
            ...
            ValidationContext allOfResult5 = this.As<Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeOidcEntity>().Validate(childContext5.CreateChildContext(), level);
