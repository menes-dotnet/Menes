...
public readonly partial struct Document
{
    ...
    public readonly partial struct RequestBodyOrReference
    {
        ...
        /// </summary>
        public static RequestBodyOrReference Create(Corvus.Json.JsonUriReference? @ref = null, Corvus.Json.JsonString? summary = null, Corvus.Json.JsonString? description = null, Menes.OpenApiSchema.V31.Document.Content? content = null, Menes.OpenApiSchema.V31.Document.RequestBody.RequiredEntity? required = null)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public RequestBodyOrReference WithContent(in Menes.OpenApiSchema.V31.Document.Content value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public RequestBodyOrReference WithRequired(in Menes.OpenApiSchema.V31.Document.RequestBody.RequiredEntity value)
        {
