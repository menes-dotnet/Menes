...
public readonly partial struct Document
{
    ...
    public readonly partial struct Parameter
    {
        ...
        public static implicit operator Parameter(Menes.OpenApiSchema.V31.Document.Parameter.OneOf0Entity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Menes.OpenApiSchema.V31.Document.Parameter.OneOf0Entity(Parameter value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Parameter(Menes.OpenApiSchema.V31.Document.Parameter.OneOf1Entity value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Menes.OpenApiSchema.V31.Document.Parameter.OneOf1Entity(Parameter value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
                return new(value.AsJsonElement);
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Parameter(Menes.OpenApiSchema.V31.Document.SpecificationExtensions value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Menes.OpenApiSchema.V31.Document.SpecificationExtensions(Parameter value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
                return new(value.AsJsonElement);
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Parameter(Menes.OpenApiSchema.V31.Document.Parameter.ThenEntity value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Menes.OpenApiSchema.V31.Document.Parameter.ThenEntity(Parameter value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
                return new(value.AsJsonElement);
