...
public readonly partial struct Document
{
    ...
    public readonly partial struct EncodingEntity
    {
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult1 = this.As<Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity>().Validate(childContext1.CreateChildContext(), level);
