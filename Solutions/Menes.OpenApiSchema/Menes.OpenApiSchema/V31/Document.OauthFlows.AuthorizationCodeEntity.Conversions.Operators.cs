...
public readonly partial struct Document
{
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct AuthorizationCodeEntity
        {
            ...
            public static implicit operator AuthorizationCodeEntity(Menes.OpenApiSchema.V31.Document.SpecificationExtensions value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator Menes.OpenApiSchema.V31.Document.SpecificationExtensions(AuthorizationCodeEntity value)
            {
