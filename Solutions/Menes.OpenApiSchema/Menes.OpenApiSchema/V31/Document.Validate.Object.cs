    ...
    private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        foreach (JsonObjectProperty property in this.EnumerateObject())
        {
            if (__TryGetCorvusLocalPropertiesValidator(property, this.HasJsonElementBacking, out ObjectPropertyValidator? propertyValidator))
            {
                ...
                if ((this.HasJsonElementBacking && property.NameEquals(OpenapiUtf8JsonPropertyName.Span)) || (!this.HasJsonElementBacking && property.NameEquals(OpenapiJsonPropertyName)))
                {
                    foundOpenapi = true;
                }
                else if ((this.HasJsonElementBacking && property.NameEquals(InfoValueUtf8JsonPropertyName.Span)) || (!this.HasJsonElementBacking && property.NameEquals(InfoValueJsonPropertyName)))
                {
                    foundInfoValue = true;
                }
            }
