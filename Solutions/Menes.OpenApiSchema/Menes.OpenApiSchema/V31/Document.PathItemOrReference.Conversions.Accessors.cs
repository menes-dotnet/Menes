...
public readonly partial struct Document
{
    ...
    public readonly partial struct PathItemOrReference
    {
        ...
        /// <summary>
        /// Gets the value as a <see cref = "Menes.OpenApiSchema.V31.Document.PathItem"/>.
        /// </summary>
        public Menes.OpenApiSchema.V31.Document.PathItem AsPathItem
        {
            get
            {
                return (Menes.OpenApiSchema.V31.Document.PathItem)this;
            }
        }

        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref = "Menes.OpenApiSchema.V31.Document.PathItem"/>.
        /// </summary>
        public bool IsPathItem
        {
            get
            {
                return ((Menes.OpenApiSchema.V31.Document.PathItem)this).IsValid();
            }
        }
        ...
        /// <param name = "result">The result of the conversion.</param>
        /// <returns><c>True</c> if the conversion was valid.</returns>
        public bool TryGetAsPathItem(out Menes.OpenApiSchema.V31.Document.PathItem result)
        {
            result = (Menes.OpenApiSchema.V31.Document.PathItem)this;
            return result.IsValid();
        }
    }
}