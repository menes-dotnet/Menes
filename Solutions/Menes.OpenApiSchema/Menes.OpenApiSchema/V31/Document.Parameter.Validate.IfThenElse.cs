...
public readonly partial struct Document
{
    ...
    public readonly partial struct Parameter
    {
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<Menes.OpenApiSchema.V31.Document.Parameter.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            if (!ifResult.IsValid)
            {
            ...
            if (ifResult.IsValid)
            {
                ...
                ValidationContext thenResult = this.As<Menes.OpenApiSchema.V31.Document.Parameter.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
