...
public readonly partial struct Document
{
    ...
    public readonly partial struct HeaderOrReference
    {
        ...
        /// </summary>
        public Menes.OpenApiSchema.V31.Document.Header IfEntityNotMatched
        {
            get
            {
                return this.As<Menes.OpenApiSchema.V31.Document.Header>();
            }
        }
        ...
        {
            if (this.As<Menes.OpenApiSchema.V31.Document.HeaderOrReference.IfEntity>().IsValid())
            {
        ...
        public bool TryNotMatchedIfEntity(out Menes.OpenApiSchema.V31.Document.Header result)
        {
            if (!this.As<Menes.OpenApiSchema.V31.Document.HeaderOrReference.IfEntity>().IsValid())
            {
                result = this.As<Menes.OpenApiSchema.V31.Document.Header>();
                return true;
            }

            result = Menes.OpenApiSchema.V31.Document.Header.Undefined;
            return false;
        }
    }
}