        ...
        private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (JsonObjectProperty property in this.EnumerateObject())
            {
                if (__TryGetCorvusLocalPropertiesValidator(property, this.HasJsonElementBacking, out ObjectPropertyValidator? propertyValidator))
                {
                    ...
                    if ((this.HasJsonElementBacking && property.NameEquals(TitleUtf8JsonPropertyName.Span)) || (!this.HasJsonElementBacking && property.NameEquals(TitleJsonPropertyName)))
                    {
                        foundTitle = true;
                    }
                    else if ((this.HasJsonElementBacking && property.NameEquals(VersionUtf8JsonPropertyName.Span)) || (!this.HasJsonElementBacking && property.NameEquals(VersionJsonPropertyName)))
                    {
                        foundVersion = true;
                    }
                }
