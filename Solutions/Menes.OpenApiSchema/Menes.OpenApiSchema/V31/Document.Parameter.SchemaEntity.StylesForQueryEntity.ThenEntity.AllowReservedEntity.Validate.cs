                    ...
                    public readonly partial struct AllowReservedEntity
                    {
                        ...
                        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                        {
                            ...
                            if (level > ValidationLevel.Basic)
                            {
                                ...
                                result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.1/schema/2022-02-27#/$defs/parameter/dependentSchemas/schema/$defs/styles-for-query/then/properties/allowReserved");
                            }
