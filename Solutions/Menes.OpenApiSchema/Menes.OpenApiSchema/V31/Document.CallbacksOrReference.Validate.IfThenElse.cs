...
public readonly partial struct Document
{
    ...
    public readonly partial struct CallbacksOrReference
    {
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<Menes.OpenApiSchema.V31.Document.CallbacksOrReference.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            if (!ifResult.IsValid)
            {
            ...
            if (ifResult.IsValid)
            {
                ...
                ValidationContext thenResult = this.As<Menes.OpenApiSchema.V31.Document.Reference>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (!ifResult.IsValid)
            {
                ...
                ValidationContext elseResult = this.As<Menes.OpenApiSchema.V31.Document.Callbacks>().Validate(validationContext.CreateChildContext(), level);
