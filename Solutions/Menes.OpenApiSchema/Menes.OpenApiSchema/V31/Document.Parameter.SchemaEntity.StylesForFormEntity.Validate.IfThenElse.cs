        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForFormEntity
            {
                private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
                {
                    ...
                    ValidationContext ifResult = this.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.IfEntity>().Validate(validationContext.CreateChildContext(), level);
                    if (!ifResult.IsValid)
                    {
                    ...
                    if (ifResult.IsValid)
                    {
                        ...
                        ValidationContext thenResult = this.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
                    ...
                    if (!ifResult.IsValid)
                    {
                        ...
                        ValidationContext elseResult = this.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
