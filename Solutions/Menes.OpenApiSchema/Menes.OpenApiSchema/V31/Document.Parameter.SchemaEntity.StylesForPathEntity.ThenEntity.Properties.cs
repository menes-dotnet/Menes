        ...
        public readonly partial struct SchemaEntity
        {
            public readonly partial struct StylesForPathEntity
            {
                ...
                public readonly partial struct ThenEntity
                {
                    ...
                    /// </summary>
                    public static ThenEntity Create(Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForPathEntity.ThenEntity.NameEntity? name = null, Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForPathEntity.ThenEntity.StyleEntity? style = null)
                    {
                        var builder = ImmutableDictionary.CreateBuilder<JsonPropertyName, JsonAny>();
                        builder.Add(RequiredJsonPropertyName, new Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForPathEntity.ThenEntity.RequiredEntity().AsAny);
                    ...
                    public ThenEntity WithName(in Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForPathEntity.ThenEntity.NameEntity value)
                    {
                    ...
                    /// <param name = "value">The value to set.</param>
                    /// <returns>The entity with the updated property.</returns>
                    public ThenEntity WithStyle(in Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForPathEntity.ThenEntity.StyleEntity value)
                    {
                    ...
                    {
                        return property.ValueAs<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForPathEntity.ThenEntity.RequiredEntity>().Validate(validationContext, level);
                    }
                    ...
                    {
                        return property.ValueAs<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForPathEntity.ThenEntity.NameEntity>().Validate(validationContext, level);
                    }
                    ...
                    {
                        return property.ValueAs<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForPathEntity.ThenEntity.StyleEntity>().Validate(validationContext, level);
                    }
                    ...
                    private bool __TryGetCorvusLocalPropertiesValidator(in JsonObjectProperty property, bool hasJsonElementBacking, [NotNullWhen(true)] out ObjectPropertyValidator? propertyValidator)
                    {
                        ...
                        {
                            if (property.NameEquals(RequiredUtf8JsonPropertyName.Span))
                            {
                        ...
                        {
                            if (property.NameEquals(RequiredJsonPropertyName))
                            {
                                propertyValidator = __CorvusValidateRequired;
                                return true;
                            }
