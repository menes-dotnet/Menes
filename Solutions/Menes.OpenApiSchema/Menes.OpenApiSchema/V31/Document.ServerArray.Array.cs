...
public readonly partial struct Document
{
    ...
    /// </summary>
    public readonly partial struct ServerArray : IJsonArray<ServerArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        ...
        public static ServerArray FromItems(in Menes.OpenApiSchema.V31.Document.Server value1)
        {
        ...
        /// <returns>A ServerArray instantiated from the given items.</returns>
        public static ServerArray FromItems(in Menes.OpenApiSchema.V31.Document.Server value1, in Menes.OpenApiSchema.V31.Document.Server value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ServerArray instantiated from the given items.</returns>
        public static ServerArray FromItems(in Menes.OpenApiSchema.V31.Document.Server value1, in Menes.OpenApiSchema.V31.Document.Server value2, in Menes.OpenApiSchema.V31.Document.Server value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ServerArray FromItems(params Menes.OpenApiSchema.V31.Document.Server[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Menes.OpenApiSchema.V31.Document.Server item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ServerArray FromRange(IEnumerable<Menes.OpenApiSchema.V31.Document.Server> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Menes.OpenApiSchema.V31.Document.Server item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.Server> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.Server>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.Server>(this.arrayBacking);
            }
