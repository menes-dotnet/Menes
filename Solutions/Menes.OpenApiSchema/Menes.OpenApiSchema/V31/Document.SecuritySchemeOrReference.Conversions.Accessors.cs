...
public readonly partial struct Document
{
    ...
    public readonly partial struct SecuritySchemeOrReference
    {
        ...
        /// <summary>
        /// Gets the value as a <see cref = "Menes.OpenApiSchema.V31.Document.SecurityScheme"/>.
        /// </summary>
        public Menes.OpenApiSchema.V31.Document.SecurityScheme AsSecurityScheme
        {
            get
            {
                return (Menes.OpenApiSchema.V31.Document.SecurityScheme)this;
            }
        }

        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref = "Menes.OpenApiSchema.V31.Document.SecurityScheme"/>.
        /// </summary>
        public bool IsSecurityScheme
        {
            get
            {
                return ((Menes.OpenApiSchema.V31.Document.SecurityScheme)this).IsValid();
            }
        }
        ...
        /// <param name = "result">The result of the conversion.</param>
        /// <returns><c>True</c> if the conversion was valid.</returns>
        public bool TryGetAsSecurityScheme(out Menes.OpenApiSchema.V31.Document.SecurityScheme result)
        {
            result = (Menes.OpenApiSchema.V31.Document.SecurityScheme)this;
            return result.IsValid();
        }
    }
}