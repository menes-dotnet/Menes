        ...
        public readonly partial struct SchemaEntity
        {
            public readonly partial struct StylesForFormEntity
            {
                ...
                public readonly partial struct IfEntity
                {
                    ...
                    /// Gets Style.
                    /// </summary>
                    public Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.IfEntity.StyleEntity Style
                    {
                        get
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                                ...
                                {
                                    return new Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.IfEntity.StyleEntity(result);
                                }
                            }
                            ...
                            if ((this.backing & Backing.Object) != 0)
                            {
                                ...
                                {
                                    return result.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.IfEntity.StyleEntity>();
                                }
                            }
                    ...
                    public static IfEntity Create()
                    {
                        ...
                        builder.Add(StyleJsonPropertyName, new Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.IfEntity.StyleEntity().AsAny);
                    ...
                    {
                        return property.ValueAs<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.IfEntity.StyleEntity>().Validate(validationContext, level);
                    }
