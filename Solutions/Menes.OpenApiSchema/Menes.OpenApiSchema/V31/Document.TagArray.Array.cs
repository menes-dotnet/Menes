...
public readonly partial struct Document
{
    ...
    /// </summary>
    public readonly partial struct TagArray : IJsonArray<TagArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly TagArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "TagArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public TagArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public TagArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(TagArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator TagArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(TagArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator TagArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static TagArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A TagArray instantiated from the given items.</returns>
        public static TagArray FromItems(in Menes.OpenApiSchema.V31.Document.Tag value1)
        {
        ...
        /// <returns>A TagArray instantiated from the given items.</returns>
        public static TagArray FromItems(in Menes.OpenApiSchema.V31.Document.Tag value1, in Menes.OpenApiSchema.V31.Document.Tag value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A TagArray instantiated from the given items.</returns>
        public static TagArray FromItems(in Menes.OpenApiSchema.V31.Document.Tag value1, in Menes.OpenApiSchema.V31.Document.Tag value2, in Menes.OpenApiSchema.V31.Document.Tag value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static TagArray FromItems(params Menes.OpenApiSchema.V31.Document.Tag[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Menes.OpenApiSchema.V31.Document.Tag item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static TagArray FromRange(IEnumerable<Menes.OpenApiSchema.V31.Document.Tag> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Menes.OpenApiSchema.V31.Document.Tag item in value)
            {
        ...
        /// </remarks>
        public static TagArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new TagArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static TagArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static TagArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.Tag> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.Tag>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.Tag>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<TagArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<TagArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
