...
public readonly partial struct Document
{
    ...
    public readonly partial struct PathItemOrReference
    {
        ...
        /// </summary>
        public Menes.OpenApiSchema.V31.Document.PathItem IfEntityNotMatched
        {
            get
            {
                return this.As<Menes.OpenApiSchema.V31.Document.PathItem>();
            }
        }
        ...
        {
            if (this.As<Menes.OpenApiSchema.V31.Document.PathItemOrReference.IfEntity>().IsValid())
            {
        ...
        public bool TryNotMatchedIfEntity(out Menes.OpenApiSchema.V31.Document.PathItem result)
        {
            if (!this.As<Menes.OpenApiSchema.V31.Document.PathItemOrReference.IfEntity>().IsValid())
            {
                result = this.As<Menes.OpenApiSchema.V31.Document.PathItem>();
                return true;
            }
