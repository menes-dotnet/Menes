    ...
    public readonly partial struct EncodingEntity
    {
        public readonly partial struct ExplodeDefaultEntity
        {
            ...
            public readonly partial struct IfEntity
            {
                ...
                /// Gets Style.
                /// </summary>
                public Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity.IfEntity.StyleEntity Style
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                            ...
                            {
                                return new Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity.IfEntity.StyleEntity(result);
                            }
                        }
                        ...
                        if ((this.backing & Backing.Object) != 0)
                        {
                            ...
                            {
                                return result.As<Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity.IfEntity.StyleEntity>();
                            }
                        }
                ...
                public static IfEntity Create()
                {
                    ...
                    builder.Add(StyleJsonPropertyName, new Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity.IfEntity.StyleEntity().AsAny);
                ...
                {
                    return property.ValueAs<Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity.IfEntity.StyleEntity>().Validate(validationContext, level);
                }
