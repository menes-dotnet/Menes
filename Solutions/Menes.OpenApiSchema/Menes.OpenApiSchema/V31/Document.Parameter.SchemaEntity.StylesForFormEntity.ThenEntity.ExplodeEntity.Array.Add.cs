        ...
        public readonly partial struct SchemaEntity
        {
            public readonly partial struct StylesForFormEntity
            {
                public readonly partial struct ThenEntity
                {
                    ...
                    {
                        /// <inheritdoc/>
                        public ExplodeEntity Add(in JsonAny item1)
                        {
                        ...
                        /// <inheritdoc/>
                        public ExplodeEntity Add(params JsonAny[] items)
                        {
                            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
                        ...
                        /// <inheritdoc/>
                        public ExplodeEntity AddRange<TArray>(in TArray items)
                        ...
                        /// <inheritdoc/>
                        public ExplodeEntity AddRange<TItem>(IEnumerable<TItem> items)
                        ...
                        /// <inheritdoc/>
                        public ExplodeEntity AddRange(IEnumerable<JsonAny> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
                            builder.AddRange(items);
                            return new(builder.ToImmutable());
                        ...
                        /// <inheritdoc/>
                        public ExplodeEntity Insert(int index, in JsonAny item1)
                        {
                            return new(this.GetImmutableListWith(index, item1));
                        }

                        /// <inheritdoc/>
                        public ExplodeEntity InsertRange<TArray>(int index, in TArray items)
                            where TArray : struct, IJsonArray<TArray>
                        {
                        ...
                        /// <inheritdoc/>
                        public ExplodeEntity InsertRange<TItem>(int index, IEnumerable<TItem> items)
                            where TItem : struct, IJsonValue<TItem>
                        {
                        ...
                        /// <inheritdoc/>
                        public ExplodeEntity InsertRange(int index, IEnumerable<JsonAny> items)
                        {
                            return new(this.GetImmutableListWith(index, items));
                        }

                        /// <inheritdoc/>
                        public ExplodeEntity Replace(in JsonAny oldValue, in JsonAny newValue)
                        {
                            return this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny);
                        }

                        /// <inheritdoc/>
                        public ExplodeEntity SetItem(int index, in JsonAny value)
                        {
