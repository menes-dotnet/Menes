...
public readonly partial struct Document
{
    ...
    public readonly partial struct Parameter
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<Menes.OpenApiSchema.V31.Document.Parameter.OneOf0Entity>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<Menes.OpenApiSchema.V31.Document.Parameter.OneOf1Entity>().Validate(childContext1.CreateChildContext(), level);
