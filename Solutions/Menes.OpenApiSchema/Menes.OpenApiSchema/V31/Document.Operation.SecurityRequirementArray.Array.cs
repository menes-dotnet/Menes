...
public readonly partial struct Document
{
    public readonly partial struct Operation
    {
        ...
        /// </summary>
        public readonly partial struct SecurityRequirementArray : IJsonArray<SecurityRequirementArray>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            ...
            public static SecurityRequirementArray FromItems(in Menes.OpenApiSchema.V31.Document.SecurityRequirement value1)
            {
            ...
            /// <returns>A SecurityRequirementArray instantiated from the given items.</returns>
            public static SecurityRequirementArray FromItems(in Menes.OpenApiSchema.V31.Document.SecurityRequirement value1, in Menes.OpenApiSchema.V31.Document.SecurityRequirement value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A SecurityRequirementArray instantiated from the given items.</returns>
            public static SecurityRequirementArray FromItems(in Menes.OpenApiSchema.V31.Document.SecurityRequirement value1, in Menes.OpenApiSchema.V31.Document.SecurityRequirement value2, in Menes.OpenApiSchema.V31.Document.SecurityRequirement value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static SecurityRequirementArray FromItems(params Menes.OpenApiSchema.V31.Document.SecurityRequirement[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Menes.OpenApiSchema.V31.Document.SecurityRequirement item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static SecurityRequirementArray FromRange(IEnumerable<Menes.OpenApiSchema.V31.Document.SecurityRequirement> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Menes.OpenApiSchema.V31.Document.SecurityRequirement item in value)
                {
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.SecurityRequirement> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.SecurityRequirement>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.SecurityRequirement>(this.arrayBacking);
                }
