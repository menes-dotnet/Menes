...
public readonly partial struct Document
{
    ...
    public readonly partial struct ParameterOrReference
    {
        ...
        /// </summary>
        public Menes.OpenApiSchema.V31.Document.Parameter IfEntityNotMatched
        {
            get
            {
                return this.As<Menes.OpenApiSchema.V31.Document.Parameter>();
            }
        }
        ...
        {
            if (this.As<Menes.OpenApiSchema.V31.Document.ParameterOrReference.IfEntity>().IsValid())
            {
        ...
        public bool TryNotMatchedIfEntity(out Menes.OpenApiSchema.V31.Document.Parameter result)
        {
            if (!this.As<Menes.OpenApiSchema.V31.Document.ParameterOrReference.IfEntity>().IsValid())
            {
                result = this.As<Menes.OpenApiSchema.V31.Document.Parameter>();
                return true;
            }

            result = Menes.OpenApiSchema.V31.Document.Parameter.Undefined;
            return false;
        }
    }
}