    ...
    public readonly partial struct SecurityScheme
    {
        public readonly partial struct TypeApikeyEntity
        {
            ...
            public readonly partial struct ThenEntity
            {
                ...
                /// </summary>
                public static ThenEntity Create(Corvus.Json.JsonString name, Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeApikeyEntity.ThenEntity.InEntity @in)
                {
                ...
                public ThenEntity WithName(in Corvus.Json.JsonString value)
                {
                ...
                /// <param name = "value">The value to set.</param>
                /// <returns>The entity with the updated property.</returns>
                public ThenEntity WithIn(in Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeApikeyEntity.ThenEntity.InEntity value)
                {
                ...
                {
                    return property.ValueAs<Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeApikeyEntity.ThenEntity.InEntity>().Validate(validationContext, level);
                }
