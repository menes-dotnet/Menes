...
public readonly partial struct Document
{
    ...
    public readonly partial struct ResponseOrReference
    {
        ...
        /// </summary>
        public Menes.OpenApiSchema.V31.Document.Response IfEntityNotMatched
        {
            get
            {
                return this.As<Menes.OpenApiSchema.V31.Document.Response>();
            }
        }
        ...
        {
            if (this.As<Menes.OpenApiSchema.V31.Document.ResponseOrReference.IfEntity>().IsValid())
            {
        ...
        public bool TryNotMatchedIfEntity(out Menes.OpenApiSchema.V31.Document.Response result)
        {
            if (!this.As<Menes.OpenApiSchema.V31.Document.ResponseOrReference.IfEntity>().IsValid())
            {
                result = this.As<Menes.OpenApiSchema.V31.Document.Response>();
                return true;
            }

            result = Menes.OpenApiSchema.V31.Document.Response.Undefined;
            return false;
        }
    }
}