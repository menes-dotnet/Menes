...
public readonly partial struct Document
{
    ...
    public readonly partial struct PathItemOrReference
    {
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<Menes.OpenApiSchema.V31.Document.PathItemOrReference.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            if (!ifResult.IsValid)
            {
            ...
            if (!ifResult.IsValid)
            {
                ...
                ValidationContext elseResult = this.As<Menes.OpenApiSchema.V31.Document.PathItem>().Validate(validationContext.CreateChildContext(), level);
