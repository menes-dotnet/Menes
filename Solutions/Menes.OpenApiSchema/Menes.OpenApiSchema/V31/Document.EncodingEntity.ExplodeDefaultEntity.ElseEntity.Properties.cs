    ...
    public readonly partial struct EncodingEntity
    {
        public readonly partial struct ExplodeDefaultEntity
        {
            ...
            public readonly partial struct ElseEntity
            {
                ...
                /// </summary>
                public static ElseEntity Create(Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity.ElseEntity.ExplodeEntity? explode = null)
                {
                ...
                public ElseEntity WithExplode(in Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity.ElseEntity.ExplodeEntity value)
                {
                ...
                {
                    return property.ValueAs<Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity.ElseEntity.ExplodeEntity>().Validate(validationContext, level);
                }
