    ...
    public readonly partial struct EncodingEntity
    {
        ...
        public readonly partial struct ExplodeDefaultEntity
        {
            private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext ifResult = this.As<Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity.IfEntity>().Validate(validationContext.CreateChildContext(), level);
                if (!ifResult.IsValid)
                {
                ...
                if (ifResult.IsValid)
                {
                    ...
                    ValidationContext thenResult = this.As<Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
                ...
                if (!ifResult.IsValid)
                {
                    ...
                    ValidationContext elseResult = this.As<Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
