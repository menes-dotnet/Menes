...
public readonly partial struct Document
{
    ...
    public readonly partial struct EncodingEntity
    {
        ...
        /// <summary>
        /// Gets the value as a <see cref = "Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity"/>.
        /// </summary>
        public Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity AsExplodeDefaultEntity
        {
            get
            {
                return (Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity)this;
            }
        }

        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref = "Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity"/>.
        /// </summary>
        public bool IsExplodeDefaultEntity
        {
            get
            {
                return ((Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity)this).IsValid();
            }
        }
        ...
        /// <param name = "result">The result of the conversion.</param>
        /// <returns><c>True</c> if the conversion was valid.</returns>
        public bool TryGetAsExplodeDefaultEntity(out Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity result)
        {
            result = (Menes.OpenApiSchema.V31.Document.EncodingEntity.ExplodeDefaultEntity)this;
            return result.IsValid();
        }
    }
}