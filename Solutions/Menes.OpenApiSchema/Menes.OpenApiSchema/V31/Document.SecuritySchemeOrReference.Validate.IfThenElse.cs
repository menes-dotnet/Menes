...
public readonly partial struct Document
{
    ...
    public readonly partial struct SecuritySchemeOrReference
    {
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<Menes.OpenApiSchema.V31.Document.SecuritySchemeOrReference.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            if (!ifResult.IsValid)
            {
            ...
            if (!ifResult.IsValid)
            {
                ...
                ValidationContext elseResult = this.As<Menes.OpenApiSchema.V31.Document.SecurityScheme>().Validate(validationContext.CreateChildContext(), level);
