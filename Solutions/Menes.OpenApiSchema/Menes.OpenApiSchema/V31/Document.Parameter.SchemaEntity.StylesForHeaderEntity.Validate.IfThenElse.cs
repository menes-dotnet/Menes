        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForHeaderEntity
            {
                private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
                {
                    ...
                    ValidationContext ifResult = this.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForHeaderEntity.IfEntity>().Validate(validationContext.CreateChildContext(), level);
                    if (!ifResult.IsValid)
                    {
                    ...
                    if (ifResult.IsValid)
                    {
                        ...
                        ValidationContext thenResult = this.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForHeaderEntity.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
