...
public readonly partial struct Document
{
    ...
    public readonly partial struct LinkOrReference
    {
        ...
        /// <summary>
        /// Gets the value as a <see cref = "Menes.OpenApiSchema.V31.Document.Link"/>.
        /// </summary>
        public Menes.OpenApiSchema.V31.Document.Link AsLink
        {
            get
            {
                return (Menes.OpenApiSchema.V31.Document.Link)this;
            }
        }

        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref = "Menes.OpenApiSchema.V31.Document.Link"/>.
        /// </summary>
        public bool IsLink
        {
            get
            {
                return ((Menes.OpenApiSchema.V31.Document.Link)this).IsValid();
            }
        }
        ...
        /// <param name = "result">The result of the conversion.</param>
        /// <returns><c>True</c> if the conversion was valid.</returns>
        public bool TryGetAsLink(out Menes.OpenApiSchema.V31.Document.Link result)
        {
            result = (Menes.OpenApiSchema.V31.Document.Link)this;
            return result.IsValid();
        }
    }
}