    ...
    public readonly partial struct SecurityScheme
    {
        public readonly partial struct TypeHttpEntity
        {
            ...
            public readonly partial struct ThenEntity
            {
                ...
                /// </summary>
                public static ThenEntity Create(Corvus.Json.JsonString scheme)
                {
                ...
                public ThenEntity WithScheme(in Corvus.Json.JsonString value)
                {
                ...
                private bool __TryGetCorvusLocalPropertiesValidator(in JsonObjectProperty property, bool hasJsonElementBacking, [NotNullWhen(true)] out ObjectPropertyValidator? propertyValidator)
                {
                    ...
                    {
                        if (property.NameEquals(SchemeUtf8JsonPropertyName.Span))
                        {
                    ...
                    {
                        if (property.NameEquals(SchemeJsonPropertyName))
                        {
                            propertyValidator = __CorvusValidateScheme;
                            return true;
                        }
