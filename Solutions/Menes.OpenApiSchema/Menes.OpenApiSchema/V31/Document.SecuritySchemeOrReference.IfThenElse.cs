...
public readonly partial struct Document
{
    ...
    public readonly partial struct SecuritySchemeOrReference
    {
        ...
        /// </summary>
        public Menes.OpenApiSchema.V31.Document.SecurityScheme IfEntityNotMatched
        {
            get
            {
                return this.As<Menes.OpenApiSchema.V31.Document.SecurityScheme>();
            }
        }
        ...
        {
            if (this.As<Menes.OpenApiSchema.V31.Document.SecuritySchemeOrReference.IfEntity>().IsValid())
            {
        ...
        public bool TryNotMatchedIfEntity(out Menes.OpenApiSchema.V31.Document.SecurityScheme result)
        {
            if (!this.As<Menes.OpenApiSchema.V31.Document.SecuritySchemeOrReference.IfEntity>().IsValid())
            {
                result = this.As<Menes.OpenApiSchema.V31.Document.SecurityScheme>();
                return true;
            }

            result = Menes.OpenApiSchema.V31.Document.SecurityScheme.Undefined;
            return false;
        }
    }
}