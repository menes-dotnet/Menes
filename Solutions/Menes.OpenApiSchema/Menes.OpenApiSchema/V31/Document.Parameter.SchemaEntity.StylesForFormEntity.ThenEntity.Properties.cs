        ...
        public readonly partial struct SchemaEntity
        {
            public readonly partial struct StylesForFormEntity
            {
                ...
                public readonly partial struct ThenEntity
                {
                    ...
                    /// Gets Explode.
                    /// </summary>
                    public Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.ThenEntity.ExplodeEntity Explode
                    {
                        get
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                                ...
                                {
                                    return new Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.ThenEntity.ExplodeEntity(result);
                                }
                            }
                            ...
                            if ((this.backing & Backing.Object) != 0)
                            {
                                ...
                                {
                                    return result.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.ThenEntity.ExplodeEntity>();
                                }
                            }
                    ...
                    /// </summary>
                    public static ThenEntity Create(Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.ThenEntity.ExplodeEntity? explode = null)
                    {
                        var builder = ImmutableDictionary.CreateBuilder<JsonPropertyName, JsonAny>();
                        if (explode is Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.ThenEntity.ExplodeEntity explode__)
                        {
                    ...
                    public ThenEntity WithExplode(in Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.ThenEntity.ExplodeEntity value)
                    {
                    ...
                    {
                        return property.ValueAs<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity.ThenEntity.ExplodeEntity>().Validate(validationContext, level);
                    }
