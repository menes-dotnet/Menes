...
public readonly partial struct Document
{
    ...
    public readonly partial struct Operation
    {
        ...
        public static implicit operator Operation(Menes.OpenApiSchema.V31.Document.SpecificationExtensions value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Menes.OpenApiSchema.V31.Document.SpecificationExtensions(Operation value)
        {
