    ...
    public readonly partial struct Parameter
    {
        ...
        public readonly partial struct SchemaEntity
        {
            private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext allOfResult0 = this.As<Menes.OpenApiSchema.V31.Document.Examples>().Validate(childContext0.CreateChildContext(), level);
                ...
                ValidationContext allOfResult1 = this.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForPathEntity>().Validate(childContext1.CreateChildContext(), level);
                ...
                ValidationContext allOfResult2 = this.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForHeaderEntity>().Validate(childContext2.CreateChildContext(), level);
                ...
                ValidationContext allOfResult3 = this.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity>().Validate(childContext3.CreateChildContext(), level);
                ...
                ValidationContext allOfResult4 = this.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForCookieEntity>().Validate(childContext4.CreateChildContext(), level);
                ...
                ValidationContext allOfResult5 = this.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForFormEntity>().Validate(childContext5.CreateChildContext(), level);
