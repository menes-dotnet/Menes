        ...
        public readonly partial struct SchemaEntity
        {
            public readonly partial struct StylesForQueryEntity
            {
                ...
                public readonly partial struct IfEntity
                {
                    ...
                    /// Gets In.
                    /// </summary>
                    public Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity.IfEntity.InEntity In
                    {
                        get
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                                ...
                                {
                                    return new Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity.IfEntity.InEntity(result);
                                }
                            }
                            ...
                            if ((this.backing & Backing.Object) != 0)
                            {
                                ...
                                {
                                    return result.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity.IfEntity.InEntity>();
                                }
                            }
                    ...
                    public static IfEntity Create()
                    {
                        ...
                        builder.Add(InJsonPropertyName, new Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity.IfEntity.InEntity().AsAny);
                    ...
                    {
                        return property.ValueAs<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity.IfEntity.InEntity>().Validate(validationContext, level);
                    }
