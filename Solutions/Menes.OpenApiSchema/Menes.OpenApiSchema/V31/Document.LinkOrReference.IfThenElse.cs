...
public readonly partial struct Document
{
    ...
    public readonly partial struct LinkOrReference
    {
        ...
        /// </summary>
        public Menes.OpenApiSchema.V31.Document.Link IfEntityNotMatched
        {
            get
            {
                return this.As<Menes.OpenApiSchema.V31.Document.Link>();
            }
        }
        ...
        {
            if (this.As<Menes.OpenApiSchema.V31.Document.LinkOrReference.IfEntity>().IsValid())
            {
        ...
        public bool TryNotMatchedIfEntity(out Menes.OpenApiSchema.V31.Document.Link result)
        {
            if (!this.As<Menes.OpenApiSchema.V31.Document.LinkOrReference.IfEntity>().IsValid())
            {
                result = this.As<Menes.OpenApiSchema.V31.Document.Link>();
                return true;
            }

            result = Menes.OpenApiSchema.V31.Document.Link.Undefined;
            return false;
        }
    }
}