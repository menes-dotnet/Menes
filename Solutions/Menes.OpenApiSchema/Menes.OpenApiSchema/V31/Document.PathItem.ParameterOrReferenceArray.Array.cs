...
public readonly partial struct Document
{
    public readonly partial struct PathItem
    {
        ...
        /// </summary>
        public readonly partial struct ParameterOrReferenceArray : IJsonArray<ParameterOrReferenceArray>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            ...
            public static ParameterOrReferenceArray FromItems(in Menes.OpenApiSchema.V31.Document.ParameterOrReference value1)
            {
            ...
            /// <returns>A ParameterOrReferenceArray instantiated from the given items.</returns>
            public static ParameterOrReferenceArray FromItems(in Menes.OpenApiSchema.V31.Document.ParameterOrReference value1, in Menes.OpenApiSchema.V31.Document.ParameterOrReference value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A ParameterOrReferenceArray instantiated from the given items.</returns>
            public static ParameterOrReferenceArray FromItems(in Menes.OpenApiSchema.V31.Document.ParameterOrReference value1, in Menes.OpenApiSchema.V31.Document.ParameterOrReference value2, in Menes.OpenApiSchema.V31.Document.ParameterOrReference value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static ParameterOrReferenceArray FromItems(params Menes.OpenApiSchema.V31.Document.ParameterOrReference[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Menes.OpenApiSchema.V31.Document.ParameterOrReference item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static ParameterOrReferenceArray FromRange(IEnumerable<Menes.OpenApiSchema.V31.Document.ParameterOrReference> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Menes.OpenApiSchema.V31.Document.ParameterOrReference item in value)
                {
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.ParameterOrReference> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.ParameterOrReference>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Menes.OpenApiSchema.V31.Document.ParameterOrReference>(this.arrayBacking);
                }
