    ...
    public readonly partial struct EncodingEntity
    {
        public readonly partial struct ExplodeDefaultEntity
        {
            public readonly partial struct ElseEntity
            {
                ...
                /// </summary>
                public readonly partial struct ExplodeEntity : IJsonString<ExplodeEntity>
                {
                    /// <summary>
                    ...
                    /// </summary>
                    /// <param name = "value">The value from which to construct the instance.</param>
                    public ExplodeEntity(in ReadOnlySpan<char> value)
                    {
                        this.jsonElementBacking = default;
                        this.backing = Backing.String;
                    ...
                    public ExplodeEntity(in ReadOnlySpan<byte> utf8Value)
                    {
                        this.jsonElementBacking = default;
                        this.backing = Backing.String;
                    ...
                    public static implicit operator JsonString(ExplodeEntity value)
                    {
                    ...
                    public static implicit operator string (ExplodeEntity value)
                    {
                    ...
                    /// </summary>
                    /// <param name = "value">The value from which to convert.</param>
                    public static implicit operator ExplodeEntity(ReadOnlySpan<char> value)
                    {
                        return new(value);
                    }
                    ...
                    /// <param name = "value">The value from which to convert.</param>
                    /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
                    public static implicit operator ReadOnlySpan<char>(ExplodeEntity value)
                    {
                    ...
                    /// </summary>
                    /// <param name = "value">The value from which to convert.</param>
                    public static implicit operator ExplodeEntity(ReadOnlySpan<byte> value)
                    {
                        return new(value);
                    }
