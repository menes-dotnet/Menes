...
public readonly partial struct Document
{
    ...
    public readonly partial struct ParameterOrReference
    {
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<Menes.OpenApiSchema.V31.Document.ParameterOrReference.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            if (!ifResult.IsValid)
            {
            ...
            if (!ifResult.IsValid)
            {
                ...
                ValidationContext elseResult = this.As<Menes.OpenApiSchema.V31.Document.Parameter>().Validate(validationContext.CreateChildContext(), level);
