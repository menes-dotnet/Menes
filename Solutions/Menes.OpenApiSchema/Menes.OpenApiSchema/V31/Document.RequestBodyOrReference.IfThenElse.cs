...
public readonly partial struct Document
{
    ...
    public readonly partial struct RequestBodyOrReference
    {
        ...
        /// </summary>
        public Menes.OpenApiSchema.V31.Document.RequestBody IfEntityNotMatched
        {
            get
            {
                return this.As<Menes.OpenApiSchema.V31.Document.RequestBody>();
            }
        }
        ...
        {
            if (this.As<Menes.OpenApiSchema.V31.Document.RequestBodyOrReference.IfEntity>().IsValid())
            {
        ...
        public bool TryNotMatchedIfEntity(out Menes.OpenApiSchema.V31.Document.RequestBody result)
        {
            if (!this.As<Menes.OpenApiSchema.V31.Document.RequestBodyOrReference.IfEntity>().IsValid())
            {
                result = this.As<Menes.OpenApiSchema.V31.Document.RequestBody>();
                return true;
            }

            result = Menes.OpenApiSchema.V31.Document.RequestBody.Undefined;
            return false;
        }
    }
}