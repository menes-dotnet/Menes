    ...
    public readonly partial struct SecurityScheme
    {
        public readonly partial struct TypeHttpEntity
        {
            ...
            public readonly partial struct IfEntity
            {
                ...
                /// Gets Type.
                /// </summary>
                public Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeHttpEntity.IfEntity.TypeEntity Type
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                            ...
                            {
                                return new Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeHttpEntity.IfEntity.TypeEntity(result);
                            }
                        }
                        ...
                        if ((this.backing & Backing.Object) != 0)
                        {
                            ...
                            {
                                return result.As<Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeHttpEntity.IfEntity.TypeEntity>();
                            }
                        }
                ...
                public static IfEntity Create()
                {
                    ...
                    builder.Add(TypeJsonPropertyName, new Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeHttpEntity.IfEntity.TypeEntity().AsAny);
                ...
                {
                    return property.ValueAs<Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeHttpEntity.IfEntity.TypeEntity>().Validate(validationContext, level);
                }
