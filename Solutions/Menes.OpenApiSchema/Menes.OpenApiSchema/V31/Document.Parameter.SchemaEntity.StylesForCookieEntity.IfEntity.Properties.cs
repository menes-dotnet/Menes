        ...
        public readonly partial struct SchemaEntity
        {
            public readonly partial struct StylesForCookieEntity
            {
                ...
                public readonly partial struct IfEntity
                {
                    ...
                    /// Gets In.
                    /// </summary>
                    public Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForCookieEntity.IfEntity.InEntity In
                    {
                        get
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                                ...
                                {
                                    return new Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForCookieEntity.IfEntity.InEntity(result);
                                }
                            }
                            ...
                            if ((this.backing & Backing.Object) != 0)
                            {
                                ...
                                {
                                    return result.As<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForCookieEntity.IfEntity.InEntity>();
                                }
                            }
                    ...
                    public static IfEntity Create()
                    {
                        ...
                        builder.Add(InJsonPropertyName, new Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForCookieEntity.IfEntity.InEntity().AsAny);
                    ...
                    {
                        return property.ValueAs<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForCookieEntity.IfEntity.InEntity>().Validate(validationContext, level);
                    }
