...
public readonly partial struct Document
{
    ...
    /// </summary>
    public readonly partial struct PathItemOrReference : IJsonObject<PathItemOrReference>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "PathItemOrReference"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public PathItemOrReference(ImmutableDictionary<JsonPropertyName, JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PathItemOrReference(ImmutableDictionary<JsonPropertyName, JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonPropertyName, JsonAny>(PathItemOrReference value)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static PathItemOrReference FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source);
        }
        ...
        /// <inheritdoc/>
        public PathItemOrReference SetProperty<TValue>(string name, TValue value)
            where TValue : struct, IJsonValue
        {
            return new(this.GetImmutableDictionaryWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        public PathItemOrReference SetProperty<TValue>(ReadOnlySpan<char> name, TValue value)
            where TValue : struct, IJsonValue
        {
            return new(this.GetImmutableDictionaryWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        public PathItemOrReference SetProperty<TValue>(ReadOnlySpan<byte> utf8Name, TValue value)
            where TValue : struct, IJsonValue
        {
        ...
        /// <inheritdoc/>
        public PathItemOrReference RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
