    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeOauth2Entity
        {
            private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext ifResult = this.As<Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeOauth2Entity.IfEntity>().Validate(validationContext.CreateChildContext(), level);
                if (!ifResult.IsValid)
                {
                ...
                if (ifResult.IsValid)
                {
                    ...
                    ValidationContext thenResult = this.As<Menes.OpenApiSchema.V31.Document.SecurityScheme.TypeOauth2Entity.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
