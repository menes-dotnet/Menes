        ...
        public readonly partial struct SchemaEntity
        {
            public readonly partial struct StylesForQueryEntity
            {
                ...
                public readonly partial struct ThenEntity
                {
                    ...
                    /// </summary>
                    public static ThenEntity Create(Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity.ThenEntity.StyleEntity? style = null, Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity.ThenEntity.AllowReservedEntity? allowReserved = null)
                    {
                    ...
                    public ThenEntity WithStyle(in Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity.ThenEntity.StyleEntity value)
                    {
                    ...
                    /// <param name = "value">The value to set.</param>
                    /// <returns>The entity with the updated property.</returns>
                    public ThenEntity WithAllowReserved(in Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity.ThenEntity.AllowReservedEntity value)
                    {
                    ...
                    {
                        return property.ValueAs<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity.ThenEntity.StyleEntity>().Validate(validationContext, level);
                    }
                    ...
                    {
                        return property.ValueAs<Menes.OpenApiSchema.V31.Document.Parameter.SchemaEntity.StylesForQueryEntity.ThenEntity.AllowReservedEntity>().Validate(validationContext, level);
                    }
