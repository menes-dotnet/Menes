...
namespace Menes.Json
{
    ...
    public readonly struct JsonContent : IJsonValue, IEquatable<JsonContent>
    {
        ...
        public JsonContent(JsonEncodedText value)
        {
            this.jsonElement = default;
            this.value = value;
            this.jsonDocumentValue = default;
        ...
        public static implicit operator JsonContent(JsonString value)
        {
            ...
            {
                return new JsonContent(value.AsJsonElement);
            }
            else
            {
                return new JsonContent((JsonEncodedText)value);
            }
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonContent(JsonEncodedText value)
        {
            return new JsonContent(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(JsonContent value)
        {
        ...
        public EncodedContentMediaTypeParseStatus TryGetJsonDocument(out JsonDocument? result)
        {
            ...
            if (this.value is JsonEncodedText value)
            {
                try
                {
                    ReadOnlySpan<byte> utf8Source = value.EncodedUtf8Bytes;
