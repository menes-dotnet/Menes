...
namespace Menes.Json
{
    ...
    /// A JSON object.
    /// </summary>
    public readonly struct JsonUriReference : IJsonValue, IEquatable<JsonUriReference>
    {
        ...
        public JsonUriReference(JsonEncodedText value)
        {
            this.jsonElement = default;
            this.value = value;
            this.localUriValue = default;
        ...
        /// </summary>
        /// <param name="value">The base64 encoded string value.</param>
        public JsonUriReference(ReadOnlySpan<char> value)
        {
            this.jsonElement = default;
            this.value = JsonEncodedText.Encode(value);
            this.localUriValue = default;
        ...
        public JsonUriReference(ReadOnlySpan<byte> value)
        {
            this.jsonElement = default;
            this.value = JsonEncodedText.Encode(value);
            this.localUriValue = default;
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonUriReference(JsonEncodedText value)
        {
            return new JsonUriReference(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(JsonUriReference value)
        {
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator ReadOnlySpan<byte>(JsonUriReference value)
        {
        ...
        public static bool operator ==(JsonUriReference lhs, JsonUriReference rhs)
        {
        ...
        public ValidationContext Validate(in ValidationContext? validationContext = null, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            return Json.Validate.TypeUriReference(this, result, level);
        }
            ...
            where T : struct, IJsonValue
        {
            ...
            return this.As<JsonUriReference, T>();
        }
        ...
        {
            if (obj is JsonUriReference jany)
            {
        ...
        /// <inheritdoc/>
        public bool Equals(JsonUriReference other)
        {
