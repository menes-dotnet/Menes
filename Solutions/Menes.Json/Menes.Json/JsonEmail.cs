...
namespace Menes.Json
{
    ...
    public readonly struct JsonEmail : IJsonValue, IEquatable<JsonEmail>
    {
        ...
        public JsonEmail(JsonEncodedText value)
        {
            this.jsonElement = default;
            this.value = value;
        }
        ...
        public static implicit operator JsonEmail(JsonString value)
        {
            ...
            {
                return new JsonEmail(value.AsJsonElement);
            }
            else
            {
                return new JsonEmail((JsonEncodedText)value);
            }
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonEmail(JsonEncodedText value)
        {
            return new JsonEmail(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(JsonEmail value)
        {
