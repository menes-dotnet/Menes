...
namespace Menes.Json
{
    ...
    public readonly struct JsonIdnEmail : IJsonValue, IEquatable<JsonIdnEmail>
    {
        ...
        public JsonIdnEmail(JsonEncodedText value)
        {
            this.jsonElement = default;
            this.value = value;
        }
        ...
        public static implicit operator JsonIdnEmail(JsonString value)
        {
            ...
            {
                return new JsonIdnEmail(value.AsJsonElement);
            }
            else
            {
                return new JsonIdnEmail((JsonEncodedText)value);
            }
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonIdnEmail(JsonEncodedText value)
        {
            return new JsonIdnEmail(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(JsonIdnEmail value)
        {
