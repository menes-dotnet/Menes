...
namespace Menes.Json
{
    ...
    public readonly struct JsonDuration : IJsonValue, IEquatable<JsonDuration>
    {
        ...
        public JsonDuration(JsonEncodedText value)
        {
            this.jsonElement = default;
            this.value = value;
            this.localPeriodValue = default;
        ...
        public static implicit operator JsonDuration(JsonString value)
        {
            ...
            {
                return new JsonDuration(value.AsJsonElement);
            }
            else
            {
                return new JsonDuration((JsonEncodedText)value);
            }
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonDuration(JsonEncodedText value)
        {
            return new JsonDuration(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(JsonDuration value)
        {
        ...
        private static bool TryParsePeriod(JsonEncodedText text, out Period value)
        {
            return TryParsePeriod(text.ToString(), out value);
        }
