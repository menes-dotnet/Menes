...
namespace UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesWithDependentSchemas
{
                    ...
                    IEquatable<Schema>
    {
        ...
        {
            return that.As<UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesWithDependentSchemas.Schema.FooEntity>().Validate(validationContext, level);
        }
                    ...
                    IEquatable<FooEntity>
    {
        ...
        private static ImmutableDictionary<string, PropertyValidator<FooEntity>> CreateLocalPropertyValidators()
        {
            ...
            return builder.ToImmutable();
                ...
                private static ValidationContext __MenesValidateBar(in FooEntity that, in ValidationContext validationContext, ValidationLevel level)
        {
