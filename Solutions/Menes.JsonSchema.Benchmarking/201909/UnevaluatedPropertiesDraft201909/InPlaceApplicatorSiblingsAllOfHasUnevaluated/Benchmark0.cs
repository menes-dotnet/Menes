...
namespace UnevaluatedPropertiesDraft201909Feature.InPlaceApplicatorSiblingsAllOfHasUnevaluated
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\unevaluatedProperties.json", "#/25/schema", "#/025/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedPropertiesDraft201909Feature.InPlaceApplicatorSiblingsAllOfHasUnevaluated.Schema>();
        }
        /// <summary>
