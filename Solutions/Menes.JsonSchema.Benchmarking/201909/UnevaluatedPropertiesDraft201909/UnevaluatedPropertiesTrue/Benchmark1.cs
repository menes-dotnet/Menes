...
namespace UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesTrue
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\unevaluatedProperties.json", "#/0/schema", "#/000/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesTrue.Schema>();
        }
        /// <summary>
