...
namespace UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesWithNot
{
                    ...
                    IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext notResult = this.As<UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesWithNot.Schema.NotEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            IEquatable<NotEntity>
    {
        ...
        private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext notResult = this.As<UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesWithNot.Schema.NotEntity.NotEntity1>().Validate(validationContext.CreateChildContext(), level);
            if (notResult.IsValid)
            {
                if (level >= ValidationLevel.Detailed)
                {
                    ...
                    IEquatable<NotEntity1>
    {
        ...
        /// {Property examples}.
        /// </example>
        public UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesWithNot.Schema.NotEntity.NotEntity1.BarEntity Bar
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesWithNot.Schema.NotEntity.NotEntity1.BarEntity(result);
                    }
                }
        ...
        public static NotEntity1 Create(
                   UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesWithNot.Schema.NotEntity.NotEntity1.BarEntity bar
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public NotEntity1 WithBar(UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesWithNot.Schema.NotEntity.NotEntity1.BarEntity value)
        {
