...
namespace HostnameDraft201909Feature.ValidationOfHostNames
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\hostname.json", "#/0/schema", "#/000/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<HostnameDraft201909Feature.ValidationOfHostNames.Schema>();
        }
        /// <summary>
