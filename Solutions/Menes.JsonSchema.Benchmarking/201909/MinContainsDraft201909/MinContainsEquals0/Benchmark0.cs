...
namespace MinContainsDraft201909Feature.MinContainsEquals0
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\minContains.json", "#/5/schema", "#/005/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinContainsDraft201909Feature.MinContainsEquals0.Schema>();
        }
        /// <summary>
