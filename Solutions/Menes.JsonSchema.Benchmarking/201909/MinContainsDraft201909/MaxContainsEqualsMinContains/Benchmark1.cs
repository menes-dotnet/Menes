...
namespace MinContainsDraft201909Feature.MaxContainsEqualsMinContains
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\minContains.json", "#/3/schema", "#/003/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinContainsDraft201909Feature.MaxContainsEqualsMinContains.Schema>();
        }
        /// <summary>
