...
namespace ContainsDraft201909Feature.ContainsKeywordValidation
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\contains.json", "#/0/schema", "#/000/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ContainsDraft201909Feature.ContainsKeywordValidation.Schema>();
        }
        /// <summary>
