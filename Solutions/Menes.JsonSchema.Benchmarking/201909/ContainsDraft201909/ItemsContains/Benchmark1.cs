...
namespace ContainsDraft201909Feature.ItemsContains
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\contains.json", "#/4/schema", "#/004/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ContainsDraft201909Feature.ItemsContains.Schema>();
        }
        /// <summary>
