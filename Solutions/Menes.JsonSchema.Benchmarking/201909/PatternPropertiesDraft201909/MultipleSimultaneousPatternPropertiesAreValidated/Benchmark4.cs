...
namespace PatternPropertiesDraft201909Feature.MultipleSimultaneousPatternPropertiesAreValidated
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\patternProperties.json", "#/1/schema", "#/001/tests/004/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<PatternPropertiesDraft201909Feature.MultipleSimultaneousPatternPropertiesAreValidated.Schema>();
        }
        /// <summary>
