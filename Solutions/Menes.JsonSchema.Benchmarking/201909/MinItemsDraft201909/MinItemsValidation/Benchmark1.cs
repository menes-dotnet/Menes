...
namespace MinItemsDraft201909Feature.MinItemsValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\minItems.json", "#/0/schema", "#/000/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinItemsDraft201909Feature.MinItemsValidation.Schema>();
        }
        /// <summary>
