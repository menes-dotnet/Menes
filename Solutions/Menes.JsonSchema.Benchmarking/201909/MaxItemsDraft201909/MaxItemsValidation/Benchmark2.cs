...
namespace MaxItemsDraft201909Feature.MaxItemsValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\maxItems.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MaxItemsDraft201909Feature.MaxItemsValidation.Schema>();
        }
        /// <summary>
