...
namespace ExclusiveMaximumDraft201909Feature.ExclusiveMaximumValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\exclusiveMaximum.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ExclusiveMaximumDraft201909Feature.ExclusiveMaximumValidation.Schema>();
        }
        /// <summary>
