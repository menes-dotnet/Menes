...
namespace MultipleOfDraft201909Feature.InvalidInstanceShouldNotRaiseErrorWhenFloatDivisionEqualsInf
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            this.ValidateMenesCore<MultipleOfDraft201909Feature.InvalidInstanceShouldNotRaiseErrorWhenFloatDivisionEqualsInf.Schema>();
        }
        /// <summary>
