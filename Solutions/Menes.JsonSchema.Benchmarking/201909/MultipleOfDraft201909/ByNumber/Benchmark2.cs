...
namespace MultipleOfDraft201909Feature.ByNumber
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\multipleOf.json", "#/1/schema", "#/001/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MultipleOfDraft201909Feature.ByNumber.Schema>();
        }
        /// <summary>
