...
namespace MultipleOfDraft201909Feature.BySmallNumber
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\multipleOf.json", "#/2/schema", "#/002/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MultipleOfDraft201909Feature.BySmallNumber.Schema>();
        }
        /// <summary>
