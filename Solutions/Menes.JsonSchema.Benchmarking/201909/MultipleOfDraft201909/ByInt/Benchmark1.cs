...
namespace MultipleOfDraft201909Feature.ByInt
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\multipleOf.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MultipleOfDraft201909Feature.ByInt.Schema>();
        }
        /// <summary>
