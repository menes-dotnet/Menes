...
namespace DependentSchemasDraft201909Feature.DependenciesWithEscapedCharacters
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\dependentSchemas.json", "#/2/schema", "#/002/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DependentSchemasDraft201909Feature.DependenciesWithEscapedCharacters.Schema>();
        }
        /// <summary>
