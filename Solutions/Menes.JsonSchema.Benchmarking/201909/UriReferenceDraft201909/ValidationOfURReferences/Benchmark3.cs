...
namespace UriReferenceDraft201909Feature.ValidationOfURReferences
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\uri-reference.json", "#/0/schema", "#/000/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UriReferenceDraft201909Feature.ValidationOfURReferences.Schema>();
        }
        /// <summary>
