...
namespace TypeDraft201909Feature.TypeArrayObjectOrNull
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\type.json", "#/10/schema", "#/010/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<TypeDraft201909Feature.TypeArrayObjectOrNull.Schema>();
        }
        /// <summary>
