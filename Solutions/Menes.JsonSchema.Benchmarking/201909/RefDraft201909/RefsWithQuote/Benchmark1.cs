...
namespace RefDraft201909Feature.RefsWithQuote
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\ref.json", "#/12/schema", "#/012/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefDraft201909Feature.RefsWithQuote.Schema>();
        }
        /// <summary>
