...
namespace RefDraft201909Feature.RemoteRefContainingRefsItself
{
                    ...
                    IEquatable<MetaData>
    {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithDeprecated(RefDraft201909Feature.RemoteRefContainingRefsItself.MetaData.DeprecatedValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithReadOnly(RefDraft201909Feature.RemoteRefContainingRefsItself.MetaData.ReadOnlyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithWriteOnly(RefDraft201909Feature.RemoteRefContainingRefsItself.MetaData.WriteOnlyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithExamples(RefDraft201909Feature.RemoteRefContainingRefsItself.MetaData.JsonAnyArray value)
        {
        ...
        {
            RefDraft201909Feature.RemoteRefContainingRefsItself.MetaData.DeprecatedValue property = that.Deprecated;
            return property.Validate(validationContext, level);
        }
        ...
        {
            RefDraft201909Feature.RemoteRefContainingRefsItself.MetaData.ReadOnlyValue property = that.ReadOnly;
            return property.Validate(validationContext, level);
        }
        ...
        {
            RefDraft201909Feature.RemoteRefContainingRefsItself.MetaData.WriteOnlyValue property = that.WriteOnly;
            return property.Validate(validationContext, level);
        }
        ...
        {
            RefDraft201909Feature.RemoteRefContainingRefsItself.MetaData.JsonAnyArray property = that.Examples;
            return property.Validate(validationContext, level);
        }
