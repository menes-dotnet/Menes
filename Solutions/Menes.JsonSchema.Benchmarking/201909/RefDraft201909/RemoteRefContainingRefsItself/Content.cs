...
namespace RefDraft201909Feature.RemoteRefContainingRefsItself
{
                    ...
                    IEquatable<Content>
    {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Content WithContentSchema(RefDraft201909Feature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        {
            RefDraft201909Feature.RemoteRefContainingRefsItself.Schema property = that.ContentSchema;
            return property.Validate(validationContext, level);
        }
