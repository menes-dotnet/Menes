...
namespace RefDraft201909Feature.RelativePointerRefToArray
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\ref.json", "#/2/schema", "#/002/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefDraft201909Feature.RelativePointerRefToArray.Schema>();
        }
        /// <summary>
