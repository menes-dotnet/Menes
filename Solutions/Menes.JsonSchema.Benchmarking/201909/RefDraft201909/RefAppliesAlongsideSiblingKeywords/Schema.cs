...
namespace RefDraft201909Feature.RefAppliesAlongsideSiblingKeywords
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public RefDraft201909Feature.RefAppliesAlongsideSiblingKeywords.Schema.FooEntity Foo
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefDraft201909Feature.RefAppliesAlongsideSiblingKeywords.Schema.FooEntity(result);
                    }
                }
        ...
        public static Schema Create(
                            RefDraft201909Feature.RefAppliesAlongsideSiblingKeywords.Schema.FooEntity? foo = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<string, JsonAny>();
                            if (foo is RefDraft201909Feature.RefAppliesAlongsideSiblingKeywords.Schema.FooEntity foo__)
            {
        ...
        public Schema WithFoo(RefDraft201909Feature.RefAppliesAlongsideSiblingKeywords.Schema.FooEntity value)
        {
        ...
        private static ImmutableDictionary<string, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    RefDraft201909Feature.RefAppliesAlongsideSiblingKeywords.Schema.FooEntity property = that.Foo;
