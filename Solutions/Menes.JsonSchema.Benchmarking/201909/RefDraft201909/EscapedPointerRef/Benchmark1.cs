...
namespace RefDraft201909Feature.EscapedPointerRef
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\ref.json", "#/3/schema", "#/003/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefDraft201909Feature.EscapedPointerRef.Schema>();
        }
        /// <summary>
