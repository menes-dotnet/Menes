...
namespace RefDraft201909Feature.RelativePointerRefToObject
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\ref.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefDraft201909Feature.RelativePointerRefToObject.Schema>();
        }
        /// <summary>
