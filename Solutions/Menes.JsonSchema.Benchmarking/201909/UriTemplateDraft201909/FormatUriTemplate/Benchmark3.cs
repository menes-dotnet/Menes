...
namespace UriTemplateDraft201909Feature.FormatUriTemplate
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\uri-template.json", "#/0/schema", "#/000/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UriTemplateDraft201909Feature.FormatUriTemplate.Schema>();
        }
        /// <summary>
