...
namespace MinLengthDraft201909Feature.MinLengthValidation
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\minLength.json", "#/0/schema", "#/000/tests/004/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinLengthDraft201909Feature.MinLengthValidation.Schema>();
        }
        /// <summary>
