...
namespace PatternDraft201909Feature.PatternValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\pattern.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<PatternDraft201909Feature.PatternValidation.Schema>();
        }
        /// <summary>
