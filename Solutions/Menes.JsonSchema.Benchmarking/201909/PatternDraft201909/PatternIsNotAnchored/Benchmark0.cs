...
namespace PatternDraft201909Feature.PatternIsNotAnchored
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\pattern.json", "#/1/schema", "#/001/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<PatternDraft201909Feature.PatternIsNotAnchored.Schema>();
        }
        /// <summary>
