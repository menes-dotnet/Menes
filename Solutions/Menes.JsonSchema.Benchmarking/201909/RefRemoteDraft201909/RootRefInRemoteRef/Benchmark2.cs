...
namespace RefRemoteDraft201909Feature.RootRefInRemoteRef
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\refRemote.json", "#/6/schema", "#/006/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefRemoteDraft201909Feature.RootRefInRemoteRef.Object>();
        }
        /// <summary>
