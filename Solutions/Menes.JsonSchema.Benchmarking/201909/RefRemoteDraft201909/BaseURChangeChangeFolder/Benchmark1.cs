...
namespace RefRemoteDraft201909Feature.BaseURChangeChangeFolder
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\refRemote.json", "#/4/schema", "#/004/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefRemoteDraft201909Feature.BaseURChangeChangeFolder.ScopeChangeDefs1Json>();
        }
        /// <summary>
