...
namespace RefRemoteDraft201909Feature.BaseURChangeChangeFolder
{
                ...
                IEquatable<JsonIntegerArray>
    {
        ...
        public static JsonIntegerArray From(params Menes.Json.JsonInteger[] items)
        {
            return new JsonIntegerArray(items.Select(i => (JsonAny)i).ToImmutableList());
        }
        ...
        /// <returns>The new array created from the items.</returns>
        public static JsonIntegerArray From(Menes.Json.JsonInteger item1)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static JsonIntegerArray From(Menes.Json.JsonInteger item1, Menes.Json.JsonInteger item2)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static JsonIntegerArray From(Menes.Json.JsonInteger item1, Menes.Json.JsonInteger item2, Menes.Json.JsonInteger item3)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static JsonIntegerArray From(Menes.Json.JsonInteger item1, Menes.Json.JsonInteger item2, Menes.Json.JsonInteger item3, Menes.Json.JsonInteger item4)
        {
