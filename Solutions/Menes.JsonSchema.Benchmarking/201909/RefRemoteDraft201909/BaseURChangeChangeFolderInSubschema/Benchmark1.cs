...
namespace RefRemoteDraft201909Feature.BaseURChangeChangeFolderInSubschema
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\refRemote.json", "#/5/schema", "#/005/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefRemoteDraft201909Feature.BaseURChangeChangeFolderInSubschema.ScopeChangeDefs2Json>();
        }
        /// <summary>
