...
namespace ItemsDraft201909Feature.ItemsAndSubitems
{
                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                ...
                {
                                case 0:
                        result = arrayEnumerator.Current.As<ItemsDraft201909Feature.ItemsAndSubitems.Schema.ItemArray>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
                ...
                IEquatable<ItemArray>
    {
        ...
        /// <param name="rhs">The right hand side of the comparison.</param>
        /// <returns>True if they are equal.</returns>
        public static bool operator ==(ItemArray lhs, ItemArray rhs)
        {
            return lhs.Equals(rhs);
        }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                ...
                {
                                case 0:
                        result = arrayEnumerator.Current.As<ItemsDraft201909Feature.ItemsAndSubitems.Schema.SubItemValue>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
