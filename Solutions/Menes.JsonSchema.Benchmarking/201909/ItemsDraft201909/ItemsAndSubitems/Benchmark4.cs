...
namespace ItemsDraft201909Feature.ItemsAndSubitems
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\items.json", "#/5/schema", "#/005/tests/004/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ItemsDraft201909Feature.ItemsAndSubitems.Schema>();
        }
        /// <summary>
