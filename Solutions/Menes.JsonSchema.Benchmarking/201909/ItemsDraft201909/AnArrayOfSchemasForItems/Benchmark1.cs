...
namespace ItemsDraft201909Feature.AnArrayOfSchemasForItems
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\items.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ItemsDraft201909Feature.AnArrayOfSchemasForItems.Schema>();
        }
        /// <summary>
