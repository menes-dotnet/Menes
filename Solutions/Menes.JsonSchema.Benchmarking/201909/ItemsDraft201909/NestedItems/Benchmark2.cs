...
namespace ItemsDraft201909Feature.NestedItems
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\items.json", "#/6/schema", "#/006/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ItemsDraft201909Feature.NestedItems.ItemsArrayArray>();
        }
        /// <summary>
