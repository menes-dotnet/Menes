...
namespace ItemsDraft201909Feature.ItemsWithBooleanSchemaTrue
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\items.json", "#/2/schema", "#/002/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ItemsDraft201909Feature.ItemsWithBooleanSchemaTrue.Schema>();
        }
        /// <summary>
