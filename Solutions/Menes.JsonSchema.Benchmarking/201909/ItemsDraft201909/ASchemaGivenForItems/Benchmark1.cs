...
namespace ItemsDraft201909Feature.ASchemaGivenForItems
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\items.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ItemsDraft201909Feature.ASchemaGivenForItems.Schema>();
        }
        /// <summary>
