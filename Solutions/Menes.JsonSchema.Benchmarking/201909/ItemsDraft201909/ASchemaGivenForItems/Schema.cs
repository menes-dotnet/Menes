...
namespace ItemsDraft201909Feature.ASchemaGivenForItems
{
                ...
                IEquatable<Schema>
    {
        ...
        public static Schema From(params Menes.Json.JsonInteger[] items)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Menes.Json.JsonInteger item1)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Menes.Json.JsonInteger item1, Menes.Json.JsonInteger item2)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Menes.Json.JsonInteger item1, Menes.Json.JsonInteger item2, Menes.Json.JsonInteger item3)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Menes.Json.JsonInteger item1, Menes.Json.JsonInteger item2, Menes.Json.JsonInteger item3, Menes.Json.JsonInteger item4)
        {
