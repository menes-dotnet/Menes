...
namespace RecursiveRefDraft201909Feature.RecursiveRefWithoutRecursiveAnchorWorksLikeRef
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public RecursiveRefDraft201909Feature.RecursiveRefWithoutRecursiveAnchorWorksLikeRef.Schema Foo
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RecursiveRefDraft201909Feature.RecursiveRefWithoutRecursiveAnchorWorksLikeRef.Schema(result);
                    }
                }
        ...
        public static Schema Create(
                            RecursiveRefDraft201909Feature.RecursiveRefWithoutRecursiveAnchorWorksLikeRef.Schema? foo = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<string, JsonAny>();
                            if (foo is RecursiveRefDraft201909Feature.RecursiveRefWithoutRecursiveAnchorWorksLikeRef.Schema foo__)
            {
        ...
        public Schema WithFoo(RecursiveRefDraft201909Feature.RecursiveRefWithoutRecursiveAnchorWorksLikeRef.Schema value)
        {
        ...
        private static ImmutableDictionary<string, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    RecursiveRefDraft201909Feature.RecursiveRefWithoutRecursiveAnchorWorksLikeRef.Schema property = that.Foo;
