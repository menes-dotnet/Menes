...
namespace RecursiveRefDraft201909Feature.RecursiveRefWithNoRecursiveAnchorWorksLikeRef
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\recursiveRef.json", "#/4/schema", "#/004/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RecursiveRefDraft201909Feature.RecursiveRefWithNoRecursiveAnchorWorksLikeRef.SchemaJson>();
        }
        /// <summary>
