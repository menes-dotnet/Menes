...
namespace RecursiveRefDraft201909Feature.RecursiveRefWithRecursiveAnchorFalseWorksLikeRef
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\recursiveRef.json", "#/3/schema", "#/003/tests/004/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RecursiveRefDraft201909Feature.RecursiveRefWithRecursiveAnchorFalseWorksLikeRef.SchemaJson>();
        }
        /// <summary>
