...
namespace UniqueItemsDraft201909Feature.UniqueItemsEqualsFalseWithAnArrayOfItemsAndAdditionalItemsEqualsFalse
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\uniqueItems.json", "#/5/schema", "#/005/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UniqueItemsDraft201909Feature.UniqueItemsEqualsFalseWithAnArrayOfItemsAndAdditionalItemsEqualsFalse.Schema>();
        }
        /// <summary>
