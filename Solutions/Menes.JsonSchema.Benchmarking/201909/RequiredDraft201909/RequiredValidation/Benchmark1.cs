...
namespace RequiredDraft201909Feature.RequiredValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\required.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RequiredDraft201909Feature.RequiredValidation.Schema>();
        }
        /// <summary>
