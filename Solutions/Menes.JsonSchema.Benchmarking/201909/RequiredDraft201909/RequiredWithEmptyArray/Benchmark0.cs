...
namespace RequiredDraft201909Feature.RequiredWithEmptyArray
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\required.json", "#/2/schema", "#/002/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RequiredDraft201909Feature.RequiredWithEmptyArray.Schema>();
        }
        /// <summary>
