                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<MaxContainsDraft201909Feature.MinContainsLessThanMaxContains.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
