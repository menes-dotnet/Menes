...
namespace DefsDraft201909Feature.ValidateDefinitionAgainstMetaschema
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\defs.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DefsDraft201909Feature.ValidateDefinitionAgainstMetaschema.Schema>();
        }
        /// <summary>
