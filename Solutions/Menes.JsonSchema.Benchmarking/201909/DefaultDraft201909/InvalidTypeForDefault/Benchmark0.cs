...
namespace DefaultDraft201909Feature.InvalidTypeForDefault
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\default.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DefaultDraft201909Feature.InvalidTypeForDefault.Schema>();
        }
        /// <summary>
