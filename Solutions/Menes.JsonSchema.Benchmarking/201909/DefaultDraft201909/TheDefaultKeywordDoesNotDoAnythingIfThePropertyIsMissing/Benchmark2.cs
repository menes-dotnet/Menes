...
namespace DefaultDraft201909Feature.TheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissing
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\default.json", "#/2/schema", "#/002/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DefaultDraft201909Feature.TheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissing.Schema>();
        }
        /// <summary>
