...
namespace IdDraft201909Feature.ValidUseOfEmptyFragmentsInLocationIndependentId
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\id.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<IdDraft201909Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.Schema>();
        }
        /// <summary>
