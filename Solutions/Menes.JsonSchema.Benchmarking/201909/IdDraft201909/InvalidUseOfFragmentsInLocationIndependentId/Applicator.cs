            ...
            foreach (Property property in this.EnumerateObject())
            {
                JsonEncodedText propertyName = property.NameAsJsonEncodedText;
                        ...
                        string propertyNameAsString = property.Name;
                            ...
                            result = new JsonString(propertyNameAsString).As<IdDraft201909Feature.InvalidUseOfFragmentsInLocationIndependentId.Applicator.PatternPropertiesValue.PropertyNamesEntity>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
