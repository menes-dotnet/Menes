...
namespace TimeDraft201909Feature.ValidationOfTimeStrings
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\time.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<TimeDraft201909Feature.ValidationOfTimeStrings.Schema>();
        }
        /// <summary>
