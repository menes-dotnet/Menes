...
namespace DateDraft201909Feature.ValidationOfDateStrings
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\date.json", "#/0/schema", "#/000/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DateDraft201909Feature.ValidationOfDateStrings.Schema>();
        }
        /// <summary>
