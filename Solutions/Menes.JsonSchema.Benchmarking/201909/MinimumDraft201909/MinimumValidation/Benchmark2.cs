...
namespace MinimumDraft201909Feature.MinimumValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\minimum.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinimumDraft201909Feature.MinimumValidation.Schema>();
        }
        /// <summary>
