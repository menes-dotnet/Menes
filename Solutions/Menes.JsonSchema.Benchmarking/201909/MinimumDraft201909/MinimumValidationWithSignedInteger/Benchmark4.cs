...
namespace MinimumDraft201909Feature.MinimumValidationWithSignedInteger
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\minimum.json", "#/1/schema", "#/001/tests/004/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinimumDraft201909Feature.MinimumValidationWithSignedInteger.Schema>();
        }
        /// <summary>
