...
namespace EnumDraft201909Feature.NulCharactersInStrings
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/9/schema", "#/009/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft201909Feature.NulCharactersInStrings.Schema>();
        }
        /// <summary>
