...
namespace EnumDraft201909Feature.EnumWith0DoesNotMatchFalse
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/7/schema", "#/007/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft201909Feature.EnumWith0DoesNotMatchFalse.Schema>();
        }
        /// <summary>
