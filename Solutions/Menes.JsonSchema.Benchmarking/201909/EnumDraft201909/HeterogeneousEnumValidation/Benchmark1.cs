...
namespace EnumDraft201909Feature.HeterogeneousEnumValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft201909Feature.HeterogeneousEnumValidation.Schema>();
        }
        /// <summary>
