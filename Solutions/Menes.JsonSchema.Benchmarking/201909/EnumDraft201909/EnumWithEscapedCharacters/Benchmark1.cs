...
namespace EnumDraft201909Feature.EnumWithEscapedCharacters
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/4/schema", "#/004/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft201909Feature.EnumWithEscapedCharacters.Schema>();
        }
        /// <summary>
