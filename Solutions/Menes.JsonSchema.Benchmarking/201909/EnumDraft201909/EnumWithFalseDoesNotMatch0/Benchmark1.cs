...
namespace EnumDraft201909Feature.EnumWithFalseDoesNotMatch0
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/5/schema", "#/005/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft201909Feature.EnumWithFalseDoesNotMatch0.Schema>();
        }
        /// <summary>
