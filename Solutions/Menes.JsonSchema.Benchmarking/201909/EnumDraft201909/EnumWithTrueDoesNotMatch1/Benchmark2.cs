...
namespace EnumDraft201909Feature.EnumWithTrueDoesNotMatch1
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/6/schema", "#/006/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft201909Feature.EnumWithTrueDoesNotMatch1.Schema>();
        }
        /// <summary>
