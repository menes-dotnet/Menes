...
namespace EnumDraft201909Feature.EnumWith1DoesNotMatchTrue
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/8/schema", "#/008/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft201909Feature.EnumWith1DoesNotMatchTrue.Schema>();
        }
        /// <summary>
