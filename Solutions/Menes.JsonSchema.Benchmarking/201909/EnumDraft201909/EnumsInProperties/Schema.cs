...
namespace EnumDraft201909Feature.EnumsInProperties
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public EnumDraft201909Feature.EnumsInProperties.Schema.BarEntity Bar
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  EnumDraft201909Feature.EnumsInProperties.Schema.BarEntity(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public EnumDraft201909Feature.EnumsInProperties.Schema.FooEntity Foo
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  EnumDraft201909Feature.EnumsInProperties.Schema.FooEntity(result);
                    }
                }
        ...
        public static Schema Create(
                   EnumDraft201909Feature.EnumsInProperties.Schema.BarEntity bar
                ,             EnumDraft201909Feature.EnumsInProperties.Schema.FooEntity? foo = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, JsonAny>();
                    builder.Add(BarJsonPropertyName, bar);
                            if (foo is EnumDraft201909Feature.EnumsInProperties.Schema.FooEntity foo__)
            {
        ...
        public Schema WithBar(EnumDraft201909Feature.EnumsInProperties.Schema.BarEntity value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithFoo(EnumDraft201909Feature.EnumsInProperties.Schema.FooEntity value)
        {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    EnumDraft201909Feature.EnumsInProperties.Schema.BarEntity property = that.Bar;
                ...
                (that, validationContext, level) =>
                {
                    EnumDraft201909Feature.EnumsInProperties.Schema.FooEntity property = that.Foo;
                    return property.Validate(validationContext, level);
                });
