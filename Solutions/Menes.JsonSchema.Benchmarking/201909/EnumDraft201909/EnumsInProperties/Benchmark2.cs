...
namespace EnumDraft201909Feature.EnumsInProperties
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/3/schema", "#/003/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft201909Feature.EnumsInProperties.Schema>();
        }
        /// <summary>
