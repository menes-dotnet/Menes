...
namespace FormatDraft201909Feature.ValidationOfURTemplates
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/16/schema", "#/016/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfURTemplates.Schema>();
        }
        /// <summary>
