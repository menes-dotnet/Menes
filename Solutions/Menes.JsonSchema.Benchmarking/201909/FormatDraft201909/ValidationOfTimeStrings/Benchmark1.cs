...
namespace FormatDraft201909Feature.ValidationOfTimeStrings
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/9/schema", "#/009/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfTimeStrings.Schema>();
        }
        /// <summary>
