...
namespace FormatDraft201909Feature.ValidationOfURReferences
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/15/schema", "#/015/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfURReferences.Schema>();
        }
        /// <summary>
