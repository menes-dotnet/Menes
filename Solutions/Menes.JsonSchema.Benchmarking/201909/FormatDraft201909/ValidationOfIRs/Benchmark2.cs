...
namespace FormatDraft201909Feature.ValidationOfIRs
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/12/schema", "#/012/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfIRs.Schema>();
        }
        /// <summary>
