...
namespace FormatDraft201909Feature.ValidationOfURs
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/14/schema", "#/014/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfURs.Schema>();
        }
        /// <summary>
