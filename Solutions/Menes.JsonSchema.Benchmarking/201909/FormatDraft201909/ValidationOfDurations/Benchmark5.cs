...
namespace FormatDraft201909Feature.ValidationOfDurations
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/18/schema", "#/018/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfDurations.Schema>();
        }
        /// <summary>
