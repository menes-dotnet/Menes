...
namespace FormatDraft201909Feature.ValidationOfIDHostnames
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/5/schema", "#/005/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfIDHostnames.Schema>();
        }
        /// <summary>
