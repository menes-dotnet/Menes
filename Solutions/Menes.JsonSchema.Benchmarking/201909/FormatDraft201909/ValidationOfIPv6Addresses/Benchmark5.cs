...
namespace FormatDraft201909Feature.ValidationOfIPv6Addresses
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/4/schema", "#/004/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfIPv6Addresses.Schema>();
        }
        /// <summary>
