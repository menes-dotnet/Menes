...
namespace FormatDraft201909Feature.ValidationOfIRReferences
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/13/schema", "#/013/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfIRReferences.Schema>();
        }
        /// <summary>
