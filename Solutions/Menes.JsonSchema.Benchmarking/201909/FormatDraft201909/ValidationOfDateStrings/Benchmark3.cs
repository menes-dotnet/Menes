...
namespace FormatDraft201909Feature.ValidationOfDateStrings
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/7/schema", "#/007/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfDateStrings.Schema>();
        }
        /// <summary>
