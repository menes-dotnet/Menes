...
namespace FormatDraft201909Feature.ValidationOfHostnames
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/6/schema", "#/006/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfHostnames.Schema>();
        }
        /// <summary>
