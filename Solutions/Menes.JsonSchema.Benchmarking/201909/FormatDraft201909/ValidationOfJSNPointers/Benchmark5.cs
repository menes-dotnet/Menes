...
namespace FormatDraft201909Feature.ValidationOfJSNPointers
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/10/schema", "#/010/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfJSNPointers.Schema>();
        }
        /// <summary>
