...
namespace FormatDraft201909Feature.ValidationOfIPAddresses
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/3/schema", "#/003/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfIPAddresses.Schema>();
        }
        /// <summary>
