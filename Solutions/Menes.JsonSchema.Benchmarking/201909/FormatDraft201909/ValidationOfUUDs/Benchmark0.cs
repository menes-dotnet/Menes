...
namespace FormatDraft201909Feature.ValidationOfUUDs
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/17/schema", "#/017/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft201909Feature.ValidationOfUUDs.Schema>();
        }
        /// <summary>
