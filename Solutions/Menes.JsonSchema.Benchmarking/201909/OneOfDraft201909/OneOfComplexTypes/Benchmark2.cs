...
namespace OneOfDraft201909Feature.OneOfComplexTypes
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\oneOf.json", "#/6/schema", "#/006/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<OneOfDraft201909Feature.OneOfComplexTypes.Schema>();
        }
        /// <summary>
