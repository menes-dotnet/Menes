...
namespace OneOfDraft201909Feature.OneOfWithEmptySchema
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\oneOf.json", "#/7/schema", "#/007/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<OneOfDraft201909Feature.OneOfWithEmptySchema.Schema>();
        }
        /// <summary>
