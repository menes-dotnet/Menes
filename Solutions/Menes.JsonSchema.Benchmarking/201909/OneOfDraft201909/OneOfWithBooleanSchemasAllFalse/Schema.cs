...
namespace OneOfDraft201909Feature.OneOfWithBooleanSchemasAllFalse
{
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<Menes.Json.JsonNotAny>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<Menes.Json.JsonNotAny>().Validate(validationContext.CreateChildContext(), level);
