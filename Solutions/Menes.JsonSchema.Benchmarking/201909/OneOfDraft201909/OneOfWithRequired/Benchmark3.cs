...
namespace OneOfDraft201909Feature.OneOfWithRequired
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\oneOf.json", "#/8/schema", "#/008/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<OneOfDraft201909Feature.OneOfWithRequired.Schema>();
        }
        /// <summary>
