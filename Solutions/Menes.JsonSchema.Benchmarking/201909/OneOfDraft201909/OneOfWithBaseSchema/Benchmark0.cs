...
namespace OneOfDraft201909Feature.OneOfWithBaseSchema
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\oneOf.json", "#/1/schema", "#/001/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<OneOfDraft201909Feature.OneOfWithBaseSchema.Schema>();
        }
        /// <summary>
