...
namespace OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity"/> from which to construct the value.</param>
        public Schema(OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity" />.
        /// </summary>
        public OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity AsOneOf0Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity" />.
        /// </summary>
        public bool IsOneOf0Entity
        {
            get
            {
                return ((OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity(Schema value)
        {
                                                    return default;
        }
        ...
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<OneOfDraft201909Feature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            IEquatable<OneOf0Entity>
    {
        ...
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<Menes.Json.JsonNull>().Validate(validationContext.CreateChildContext(), level);
