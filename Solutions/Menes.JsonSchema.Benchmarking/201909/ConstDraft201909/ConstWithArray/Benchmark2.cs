...
namespace ConstDraft201909Feature.ConstWithArray
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\const.json", "#/2/schema", "#/002/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstDraft201909Feature.ConstWithArray.Schema>();
        }
        /// <summary>
