...
namespace ConstDraft201909Feature.ConstWith1DoesNotMatchTrue
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\const.json", "#/11/schema", "#/011/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstDraft201909Feature.ConstWith1DoesNotMatchTrue.Schema>();
        }
        /// <summary>
