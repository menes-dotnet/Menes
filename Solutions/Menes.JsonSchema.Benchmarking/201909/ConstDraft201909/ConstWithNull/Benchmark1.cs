...
namespace ConstDraft201909Feature.ConstWithNull
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\const.json", "#/3/schema", "#/003/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstDraft201909Feature.ConstWithNull.Schema>();
        }
        /// <summary>
