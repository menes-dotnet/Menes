...
namespace ConstDraft201909Feature.ConstWithTrueDoesNotMatch1
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\const.json", "#/5/schema", "#/005/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstDraft201909Feature.ConstWithTrueDoesNotMatch1.Schema>();
        }
        /// <summary>
