...
namespace ConstDraft201909Feature.NulCharactersInStrings
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\const.json", "#/14/schema", "#/014/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstDraft201909Feature.NulCharactersInStrings.Schema>();
        }
        /// <summary>
