...
namespace ConstDraft201909Feature.ConstWithObject
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\const.json", "#/1/schema", "#/001/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstDraft201909Feature.ConstWithObject.Schema>();
        }
        /// <summary>
