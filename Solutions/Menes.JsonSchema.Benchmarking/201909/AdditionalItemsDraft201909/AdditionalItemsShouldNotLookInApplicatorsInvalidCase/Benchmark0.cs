...
namespace AdditionalItemsDraft201909Feature.AdditionalItemsShouldNotLookInApplicatorsInvalidCase
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            this.ValidateMenesCore<AdditionalItemsDraft201909Feature.AdditionalItemsShouldNotLookInApplicatorsInvalidCase.Schema>();
        }
        /// <summary>
