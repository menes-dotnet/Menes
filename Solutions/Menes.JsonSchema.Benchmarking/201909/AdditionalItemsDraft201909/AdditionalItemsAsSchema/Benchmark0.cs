...
namespace AdditionalItemsDraft201909Feature.AdditionalItemsAsSchema
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\additionalItems.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AdditionalItemsDraft201909Feature.AdditionalItemsAsSchema.Schema>();
        }
        /// <summary>
