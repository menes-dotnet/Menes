...
namespace AllOfDraft201909Feature.NestedAllOfToCheckValidationSemantics
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\allOf.json", "#/10/schema", "#/010/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AllOfDraft201909Feature.NestedAllOfToCheckValidationSemantics.Schema>();
        }
        /// <summary>
