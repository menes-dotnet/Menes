...
namespace AllOfDraft201909Feature.AllOfWithBaseSchema
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\allOf.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AllOfDraft201909Feature.AllOfWithBaseSchema.Schema>();
        }
        /// <summary>
