...
namespace AllOfDraft201909Feature.AllOfWithTwoEmptySchemas
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\allOf.json", "#/7/schema", "#/007/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AllOfDraft201909Feature.AllOfWithTwoEmptySchemas.Schema>();
        }
        /// <summary>
