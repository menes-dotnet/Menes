...
namespace UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithOneOf
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\unevaluatedItems.json", "#/10/schema", "#/010/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithOneOf.Schema>();
        }
        /// <summary>
