...
namespace Ipv4Draft201909Feature.ValidationOfIPAddresses
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\ipv4.json", "#/0/schema", "#/000/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<Ipv4Draft201909Feature.ValidationOfIPAddresses.Schema>();
        }
        /// <summary>
