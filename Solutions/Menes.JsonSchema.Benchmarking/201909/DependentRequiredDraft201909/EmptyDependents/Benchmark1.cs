...
namespace DependentRequiredDraft201909Feature.EmptyDependents
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\dependentRequired.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DependentRequiredDraft201909Feature.EmptyDependents.Schema>();
        }
        /// <summary>
