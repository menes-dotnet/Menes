...
namespace PropertiesDraft201909Feature.PropertiesWithEscapedCharacters
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\properties.json", "#/3/schema", "#/003/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<PropertiesDraft201909Feature.PropertiesWithEscapedCharacters.Schema>();
        }
        /// <summary>
