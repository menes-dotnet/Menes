...
namespace NotDraft201909Feature.NotWithBooleanSchemaFalse
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("not.json", "#/5/schema", "#/005/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<NotDraft201909Feature.NotWithBooleanSchemaFalse.Schema>();
        }
        /// <summary>
