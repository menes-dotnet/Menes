...
namespace NotDraft201909Feature.NotMultipleTypes
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("not.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<NotDraft201909Feature.NotMultipleTypes.Schema>();
        }
        /// <summary>
