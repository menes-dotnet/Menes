...
namespace NotDraft201909Feature.NotMoreComplexSchema
{
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext notResult = this.As<NotDraft201909Feature.NotMoreComplexSchema.Schema.NotValue>().Validate(validationContext.CreateChildContext(), level);
    ...
    /// A type generated from a JsonSchema specification.
    /// </summary>
    public readonly struct NotValue :
            IJsonObject<NotValue>,
                    IEquatable<NotValue>
    {
        ...
        public static readonly JsonEncodedText FooJsonPropertyName = JsonEncodedText.Encode( FooUtf8JsonPropertyName.Span);
            ...
            private static readonly ImmutableDictionary<JsonEncodedText, Func<NotValue, ValidationContext, ValidationLevel, ValidationContext>> __MenesLocalProperties = CreateLocalPropertyValidators();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NotValue"/> struct.
        /// </summary>
        /// <param name="value">The backing <see cref="JsonElement"/>.</param>
        public NotValue(JsonElement value)
        {
            this.jsonElementBacking = value;
        ...
        public NotValue(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
        ...
        public NotValue(JsonObject jsonObject)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator NotValue(JsonAny value)
        {
            if (value.HasJsonElement)
            {
                return new NotValue(value.AsJsonElement);
            }

            return value.As<NotValue>();
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonAny(NotValue value)
        {
            return value.AsAny;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator NotValue(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonObject(NotValue value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonEncodedText, JsonAny>(NotValue  value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator NotValue (ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
            return new NotValue (value);
        }
        ...
        /// <param name="rhs">The right hand side of the comparison.</param>
        /// <returns>True if they are equal.</returns>
        public static bool operator ==(NotValue lhs, NotValue rhs)
        {
            return lhs.Equals(rhs);
        }
        ...
        public static bool operator !=(NotValue lhs, NotValue rhs)
        {
            ...
            /// <summary>
        /// Creates an instance of a <see cref="NotValue"/>.
        /// </summary>
        public static NotValue Create(
        ...
        public NotValue WithFoo(Menes.Json.JsonString value)
        {
        ...
        /// <inheritdoc/>
        public bool Equals(NotValue other)
        {
            JsonValueKind valueKind = this.ValueKind;
        ...
        /// <inheritdoc/>
        public NotValue SetProperty<TValue>(JsonEncodedText name, TValue value)
        ...
        /// <inheritdoc/>
        public NotValue RemoveProperty(JsonEncodedText name)
        {
        ...
        /// <inheritdoc/>
        public NotValue RemoveProperty(string name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
                return this.AsObject.RemoveProperty(name);
        ...
        /// <inheritdoc/>
        public NotValue RemoveProperty(ReadOnlySpan<char> name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
                return this.AsObject.RemoveProperty(name);
        ...
        /// <inheritdoc/>
        public NotValue RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<NotValue, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<NotValue, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ImmutableDictionary.CreateBuilder<JsonEncodedText, Func<NotValue, ValidationContext, ValidationLevel, ValidationContext>>();
