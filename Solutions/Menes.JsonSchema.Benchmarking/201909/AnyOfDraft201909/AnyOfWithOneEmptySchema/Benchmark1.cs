...
namespace AnyOfDraft201909Feature.AnyOfWithOneEmptySchema
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\anyOf.json", "#/6/schema", "#/006/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AnyOfDraft201909Feature.AnyOfWithOneEmptySchema.Schema>();
        }
        /// <summary>
