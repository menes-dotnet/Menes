...
namespace AnyOfDraft201909Feature.AnyOfWithBaseSchema
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\anyOf.json", "#/1/schema", "#/001/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AnyOfDraft201909Feature.AnyOfWithBaseSchema.Schema>();
        }
        /// <summary>
