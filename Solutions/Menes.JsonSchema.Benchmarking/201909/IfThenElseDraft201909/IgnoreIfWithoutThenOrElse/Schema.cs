...
namespace IfThenElseDraft201909Feature.IgnoreIfWithoutThenOrElse
{
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<IfThenElseDraft201909Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity>().Validate(validationContext.CreateChildContext(), level);
