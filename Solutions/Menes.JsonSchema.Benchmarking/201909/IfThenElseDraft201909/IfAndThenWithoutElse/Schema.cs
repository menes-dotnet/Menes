...
namespace IfThenElseDraft201909Feature.IfAndThenWithoutElse
{
            ...
            IEquatable<Schema>
    {
        ...
        /// </summary>
        public IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.ThenEntity AsThenEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.ThenEntity" />.
        /// </summary>
        public bool IsThenEntity
        {
            get
            {
                return ((IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.ThenEntity)this).Validate().IsValid;
            }
        }
        ...
        public bool IsIfMatchThenEntity
        {
            get
            {
                return this.As<IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.IfEntity>().IsValid(); 
            }
        }
        ...
        /// </summary>
        public IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.ThenEntity AsIfMatchThenEntity
        {
            get
            {
                return this.As<IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.ThenEntity>(); 
            }
        }
        ...
        public static implicit operator Schema(IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.ThenEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.ThenEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.ThenEntity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.ThenEntity(value.AsNumber);
            }
                    return default;
        }
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (ifResult.IsValid)
            {
                ValidationContext thenResult = this.As<IfThenElseDraft201909Feature.IfAndThenWithoutElse.Schema.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
