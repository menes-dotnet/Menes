...
namespace IfThenElseDraft201909Feature.NonInterferenceAcrossCombinedSchemas
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\if-then-else.json", "#/6/schema", "#/006/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<IfThenElseDraft201909Feature.NonInterferenceAcrossCombinedSchemas.Schema>();
        }
        /// <summary>
