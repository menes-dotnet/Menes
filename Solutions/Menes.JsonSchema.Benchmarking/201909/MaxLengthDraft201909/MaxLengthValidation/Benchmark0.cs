...
namespace MaxLengthDraft201909Feature.MaxLengthValidation
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\maxLength.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MaxLengthDraft201909Feature.MaxLengthValidation.Schema>();
        }
        /// <summary>
