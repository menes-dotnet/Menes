...
namespace UriReferenceFeature.ValidationOfURReferences
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("uri-reference.json", "#/0/schema", "#/000/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UriReferenceFeature.ValidationOfURReferences.RootEntity>();
        }
        /// <summary>
