...
namespace RefFeature.RelativePointerRefToObject
{
    public readonly struct RootEntity : Menes.IJsonObject<RootEntity>
    {
        ...
        public RootEntity(Menes.JsonInteger? foo = null, Menes.JsonInteger? bar = null)
        {
        ...
        private RootEntity(Menes.JsonInteger? foo, Menes.JsonInteger? bar, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
        {
            this._menesJsonElementBacking = default;
            this.foo = foo;
            this.bar = bar;
