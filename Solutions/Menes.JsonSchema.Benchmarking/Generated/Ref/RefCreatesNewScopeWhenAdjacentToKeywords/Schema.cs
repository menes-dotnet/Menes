...
namespace RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity"/> from which to construct the value.</param>
        public Schema(RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity" />.
        /// </summary>
        public RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity AsAEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity" />.
        /// </summary>
        public bool IsAEntity
        {
            get
            {
                return ((RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity(value.AsObject);
            }
                                                    return default;
        }
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    JsonString property = that.Prop1;
            ...
            private ValidationContext ValidateRef(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext refResult = this.As<RefFeature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema.AEntity>().Validate(validationContext.CreateChildContext(), level);
