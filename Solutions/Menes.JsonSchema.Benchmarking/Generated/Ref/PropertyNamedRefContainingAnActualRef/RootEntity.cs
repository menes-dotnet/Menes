...
namespace RefFeature.PropertyNamedRefContainingAnActualRef
{
...
public RootEntity(Menes.JsonString? @ref = null)
{
    this._menesJsonElementBacking = default;
this.@ref = @ref;
this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
}
private RootEntity(Menes.JsonString? @ref, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
{
    this._menesJsonElementBacking = default;
this.@ref = @ref;
...
if (this.IsObject)
{
    ...
    if (this.TryGetProperty<Menes.JsonString>(_MenesRefJsonPropertyName.Span, out Menes.JsonString value0))
    {
...
public RootEntity WithRef(Menes.JsonString value)
{
...
int currentIndex = 0;
    ...
    {
        result = new Menes.Property<RootEntity>(this, _MenesRefJsonPropertyName);
      return true;
    }
    currentIndex++;
foreach (var property in this._menesAdditionalPropertiesBacking)
...
{
    return new RootEntity(this.@ref, value);
}
/// <summary>
