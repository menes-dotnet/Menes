...
namespace RefFeature.RefsWithQuote
{
...
public RootEntity(Menes.JsonNumber? fooBar = null)
{
    this._menesJsonElementBacking = default;
this.fooBar = fooBar;
this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
}
private RootEntity(Menes.JsonNumber? fooBar, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
{
    this._menesJsonElementBacking = default;
this.fooBar = fooBar;
...
{
    return new RootEntity(this.fooBar, value);
}
/// <summary>
