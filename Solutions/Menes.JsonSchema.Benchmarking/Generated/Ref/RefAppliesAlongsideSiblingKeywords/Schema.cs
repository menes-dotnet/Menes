...
namespace RefFeature.RefAppliesAlongsideSiblingKeywords
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RefAppliesAlongsideSiblingKeywords.Schema.FooEntity Foo
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RefAppliesAlongsideSiblingKeywords.Schema.FooEntity(result);
                    }
                }
        ...
        public static Schema Create(
                            RefFeature.RefAppliesAlongsideSiblingKeywords.Schema.FooEntity? foo = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, JsonAny>();
                            if (foo is RefFeature.RefAppliesAlongsideSiblingKeywords.Schema.FooEntity foo__)
            {
        ...
        public Schema WithFoo(RefFeature.RefAppliesAlongsideSiblingKeywords.Schema.FooEntity value)
        {
