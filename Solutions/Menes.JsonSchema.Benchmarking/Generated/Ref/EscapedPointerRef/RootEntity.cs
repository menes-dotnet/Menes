...
namespace RefFeature.EscapedPointerRef
{
    public readonly struct RootEntity : Menes.IJsonObject<RootEntity>
    {
        public static readonly RootEntity Null = default(RootEntity);
        private static readonly System.ReadOnlyMemory<char> _MenesTildeJsonPropertyName = System.MemoryExtensions.AsMemory("tilde");
        private static readonly System.ReadOnlyMemory<char> _MenesSlashJsonPropertyName = System.MemoryExtensions.AsMemory("slash");
        private static readonly System.ReadOnlyMemory<char> _MenesPercentJsonPropertyName = System.MemoryExtensions.AsMemory("percent");
        private static readonly System.ReadOnlyMemory<byte> _MenesTildeUtf8JsonPropertyName = new byte[] { 116, 105, 108, 100, 101 };
        private static readonly System.ReadOnlyMemory<byte> _MenesSlashUtf8JsonPropertyName = new byte[] { 115, 108, 97, 115, 104 };
        private static readonly System.ReadOnlyMemory<byte> _MenesPercentUtf8JsonPropertyName = new byte[] { 112, 101, 114, 99, 101, 110, 116 };
        private static readonly System.Text.Json.JsonEncodedText _MenesTildeEncodedJsonPropertyName = System.Text.Json.JsonEncodedText.Encode(_MenesTildeUtf8JsonPropertyName.Span);
        private static readonly System.Text.Json.JsonEncodedText _MenesSlashEncodedJsonPropertyName = System.Text.Json.JsonEncodedText.Encode(_MenesSlashUtf8JsonPropertyName.Span);
        private static readonly System.Text.Json.JsonEncodedText _MenesPercentEncodedJsonPropertyName = System.Text.Json.JsonEncodedText.Encode(_MenesPercentUtf8JsonPropertyName.Span);
        ...
        public RootEntity(Menes.JsonInteger? tilde = null, Menes.JsonInteger? slash = null, Menes.JsonInteger? percent = null)
        {
        ...
        private RootEntity(Menes.JsonInteger? tilde, Menes.JsonInteger? slash, Menes.JsonInteger? percent, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
        {
            this._menesJsonElementBacking = default;
            this.tilde = tilde;
            this.slash = slash;
        ...
        public Menes.JsonInteger? Tilde => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<Menes.JsonInteger>(_MenesTildeUtf8JsonPropertyName.Span) : this.tilde;
        public Menes.JsonInteger? Slash => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<Menes.JsonInteger>(_MenesSlashUtf8JsonPropertyName.Span) : this.slash;
        public Menes.JsonInteger? Percent => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<Menes.JsonInteger>(_MenesPercentUtf8JsonPropertyName.Span) : this.percent;
        ...
        public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
        {
            ...
            if (this.IsObject)
            {
                result = result.WithLocalProperty("tilde");
                if (this.TryGetProperty<Menes.JsonInteger>(_MenesTildeJsonPropertyName.Span, out Menes.JsonInteger value0))
                {
                ...
                result = result.WithLocalProperty("slash");
                if (this.TryGetProperty<Menes.JsonInteger>(_MenesSlashJsonPropertyName.Span, out Menes.JsonInteger value1))
                {
                ...
                result = result.WithLocalProperty("percent");
                if (this.TryGetProperty<Menes.JsonInteger>(_MenesPercentJsonPropertyName.Span, out Menes.JsonInteger value2))
                {
        ...
        public void WriteTo(System.Text.Json.Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName(_MenesTildeEncodedJsonPropertyName);
                tilde.WriteTo(writer);
            }
            if (this.slash is Menes.JsonInteger slash)
            {
                writer.WritePropertyName(_MenesSlashEncodedJsonPropertyName);
                slash.WriteTo(writer);
            }
            if (this.percent is Menes.JsonInteger percent)
            {
                writer.WritePropertyName(_MenesPercentEncodedJsonPropertyName);
        ...
        public bool HasProperty(System.ReadOnlySpan<char> propertyName)
        {
            ...
            {
                if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesTildeJsonPropertyName.Span))
                {
                    return true;
                }
                if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesSlashJsonPropertyName.Span))
                {
                    return true;
                }
                if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesPercentJsonPropertyName.Span))
                {
                    return true;
                }
        ...
        public bool HasProperty(string propertyName)
        {
            ...
            {
                if (System.MemoryExtensions.SequenceEqual(System.MemoryExtensions.AsSpan(propertyName), _MenesTildeJsonPropertyName.Span))
                {
                    return true;
                }
                if (System.MemoryExtensions.SequenceEqual(System.MemoryExtensions.AsSpan(propertyName), _MenesSlashJsonPropertyName.Span))
                {
                    return true;
                }
                if (System.MemoryExtensions.SequenceEqual(System.MemoryExtensions.AsSpan(propertyName), _MenesPercentJsonPropertyName.Span))
                {
                    return true;
                }
                foreach (var additionalProperty in this._menesAdditionalPropertiesBacking)
        ...
        public bool HasProperty(System.ReadOnlySpan<byte> propertyName)
        {
            ...
            {
                if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesTildeUtf8JsonPropertyName.Span))
                {
                    return true;
                }
                if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesSlashUtf8JsonPropertyName.Span))
                {
                    return true;
                }
                if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesPercentUtf8JsonPropertyName.Span))
                {
                    return true;
                }
                foreach (var additionalProperty in this._menesAdditionalPropertiesBacking)
            ...
            where T : struct, Menes.IJsonValue
        {
            ...
            if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesTildeJsonPropertyName.Span))
            {
                if (!(this.Tilde?.As<T>() is T result))
                {
                    property = default;
                    return false;
                }
            ...
            if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesSlashJsonPropertyName.Span))
            {
                if (!(this.Slash?.As<T>() is T result))
                {
                    property = default;
                    return false;
                }
            ...
            if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesPercentJsonPropertyName.Span))
            {
                if (!(this.Percent?.As<T>() is T result))
                {
                    property = default;
                    return false;
                }
        ...
        where T : struct, Menes.IJsonValue
        {
            ...
            if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesTildeJsonPropertyName.Span))
            {
                return this.WithTilde(value.As<Menes.JsonInteger>());
            }
            if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesSlashJsonPropertyName.Span))
            {
                return this.WithSlash(value.As<Menes.JsonInteger>());
            }
            if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesPercentJsonPropertyName.Span))
            {
                return this.WithPercent(value.As<Menes.JsonInteger>());
            }
        ...
        public RootEntity WithTilde(Menes.JsonInteger value)
        {
            return new RootEntity(value, this.slash, this.percent, this._menesAdditionalPropertiesBacking);
        }
        public RootEntity WithSlash(Menes.JsonInteger value)
        {
            return new RootEntity(this.tilde, value, this.percent, this._menesAdditionalPropertiesBacking);
        }
        public RootEntity WithPercent(Menes.JsonInteger value)
        {
            return new RootEntity(this.tilde, this.slash, value, this._menesAdditionalPropertiesBacking);
        }
        ...
        {
            if (this.tilde is not null)
            {
                return false;
            }
            if (this.slash is not null)
            {
                return false;
            }
            if (this.percent is not null)
            {
                return false;
            }
        ...
        private bool TryGetPropertyAtIndex(int index, out Menes.Property<RootEntity> result)
        {
            ...
            {
                result = new Menes.Property<RootEntity>(this, _MenesTildeJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.Property<RootEntity>(this, _MenesSlashJsonPropertyName);
                return true;
            }
            currentIndex++;
            if (currentIndex == index)
            {
                result = new Menes.Property<RootEntity>(this, _MenesPercentJsonPropertyName);
                return true;
            }
            currentIndex++;
            foreach (var property in this._menesAdditionalPropertiesBacking)
        ...
        {
            return new RootEntity(this.tilde, this.slash, this.percent, value);
        }
        /// <summary>
