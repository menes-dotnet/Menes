...
namespace RefFeature.RemoteRefContainingRefsItself
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="RefFeature.RemoteRefContainingRefsItself.Core"/> from which to construct the value.</param>
        public Schema(RefFeature.RemoteRefContainingRefsItself.Core conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="RefFeature.RemoteRefContainingRefsItself.Applicator"/> from which to construct the value.</param>
        public Schema(RefFeature.RemoteRefContainingRefsItself.Applicator conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="RefFeature.RemoteRefContainingRefsItself.Validation"/> from which to construct the value.</param>
        public Schema(RefFeature.RemoteRefContainingRefsItself.Validation conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="RefFeature.RemoteRefContainingRefsItself.MetaData"/> from which to construct the value.</param>
        public Schema(RefFeature.RemoteRefContainingRefsItself.MetaData conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="RefFeature.RemoteRefContainingRefsItself.Format"/> from which to construct the value.</param>
        public Schema(RefFeature.RemoteRefContainingRefsItself.Format conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="RefFeature.RemoteRefContainingRefsItself.Content"/> from which to construct the value.</param>
        public Schema(RefFeature.RemoteRefContainingRefsItself.Content conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
        /// Gets the value as a <see cref="RefFeature.RemoteRefContainingRefsItself.Core" />.
        /// </summary>
        public RefFeature.RemoteRefContainingRefsItself.Core AsCore
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="RefFeature.RemoteRefContainingRefsItself.Core" />.
        /// </summary>
        public bool IsCore
        {
            get
            {
                return ((RefFeature.RemoteRefContainingRefsItself.Core)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="RefFeature.RemoteRefContainingRefsItself.Applicator" />.
        /// </summary>
        public RefFeature.RemoteRefContainingRefsItself.Applicator AsApplicator
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="RefFeature.RemoteRefContainingRefsItself.Applicator" />.
        /// </summary>
        public bool IsApplicator
        {
            get
            {
                return ((RefFeature.RemoteRefContainingRefsItself.Applicator)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="RefFeature.RemoteRefContainingRefsItself.Validation" />.
        /// </summary>
        public RefFeature.RemoteRefContainingRefsItself.Validation AsValidation
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="RefFeature.RemoteRefContainingRefsItself.Validation" />.
        /// </summary>
        public bool IsValidation
        {
            get
            {
                return ((RefFeature.RemoteRefContainingRefsItself.Validation)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="RefFeature.RemoteRefContainingRefsItself.MetaData" />.
        /// </summary>
        public RefFeature.RemoteRefContainingRefsItself.MetaData AsMetaData
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="RefFeature.RemoteRefContainingRefsItself.MetaData" />.
        /// </summary>
        public bool IsMetaData
        {
            get
            {
                return ((RefFeature.RemoteRefContainingRefsItself.MetaData)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="RefFeature.RemoteRefContainingRefsItself.Format" />.
        /// </summary>
        public RefFeature.RemoteRefContainingRefsItself.Format AsFormat
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="RefFeature.RemoteRefContainingRefsItself.Format" />.
        /// </summary>
        public bool IsFormat
        {
            get
            {
                return ((RefFeature.RemoteRefContainingRefsItself.Format)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="RefFeature.RemoteRefContainingRefsItself.Content" />.
        /// </summary>
        public RefFeature.RemoteRefContainingRefsItself.Content AsContent
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="RefFeature.RemoteRefContainingRefsItself.Content" />.
        /// </summary>
        public bool IsContent
        {
            get
            {
                return ((RefFeature.RemoteRefContainingRefsItself.Content)this).Validate().IsValid;
            }
        }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Core.IdValue Id
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Core.IdValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Core.AnchorValue Anchor
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Core.AnchorValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Core.RecursiveAnchorValue RecursiveAnchor
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Core.RecursiveAnchorValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Core.VocabularyValue Vocabulary
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Core.VocabularyValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Core.DefsValue Defs
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Core.DefsValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema AdditionalItems
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Schema(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema UnevaluatedItems
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Applicator.PropertiesEntity Items
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Applicator.PropertiesEntity(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema Contains
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema AdditionalProperties
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema UnevaluatedProperties
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Applicator.PropertiesValue Properties
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Applicator.PropertiesValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Applicator.PatternPropertiesValue PatternProperties
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Applicator.PatternPropertiesValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Applicator.DependentSchemasValue DependentSchemas
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Applicator.DependentSchemasValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema PropertyNames
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema If
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema Then
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema Else
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray AllOf
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray AnyOf
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray OneOf
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema Not
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.MultipleOfValue MultipleOf
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Validation.MultipleOfValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue MaxLength
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity MinLength
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue MaxItems
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity MinItems
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.UniqueItemsValue UniqueItems
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Validation.UniqueItemsValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue MaxContains
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.MinContainsEntity MinContains
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Validation.MinContainsEntity(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue MaxProperties
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity MinProperties
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray Required
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.DependentRequiredValue DependentRequired
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Validation.DependentRequiredValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.JsonAnyArray Enum
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Validation.JsonAnyArray(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Validation.TypeEntity Type
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Validation.TypeEntity(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.MetaData.DeprecatedValue Deprecated
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.MetaData.DeprecatedValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.MetaData.ReadOnlyValue ReadOnly
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.MetaData.ReadOnlyValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.MetaData.WriteOnlyValue WriteOnly
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.MetaData.WriteOnlyValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.MetaData.JsonAnyArray Examples
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.MetaData.JsonAnyArray(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema ContentSchema
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema.DefinitionsValue Definitions
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Schema.DefinitionsValue(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue Dependencies
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue(result);
                    }
                }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="RefFeature.RemoteRefContainingRefsItself.Core" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(RefFeature.RemoteRefContainingRefsItself.Core value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="RefFeature.RemoteRefContainingRefsItself.Core" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Core(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Core(value.AsObject);
            }
                                            if (value.ValueKind == JsonValueKind.True || value.ValueKind == JsonValueKind.False)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Core(value.AsBoolean);
            }
                            return default;
        }
            /// <summary>
        /// Conversion from <see cref="RefFeature.RemoteRefContainingRefsItself.Applicator" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(RefFeature.RemoteRefContainingRefsItself.Applicator value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="RefFeature.RemoteRefContainingRefsItself.Applicator" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Applicator(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Applicator(value.AsObject);
            }
                                            if (value.ValueKind == JsonValueKind.True || value.ValueKind == JsonValueKind.False)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Applicator(value.AsBoolean);
            }
                            return default;
        }
            /// <summary>
        /// Conversion from <see cref="RefFeature.RemoteRefContainingRefsItself.Validation" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(RefFeature.RemoteRefContainingRefsItself.Validation value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="RefFeature.RemoteRefContainingRefsItself.Validation" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Validation(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Validation(value.AsObject);
            }
                                            if (value.ValueKind == JsonValueKind.True || value.ValueKind == JsonValueKind.False)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Validation(value.AsBoolean);
            }
                            return default;
        }
            /// <summary>
        /// Conversion from <see cref="RefFeature.RemoteRefContainingRefsItself.MetaData" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(RefFeature.RemoteRefContainingRefsItself.MetaData value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="RefFeature.RemoteRefContainingRefsItself.MetaData" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.MetaData(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new RefFeature.RemoteRefContainingRefsItself.MetaData(value.AsObject);
            }
                                            if (value.ValueKind == JsonValueKind.True || value.ValueKind == JsonValueKind.False)
            {
                return new RefFeature.RemoteRefContainingRefsItself.MetaData(value.AsBoolean);
            }
                            return default;
        }
            /// <summary>
        /// Conversion from <see cref="RefFeature.RemoteRefContainingRefsItself.Format" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(RefFeature.RemoteRefContainingRefsItself.Format value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="RefFeature.RemoteRefContainingRefsItself.Format" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Format(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Format(value.AsObject);
            }
                                            if (value.ValueKind == JsonValueKind.True || value.ValueKind == JsonValueKind.False)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Format(value.AsBoolean);
            }
                            return default;
        }
            /// <summary>
        /// Conversion from <see cref="RefFeature.RemoteRefContainingRefsItself.Content" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(RefFeature.RemoteRefContainingRefsItself.Content value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="RefFeature.RemoteRefContainingRefsItself.Content" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Content(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Content(value.AsObject);
            }
                                            if (value.ValueKind == JsonValueKind.True || value.ValueKind == JsonValueKind.False)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Content(value.AsBoolean);
            }
                            return default;
        }
        ...
        public static Schema Create(
                            RefFeature.RemoteRefContainingRefsItself.Core.IdValue? id = null
        ,             Menes.Json.JsonUri? schema1 = null
        ,             RefFeature.RemoteRefContainingRefsItself.Core.AnchorValue? anchor = null
        ,             Menes.Json.JsonUriReference? @ref = null
        ,             Menes.Json.JsonUriReference? recursiveRef = null
        ,             RefFeature.RemoteRefContainingRefsItself.Core.RecursiveAnchorValue? recursiveAnchor = null
        ,             RefFeature.RemoteRefContainingRefsItself.Core.VocabularyValue? vocabulary = null
        ,             Menes.Json.JsonString? comment = null
        ,             RefFeature.RemoteRefContainingRefsItself.Core.DefsValue? defs = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema? additionalItems = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema? unevaluatedItems = null
        ,             RefFeature.RemoteRefContainingRefsItself.Applicator.PropertiesEntity? items = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema? contains = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema? additionalProperties = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema? unevaluatedProperties = null
        ,             RefFeature.RemoteRefContainingRefsItself.Applicator.PropertiesValue? properties = null
        ,             RefFeature.RemoteRefContainingRefsItself.Applicator.PatternPropertiesValue? patternProperties = null
        ,             RefFeature.RemoteRefContainingRefsItself.Applicator.DependentSchemasValue? dependentSchemas = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema? propertyNames = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema? @if = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema? then = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema? @else = null
        ,             RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray? allOf = null
        ,             RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray? anyOf = null
        ,             RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray? oneOf = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema? not = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.MultipleOfValue? multipleOf = null
        ...
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue? maxLength = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity? minLength = null
        ,             Menes.Json.JsonRegex? pattern = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue? maxItems = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity? minItems = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.UniqueItemsValue? uniqueItems = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue? maxContains = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.MinContainsEntity? minContains = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue? maxProperties = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity? minProperties = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray? required = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.DependentRequiredValue? dependentRequired = null
        ,             Menes.Json.JsonAny? @const = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.JsonAnyArray? @enum = null
        ,             RefFeature.RemoteRefContainingRefsItself.Validation.TypeEntity? type = null
        ,             Menes.Json.JsonString? title = null
        ,             Menes.Json.JsonString? description = null
        ,             Menes.Json.JsonAny? @default = null
        ,             RefFeature.RemoteRefContainingRefsItself.MetaData.DeprecatedValue? deprecated = null
        ,             RefFeature.RemoteRefContainingRefsItself.MetaData.ReadOnlyValue? readOnly = null
        ,             RefFeature.RemoteRefContainingRefsItself.MetaData.WriteOnlyValue? writeOnly = null
        ,             RefFeature.RemoteRefContainingRefsItself.MetaData.JsonAnyArray? examples = null
        ,             Menes.Json.JsonString? format = null
        ,             Menes.Json.JsonString? contentMediaType = null
        ,             Menes.Json.JsonString? contentEncoding = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema? contentSchema = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema.DefinitionsValue? definitions = null
        ,             RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue? dependencies = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, JsonAny>();
                            if (id is RefFeature.RemoteRefContainingRefsItself.Core.IdValue id__)
            {
                    ...
                    if (schema1 is Menes.Json.JsonUri schema1__)
            {
                builder.Add(Schema1JsonPropertyName, schema1__);
                    ...
                    if (anchor is RefFeature.RemoteRefContainingRefsItself.Core.AnchorValue anchor__)
            {
                    ...
                    if (recursiveRef is Menes.Json.JsonUriReference recursiveRef__)
            {
                builder.Add(RecursiveRefJsonPropertyName, recursiveRef__);
                    ...
                    if (recursiveAnchor is RefFeature.RemoteRefContainingRefsItself.Core.RecursiveAnchorValue recursiveAnchor__)
            {
                builder.Add(RecursiveAnchorJsonPropertyName, recursiveAnchor__);
            }
                    if (vocabulary is RefFeature.RemoteRefContainingRefsItself.Core.VocabularyValue vocabulary__)
            {
                    ...
                    if (comment is Menes.Json.JsonString comment__)
            {
                builder.Add(CommentJsonPropertyName, comment__);
                    ...
                    if (defs is RefFeature.RemoteRefContainingRefsItself.Core.DefsValue defs__)
            {
                builder.Add(DefsJsonPropertyName, defs__);
            }
                    if (additionalItems is RefFeature.RemoteRefContainingRefsItself.Schema additionalItems__)
            {
                builder.Add(AdditionalItemsJsonPropertyName, additionalItems__);
            }
                    if (unevaluatedItems is RefFeature.RemoteRefContainingRefsItself.Schema unevaluatedItems__)
            {
                builder.Add(UnevaluatedItemsJsonPropertyName, unevaluatedItems__);
            }
                    if (items is RefFeature.RemoteRefContainingRefsItself.Applicator.PropertiesEntity items__)
            {
                builder.Add(ItemsJsonPropertyName, items__);
            }
                    if (contains is RefFeature.RemoteRefContainingRefsItself.Schema contains__)
            {
                builder.Add(ContainsJsonPropertyName, contains__);
            }
                    if (additionalProperties is RefFeature.RemoteRefContainingRefsItself.Schema additionalProperties__)
            {
                builder.Add(AdditionalPropertiesJsonPropertyName, additionalProperties__);
            }
                    if (unevaluatedProperties is RefFeature.RemoteRefContainingRefsItself.Schema unevaluatedProperties__)
            {
                builder.Add(UnevaluatedPropertiesJsonPropertyName, unevaluatedProperties__);
            }
                    if (properties is RefFeature.RemoteRefContainingRefsItself.Applicator.PropertiesValue properties__)
            {
                builder.Add(PropertiesJsonPropertyName, properties__);
            }
                    if (patternProperties is RefFeature.RemoteRefContainingRefsItself.Applicator.PatternPropertiesValue patternProperties__)
            {
                builder.Add(PatternPropertiesJsonPropertyName, patternProperties__);
            }
                    if (dependentSchemas is RefFeature.RemoteRefContainingRefsItself.Applicator.DependentSchemasValue dependentSchemas__)
            {
                builder.Add(DependentSchemasJsonPropertyName, dependentSchemas__);
            }
                    if (propertyNames is RefFeature.RemoteRefContainingRefsItself.Schema propertyNames__)
            {
                builder.Add(PropertyNamesJsonPropertyName, propertyNames__);
            }
                    if (@if is RefFeature.RemoteRefContainingRefsItself.Schema @if__)
            {
                builder.Add(IfJsonPropertyName, @if__);
            }
                    if (then is RefFeature.RemoteRefContainingRefsItself.Schema then__)
            {
                builder.Add(ThenJsonPropertyName, then__);
            }
                    if (@else is RefFeature.RemoteRefContainingRefsItself.Schema @else__)
            {
                builder.Add(ElseJsonPropertyName, @else__);
            }
                    if (allOf is RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray allOf__)
            {
                builder.Add(AllOfJsonPropertyName, allOf__);
            }
                    if (anyOf is RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray anyOf__)
            {
                builder.Add(AnyOfJsonPropertyName, anyOf__);
            }
                    if (oneOf is RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray oneOf__)
            {
                builder.Add(OneOfJsonPropertyName, oneOf__);
            }
                    if (not is RefFeature.RemoteRefContainingRefsItself.Schema not__)
            {
                builder.Add(NotJsonPropertyName, not__);
            }
                    if (multipleOf is RefFeature.RemoteRefContainingRefsItself.Validation.MultipleOfValue multipleOf__)
            {
                    ...
                    if (exclusiveMinimum is Menes.Json.JsonNumber exclusiveMinimum__)
            {
                builder.Add(ExclusiveMinimumJsonPropertyName, exclusiveMinimum__);
                    ...
                    if (maxLength is RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue maxLength__)
            {
                builder.Add(MaxLengthJsonPropertyName, maxLength__);
            }
                    if (minLength is RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity minLength__)
            {
                    ...
                    if (pattern is Menes.Json.JsonRegex pattern__)
            {
                builder.Add(PatternJsonPropertyName, pattern__);
                    ...
                    if (maxItems is RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue maxItems__)
            {
                builder.Add(MaxItemsJsonPropertyName, maxItems__);
            }
                    if (minItems is RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity minItems__)
            {
                builder.Add(MinItemsJsonPropertyName, minItems__);
            }
                    if (uniqueItems is RefFeature.RemoteRefContainingRefsItself.Validation.UniqueItemsValue uniqueItems__)
            {
                builder.Add(UniqueItemsJsonPropertyName, uniqueItems__);
            }
                    if (maxContains is RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue maxContains__)
            {
                builder.Add(MaxContainsJsonPropertyName, maxContains__);
            }
                    if (minContains is RefFeature.RemoteRefContainingRefsItself.Validation.MinContainsEntity minContains__)
            {
                builder.Add(MinContainsJsonPropertyName, minContains__);
            }
                    if (maxProperties is RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue maxProperties__)
            {
                builder.Add(MaxPropertiesJsonPropertyName, maxProperties__);
            }
                    if (minProperties is RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity minProperties__)
            {
                builder.Add(MinPropertiesJsonPropertyName, minProperties__);
            }
                    if (required is RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray required__)
            {
                builder.Add(RequiredJsonPropertyName, required__);
            }
                    if (dependentRequired is RefFeature.RemoteRefContainingRefsItself.Validation.DependentRequiredValue dependentRequired__)
            {
                    ...
                    if (@const is Menes.Json.JsonAny @const__)
            {
                builder.Add(ConstJsonPropertyName, @const__);
                    ...
                    if (@enum is RefFeature.RemoteRefContainingRefsItself.Validation.JsonAnyArray @enum__)
            {
                builder.Add(EnumJsonPropertyName, @enum__);
            }
                    if (type is RefFeature.RemoteRefContainingRefsItself.Validation.TypeEntity type__)
            {
                    ...
                    if (@default is Menes.Json.JsonAny @default__)
            {
                builder.Add(DefaultJsonPropertyName, @default__);
                    ...
                    if (deprecated is RefFeature.RemoteRefContainingRefsItself.MetaData.DeprecatedValue deprecated__)
            {
                builder.Add(DeprecatedJsonPropertyName, deprecated__);
            }
                    if (readOnly is RefFeature.RemoteRefContainingRefsItself.MetaData.ReadOnlyValue readOnly__)
            {
                builder.Add(ReadOnlyJsonPropertyName, readOnly__);
            }
                    if (writeOnly is RefFeature.RemoteRefContainingRefsItself.MetaData.WriteOnlyValue writeOnly__)
            {
                builder.Add(WriteOnlyJsonPropertyName, writeOnly__);
            }
                    if (examples is RefFeature.RemoteRefContainingRefsItself.MetaData.JsonAnyArray examples__)
            {
                    ...
                    if (contentEncoding is Menes.Json.JsonString contentEncoding__)
            {
                builder.Add(ContentEncodingJsonPropertyName, contentEncoding__);
                    ...
                    if (contentSchema is RefFeature.RemoteRefContainingRefsItself.Schema contentSchema__)
            {
                builder.Add(ContentSchemaJsonPropertyName, contentSchema__);
            }
                    if (definitions is RefFeature.RemoteRefContainingRefsItself.Schema.DefinitionsValue definitions__)
            {
                builder.Add(DefinitionsJsonPropertyName, definitions__);
            }
                    if (dependencies is RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue dependencies__)
            {
        ...
        public Schema WithId(RefFeature.RemoteRefContainingRefsItself.Core.IdValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithAnchor(RefFeature.RemoteRefContainingRefsItself.Core.AnchorValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithRecursiveAnchor(RefFeature.RemoteRefContainingRefsItself.Core.RecursiveAnchorValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithVocabulary(RefFeature.RemoteRefContainingRefsItself.Core.VocabularyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithDefs(RefFeature.RemoteRefContainingRefsItself.Core.DefsValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithAdditionalItems(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithUnevaluatedItems(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithItems(RefFeature.RemoteRefContainingRefsItself.Applicator.PropertiesEntity value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithContains(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithAdditionalProperties(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithUnevaluatedProperties(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithProperties(RefFeature.RemoteRefContainingRefsItself.Applicator.PropertiesValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithPatternProperties(RefFeature.RemoteRefContainingRefsItself.Applicator.PatternPropertiesValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithDependentSchemas(RefFeature.RemoteRefContainingRefsItself.Applicator.DependentSchemasValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithPropertyNames(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithIf(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithThen(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithElse(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithAllOf(RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithAnyOf(RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithOneOf(RefFeature.RemoteRefContainingRefsItself.Applicator.SchemaArray value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithNot(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithMultipleOf(RefFeature.RemoteRefContainingRefsItself.Validation.MultipleOfValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithMaxLength(RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithMinLength(RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithMaxItems(RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithMinItems(RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithUniqueItems(RefFeature.RemoteRefContainingRefsItself.Validation.UniqueItemsValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithMaxContains(RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithMinContains(RefFeature.RemoteRefContainingRefsItself.Validation.MinContainsEntity value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithMaxProperties(RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithMinProperties(RefFeature.RemoteRefContainingRefsItself.Validation.NonNegativeIntegerDefault0Entity value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithRequired(RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithDependentRequired(RefFeature.RemoteRefContainingRefsItself.Validation.DependentRequiredValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithEnum(RefFeature.RemoteRefContainingRefsItself.Validation.JsonAnyArray value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithType(RefFeature.RemoteRefContainingRefsItself.Validation.TypeEntity value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithDeprecated(RefFeature.RemoteRefContainingRefsItself.MetaData.DeprecatedValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithReadOnly(RefFeature.RemoteRefContainingRefsItself.MetaData.ReadOnlyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithWriteOnly(RefFeature.RemoteRefContainingRefsItself.MetaData.WriteOnlyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithExamples(RefFeature.RemoteRefContainingRefsItself.MetaData.JsonAnyArray value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithContentSchema(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithDefinitions(RefFeature.RemoteRefContainingRefsItself.Schema.DefinitionsValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithDependencies(RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue value)
        {
        ...
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<RefFeature.RemoteRefContainingRefsItself.Core>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult1 = this.As<RefFeature.RemoteRefContainingRefsItself.Applicator>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult2 = this.As<RefFeature.RemoteRefContainingRefsItself.Validation>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult3 = this.As<RefFeature.RemoteRefContainingRefsItself.MetaData>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult4 = this.As<RefFeature.RemoteRefContainingRefsItself.Format>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult5 = this.As<RefFeature.RemoteRefContainingRefsItself.Content>().Validate(validationContext.CreateChildContext(), level);
                    ...
                    IEquatable<DefinitionsValue>
    {
        ...
        /// </summary>
        public JsonObjectEnumerator<RefFeature.RemoteRefContainingRefsItself.Schema> EnumerateProperties()
        {
            if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
            {
                return new JsonObjectEnumerator<RefFeature.RemoteRefContainingRefsItself.Schema>(properties);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
            {
                return new JsonObjectEnumerator<RefFeature.RemoteRefContainingRefsItself.Schema>(this.jsonElementBacking);
            }
            ...
            private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (Property property in this.EnumerateObject())
            {
                ...
                {
                    result = property.ValueAs<RefFeature.RemoteRefContainingRefsItself.Schema>().Validate(result, level);
                    if (level == ValidationLevel.Flag && !result.IsValid)
                    {
                        return result;
                    }
                    ...
                    IEquatable<DependenciesValue>
    {
        ...
        /// Enumerate the object as the given item type
        /// </summary>
        public JsonObjectEnumerator<RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity> EnumerateProperties()
        {
            if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
            {
                return new JsonObjectEnumerator<RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity>(properties);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
            {
                return new JsonObjectEnumerator<RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity>(this.jsonElementBacking);
            }
            ...
            private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (Property property in this.EnumerateObject())
            {
                JsonEncodedText propertyName = property.NameAsJsonEncodedText;
                        ...
                        if (!result.HasEvaluatedLocalProperty(propertyName))
                {
                    result = property.ValueAs<RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity>().Validate(result, level);
                    if (level == ValidationLevel.Flag && !result.IsValid)
                    {
                        return result;
                    }
                ...
                IEquatable<AdditionalPropertiesEntity>
    {
        ...
        /// Initializes a new instance of the <see cref="AdditionalPropertiesEntity"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="RefFeature.RemoteRefContainingRefsItself.Schema"/> from which to construct the value.</param>
        public AdditionalPropertiesEntity(RefFeature.RemoteRefContainingRefsItself.Schema conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
        ...
        /// Initializes a new instance of the <see cref="AdditionalPropertiesEntity"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray"/> from which to construct the value.</param>
        public AdditionalPropertiesEntity(RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
        ...
        public int Length
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="RefFeature.RemoteRefContainingRefsItself.Schema" />.
        /// </summary>
        public RefFeature.RemoteRefContainingRefsItself.Schema AsSchema
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="RefFeature.RemoteRefContainingRefsItself.Schema" />.
        /// </summary>
        public bool IsSchema
        {
            get
            {
                return ((RefFeature.RemoteRefContainingRefsItself.Schema)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray" />.
        /// </summary>
        public RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray AsJsonStringArray
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray" />.
        /// </summary>
        public bool IsJsonStringArray
        {
            get
            {
                return ((RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="RefFeature.RemoteRefContainingRefsItself.Schema" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(RefFeature.RemoteRefContainingRefsItself.Schema value)
        {
            return new AdditionalPropertiesEntity(value);
        }

        /// <summary>
        /// Conversion to <see cref="RefFeature.RemoteRefContainingRefsItself.Schema" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Schema(AdditionalPropertiesEntity value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Schema(value.AsObject);
            }
                                            if (value.ValueKind == JsonValueKind.True || value.ValueKind == JsonValueKind.False)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Schema(value.AsBoolean);
            }
                            return default;
        }
            /// <summary>
        /// Conversion from <see cref="RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray value)
        {
            return new AdditionalPropertiesEntity(value);
        }

        /// <summary>
        /// Conversion to <see cref="RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray(AdditionalPropertiesEntity value)
        {
                            if (value.ValueKind == JsonValueKind.Array)
            {
                return new RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray(value.AsArray);
            }
                                            return default;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(RefFeature.RemoteRefContainingRefsItself.Core value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Core(AdditionalPropertiesEntity value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
            /// <summary>
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(RefFeature.RemoteRefContainingRefsItself.Applicator value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Applicator(AdditionalPropertiesEntity value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
            /// <summary>
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(RefFeature.RemoteRefContainingRefsItself.Validation value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Validation(AdditionalPropertiesEntity value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
            /// <summary>
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(RefFeature.RemoteRefContainingRefsItself.MetaData value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.MetaData(AdditionalPropertiesEntity value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
            /// <summary>
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(RefFeature.RemoteRefContainingRefsItself.Format value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Format(AdditionalPropertiesEntity value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
            /// <summary>
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(RefFeature.RemoteRefContainingRefsItself.Content value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefFeature.RemoteRefContainingRefsItself.Content(AdditionalPropertiesEntity value)
        {
            return (RefFeature.RemoteRefContainingRefsItself.Schema.DependenciesValue.AdditionalPropertiesEntity)value;
        }
        ...
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult0 = this.As<RefFeature.RemoteRefContainingRefsItself.Schema>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext anyOfResult1 = this.As<RefFeature.RemoteRefContainingRefsItself.Validation.JsonStringArray>().Validate(validationContext.CreateChildContext(), level);
