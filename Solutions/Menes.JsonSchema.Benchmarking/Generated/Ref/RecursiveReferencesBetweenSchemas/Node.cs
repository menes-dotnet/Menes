...
namespace RefFeature.RecursiveReferencesBetweenSchemas
{
                    ...
                    IEquatable<Node>
    {
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RecursiveReferencesBetweenSchemas.Tree Subtree
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RecursiveReferencesBetweenSchemas.Tree(result);
                    }
                }
        ...
        public static Node Create(
                ...
                ,             RefFeature.RecursiveReferencesBetweenSchemas.Tree? subtree = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, JsonAny>();
                    builder.Add(ValueJsonPropertyName, value);
                            if (subtree is RefFeature.RecursiveReferencesBetweenSchemas.Tree subtree__)
            {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Node WithSubtree(RefFeature.RecursiveReferencesBetweenSchemas.Tree value)
        {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<Node, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<Node, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    JsonNumber property = that.Value;
