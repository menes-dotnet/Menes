...
namespace RefFeature.RootPointerRef
{
...
private readonly Menes.JsonValueBacking foo;
public RootEntity(System.Text.Json.JsonElement jsonElement)
{
    this._menesJsonElementBacking = jsonElement;
this.foo = default;
}
public RootEntity(RootEntity? foo = null)
{
    this._menesJsonElementBacking = default;
this.foo = Menes.JsonValueBacking.From<RootEntity>(foo);
}
private RootEntity(Menes.JsonValueBacking foo)
{
    this._menesJsonElementBacking = default;
this.foo = foo;
}
...
public RootEntity? Foo => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<RootEntity>(_MenesFooUtf8JsonPropertyName.Span) : this.foo.As<RootEntity>();
...
if (this.IsObject)
{
    ...
    if (this.TryGetProperty<RootEntity>(_MenesFooJsonPropertyName.Span, out RootEntity value0))
    {
...
writer.WriteStartObject();
    if (this.foo is Menes.JsonValueBacking foo && !foo.IsNull)
    {
...
if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesFooJsonPropertyName.Span))
{
    return this.WithFoo(value.As<RootEntity>());
}
return this;
}
...
public RootEntity WithFoo(RootEntity value)
{
    return new RootEntity(Menes.JsonValueBacking.From<RootEntity>(value));
}
