...
namespace RefFeature.RootPointerRef
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public RefFeature.RootPointerRef.Schema Foo
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefFeature.RootPointerRef.Schema(result);
                    }
                }
        ...
        public static Schema Create(
                            RefFeature.RootPointerRef.Schema? foo = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, JsonAny>();
                            if (foo is RefFeature.RootPointerRef.Schema foo__)
            {
        ...
        public Schema WithFoo(RefFeature.RootPointerRef.Schema value)
        {
