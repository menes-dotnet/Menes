...
namespace MaxPropertiesFeature.MaxPropertiesEquals0MeansTheObjectIsEmpty
{
...
{
    result = result.WithResult(isValid: false, message: "6.5.1.  maxProperties - property count greater than 0");
}
else
{
