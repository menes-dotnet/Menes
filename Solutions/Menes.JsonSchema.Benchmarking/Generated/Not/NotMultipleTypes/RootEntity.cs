...
namespace NotFeature.NotMultipleTypes
{
...
public NotEntity(Menes.JsonInteger value)
{
    this._menesJsonElementBacking = default;
    this._menesIntegerTypeBacking = value;
this._menesBooleanTypeBacking = default;
}
public NotEntity(Menes.JsonBoolean value)
{
    this._menesJsonElementBacking = default;
    this._menesBooleanTypeBacking = value;
this._menesIntegerTypeBacking = default;
}
private NotEntity(Menes.JsonInteger? _menesIntegerTypeBacking, Menes.JsonBoolean? _menesBooleanTypeBacking)
{
    this._menesJsonElementBacking = default;
this._menesIntegerTypeBacking = _menesIntegerTypeBacking;
this._menesBooleanTypeBacking = _menesBooleanTypeBacking;
}
public static implicit operator Menes.JsonInteger(NotEntity value)
{
    return value.As<Menes.JsonInteger>();
}
public static implicit operator NotEntity(Menes.JsonInteger value)
{
    return value.As<RootEntity.NotEntity>();
}
public static implicit operator Menes.JsonNumber(NotEntity value)
{
    return value.As<Menes.JsonNumber>();
}
public static implicit operator NotEntity(Menes.JsonNumber value)
{
    return value.As<RootEntity.NotEntity>();
}
public static implicit operator long(NotEntity value)
{
    return (long)(Menes.JsonInteger)value;
}
public static implicit operator NotEntity(long value)
{
    return (RootEntity.NotEntity)(Menes.JsonInteger)value;
}
public static implicit operator int(NotEntity value)
{
...
public static implicit operator Menes.JsonBoolean(NotEntity value)
{
    return value.As<Menes.JsonBoolean>();
}
public static implicit operator NotEntity(Menes.JsonBoolean value)
{
    return value.As<RootEntity.NotEntity>();
}
public static implicit operator bool(NotEntity value)
{
    return (bool)(Menes.JsonBoolean)value;
}
public static implicit operator NotEntity(bool value)
{
    return (RootEntity.NotEntity)(Menes.JsonBoolean)value;
}
/// <inheritdoc />
public bool IsUndefined => !this.HasJsonElement && this.AllBackingFieldsAreNull();
/// <inheritdoc />
...
if (!this.IsInteger && !this.IsBoolean)
{
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.1.1.  type - item must be one of integer,boolean");
}
else
{
    result = result.WithResult(isValid: false);
