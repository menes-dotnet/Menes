...
namespace NotFeature.NotMoreComplexSchema
{
    public readonly struct RootEntity : Menes.IJsonValue
    {
        ...
        public readonly struct NotEntity : Menes.IJsonObject<NotEntity>
        {
            ...
            public NotEntity(Menes.JsonString? foo = null)
            {
                this._menesJsonElementBacking = default;
                this.foo = foo;
                this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
            }
            private NotEntity(Menes.JsonString? foo, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
            {
                this._menesJsonElementBacking = default;
                this.foo = foo;
            ...
            {
                var rc = this.TryGetPropertyAtIndex(index, out Menes.Property<NotEntity> prop);
                result = prop;
                return rc;
            }
            public NotEntity RemoveProperty(string propertyName)
            {
                return this.SetProperty(propertyName, Menes.JsonNull.Instance);
            }
            public NotEntity RemoveProperty(System.ReadOnlySpan<char> propertyName)
            {
                return this.SetProperty(propertyName, Menes.JsonNull.Instance);
            }
            public NotEntity RemoveProperty(System.ReadOnlySpan<byte> propertyName)
            {
                return this.SetProperty(propertyName, Menes.JsonNull.Instance);
            }
            public NotEntity SetProperty<T>(string name, T value)
            where T : struct, Menes.IJsonValue
            {
            ...
            public NotEntity SetProperty<T>(System.ReadOnlySpan<char> propertyName, T value)
            where T : struct, Menes.IJsonValue
            {
                if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesFooJsonPropertyName.Span))
                {
            ...
            public NotEntity SetProperty<T>(System.ReadOnlySpan<byte> utf8Name, T value)
            where T : struct, Menes.IJsonValue
            {
            ...
            public RootEntity.NotEntity.MenesPropertyEnumerator GetEnumerator()
            {
            ...
            System.Collections.Generic.IEnumerator<Menes.Property<RootEntity.NotEntity>> System.Collections.Generic.IEnumerable<Menes.Property<RootEntity.NotEntity>>.GetEnumerator()
            {
                return this.GetEnumerator();
            }
            public NotEntity WithFoo(Menes.JsonString value)
            {
                return new NotEntity(value, this._menesAdditionalPropertiesBacking);
            }
            ...
            /// <inheritdoc />
            private bool TryGetPropertyAtIndex(int index, out Menes.Property<NotEntity> result)
            {
                if (this.HasJsonElement)
                {
                    int jsonPropertyIndex = 0;
                    foreach (var property in this.JsonElement.EnumerateObject())
                    {
                        ...
                        {
                            result = new Menes.Property<NotEntity>(property);
                            return true;
                        }
                        jsonPropertyIndex++;
                    }
                ...
                {
                    result = new Menes.Property<NotEntity>(this, _MenesFooJsonPropertyName);
                    return true;
                }
                currentIndex++;
                foreach (var property in this._menesAdditionalPropertiesBacking)
                {
                    if (currentIndex == index)
                    {
                        result = new Menes.Property<NotEntity>(this, property.NameAsMemory);
                        return true;
                    }
                    currentIndex++;
                }
            ...
            private NotEntity WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> value)
            {
                return new NotEntity(this.foo, value);
            }
            /// <summary>
            /// An enumerator for the properties in a <see cref="NotEntity"/>.
            /// </summary>
            public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.Property<NotEntity>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.Property<NotEntity>>, System.Collections.IEnumerator
            {
                private NotEntity instance;
                private System.Text.Json.JsonElement.ObjectEnumerator jsonEnumerator;
                private bool hasJsonEnumerator;
                private int index;
                private int propertyCount;
                internal MenesPropertyEnumerator(NotEntity instance)
                {
                ...
                /// <inheritdoc/>
                public Menes.Property<NotEntity> Current
                {
                    get
                    {
                        if (this.hasJsonEnumerator)
                        {
                            return new Menes.Property<NotEntity>(this.jsonEnumerator.Current);
                        }
                        else if (this.index >= 0)
                        {
                            if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.Property<NotEntity> result))
                            {
                                return result;
                            }
                        ...
                        return new Menes.Property<NotEntity>(this.instance, default);
                    }
                }
                /// <inheritdoc/>
                ...
                /// </summary>
                /// <returns>An enumerator for the properties in a <see cref="NotEntity"/>.</returns>
                ...
                /// <inheritdoc/>
                System.Collections.Generic.IEnumerator<Menes.Property<NotEntity>> System.Collections.Generic.IEnumerable<Menes.Property<NotEntity>>.GetEnumerator()
                {
                    return this.GetEnumerator();
                }
                /// <inheritdoc/>
