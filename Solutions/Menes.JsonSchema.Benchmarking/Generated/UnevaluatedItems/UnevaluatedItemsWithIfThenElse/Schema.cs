...
namespace UnevaluatedItemsFeature.UnevaluatedItemsWithIfThenElse
{
                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                ...
                {
                                case 0:
                        result = arrayEnumerator.Current.As<UnevaluatedItemsFeature.UnevaluatedItemsWithIfThenElse.Schema.Items0Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<UnevaluatedItemsFeature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (ifResult.IsValid)
            {
                ValidationContext thenResult = this.As<UnevaluatedItemsFeature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (!ifResult.IsValid)
            {
                ValidationContext elseResult = this.As<UnevaluatedItemsFeature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        break;
                                case 3:
                        result = arrayEnumerator.Current.As<UnevaluatedItemsFeature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity.Items3Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
            ...
            IEquatable<Items3Entity>
    {
            ...
            private static readonly Items3Entity __MenesConstValue = JsonAny.Parse("\"else\"");
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public Items3Entity(JsonEncodedText value)
        {
            this.jsonElementBacking = default;
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Items3Entity(JsonEncodedText value)
        {
            return new Items3Entity(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(Items3Entity value)
        {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        break;
                                case 1:
                        result = arrayEnumerator.Current.As<UnevaluatedItemsFeature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity.Items1Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        break;
                                case 2:
                        result = arrayEnumerator.Current.As<UnevaluatedItemsFeature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity.Items2Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
            ...
            IEquatable<Items2Entity>
    {
            ...
            private static readonly Items2Entity __MenesConstValue = JsonAny.Parse("\"then\"");
