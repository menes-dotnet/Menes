...
namespace UnevaluatedItemsFeature.UnevaluatedItemsWithTuple
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("unevaluatedItems.json", "#/4/schema", "#/004/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedItemsFeature.UnevaluatedItemsWithTuple.RootEntity>();
        }
        /// <summary>
