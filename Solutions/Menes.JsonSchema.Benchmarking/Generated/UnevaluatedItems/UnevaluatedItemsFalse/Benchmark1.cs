...
namespace UnevaluatedItemsFeature.UnevaluatedItemsFalse
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("unevaluatedItems.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedItemsFeature.UnevaluatedItemsFalse.RootEntity>();
        }
        /// <summary>
