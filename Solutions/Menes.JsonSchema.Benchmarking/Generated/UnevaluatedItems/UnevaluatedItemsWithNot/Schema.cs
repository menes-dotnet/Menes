...
namespace UnevaluatedItemsFeature.UnevaluatedItemsWithNot
{
                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                ...
                {
                                case 0:
                        result = arrayEnumerator.Current.As<UnevaluatedItemsFeature.UnevaluatedItemsWithNot.Schema.Items0Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
        ...
        private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext notResult = this.As<UnevaluatedItemsFeature.UnevaluatedItemsWithNot.Schema.NotEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            IEquatable<NotEntity>
    {
        ...
        private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext notResult = this.As<UnevaluatedItemsFeature.UnevaluatedItemsWithNot.Schema.NotEntity.NotEntity1>().Validate(validationContext.CreateChildContext(), level);
            if (notResult.IsValid)
            {
                if (level >= ValidationLevel.Detailed)
                {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        break;
                                case 1:
                        result = arrayEnumerator.Current.As<UnevaluatedItemsFeature.UnevaluatedItemsWithNot.Schema.NotEntity.NotEntity1.Items1Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
