...
namespace UnevaluatedItemsFeature.UnevaluatedItemsWithRef
{
    public readonly struct RootEntity : Menes.IJsonValue, Menes.IJsonArray<RootEntity, Menes.JsonAny>
    {
        ...
        public static implicit operator RootEntity.BarEntity(RootEntity value)
        {
            return value.As<RootEntity.BarEntity>();
        }
        public static implicit operator RootEntity(RootEntity.BarEntity value)
        {
        ...
        public readonly RootEntity.BarEntity AsBarEntity()
        {
            return this.As<RootEntity.BarEntity>();
        }
        /// <inheritdoc/>
        ...
        public readonly struct BarEntity : Menes.IJsonValue, Menes.IJsonArray<BarEntity, Menes.JsonAny>
        {
            ...
            public BarEntity(System.Collections.Immutable.ImmutableArray<Menes.JsonAny> value)
            {
                this._menesArrayValueBacking = value;
                this._menesJsonElementBacking = default;
            }
            public static implicit operator BarEntity(System.Collections.Immutable.ImmutableArray<Menes.JsonAny> items)
            {
                return new RootEntity.BarEntity(items);
            }
            /// <inheritdoc />
            public bool IsUndefined => !this.HasJsonElement && this.AllBackingFieldsAreNull();
            /// <inheritdoc />
            ...
            public RootEntity.BarEntity.MenesArrayEnumerator GetEnumerator()
            {
                return new RootEntity.BarEntity.MenesArrayEnumerator(this);
            }
            public RootEntity.BarEntity.MenesArrayEnumerator EnumerateArray()
            {
                return new RootEntity.BarEntity.MenesArrayEnumerator(this);
            }
            System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            ...
            public BarEntity Add<T1>(T1 item1)
                where T1 : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonAny>();
                foreach (var oldItem in this._menesArrayValueBacking)
                ...
                arrayBuilder.Add(item1.As<Menes.JsonAny>());
                return new RootEntity.BarEntity(arrayBuilder.ToImmutable());
            }
            public BarEntity Add<T1, T2>(T1 item1, T2 item2)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonAny>();
            ...
            public BarEntity Add<T1, T2, T3>(T1 item1, T2 item2, T3 item3)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
                where T3 : struct, Menes.IJsonValue
            {
            ...
            public BarEntity Add<T1, T2, T3, T4>(T1 item1, T2 item2, T3 item3, T4 item4)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
                where T3 : struct, Menes.IJsonValue
                where T4 : struct, Menes.IJsonValue
            ...
            public BarEntity Add<T>(params T[] items)
                where T : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonAny>();
                foreach (var oldItem in this._menesArrayValueBacking)
            ...
            public BarEntity Insert<T>(int index, T item1)
                where T : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonAny>();
                int currentIndex = 0;
            ...
            public BarEntity Insert<T1, T2>(int index, T1 item1, T2 item2)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonAny>();
            ...
            public BarEntity Insert<T1, T2, T3>(int index, T1 item1, T2 item2, T3 item3)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
                where T3 : struct, Menes.IJsonValue
            {
            ...
            public BarEntity Insert<T1, T2, T3, T4>(int index, T1 item1, T2 item2, T3 item3, T4 item4)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
                where T3 : struct, Menes.IJsonValue
                where T4 : struct, Menes.IJsonValue
            ...
            public BarEntity Insert<T>(int index, params T[] items)
                where T : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonAny>();
                int currentIndex = 0;
            ...
            public BarEntity RemoveIf(System.Predicate<Menes.JsonAny> condition)
            {
                return this.RemoveIf<Menes.JsonAny>(condition);
            }
            public BarEntity RemoveIf<T>(System.Predicate<T> condition)
                where T : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonAny>();
                foreach (var item in this._menesArrayValueBacking)
            ...
            /// <summary>
            /// An enumerator for the array values in a <see cref="BarEntity"/>.
            /// </summary>
            public struct MenesArrayEnumerator : System.Collections.Generic.IEnumerable<Menes.JsonAny>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.JsonAny>, System.Collections.IEnumerator
            {
                ...
                private int index;
                internal MenesArrayEnumerator(BarEntity instance)
                {
                ...
                /// </summary>
                /// <returns>An enumerator for the array values in a <see cref="BarEntity"/>.</returns>
