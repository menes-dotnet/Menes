...
namespace UnevaluatedItemsFeature.UnevaluatedItemsWithAnyOf
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("unevaluatedItems.json", "#/9/schema", "#/009/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedItemsFeature.UnevaluatedItemsWithAnyOf.RootEntity>();
        }
        /// <summary>
