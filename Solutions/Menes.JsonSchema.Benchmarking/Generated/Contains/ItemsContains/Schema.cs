...
namespace ContainsFeature.ItemsContains
{
                ...
                IEquatable<Schema>
    {
        ...
        public static Schema From(params ContainsFeature.ItemsContains.Schema.ItemsEntity[] items)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsFeature.ItemsContains.Schema.ItemsEntity item1)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsFeature.ItemsContains.Schema.ItemsEntity item1, ContainsFeature.ItemsContains.Schema.ItemsEntity item2)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsFeature.ItemsContains.Schema.ItemsEntity item1, ContainsFeature.ItemsContains.Schema.ItemsEntity item2, ContainsFeature.ItemsContains.Schema.ItemsEntity item3)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsFeature.ItemsContains.Schema.ItemsEntity item1, ContainsFeature.ItemsContains.Schema.ItemsEntity item2, ContainsFeature.ItemsContains.Schema.ItemsEntity item3, ContainsFeature.ItemsContains.Schema.ItemsEntity item4)
        {
        ...
        public void WriteTo(Utf8JsonWriter writer)
        {
            ...
            writer.WriteNullValue();
                ...
                /// <summary>
        /// Enumerate the items in the array as a <see cref="ContainsFeature.ItemsContains.Schema.ItemsEntity" />.
        /// </summary>
        public JsonArrayEnumerator<ContainsFeature.ItemsContains.Schema.ItemsEntity> EnumerateItems()
        {
            if (this.arrayBacking is ImmutableList<JsonAny> items)
            {
                return new JsonArrayEnumerator<ContainsFeature.ItemsContains.Schema.ItemsEntity>(items);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
            {
                return new JsonArrayEnumerator<ContainsFeature.ItemsContains.Schema.ItemsEntity>(this.jsonElementBacking);
            }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<ContainsFeature.ItemsContains.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
                ...
                if (containsResult.IsValid)
                {
                    ...
                    containsCount++;
                        ...
                        result = arrayEnumerator.Current.As<ContainsFeature.ItemsContains.Schema.ItemsEntity>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
