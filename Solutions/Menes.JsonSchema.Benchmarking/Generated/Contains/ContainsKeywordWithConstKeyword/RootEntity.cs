...
namespace ContainsFeature.ContainsKeywordWithConstKeyword
{
...
private static readonly Menes.JsonNumber _MenesConstValue = new Menes.JsonNumber((double)5);
...
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.1.3. const - does not match const value 5");
}
else
{
    result = result.WithResult(isValid: false);
