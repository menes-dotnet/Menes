...
namespace ContainsFeature.ContainsKeywordWithConstKeyword
{
                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<ContainsFeature.ContainsKeywordWithConstKeyword.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
            ...
            IEquatable<ContainsEntity>
    {
            ...
            private static readonly ContainsEntity __MenesConstValue = JsonAny.Parse("5");
