...
namespace ContainsFeature.ContainsKeywordWithConstKeyword
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("contains.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ContainsFeature.ContainsKeywordWithConstKeyword.RootEntity>();
        }
        /// <summary>
