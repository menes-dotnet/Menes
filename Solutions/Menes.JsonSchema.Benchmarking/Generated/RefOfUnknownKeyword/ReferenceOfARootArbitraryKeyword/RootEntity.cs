...
namespace RefOfUnknownKeywordFeature.ReferenceOfARootArbitraryKeyword
{
    public readonly struct RootEntity : Menes.IJsonObject<RootEntity>
    {
        ...
        public RootEntity(Menes.JsonInteger? bar = null)
        {
            this._menesJsonElementBacking = default;
            this.bar = bar;
            this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
        }
        private RootEntity(Menes.JsonInteger? bar, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
        {
            this._menesJsonElementBacking = default;
            this.bar = bar;
