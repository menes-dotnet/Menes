...
namespace RefOfUnknownKeywordFeature.ReferenceOfAnArbitraryKeywordOfASubSchema
{
...
public RootEntity(Menes.JsonAny? foo = null, Menes.JsonInteger? bar = null)
{
...
private RootEntity(Menes.JsonAny? foo, Menes.JsonInteger? bar, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
{
    this._menesJsonElementBacking = default;
this.foo = foo;
this.bar = bar;
