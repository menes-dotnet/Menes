// <copyright file="NestedEntity.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace AnchorFeature.LocationIndependentIdentifierWithBaseURChangeInSubschema
{
    public readonly struct NestedEntity : Menes.IJsonValue
    {
        public static readonly NestedEntity Null = default(NestedEntity);
        private readonly System.Text.Json.JsonElement _menesJsonElementBacking;
        public NestedEntity(System.Text.Json.JsonElement jsonElement)
        {
        ...
        {
            if (typeof(T) == typeof(NestedEntity))
            {
                return Corvus.Extensions.CastTo<T>.From(this);
            }
            return Menes.JsonValue.As<NestedEntity, T>(this);
        }
        /// <inheritdoc />
        public bool Is<T>()
            where T : struct, Menes.IJsonValue
