...
namespace EnumFeature.SimpleEnumValidation
{
...
if (!foundMatch)
{
    if (this.IsNumber)
    {
        if ((double)this != (double)RootEntity.EnumValues.Item0)
        {
            foundMatch = false;
        }
        else
...
if (!foundMatch)
{
    if (this.IsNumber)
    {
        if ((double)this != (double)RootEntity.EnumValues.Item1)
        {
            foundMatch = false;
        }
        else
...
if (!foundMatch)
{
    if (this.IsNumber)
    {
        if ((double)this != (double)RootEntity.EnumValues.Item2)
        {
            foundMatch = false;
        }
        else
...
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.1.2. enum - does not match enum values 1, 2, 3");
}
else
{
    result = result.WithResult(isValid: false);
...
{
public static readonly Menes.JsonNumber Item0 = new Menes.JsonNumber((double)1);
public static readonly Menes.JsonNumber Item1 = new Menes.JsonNumber((double)2);
public static readonly Menes.JsonNumber Item2 = new Menes.JsonNumber((double)3);
}
}
}
