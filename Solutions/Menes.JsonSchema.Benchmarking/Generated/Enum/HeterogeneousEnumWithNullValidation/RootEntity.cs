...
namespace EnumFeature.HeterogeneousEnumWithNullValidation
{
...
{
    result = result.WithResult(isValid: false, message: "6.1.2. enum - does not match enum values 6, null");
}
else
{
...
public static readonly Menes.JsonNull Item1 = Menes.JsonNull.Instance;
}
}
}
