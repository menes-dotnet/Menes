...
namespace EnumFeature.EnumWithEscapedCharacters
{
...
public static readonly Menes.JsonString FooBar = new Menes.JsonString("foo\nbar");
internal static readonly Menes.JsonString Item1 = new Menes.JsonString("foo\rbar");
public static readonly Menes.JsonString FooBar1 = new Menes.JsonString("foo\rbar");
}
}
}
