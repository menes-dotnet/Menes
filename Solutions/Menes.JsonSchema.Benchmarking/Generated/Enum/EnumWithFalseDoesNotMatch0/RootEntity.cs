...
namespace EnumFeature.EnumWithFalseDoesNotMatch0
{
...
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.1.2. enum - does not match enum values false");
}
else
{
    result = result.WithResult(isValid: false);
...
{
public static readonly Menes.JsonBoolean Item0 = new Menes.JsonBoolean(false);
}
}
}
