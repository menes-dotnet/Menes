...
namespace IfThenElseFeature.IfAndElseWithoutThen
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("if-then-else.json", "#/4/schema", "#/004/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<IfThenElseFeature.IfAndElseWithoutThen.RootEntity>();
        }
        /// <summary>
