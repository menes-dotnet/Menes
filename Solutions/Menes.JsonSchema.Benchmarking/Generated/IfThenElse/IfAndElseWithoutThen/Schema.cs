...
namespace IfThenElseFeature.IfAndElseWithoutThen
{
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<IfThenElseFeature.IfAndElseWithoutThen.Schema.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (!ifResult.IsValid)
            {
                ValidationContext elseResult = this.As<IfThenElseFeature.IfAndElseWithoutThen.Schema.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
