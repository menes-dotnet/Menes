...
namespace IfThenElseFeature.IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence
{
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<IfThenElseFeature.IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence.Schema.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (ifResult.IsValid)
            {
                ValidationContext thenResult = this.As<IfThenElseFeature.IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence.Schema.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (!ifResult.IsValid)
            {
                ValidationContext elseResult = this.As<IfThenElseFeature.IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence.Schema.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
