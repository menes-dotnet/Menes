...
namespace IfThenElseFeature.IgnoreIfWithoutThenOrElse
{
    public readonly struct RootEntity : Menes.IJsonValue
    {
        ...
        public readonly struct IfEntity : Menes.IJsonValue
        {
            ...
            public IfEntity(Menes.JsonNumber value)
            {
                this._menesJsonElementBacking = default;
                this._menesNumberTypeBacking = value;
            }
            private IfEntity(Menes.JsonNumber? _menesNumberTypeBacking)
            {
                this._menesJsonElementBacking = default;
                this._menesNumberTypeBacking = _menesNumberTypeBacking;
            }
            public static implicit operator Menes.JsonInteger(IfEntity value)
            {
                return value.As<Menes.JsonInteger>();
            }
            public static implicit operator IfEntity(Menes.JsonInteger value)
            {
                return value.As<RootEntity.IfEntity>();
            }
            public static implicit operator Menes.JsonNumber(IfEntity value)
            {
                return value.As<Menes.JsonNumber>();
            }
            public static implicit operator IfEntity(Menes.JsonNumber value)
            {
                return value.As<RootEntity.IfEntity>();
            }
            public static implicit operator int(IfEntity value)
            {
                return (int)(Menes.JsonNumber)value;
            }
            public static implicit operator IfEntity(int value)
            {
                return (RootEntity.IfEntity)(Menes.JsonNumber)value;
            }
            public static implicit operator long(IfEntity value)
            {
            ...
            public static implicit operator double(IfEntity value)
            {
            ...
            public static implicit operator float(IfEntity value)
            {
