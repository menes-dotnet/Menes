...
namespace IfThenElseFeature.NonInterferenceAcrossCombinedSchemas
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity"/> from which to construct the value.</param>
        public Schema(IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf1Entity"/> from which to construct the value.</param>
        public Schema(IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf1Entity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf2Entity"/> from which to construct the value.</param>
        public Schema(IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf2Entity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
        /// Gets the value as a <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity" />.
        /// </summary>
        public IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity AsAllOf0Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity" />.
        /// </summary>
        public bool IsAllOf0Entity
        {
            get
            {
                return ((IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf1Entity" />.
        /// </summary>
        public IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf1Entity AsAllOf1Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf1Entity" />.
        /// </summary>
        public bool IsAllOf1Entity
        {
            get
            {
                return ((IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf1Entity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf2Entity" />.
        /// </summary>
        public IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf2Entity AsAllOf2Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf2Entity" />.
        /// </summary>
        public bool IsAllOf2Entity
        {
            get
            {
                return ((IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf2Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity(Schema value)
        {
                                                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf1Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf1Entity(Schema value)
        {
                                                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf2Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf2Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf2Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf2Entity(Schema value)
        {
                                                    return default;
        }
        ...
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult1 = this.As<IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf1Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult2 = this.As<IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf2Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            IEquatable<AllOf0Entity>
    {
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<IfThenElseFeature.NonInterferenceAcrossCombinedSchemas.Schema.AllOf0Entity.IfEntity>().Validate(validationContext.CreateChildContext(), level);
