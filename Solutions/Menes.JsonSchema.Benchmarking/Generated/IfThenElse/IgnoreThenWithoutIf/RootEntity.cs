...
namespace IfThenElseFeature.IgnoreThenWithoutIf
{
    public readonly struct RootEntity : Menes.IJsonValue
    {
        ...
        public readonly struct ThenEntity : Menes.IJsonValue
        {
            ...
            public ThenEntity(Menes.JsonNumber value)
            {
                this._menesJsonElementBacking = default;
                this._menesNumberTypeBacking = value;
            }
            private ThenEntity(Menes.JsonNumber? _menesNumberTypeBacking)
            {
                this._menesJsonElementBacking = default;
                this._menesNumberTypeBacking = _menesNumberTypeBacking;
            }
            public static implicit operator Menes.JsonInteger(ThenEntity value)
            {
                return value.As<Menes.JsonInteger>();
            }
            public static implicit operator ThenEntity(Menes.JsonInteger value)
            {
                return value.As<RootEntity.ThenEntity>();
            }
            public static implicit operator Menes.JsonNumber(ThenEntity value)
            {
                return value.As<Menes.JsonNumber>();
            }
            public static implicit operator ThenEntity(Menes.JsonNumber value)
            {
                return value.As<RootEntity.ThenEntity>();
            }
            public static implicit operator int(ThenEntity value)
            {
                return (int)(Menes.JsonNumber)value;
            }
            public static implicit operator ThenEntity(int value)
            {
                return (RootEntity.ThenEntity)(Menes.JsonNumber)value;
            }
            public static implicit operator long(ThenEntity value)
            {
            ...
            public static implicit operator double(ThenEntity value)
            {
            ...
            public static implicit operator float(ThenEntity value)
            {
