...
namespace IfThenElseFeature.ValidateAgainstCorrectBranchThenVsElse
{
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<IfThenElseFeature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (ifResult.IsValid)
            {
                ValidationContext thenResult = this.As<IfThenElseFeature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (!ifResult.IsValid)
            {
                ValidationContext elseResult = this.As<IfThenElseFeature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
