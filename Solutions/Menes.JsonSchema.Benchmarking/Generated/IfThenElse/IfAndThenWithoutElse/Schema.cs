...
namespace IfThenElseFeature.IfAndThenWithoutElse
{
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<IfThenElseFeature.IfAndThenWithoutElse.Schema.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (ifResult.IsValid)
            {
                ValidationContext thenResult = this.As<IfThenElseFeature.IfAndThenWithoutElse.Schema.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
