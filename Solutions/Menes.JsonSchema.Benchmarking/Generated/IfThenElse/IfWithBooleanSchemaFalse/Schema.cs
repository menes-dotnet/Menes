...
namespace IfThenElseFeature.IfWithBooleanSchemaFalse
{
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<Menes.Json.JsonNotAny>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (ifResult.IsValid)
            {
                ValidationContext thenResult = this.As<IfThenElseFeature.IfWithBooleanSchemaFalse.Schema.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (!ifResult.IsValid)
            {
                ValidationContext elseResult = this.As<IfThenElseFeature.IfWithBooleanSchemaFalse.Schema.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
