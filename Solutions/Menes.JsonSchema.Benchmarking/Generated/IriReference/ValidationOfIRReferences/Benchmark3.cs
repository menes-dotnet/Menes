...
namespace IriReferenceFeature.ValidationOfIRReferences
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("iri-reference.json", "#/0/schema", "#/000/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<IriReferenceFeature.ValidationOfIRReferences.RootEntity>();
        }
        /// <summary>
