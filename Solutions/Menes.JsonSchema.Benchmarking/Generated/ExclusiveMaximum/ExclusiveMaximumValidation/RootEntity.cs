...
namespace ExclusiveMaximumFeature.ExclusiveMaximumValidation
{
...
{
    result = result.WithResult(isValid: false, message: "6.2.3.  exclusiveMaximum - item must be less then 3");
}
else
{
