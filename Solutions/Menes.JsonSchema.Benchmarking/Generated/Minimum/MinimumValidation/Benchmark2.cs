...
namespace MinimumFeature.MinimumValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("minimum.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinimumFeature.MinimumValidation.RootEntity>();
        }
        /// <summary>
