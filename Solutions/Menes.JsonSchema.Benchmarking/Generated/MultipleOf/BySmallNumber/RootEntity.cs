...
namespace MultipleOfFeature.BySmallNumber
{
...
if (this.IsNumber)
{
    ...
    if (System.Math.Abs(System.Math.IEEERemainder((double)number, (double)0.0001)) > 1.0E-18)
    {
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.2.1.  multipleOf - item must be a multiple of 0.0001");
}
else
{
