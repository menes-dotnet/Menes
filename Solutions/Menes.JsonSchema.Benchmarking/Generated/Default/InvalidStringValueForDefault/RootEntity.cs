...
namespace DefaultFeature.InvalidStringValueForDefault
{
    public readonly struct RootEntity : Menes.IJsonObject<RootEntity>
    {
        ...
        private readonly RootEntity.BarValue? bar;
        ...
        public RootEntity(RootEntity.BarValue? bar = null)
        {
            this._menesJsonElementBacking = default;
            this.bar = bar;
            this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
        }
        private RootEntity(RootEntity.BarValue? bar, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
        {
            this._menesJsonElementBacking = default;
            this.bar = bar;
        ...
        public RootEntity.BarValue? Bar => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<RootEntity.BarValue>(_MenesBarUtf8JsonPropertyName.Span) : this.bar;
        ...
        public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
        {
            ...
            if (this.IsObject)
            {
                ...
                if (this.TryGetProperty<RootEntity.BarValue>(_MenesBarJsonPropertyName.Span, out RootEntity.BarValue value0))
                {
        ...
        public void WriteTo(System.Text.Json.Utf8JsonWriter writer)
        {
            ...
            if (this.bar is RootEntity.BarValue bar)
            {
        ...
        where T : struct, Menes.IJsonValue
        {
            ...
            if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesBarJsonPropertyName.Span))
            {
                return this.WithBar(value.As<RootEntity.BarValue>());
            }
        ...
        public RootEntity WithBar(RootEntity.BarValue value)
        {
        ...
        {
            return new RootEntity(this.bar, value);
        }
        public readonly struct BarValue : Menes.IJsonValue
        {
            public static readonly BarValue Null = default(BarValue);
            private readonly System.Text.Json.JsonElement _menesJsonElementBacking;
            ...
            private BarValue(Menes.JsonString? _menesStringTypeBacking)
            {
                this._menesJsonElementBacking = default;
            ...
            {
                return value.As<RootEntity.BarValue>();
            }
            ...
            {
                return (RootEntity.BarValue)(Menes.JsonString)value;
            }
            /// <inheritdoc />
            public bool IsUndefined => !this.HasJsonElement && this.AllBackingFieldsAreNull();
            /// <inheritdoc />
            ...
            public T As<T>()
                where T : struct, Menes.IJsonValue
            {
                if (typeof(T) == typeof(BarValue))
                {
                    return Corvus.Extensions.CastTo<T>.From(this);
                }
                return Menes.JsonValue.As<BarValue, T>(this);
            }
            /// <inheritdoc />
            public bool Is<T>()
                where T : struct, Menes.IJsonValue
            {
                if (typeof(T) == typeof(RootEntity.BarValue))
                {
                    return this.Validate(Menes.ValidationContext.ValidContext).IsValid;
                }
                return this.As<T>().Validate(Menes.ValidationContext.ValidContext).IsValid;
