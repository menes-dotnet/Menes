...
namespace DefaultFeature.InvalidTypeForDefault
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public DefaultFeature.InvalidTypeForDefault.Schema.FooValue Foo
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  DefaultFeature.InvalidTypeForDefault.Schema.FooValue(result);
                    }
                }
        ...
        public static Schema Create(
                            DefaultFeature.InvalidTypeForDefault.Schema.FooValue? foo = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, JsonAny>();
                            if (foo is DefaultFeature.InvalidTypeForDefault.Schema.FooValue foo__)
            {
        ...
        public Schema WithFoo(DefaultFeature.InvalidTypeForDefault.Schema.FooValue value)
        {
