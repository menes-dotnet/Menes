...
namespace MaxContainsFeature.MinContainsLessThanMaxContains
{
                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<MaxContainsFeature.MinContainsLessThanMaxContains.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
                ...
                if (containsResult.IsValid)
                {
                    ...
                    containsCount++;
                                ...
                                if (level == ValidationLevel.Flag && containsCount > 3)
                    {
            ...
            if (containsCount > 3)
            {
                ...
                {
                    result = result.WithResult(isValid: false, $"6.4.4. maxContains - {containsCount} exceeds maximum number of matching items 3.");
                }
                else if (level >= ValidationLevel.Basic)
                {
                    result = result.WithResult(isValid: false, "6.4.4. maxContains - item count exceeds maximum number of matching items 3.");
                }
                else
                {
                    return result.WithResult(isValid: false);
            ...
            IEquatable<ContainsEntity>
    {
            ...
            private static readonly ContainsEntity __MenesConstValue = JsonAny.Parse("1");
