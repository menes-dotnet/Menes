...
namespace MaxContainsFeature.MaxContainsWithContains
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("maxContains.json", "#/1/schema", "#/001/tests/004/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MaxContainsFeature.MaxContainsWithContains.RootEntity>();
        }
        /// <summary>
