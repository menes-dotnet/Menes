...
namespace ItemsFeature.ItemsWithBooleanSchemas
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("items.json", "#/4/schema", "#/004/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ItemsFeature.ItemsWithBooleanSchemas.RootEntity>();
        }
        /// <summary>
