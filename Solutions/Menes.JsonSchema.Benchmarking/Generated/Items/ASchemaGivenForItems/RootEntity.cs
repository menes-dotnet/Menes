...
namespace ItemsFeature.ASchemaGivenForItems
{
public readonly struct RootEntity : Menes.IJsonValue, Menes.IJsonArray<RootEntity, Menes.JsonInteger>
{
...
public RootEntity(System.Collections.Immutable.ImmutableArray<Menes.JsonInteger> value)
{
    this._menesArrayValueBacking = value;
    this._menesJsonElementBacking = default;
}
public static implicit operator RootEntity(System.Collections.Immutable.ImmutableArray<Menes.JsonInteger> items)
{
...
public RootEntity RemoveIf(System.Predicate<Menes.JsonInteger> condition)
{
