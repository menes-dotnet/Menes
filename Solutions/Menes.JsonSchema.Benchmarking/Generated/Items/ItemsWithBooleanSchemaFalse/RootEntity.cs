...
namespace ItemsFeature.ItemsWithBooleanSchemaFalse
{
    public readonly struct RootEntity : Menes.IJsonValue, Menes.IJsonArray<RootEntity, Menes.JsonNotAny>
    {
        public static readonly RootEntity Null = default(RootEntity);
        private readonly System.Text.Json.JsonElement _menesJsonElementBacking;
        private readonly System.Collections.Immutable.ImmutableArray<Menes.JsonNotAny>? _menesArrayValueBacking;
        public RootEntity(System.Text.Json.JsonElement jsonElement)
        {
            this._menesJsonElementBacking = jsonElement;
            this._menesArrayValueBacking = default;
        }
        public RootEntity(System.Collections.Immutable.ImmutableArray<Menes.JsonNotAny> value)
        {
            this._menesArrayValueBacking = value;
            this._menesJsonElementBacking = default;
        }
        public static implicit operator RootEntity(System.Collections.Immutable.ImmutableArray<Menes.JsonNotAny> items)
        {
        ...
        {
            var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonNotAny>();
            foreach (var oldItem in this._menesArrayValueBacking)
            {
                arrayBuilder.Add(oldItem);
            }
            arrayBuilder.Add(item1.As<Menes.JsonNotAny>());
            ...
            where T2 : struct, Menes.IJsonValue
        {
            ...
            arrayBuilder.Add(item1.As<Menes.JsonNotAny>());
            arrayBuilder.Add(item2.As<Menes.JsonNotAny>());
            return new RootEntity(arrayBuilder.ToImmutable());
        }
            ...
            where T3 : struct, Menes.IJsonValue
        {
            ...
            arrayBuilder.Add(item1.As<Menes.JsonNotAny>());
            arrayBuilder.Add(item2.As<Menes.JsonNotAny>());
            arrayBuilder.Add(item3.As<Menes.JsonNotAny>());
            return new RootEntity(arrayBuilder.ToImmutable());
        }
            ...
            where T4 : struct, Menes.IJsonValue
        {
            ...
            arrayBuilder.Add(item2.As<Menes.JsonNotAny>());
            arrayBuilder.Add(item3.As<Menes.JsonNotAny>());
            arrayBuilder.Add(item4.As<Menes.JsonNotAny>());
            return new RootEntity(arrayBuilder.ToImmutable());
        }
        ...
        public RootEntity RemoveIf(System.Predicate<Menes.JsonNotAny> condition)
        {
            return this.RemoveIf<Menes.JsonNotAny>(condition);
        }
        ...
        /// </summary>
        public struct MenesArrayEnumerator : System.Collections.Generic.IEnumerable<Menes.JsonNotAny>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.JsonNotAny>, System.Collections.IEnumerator
        {
            ...
            /// <inheritdoc/>
            public Menes.JsonNotAny Current
            {
                get
                {
                    if (this.hasJsonEnumerator)
                    {
                        return new Menes.JsonNotAny(this.jsonEnumerator.Current);
                    }
                    else if (this.instance._menesArrayValueBacking is System.Collections.Immutable.ImmutableArray<Menes.JsonNotAny> array && this.index >= 0 && this.index < array.Length)
                    {
            ...
            public bool MoveNext()
            {
                ...
                else if (this.instance._menesArrayValueBacking is System.Collections.Immutable.ImmutableArray<Menes.JsonNotAny> array && this.index + 1 < array.Length)
                {
                    this.index++;
                    return true;
                }
