...
namespace ItemsFeature.NestedItems
{
                ...
                IEquatable<ItemsArrayArray>
    {
        ...
        public static ItemsArrayArray From(params ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array[] items)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static ItemsArrayArray From(ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array item1)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static ItemsArrayArray From(ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array item1, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array item2)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static ItemsArrayArray From(ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array item1, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array item2, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array item3)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static ItemsArrayArray From(ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array item1, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array item2, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array item3, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array item4)
        {
        ...
        public void WriteTo(Utf8JsonWriter writer)
        {
            ...
            writer.WriteNullValue();
                ...
                /// <summary>
        /// Enumerate the items in the array as a <see cref="ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array" />.
        /// </summary>
        public JsonArrayEnumerator<ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array> EnumerateItems()
        {
            if (this.arrayBacking is ImmutableList<JsonAny> items)
            {
                return new JsonArrayEnumerator<ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array>(items);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
            {
                return new JsonArrayEnumerator<ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array>(this.jsonElementBacking);
            }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        result = arrayEnumerator.Current.As<ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray1Array>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
                ...
                IEquatable<ItemsArray1Array>
    {
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemsArray1Array From(params ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array[] items)
        {
        ...
        /// <param name="item1">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemsArray1Array From(ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array item1)
        {
        ...
        /// <param name="item2">The second item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemsArray1Array From(ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array item1, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array item2)
        {
        ...
        /// <param name="item3">The third item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemsArray1Array From(ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array item1, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array item2, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array item3)
        {
        ...
        /// <param name="item4">The fourth item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemsArray1Array From(ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array item1, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array item2, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array item3, ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array item4)
        {
        ...
        public void WriteTo(Utf8JsonWriter writer)
        {
            ...
            writer.WriteNullValue();
                ...
                /// <summary>
        /// Enumerate the items in the array as a <see cref="ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array" />.
        /// </summary>
        public JsonArrayEnumerator<ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array> EnumerateItems()
        {
            if (this.arrayBacking is ImmutableList<JsonAny> items)
            {
                return new JsonArrayEnumerator<ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array>(items);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
            {
                return new JsonArrayEnumerator<ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array>(this.jsonElementBacking);
            }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        result = arrayEnumerator.Current.As<ItemsFeature.NestedItems.ItemsArrayArray.ItemsArray2Array>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
                ...
                IEquatable<ItemsArray2Array>
    {
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemsArray2Array From(params ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray[] items)
        {
        ...
        /// <param name="item1">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemsArray2Array From(ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray item1)
        {
        ...
        /// <param name="item2">The second item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemsArray2Array From(ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray item1, ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray item2)
        {
        ...
        /// <param name="item3">The third item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemsArray2Array From(ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray item1, ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray item2, ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray item3)
        {
        ...
        /// <param name="item4">The fourth item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemsArray2Array From(ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray item1, ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray item2, ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray item3, ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray item4)
        {
        ...
        public void WriteTo(Utf8JsonWriter writer)
        {
            ...
            writer.WriteNullValue();
                ...
                /// <summary>
        /// Enumerate the items in the array as a <see cref="ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray" />.
        /// </summary>
        public JsonArrayEnumerator<ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray> EnumerateItems()
        {
            if (this.arrayBacking is ImmutableList<JsonAny> items)
            {
                return new JsonArrayEnumerator<ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray>(items);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
            {
                return new JsonArrayEnumerator<ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray>(this.jsonElementBacking);
            }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        result = arrayEnumerator.Current.As<ItemsFeature.NestedItems.ItemsArrayArray.JsonNumberArray>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
