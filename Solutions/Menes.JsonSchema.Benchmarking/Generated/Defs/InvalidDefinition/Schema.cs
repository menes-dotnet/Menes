...
namespace DefsFeature.InvalidDefinition
{
                    ...
                    IEquatable<Schema>
    {
        ...
        public Schema(DefsFeature.InvalidDefinition.Content conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="DefsFeature.InvalidDefinition.Core" />.
        /// </summary>
        public DefsFeature.InvalidDefinition.Core AsCore
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="DefsFeature.InvalidDefinition.Core" />.
        /// </summary>
        public bool IsCore
        {
            get
            {
                return ((DefsFeature.InvalidDefinition.Core)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="DefsFeature.InvalidDefinition.Applicator" />.
        /// </summary>
        public DefsFeature.InvalidDefinition.Applicator AsApplicator
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="DefsFeature.InvalidDefinition.Applicator" />.
        /// </summary>
        public bool IsApplicator
        {
            get
            {
                return ((DefsFeature.InvalidDefinition.Applicator)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="DefsFeature.InvalidDefinition.Validation" />.
        /// </summary>
        public DefsFeature.InvalidDefinition.Validation AsValidation
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="DefsFeature.InvalidDefinition.Validation" />.
        /// </summary>
        public bool IsValidation
        {
            get
            {
                return ((DefsFeature.InvalidDefinition.Validation)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="DefsFeature.InvalidDefinition.MetaData" />.
        /// </summary>
        public DefsFeature.InvalidDefinition.MetaData AsMetaData
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="DefsFeature.InvalidDefinition.MetaData" />.
        /// </summary>
        public bool IsMetaData
        {
            get
            {
                return ((DefsFeature.InvalidDefinition.MetaData)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="DefsFeature.InvalidDefinition.Format" />.
        /// </summary>
        public DefsFeature.InvalidDefinition.Format AsFormat
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="DefsFeature.InvalidDefinition.Format" />.
        /// </summary>
        public bool IsFormat
        {
            get
            {
                return ((DefsFeature.InvalidDefinition.Format)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="DefsFeature.InvalidDefinition.Content" />.
        /// </summary>
        public DefsFeature.InvalidDefinition.Content AsContent
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="DefsFeature.InvalidDefinition.Content" />.
        /// </summary>
        public bool IsContent
        {
            get
            {
                return ((DefsFeature.InvalidDefinition.Content)this).Validate().IsValid;
            }
        }
        ...
        /// {Property examples}.
        /// </example>
        public DefsFeature.InvalidDefinition.Applicator.PropertiesEntity Items
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  DefsFeature.InvalidDefinition.Applicator.PropertiesEntity(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public DefsFeature.InvalidDefinition.Validation.JsonAnyArray Enum
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  DefsFeature.InvalidDefinition.Validation.JsonAnyArray(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public DefsFeature.InvalidDefinition.MetaData.JsonAnyArray Examples
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  DefsFeature.InvalidDefinition.MetaData.JsonAnyArray(result);
                    }
                }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="DefsFeature.InvalidDefinition.Core" />.
        /// </summary>
        ...
        /// <summary>
        /// Conversion to <see cref="DefsFeature.InvalidDefinition.Core" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DefsFeature.InvalidDefinition.Core(Schema value)
        {
            ...
            /// <summary>
        /// Conversion from <see cref="DefsFeature.InvalidDefinition.Applicator" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        ...
        /// <summary>
        /// Conversion to <see cref="DefsFeature.InvalidDefinition.Applicator" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DefsFeature.InvalidDefinition.Applicator(Schema value)
        {
            ...
            /// <summary>
        /// Conversion from <see cref="DefsFeature.InvalidDefinition.Validation" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        ...
        /// <summary>
        /// Conversion to <see cref="DefsFeature.InvalidDefinition.Validation" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DefsFeature.InvalidDefinition.Validation(Schema value)
        {
            ...
            /// <summary>
        /// Conversion from <see cref="DefsFeature.InvalidDefinition.MetaData" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        ...
        /// <summary>
        /// Conversion to <see cref="DefsFeature.InvalidDefinition.MetaData" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DefsFeature.InvalidDefinition.MetaData(Schema value)
        {
            ...
            /// <summary>
        /// Conversion from <see cref="DefsFeature.InvalidDefinition.Format" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        ...
        /// <summary>
        /// Conversion to <see cref="DefsFeature.InvalidDefinition.Format" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DefsFeature.InvalidDefinition.Format(Schema value)
        {
            ...
            /// <summary>
        /// Conversion from <see cref="DefsFeature.InvalidDefinition.Content" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        ...
        /// <summary>
        /// Conversion to <see cref="DefsFeature.InvalidDefinition.Content" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        ...
        public static Schema Create(
                            DefsFeature.InvalidDefinition.Core.IdValue? id = null
        ,             Menes.Json.JsonUri? schema1 = null
        ,             DefsFeature.InvalidDefinition.Core.AnchorValue? anchor = null
        ,             Menes.Json.JsonUriReference? @ref = null
        ,             Menes.Json.JsonUriReference? recursiveRef = null
        ,             DefsFeature.InvalidDefinition.Core.RecursiveAnchorValue? recursiveAnchor = null
        ,             DefsFeature.InvalidDefinition.Core.VocabularyValue? vocabulary = null
        ,             Menes.Json.JsonString? comment = null
        ,             DefsFeature.InvalidDefinition.Core.DefsValue? defs = null
        ,             DefsFeature.InvalidDefinition.Schema? additionalItems = null
        ,             DefsFeature.InvalidDefinition.Schema? unevaluatedItems = null
        ,             DefsFeature.InvalidDefinition.Applicator.PropertiesEntity? items = null
        ,             DefsFeature.InvalidDefinition.Schema? contains = null
        ,             DefsFeature.InvalidDefinition.Schema? additionalProperties = null
        ,             DefsFeature.InvalidDefinition.Schema? unevaluatedProperties = null
        ,             DefsFeature.InvalidDefinition.Applicator.PropertiesValue? properties = null
        ,             DefsFeature.InvalidDefinition.Applicator.PatternPropertiesValue? patternProperties = null
        ,             DefsFeature.InvalidDefinition.Applicator.DependentSchemasValue? dependentSchemas = null
        ,             DefsFeature.InvalidDefinition.Schema? propertyNames = null
        ,             DefsFeature.InvalidDefinition.Schema? @if = null
        ,             DefsFeature.InvalidDefinition.Schema? then = null
        ,             DefsFeature.InvalidDefinition.Schema? @else = null
        ,             DefsFeature.InvalidDefinition.Applicator.SchemaArray? allOf = null
        ,             DefsFeature.InvalidDefinition.Applicator.SchemaArray? anyOf = null
        ,             DefsFeature.InvalidDefinition.Applicator.SchemaArray? oneOf = null
        ,             DefsFeature.InvalidDefinition.Schema? not = null
        ,             DefsFeature.InvalidDefinition.Validation.MultipleOfValue? multipleOf = null
        ...
        ,             DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerValue? maxLength = null
        ,             DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerDefault0Entity? minLength = null
        ,             Menes.Json.JsonRegex? pattern = null
        ,             DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerValue? maxItems = null
        ,             DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerDefault0Entity? minItems = null
        ,             DefsFeature.InvalidDefinition.Validation.UniqueItemsValue? uniqueItems = null
        ,             DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerValue? maxContains = null
        ,             DefsFeature.InvalidDefinition.Validation.MinContainsEntity? minContains = null
        ,             DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerValue? maxProperties = null
        ,             DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerDefault0Entity? minProperties = null
        ,             DefsFeature.InvalidDefinition.Validation.JsonStringArray? required = null
        ,             DefsFeature.InvalidDefinition.Validation.DependentRequiredValue? dependentRequired = null
        ,             Menes.Json.JsonAny? @const = null
        ,             DefsFeature.InvalidDefinition.Validation.JsonAnyArray? @enum = null
        ,             DefsFeature.InvalidDefinition.Validation.TypeEntity? type = null
        ,             Menes.Json.JsonString? title = null
        ,             Menes.Json.JsonString? description = null
        ,             Menes.Json.JsonAny? @default = null
        ,             DefsFeature.InvalidDefinition.MetaData.DeprecatedValue? deprecated = null
        ,             DefsFeature.InvalidDefinition.MetaData.ReadOnlyValue? readOnly = null
        ,             DefsFeature.InvalidDefinition.MetaData.WriteOnlyValue? writeOnly = null
        ,             DefsFeature.InvalidDefinition.MetaData.JsonAnyArray? examples = null
        ,             Menes.Json.JsonString? format = null
        ,             Menes.Json.JsonString? contentMediaType = null
        ,             Menes.Json.JsonString? contentEncoding = null
        ,             DefsFeature.InvalidDefinition.Schema? contentSchema = null
        ,             DefsFeature.InvalidDefinition.Schema.DefinitionsValue? definitions = null
        ,             DefsFeature.InvalidDefinition.Schema.DependenciesValue? dependencies = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonEncodedText, JsonAny>();
                            if (id is DefsFeature.InvalidDefinition.Core.IdValue id__)
            {
                    ...
                    if (schema1 is Menes.Json.JsonUri schema1__)
            {
                builder.Add(Schema1JsonPropertyName, schema1__);
                    ...
                    if (anchor is DefsFeature.InvalidDefinition.Core.AnchorValue anchor__)
            {
                    ...
                    if (recursiveRef is Menes.Json.JsonUriReference recursiveRef__)
            {
                builder.Add(RecursiveRefJsonPropertyName, recursiveRef__);
                    ...
                    if (recursiveAnchor is DefsFeature.InvalidDefinition.Core.RecursiveAnchorValue recursiveAnchor__)
            {
                builder.Add(RecursiveAnchorJsonPropertyName, recursiveAnchor__);
            }
                    if (vocabulary is DefsFeature.InvalidDefinition.Core.VocabularyValue vocabulary__)
            {
                    ...
                    if (comment is Menes.Json.JsonString comment__)
            {
                builder.Add(CommentJsonPropertyName, comment__);
                    ...
                    if (defs is DefsFeature.InvalidDefinition.Core.DefsValue defs__)
            {
                builder.Add(DefsJsonPropertyName, defs__);
            }
                    if (additionalItems is DefsFeature.InvalidDefinition.Schema additionalItems__)
            {
                builder.Add(AdditionalItemsJsonPropertyName, additionalItems__);
            }
                    if (unevaluatedItems is DefsFeature.InvalidDefinition.Schema unevaluatedItems__)
            {
                builder.Add(UnevaluatedItemsJsonPropertyName, unevaluatedItems__);
            }
                    if (items is DefsFeature.InvalidDefinition.Applicator.PropertiesEntity items__)
            {
                builder.Add(ItemsJsonPropertyName, items__);
            }
                    if (contains is DefsFeature.InvalidDefinition.Schema contains__)
            {
                builder.Add(ContainsJsonPropertyName, contains__);
            }
                    if (additionalProperties is DefsFeature.InvalidDefinition.Schema additionalProperties__)
            {
                builder.Add(AdditionalPropertiesJsonPropertyName, additionalProperties__);
            }
                    if (unevaluatedProperties is DefsFeature.InvalidDefinition.Schema unevaluatedProperties__)
            {
                builder.Add(UnevaluatedPropertiesJsonPropertyName, unevaluatedProperties__);
            }
                    if (properties is DefsFeature.InvalidDefinition.Applicator.PropertiesValue properties__)
            {
                builder.Add(PropertiesJsonPropertyName, properties__);
            }
                    if (patternProperties is DefsFeature.InvalidDefinition.Applicator.PatternPropertiesValue patternProperties__)
            {
                builder.Add(PatternPropertiesJsonPropertyName, patternProperties__);
            }
                    if (dependentSchemas is DefsFeature.InvalidDefinition.Applicator.DependentSchemasValue dependentSchemas__)
            {
                builder.Add(DependentSchemasJsonPropertyName, dependentSchemas__);
            }
                    if (propertyNames is DefsFeature.InvalidDefinition.Schema propertyNames__)
            {
                builder.Add(PropertyNamesJsonPropertyName, propertyNames__);
            }
                    if (@if is DefsFeature.InvalidDefinition.Schema @if__)
            {
                builder.Add(IfJsonPropertyName, @if__);
            }
                    if (then is DefsFeature.InvalidDefinition.Schema then__)
            {
                builder.Add(ThenJsonPropertyName, then__);
            }
                    if (@else is DefsFeature.InvalidDefinition.Schema @else__)
            {
                builder.Add(ElseJsonPropertyName, @else__);
            }
                    if (allOf is DefsFeature.InvalidDefinition.Applicator.SchemaArray allOf__)
            {
                builder.Add(AllOfJsonPropertyName, allOf__);
            }
                    if (anyOf is DefsFeature.InvalidDefinition.Applicator.SchemaArray anyOf__)
            {
                builder.Add(AnyOfJsonPropertyName, anyOf__);
            }
                    if (oneOf is DefsFeature.InvalidDefinition.Applicator.SchemaArray oneOf__)
            {
                builder.Add(OneOfJsonPropertyName, oneOf__);
            }
                    if (not is DefsFeature.InvalidDefinition.Schema not__)
            {
                builder.Add(NotJsonPropertyName, not__);
            }
                    if (multipleOf is DefsFeature.InvalidDefinition.Validation.MultipleOfValue multipleOf__)
            {
                    ...
                    if (exclusiveMinimum is Menes.Json.JsonNumber exclusiveMinimum__)
            {
                builder.Add(ExclusiveMinimumJsonPropertyName, exclusiveMinimum__);
                    ...
                    if (maxLength is DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerValue maxLength__)
            {
                builder.Add(MaxLengthJsonPropertyName, maxLength__);
            }
                    if (minLength is DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerDefault0Entity minLength__)
            {
                    ...
                    if (pattern is Menes.Json.JsonRegex pattern__)
            {
                builder.Add(PatternJsonPropertyName, pattern__);
                    ...
                    if (maxItems is DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerValue maxItems__)
            {
                builder.Add(MaxItemsJsonPropertyName, maxItems__);
            }
                    if (minItems is DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerDefault0Entity minItems__)
            {
                builder.Add(MinItemsJsonPropertyName, minItems__);
            }
                    if (uniqueItems is DefsFeature.InvalidDefinition.Validation.UniqueItemsValue uniqueItems__)
            {
                builder.Add(UniqueItemsJsonPropertyName, uniqueItems__);
            }
                    if (maxContains is DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerValue maxContains__)
            {
                builder.Add(MaxContainsJsonPropertyName, maxContains__);
            }
                    if (minContains is DefsFeature.InvalidDefinition.Validation.MinContainsEntity minContains__)
            {
                builder.Add(MinContainsJsonPropertyName, minContains__);
            }
                    if (maxProperties is DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerValue maxProperties__)
            {
                builder.Add(MaxPropertiesJsonPropertyName, maxProperties__);
            }
                    if (minProperties is DefsFeature.InvalidDefinition.Validation.NonNegativeIntegerDefault0Entity minProperties__)
            {
                builder.Add(MinPropertiesJsonPropertyName, minProperties__);
            }
                    if (required is DefsFeature.InvalidDefinition.Validation.JsonStringArray required__)
            {
                builder.Add(RequiredJsonPropertyName, required__);
            }
                    if (dependentRequired is DefsFeature.InvalidDefinition.Validation.DependentRequiredValue dependentRequired__)
            {
                    ...
                    if (@const is Menes.Json.JsonAny @const__)
            {
                builder.Add(ConstJsonPropertyName, @const__);
                    ...
                    if (@enum is DefsFeature.InvalidDefinition.Validation.JsonAnyArray @enum__)
            {
                builder.Add(EnumJsonPropertyName, @enum__);
            }
                    if (type is DefsFeature.InvalidDefinition.Validation.TypeEntity type__)
            {
                    ...
                    if (@default is Menes.Json.JsonAny @default__)
            {
                builder.Add(DefaultJsonPropertyName, @default__);
                    ...
                    if (deprecated is DefsFeature.InvalidDefinition.MetaData.DeprecatedValue deprecated__)
            {
                builder.Add(DeprecatedJsonPropertyName, deprecated__);
            }
                    if (readOnly is DefsFeature.InvalidDefinition.MetaData.ReadOnlyValue readOnly__)
            {
                builder.Add(ReadOnlyJsonPropertyName, readOnly__);
            }
                    if (writeOnly is DefsFeature.InvalidDefinition.MetaData.WriteOnlyValue writeOnly__)
            {
                builder.Add(WriteOnlyJsonPropertyName, writeOnly__);
            }
                    if (examples is DefsFeature.InvalidDefinition.MetaData.JsonAnyArray examples__)
            {
                    ...
                    if (contentEncoding is Menes.Json.JsonString contentEncoding__)
            {
                builder.Add(ContentEncodingJsonPropertyName, contentEncoding__);
                    ...
                    if (contentSchema is DefsFeature.InvalidDefinition.Schema contentSchema__)
            {
                builder.Add(ContentSchemaJsonPropertyName, contentSchema__);
            }
                    if (definitions is DefsFeature.InvalidDefinition.Schema.DefinitionsValue definitions__)
            {
                builder.Add(DefinitionsJsonPropertyName, definitions__);
            }
                    if (dependencies is DefsFeature.InvalidDefinition.Schema.DependenciesValue dependencies__)
            {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithItems(DefsFeature.InvalidDefinition.Applicator.PropertiesEntity value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithEnum(DefsFeature.InvalidDefinition.Validation.JsonAnyArray value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithExamples(DefsFeature.InvalidDefinition.MetaData.JsonAnyArray value)
        {
                    ...
                    IEquatable<DefinitionsValue>
    {
        ...
        /// </summary>
        public JsonObjectEnumerator<DefsFeature.InvalidDefinition.Schema> EnumerateProperties()
        {
            if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
            {
                return new JsonObjectEnumerator<DefsFeature.InvalidDefinition.Schema>(properties);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
            {
                return new JsonObjectEnumerator<DefsFeature.InvalidDefinition.Schema>(this.jsonElementBacking);
            }
                    ...
                    IEquatable<DependenciesValue>
    {
        ...
        /// Enumerate the object as the given item type
        /// </summary>
        public JsonObjectEnumerator<DefsFeature.InvalidDefinition.Schema.DependenciesValue.AdditionalPropertiesEntity> EnumerateProperties()
        {
            if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
            {
                return new JsonObjectEnumerator<DefsFeature.InvalidDefinition.Schema.DependenciesValue.AdditionalPropertiesEntity>(properties);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
            {
                return new JsonObjectEnumerator<DefsFeature.InvalidDefinition.Schema.DependenciesValue.AdditionalPropertiesEntity>(this.jsonElementBacking);
            }
                ...
                IEquatable<AdditionalPropertiesEntity>
    {
        ...
        public int Length
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="DefsFeature.InvalidDefinition.Schema" />.
        /// </summary>
        public DefsFeature.InvalidDefinition.Schema AsSchema
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="DefsFeature.InvalidDefinition.Schema" />.
        /// </summary>
        public bool IsSchema
        {
            get
            {
                return ((DefsFeature.InvalidDefinition.Schema)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="DefsFeature.InvalidDefinition.Validation.JsonStringArray" />.
        /// </summary>
        public DefsFeature.InvalidDefinition.Validation.JsonStringArray AsJsonStringArray
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="DefsFeature.InvalidDefinition.Validation.JsonStringArray" />.
        /// </summary>
        public bool IsJsonStringArray
        {
            get
            {
                return ((DefsFeature.InvalidDefinition.Validation.JsonStringArray)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="DefsFeature.InvalidDefinition.Schema" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        ...
        /// <summary>
        /// Conversion to <see cref="DefsFeature.InvalidDefinition.Schema" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DefsFeature.InvalidDefinition.Schema(AdditionalPropertiesEntity value)
        {
            ...
            /// <summary>
        /// Conversion from <see cref="DefsFeature.InvalidDefinition.Validation.JsonStringArray" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        ...
        /// <summary>
        /// Conversion to <see cref="DefsFeature.InvalidDefinition.Validation.JsonStringArray" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
