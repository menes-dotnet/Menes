...
namespace AllOfFeature.AllOfWithOneEmptySchema
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("allOf.json", "#/6/schema", "#/006/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AllOfFeature.AllOfWithOneEmptySchema.RootEntity>();
        }
        /// <summary>
