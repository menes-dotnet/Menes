...
namespace AllOfFeature.AllOf
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="AllOfFeature.AllOf.Schema.AllOf0Entity"/> from which to construct the value.</param>
        public Schema(AllOfFeature.AllOf.Schema.AllOf0Entity conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="AllOfFeature.AllOf.Schema.AllOf1Entity"/> from which to construct the value.</param>
        public Schema(AllOfFeature.AllOf.Schema.AllOf1Entity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
        /// Gets the value as a <see cref="AllOfFeature.AllOf.Schema.AllOf0Entity" />.
        /// </summary>
        public AllOfFeature.AllOf.Schema.AllOf0Entity AsAllOf0Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="AllOfFeature.AllOf.Schema.AllOf0Entity" />.
        /// </summary>
        public bool IsAllOf0Entity
        {
            get
            {
                return ((AllOfFeature.AllOf.Schema.AllOf0Entity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="AllOfFeature.AllOf.Schema.AllOf1Entity" />.
        /// </summary>
        public AllOfFeature.AllOf.Schema.AllOf1Entity AsAllOf1Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="AllOfFeature.AllOf.Schema.AllOf1Entity" />.
        /// </summary>
        public bool IsAllOf1Entity
        {
            get
            {
                return ((AllOfFeature.AllOf.Schema.AllOf1Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="AllOfFeature.AllOf.Schema.AllOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(AllOfFeature.AllOf.Schema.AllOf0Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="AllOfFeature.AllOf.Schema.AllOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AllOfFeature.AllOf.Schema.AllOf0Entity(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new AllOfFeature.AllOf.Schema.AllOf0Entity(value.AsObject);
            }
                                                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="AllOfFeature.AllOf.Schema.AllOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(AllOfFeature.AllOf.Schema.AllOf1Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="AllOfFeature.AllOf.Schema.AllOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AllOfFeature.AllOf.Schema.AllOf1Entity(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new AllOfFeature.AllOf.Schema.AllOf1Entity(value.AsObject);
            }
                                                    return default;
        }
        ...
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<AllOfFeature.AllOf.Schema.AllOf0Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult1 = this.As<AllOfFeature.AllOf.Schema.AllOf1Entity>().Validate(validationContext.CreateChildContext(), level);
