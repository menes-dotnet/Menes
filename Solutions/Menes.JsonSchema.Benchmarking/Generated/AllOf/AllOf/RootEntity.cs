...
namespace AllOfFeature.AllOf
{
    public readonly struct RootEntity : Menes.IJsonObject<RootEntity>
    {
        ...
        public RootEntity(Menes.JsonInteger bar, Menes.JsonString foo)
        {
        ...
        private RootEntity(Menes.JsonInteger? bar, Menes.JsonString? foo, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
        {
            this._menesJsonElementBacking = default;
            this.bar = bar;
            this.foo = foo;
        ...
        public readonly struct AllOf0Entity : Menes.IJsonObject<AllOf0Entity>
        {
            ...
            public AllOf0Entity(Menes.JsonInteger bar)
            {
                this._menesJsonElementBacking = default;
                this.bar = bar;
                this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
            }
            private AllOf0Entity(Menes.JsonInteger? bar, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
            {
                this._menesJsonElementBacking = default;
                this.bar = bar;
                this._menesAdditionalPropertiesBacking = _menesAdditionalPropertiesBacking;
            ...
            public AllOf0Entity WithBar(Menes.JsonInteger value)
            {
            ...
            private bool TryGetPropertyAtIndex(int index, out Menes.Property<AllOf0Entity> result)
            {
                ...
                if (currentIndex == index)
                {
                    result = new Menes.Property<AllOf0Entity>(this, _MenesBarJsonPropertyName);
                    return true;
                }
                currentIndex++;
                foreach (var property in this._menesAdditionalPropertiesBacking)
            ...
            {
                return new AllOf0Entity(this.bar, value);
            }
            /// <summary>
        ...
        public readonly struct AllOf1Entity : Menes.IJsonObject<AllOf1Entity>
        {
            ...
            public AllOf1Entity(Menes.JsonString foo)
            {
                this._menesJsonElementBacking = default;
                this.foo = foo;
                this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
            }
            private AllOf1Entity(Menes.JsonString? foo, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
            {
                this._menesJsonElementBacking = default;
                this.foo = foo;
                this._menesAdditionalPropertiesBacking = _menesAdditionalPropertiesBacking;
            ...
            public AllOf1Entity WithFoo(Menes.JsonString value)
            {
            ...
            private bool TryGetPropertyAtIndex(int index, out Menes.Property<AllOf1Entity> result)
            {
                ...
                if (currentIndex == index)
                {
                    result = new Menes.Property<AllOf1Entity>(this, _MenesFooJsonPropertyName);
                    return true;
                }
                currentIndex++;
                foreach (var property in this._menesAdditionalPropertiesBacking)
            ...
            {
                return new AllOf1Entity(this.foo, value);
            }
            /// <summary>
