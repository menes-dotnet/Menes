...
namespace TypeFeature.ArrayTypeMatchesArrays
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("type.json", "#/4/schema", "#/004/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<TypeFeature.ArrayTypeMatchesArrays.RootEntity>();
        }
        /// <summary>
