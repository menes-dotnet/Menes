...
namespace TypeFeature.ObjectTypeMatchesObjects
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("type.json", "#/3/schema", "#/003/tests/005/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<TypeFeature.ObjectTypeMatchesObjects.RootEntity>();
        }
        /// <summary>
