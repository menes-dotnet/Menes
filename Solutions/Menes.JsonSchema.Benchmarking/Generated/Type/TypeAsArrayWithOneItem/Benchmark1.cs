...
namespace TypeFeature.TypeAsArrayWithOneItem
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("type.json", "#/8/schema", "#/008/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<TypeFeature.TypeAsArrayWithOneItem.Schema>();
        }
        /// <summary>
