...
namespace TypeFeature.TypeArrayObjectOrNull
{
...
if (!this.IsArray && !this.IsObject && !this.IsNull)
{
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.1.1.  type - item must be one of array,object,null");
}
else
{
