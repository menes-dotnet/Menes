...
namespace MaximumFeature.MaximumValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("maximum.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MaximumFeature.MaximumValidation.RootEntity>();
        }
        /// <summary>
