...
namespace DependentRequiredFeature.SingleDependency
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("dependentRequired.json", "#/0/schema", "#/000/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DependentRequiredFeature.SingleDependency.RootEntity>();
        }
        /// <summary>
