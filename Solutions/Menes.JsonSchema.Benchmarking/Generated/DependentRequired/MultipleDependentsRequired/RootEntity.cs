...
namespace DependentRequiredFeature.MultipleDependentsRequired
{
...
{
    result = result.WithResult(isValid: false, message: "6.5.4.  dependentRequired - because you have property quux you must have property foo.");
}
else
{
...
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.5.4.  dependentRequired - because you have property quux you must have property bar.");
}
else
{
    result = result.WithResult(isValid: false);
