...
namespace DependentSchemasFeature.SingleDependency
{
    public readonly struct RootEntity : Menes.IJsonObject<RootEntity>
    {
            ...
            if (this.IsObject)
            {
                foreach (var property in this.EnumerateObject())
                {
                    if (property.NameEquals("bar"))
                    {
                        ...
                        result = this.As<RootEntity.BarEntity>().Validate(result, level);
                    }
                }
            }
            return result;
        ...
        public readonly struct BarEntity : Menes.IJsonObject<BarEntity>
        {
            ...
            public BarEntity(Menes.JsonInteger? foo = null, Menes.JsonInteger? bar = null)
            {
                this._menesJsonElementBacking = default;
                this.foo = foo;
                this.bar = bar;
            ...
            private BarEntity(Menes.JsonInteger? foo, Menes.JsonInteger? bar, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
            {
                this._menesJsonElementBacking = default;
                this.foo = foo;
                this.bar = bar;
            ...
            public Menes.JsonInteger? Bar => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<Menes.JsonInteger>(_MenesBarUtf8JsonPropertyName.Span) : this.bar;
            public int PropertyCount
            {
                get
                {
            ...
            public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
            {
                ...
                if (this.IsObject)
                {
                    ...
                    if (this.TryGetProperty<Menes.JsonInteger>(_MenesBarJsonPropertyName.Span, out Menes.JsonInteger value1))
                    {
            ...
            public BarEntity WithFoo(Menes.JsonInteger value)
            {
                return new BarEntity(value, this.bar, this._menesAdditionalPropertiesBacking);
            }
            public BarEntity WithBar(Menes.JsonInteger value)
            {
                return new BarEntity(this.foo, value, this._menesAdditionalPropertiesBacking);
            }
            private TPropertyValue GetPropertyFromJsonElement<TPropertyValue>(System.ReadOnlySpan<byte> propertyName)
                where TPropertyValue : struct, Menes.IJsonValue
            {
            ...
            private bool TryGetPropertyAtIndex(int index, out Menes.Property<BarEntity> result)
            {
                ...
                if (currentIndex == index)
                {
                    result = new Menes.Property<BarEntity>(this, _MenesFooJsonPropertyName);
                    return true;
                }
                currentIndex++;
                if (currentIndex == index)
            ...
            {
                return new BarEntity(this.foo, this.bar, value);
            }
            /// <summary>
