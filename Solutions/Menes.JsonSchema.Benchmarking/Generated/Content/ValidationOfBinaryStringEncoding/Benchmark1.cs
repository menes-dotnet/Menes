...
namespace ContentFeature.ValidationOfBinaryStringEncoding
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("content.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ContentFeature.ValidationOfBinaryStringEncoding.Schema>();
        }
        /// <summary>
