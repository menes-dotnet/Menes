...
namespace UnevaluatedPropertiesFeature.UnevaluatedPropertiesWithNestedProperties
{
...
public AllOf0Entity(Menes.JsonString? bar = null)
{
    this._menesJsonElementBacking = default;
this.bar = bar;
this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
}
private AllOf0Entity(Menes.JsonString? bar, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
{
    this._menesJsonElementBacking = default;
this.bar = bar;
this._menesAdditionalPropertiesBacking = _menesAdditionalPropertiesBacking;
...
public AllOf0Entity WithBar(Menes.JsonString value)
{
