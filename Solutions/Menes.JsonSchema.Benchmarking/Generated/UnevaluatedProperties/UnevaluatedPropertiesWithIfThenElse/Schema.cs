...
namespace UnevaluatedPropertiesFeature.UnevaluatedPropertiesWithIfThenElse
{
                    ...
                    IEquatable<IfEntity>
    {
        ...
        public UnevaluatedPropertiesFeature.UnevaluatedPropertiesWithIfThenElse.Schema.IfEntity.FooEntity Foo
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  UnevaluatedPropertiesFeature.UnevaluatedPropertiesWithIfThenElse.Schema.IfEntity.FooEntity(result);
                    }
                }
        ...
        public static IfEntity Create(
                   UnevaluatedPropertiesFeature.UnevaluatedPropertiesWithIfThenElse.Schema.IfEntity.FooEntity foo
