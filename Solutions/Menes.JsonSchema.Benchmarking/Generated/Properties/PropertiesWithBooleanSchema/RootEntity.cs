...
namespace PropertiesFeature.PropertiesWithBooleanSchema
{
...
public RootEntity(Menes.JsonAny? foo = null, Menes.JsonNotAny? bar = null)
{
...
private RootEntity(Menes.JsonAny? foo, Menes.JsonNotAny? bar, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
{
    this._menesJsonElementBacking = default;
this.foo = foo;
this.bar = bar;
...
public Menes.JsonNotAny? Bar => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<Menes.JsonNotAny>(_MenesBarUtf8JsonPropertyName.Span) : this.bar;
...
if (level == Menes.ValidationLevel.Verbose)
{
    ...
    if (this.TryGetProperty<Menes.JsonNotAny>(_MenesBarJsonPropertyName.Span, out Menes.JsonNotAny value1))
    {
...
if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesBarJsonPropertyName.Span))
{
    return this.WithBar(value.As<Menes.JsonNotAny>());
}
...
public RootEntity WithBar(Menes.JsonNotAny value)
{
