...
namespace AdditionalPropertiesFeature.NonASIIPatternWithAdditionalProperties
{
    public readonly struct RootEntity : Menes.IJsonObject<RootEntity>
    {
        ...
        private static readonly System.Text.RegularExpressions.Regex _MenesPatternExpression0 = new System.Text.RegularExpressions.Regex("^á", System.Text.RegularExpressions.RegexOptions.Compiled);
        ...
        public readonly struct ÁEntity : Menes.IJsonValue
        {
            public static readonly ÁEntity Null = default(ÁEntity);
            private readonly System.Text.Json.JsonElement _menesJsonElementBacking;
            public ÁEntity(System.Text.Json.JsonElement jsonElement)
            {
                this._menesJsonElementBacking = jsonElement;
            }
            /// <inheritdoc />
            ...
            public T As<T>()
                where T : struct, Menes.IJsonValue
            {
                if (typeof(T) == typeof(ÁEntity))
                {
                    return Corvus.Extensions.CastTo<T>.From(this);
                }
                return Menes.JsonValue.As<ÁEntity, T>(this);
            }
            /// <inheritdoc />
            public bool Is<T>()
                where T : struct, Menes.IJsonValue
            {
                if (typeof(T) == typeof(RootEntity.ÁEntity))
                {
                    return this.Validate(Menes.ValidationContext.ValidContext).IsValid;
                }
                return this.As<T>().Validate(Menes.ValidationContext.ValidContext).IsValid;
