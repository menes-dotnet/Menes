...
namespace AdditionalPropertiesFeature.AdditionalPropertiesShouldNotLookInApplicators
{
    public readonly struct RootEntity : Menes.IJsonObject<RootEntity>
    {
        ...
        public RootEntity(Menes.JsonAny? foo = null)
        {
            this._menesJsonElementBacking = default;
            this.foo = foo;
            this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonBoolean>>.Empty;
        }
        private RootEntity(Menes.JsonAny? foo, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonBoolean>> _menesAdditionalPropertiesBacking)
        {
            this._menesJsonElementBacking = default;
            this.foo = foo;
        ...
        private RootEntity WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonBoolean>> value)
        {
        ...
        public readonly struct AllOf0Entity : Menes.IJsonObject<AllOf0Entity>
        {
            ...
            public AllOf0Entity(Menes.JsonAny? foo = null)
            {
                this._menesJsonElementBacking = default;
                this.foo = foo;
                this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
            }
            private AllOf0Entity(Menes.JsonAny? foo, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
            {
                this._menesJsonElementBacking = default;
                this.foo = foo;
                this._menesAdditionalPropertiesBacking = _menesAdditionalPropertiesBacking;
            ...
            public AllOf0Entity WithFoo(Menes.JsonAny value)
            {
            ...
            public readonly struct FooEntity : Menes.IJsonValue
            {
                ...
                public bool Is<T>()
                    where T : struct, Menes.IJsonValue
                {
                    if (typeof(T) == typeof(RootEntity.AllOf0Entity.FooEntity))
                    {
                        return this.Validate(Menes.ValidationContext.ValidContext).IsValid;
                    }
                    return this.As<T>().Validate(Menes.ValidationContext.ValidContext).IsValid;
