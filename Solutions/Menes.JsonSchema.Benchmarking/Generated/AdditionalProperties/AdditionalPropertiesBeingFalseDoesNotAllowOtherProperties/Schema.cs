...
namespace AdditionalPropertiesFeature.AdditionalPropertiesBeingFalseDoesNotAllowOtherProperties
{
                    ...
                    IEquatable<Schema>
    {
                ...
                /// <summary>
        /// A pattern property matching ^v producing a <see cref="Menes.Json.JsonAny" />.
        /// </summary>
        public static Regex PatternPropertyJsonAny = new Regex("^v", RegexOptions.Compiled);
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithBar(Menes.Json.JsonAny value)
        {
