...
namespace PatternPropertiesFeature.MultipleSimultaneousPatternPropertiesAreValidated
{
    public readonly struct RootEntity : Menes.IJsonObject<RootEntity>
    {
        ...
        private static readonly System.Text.RegularExpressions.Regex _MenesPatternExpression0 = new System.Text.RegularExpressions.Regex("a*", System.Text.RegularExpressions.RegexOptions.Compiled);
        private static readonly System.Text.RegularExpressions.Regex _MenesPatternExpression1 = new System.Text.RegularExpressions.Regex("aaa*", System.Text.RegularExpressions.RegexOptions.Compiled);
        ...
        public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
        {
            ...
            if (this.IsObject)
            {
                foreach (var property in this.EnumerateObject())
                {
                    ...
                    {
                        result = result.WithLocalProperty(property.Name);
                        result = property.Value<RootEntity.AaaEntity>().Validate(result, level);
                        if (level == Menes.ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
        ...
        public readonly struct AaaEntity : Menes.IJsonValue
        {
            public static readonly AaaEntity Null = default(AaaEntity);
            private readonly System.Text.Json.JsonElement _menesJsonElementBacking;
            public AaaEntity(System.Text.Json.JsonElement jsonElement)
            {
                this._menesJsonElementBacking = jsonElement;
            }
            /// <inheritdoc />
            ...
            public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
            {
                ...
                if (this.IsNumber)
                {
                    ...
                    if (number > (double)20)
                    {
                        ...
                        {
                            result = result.WithResult(isValid: false, message: "6.2.2.  maximum - item must be less than or equal to 20");
                        }
                        else
                        {
            ...
            public T As<T>()
                where T : struct, Menes.IJsonValue
            {
                if (typeof(T) == typeof(AaaEntity))
                {
                    return Corvus.Extensions.CastTo<T>.From(this);
                }
                return Menes.JsonValue.As<AaaEntity, T>(this);
            }
            /// <inheritdoc />
            public bool Is<T>()
                where T : struct, Menes.IJsonValue
            {
                if (typeof(T) == typeof(RootEntity.AaaEntity))
                {
                    return this.Validate(Menes.ValidationContext.ValidContext).IsValid;
                }
                return this.As<T>().Validate(Menes.ValidationContext.ValidContext).IsValid;
