...
namespace PatternPropertiesFeature.MultipleSimultaneousPatternPropertiesAreValidated
{
                    ...
                    IEquatable<Schema>
    {
        ...
        public static Regex PatternPropertyJsonInteger = new Regex("a*", RegexOptions.Compiled);
                ...
                /// <summary>
        /// A pattern property matching aaa* producing a <see cref="PatternPropertiesFeature.MultipleSimultaneousPatternPropertiesAreValidated.Schema.AaaEntity" />.
        /// </summary>
            ...
            private static ImmutableDictionary<Regex, Func<Property, ValidationContext, ValidationLevel, ValidationContext>> CreatePatternPropertiesValidators()
        {
            ImmutableDictionary<Regex, Func<Property, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                (property, validationContext, level) =>
                {
                    return property.ValueAs<PatternPropertiesFeature.MultipleSimultaneousPatternPropertiesAreValidated.Schema.AaaEntity>().Validate(validationContext, level);
                });
