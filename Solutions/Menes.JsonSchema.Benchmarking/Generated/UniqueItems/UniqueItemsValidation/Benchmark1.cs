...
namespace UniqueItemsFeature.UniqueItemsValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("uniqueItems.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UniqueItemsFeature.UniqueItemsValidation.RootEntity>();
        }
        /// <summary>
