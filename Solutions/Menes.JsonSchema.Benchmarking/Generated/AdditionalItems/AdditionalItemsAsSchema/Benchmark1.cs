...
namespace AdditionalItemsFeature.AdditionalItemsAsSchema
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("additionalItems.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AdditionalItemsFeature.AdditionalItemsAsSchema.RootEntity>();
        }
        /// <summary>
