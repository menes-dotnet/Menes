...
namespace EmailFeature.ValidationOfEMailAddresses
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("email.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EmailFeature.ValidationOfEMailAddresses.RootEntity>();
        }
        /// <summary>
