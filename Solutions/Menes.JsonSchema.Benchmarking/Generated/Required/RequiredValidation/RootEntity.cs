...
namespace RequiredFeature.RequiredValidation
{
    public readonly struct RootEntity : Menes.IJsonObject<RootEntity>
    {
        ...
        public RootEntity(Menes.JsonAny foo, Menes.JsonAny? bar = null)
        {
        ...
        private RootEntity(Menes.JsonAny? foo, Menes.JsonAny? bar, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
        {
            this._menesJsonElementBacking = default;
            this.foo = foo;
            this.bar = bar;
