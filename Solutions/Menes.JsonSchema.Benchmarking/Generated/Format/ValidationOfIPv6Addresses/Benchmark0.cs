...
namespace FormatFeature.ValidationOfIPv6Addresses
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("format.json", "#/4/schema", "#/004/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatFeature.ValidationOfIPv6Addresses.RootEntity>();
        }
        /// <summary>
