...
namespace FormatFeature.ValidationOfIDEMailAddresses
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("format.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatFeature.ValidationOfIDEMailAddresses.RootEntity>();
        }
        /// <summary>
