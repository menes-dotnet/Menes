...
namespace FormatFeature.ValidationOfURTemplates
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("format.json", "#/16/schema", "#/016/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatFeature.ValidationOfURTemplates.RootEntity>();
        }
        /// <summary>
