...
namespace FormatFeature.ValidationOfTimeStrings
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("format.json", "#/9/schema", "#/009/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatFeature.ValidationOfTimeStrings.RootEntity>();
        }
        /// <summary>
