...
namespace FormatFeature.ValidationOfRelativeJSNPointers
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("format.json", "#/11/schema", "#/011/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatFeature.ValidationOfRelativeJSNPointers.RootEntity>();
        }
        /// <summary>
