...
namespace FormatFeature.ValidationOfDateTimeStrings
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("format.json", "#/8/schema", "#/008/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatFeature.ValidationOfDateTimeStrings.RootEntity>();
        }
        /// <summary>
