...
namespace FormatFeature.ValidationOfIPAddresses
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("format.json", "#/3/schema", "#/003/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatFeature.ValidationOfIPAddresses.RootEntity>();
        }
        /// <summary>
