...
namespace FormatFeature.ValidationOfUUDs
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("format.json", "#/17/schema", "#/017/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatFeature.ValidationOfUUDs.RootEntity>();
        }
        /// <summary>
