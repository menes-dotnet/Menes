...
namespace FormatFeature.ValidationOfIRs
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("format.json", "#/12/schema", "#/012/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatFeature.ValidationOfIRs.RootEntity>();
        }
        /// <summary>
