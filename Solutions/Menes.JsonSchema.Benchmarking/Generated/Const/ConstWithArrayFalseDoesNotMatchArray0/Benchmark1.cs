...
namespace ConstFeature.ConstWithArrayFalseDoesNotMatchArray0
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("const.json", "#/6/schema", "#/006/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstFeature.ConstWithArrayFalseDoesNotMatchArray0.RootEntity>();
        }
        /// <summary>
