...
namespace ConstFeature.ConstWith1DoesNotMatchTrue
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("const.json", "#/11/schema", "#/011/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstFeature.ConstWith1DoesNotMatchTrue.RootEntity>();
        }
        /// <summary>
