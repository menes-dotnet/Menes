...
namespace ConstFeature.ConstWithArrayTrueDoesNotMatchArray1
{
...
private static readonly Menes.JsonAny _MenesConstValue = new Menes.JsonAny("[true]");
...
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.1.3. const - does not match const value [true]");
}
else
{
    result = result.WithResult(isValid: false);
