...
namespace ConstFeature.ConstWithFalseDoesNotMatch0
{
...
private static readonly Menes.JsonBoolean _MenesConstValue = new Menes.JsonBoolean(false);
...
{
    if ((bool)this != (bool)_MenesConstValue)
    {
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.1.3. const - does not match const value false");
