...
namespace PatternFeature.PatternIsNotAnchored
{
...
private static readonly System.Text.RegularExpressions.Regex _MenesPatternExpression = new System.Text.RegularExpressions.Regex("a+", System.Text.RegularExpressions.RegexOptions.Compiled);
...
{
    result = result.WithResult(isValid: false, message: "6.3.3.  pattern - value must match the regular expression a+");
}
else
{
