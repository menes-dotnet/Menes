...
namespace OneOfFeature.OneOfWithBaseSchema
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity"/> from which to construct the value.</param>
        public Schema(OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity"/> from which to construct the value.</param>
        public Schema(OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
        /// Gets the value as a <see cref="OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity" />.
        /// </summary>
        public OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity AsOneOf0Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity" />.
        /// </summary>
        public bool IsOneOf0Entity
        {
            get
            {
                return ((OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity" />.
        /// </summary>
        public OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity AsOneOf1Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity" />.
        /// </summary>
        public bool IsOneOf1Entity
        {
            get
            {
                return ((OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity(Schema value)
        {
                                    if (value.ValueKind == JsonValueKind.String)
            {
                return new OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity(value.AsString);
            }
                                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity(Schema value)
        {
                                    if (value.ValueKind == JsonValueKind.String)
            {
                return new OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity(value.AsString);
            }
                                    return default;
        }
        ...
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<OneOfFeature.OneOfWithBaseSchema.Schema.OneOf0Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<OneOfFeature.OneOfWithBaseSchema.Schema.OneOf1Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            IEquatable<OneOf0Entity>
    {
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public OneOf0Entity(JsonEncodedText value)
        {
            this.jsonElementBacking = default;
                                            this.stringBacking = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOf0Entity(JsonEncodedText value)
        {
            return new OneOf0Entity(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(OneOf0Entity value)
        {
            return value.AsString.GetJsonEncodedText();
        }
            ...
            IEquatable<OneOf1Entity>
    {
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public OneOf1Entity(JsonEncodedText value)
        {
            this.jsonElementBacking = default;
                                            this.stringBacking = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOf1Entity(JsonEncodedText value)
        {
            return new OneOf1Entity(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(OneOf1Entity value)
        {
            return value.AsString.GetJsonEncodedText();
        }
