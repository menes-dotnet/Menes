...
namespace OneOfFeature.NestedOneOfToCheckValidationSemantics
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="OneOfFeature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity"/> from which to construct the value.</param>
        public Schema(OneOfFeature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="OneOfFeature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity" />.
        /// </summary>
        public OneOfFeature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity AsOneOf0Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="OneOfFeature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity" />.
        /// </summary>
        public bool IsOneOf0Entity
        {
            get
            {
                return ((OneOfFeature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="OneOfFeature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(OneOfFeature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="OneOfFeature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOfFeature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity(Schema value)
        {
                                                    return default;
        }
        ...
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<OneOfFeature.NestedOneOfToCheckValidationSemantics.Schema.OneOf0Entity>().Validate(validationContext.CreateChildContext(), level);
