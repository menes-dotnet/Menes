...
public OneOf0Entity(Menes.JsonAny bar, Menes.JsonAny? baz = null)
{
...
private OneOf0Entity(Menes.JsonAny? bar, Menes.JsonAny? baz, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
{
    this._menesJsonElementBacking = default;
this.bar = bar;
this.baz = baz;
...
public Menes.JsonAny? Baz => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<Menes.JsonAny>(_MenesBazUtf8JsonPropertyName.Span) : this.baz;
...
if (this.IsObject)
{
    ...
    if (this.TryGetProperty<Menes.JsonAny>(_MenesBarJsonPropertyName.Span, out Menes.JsonAny value0))
    {
...
{
    return new OneOf0Entity(value, this.baz, this._menesAdditionalPropertiesBacking);
}
public OneOf0Entity WithBaz(Menes.JsonAny value)
{
    return new OneOf0Entity(this.bar, value, this._menesAdditionalPropertiesBacking);
}
...
int currentIndex = 0;
    ...
    if (currentIndex == index)
    {
        result = new Menes.Property<OneOf0Entity>(this, _MenesBazJsonPropertyName);
      return true;
    }
    currentIndex++;
foreach (var property in this._menesAdditionalPropertiesBacking)
...
{
    return new OneOf0Entity(this.bar, this.baz, value);
}
/// <summary>
...
public OneOf1Entity(Menes.JsonAny foo)
{
    this._menesJsonElementBacking = default;
this.foo = foo;
this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
}
private OneOf1Entity(Menes.JsonAny? foo, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
{
    this._menesJsonElementBacking = default;
this.foo = foo;
this._menesAdditionalPropertiesBacking = _menesAdditionalPropertiesBacking;
