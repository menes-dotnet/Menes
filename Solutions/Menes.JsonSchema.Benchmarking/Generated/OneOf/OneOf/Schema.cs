...
namespace OneOfFeature.OneOf
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="OneOfFeature.OneOf.Schema.OneOf1Entity"/> from which to construct the value.</param>
        public Schema(OneOfFeature.OneOf.Schema.OneOf1Entity conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="OneOfFeature.OneOf.Schema.OneOf1Entity" />.
        /// </summary>
        public OneOfFeature.OneOf.Schema.OneOf1Entity AsOneOf1Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="OneOfFeature.OneOf.Schema.OneOf1Entity" />.
        /// </summary>
        public bool IsOneOf1Entity
        {
            get
            {
                return ((OneOfFeature.OneOf.Schema.OneOf1Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="OneOfFeature.OneOf.Schema.OneOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(OneOfFeature.OneOf.Schema.OneOf1Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="OneOfFeature.OneOf.Schema.OneOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOfFeature.OneOf.Schema.OneOf1Entity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new OneOfFeature.OneOf.Schema.OneOf1Entity(value.AsNumber);
            }
                    return default;
        }
        ...
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult1 = this.As<OneOfFeature.OneOf.Schema.OneOf1Entity>().Validate(validationContext.CreateChildContext(), level);
