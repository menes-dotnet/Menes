// <copyright file="ScopeChangeDefs2.cs" company="Endjin Limited">
// Copyright (c) Endjin Limited. All rights reserved.
// </copyright>
#pragma warning disable
namespace RefRemoteFeature.BaseURChangeChangeFolderInSubschema
{
public readonly struct ScopeChangeDefs2 : Menes.IJsonObject<ScopeChangeDefs2>
{
public static readonly ScopeChangeDefs2 Null = default(ScopeChangeDefs2);
...
public ScopeChangeDefs2(Bar? list = null)
{
    this._menesJsonElementBacking = default;
this.list = list;
this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
}
private ScopeChangeDefs2(Bar? list, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
{
    this._menesJsonElementBacking = default;
this.list = list;
...
public Bar? List => this.HasJsonElement ? this.GetOptionalPropertyFromJsonElement<Bar>(_MenesListUtf8JsonPropertyName.Span) : this.list;
...
if (this.IsObject)
{
    ...
    if (this.TryGetProperty<Bar>(_MenesListJsonPropertyName.Span, out Bar value0))
    {
...
{
if (typeof(T) == typeof(ScopeChangeDefs2))
{
    return Corvus.Extensions.CastTo<T>.From(this);
}
    return Menes.JsonValue.As<ScopeChangeDefs2, T>(this);
}
/// <inheritdoc />
public bool Is<T>()
    where T : struct, Menes.IJsonValue
...
{
    var rc = this.TryGetPropertyAtIndex(index, out Menes.Property<ScopeChangeDefs2> prop);
    result = prop;
    return rc;
}
public ScopeChangeDefs2 RemoveProperty(string propertyName)
{
    return this.SetProperty(propertyName, Menes.JsonNull.Instance);
}
public ScopeChangeDefs2 RemoveProperty(System.ReadOnlySpan<char> propertyName)
{
    return this.SetProperty(propertyName, Menes.JsonNull.Instance);
}
public ScopeChangeDefs2 RemoveProperty(System.ReadOnlySpan<byte> propertyName)
{
    return this.SetProperty(propertyName, Menes.JsonNull.Instance);
}
public ScopeChangeDefs2 SetProperty<T>(string name, T value)
where T : struct, Menes.IJsonValue
{
    var propertyName = System.MemoryExtensions.AsSpan(name);
if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesListJsonPropertyName.Span))
{
    return this.WithList(value.As<Bar>());
}
...
public ScopeChangeDefs2 SetProperty<T>(System.ReadOnlySpan<char> propertyName, T value)
where T : struct, Menes.IJsonValue
{
if (System.MemoryExtensions.SequenceEqual(propertyName, _MenesListJsonPropertyName.Span))
{
...
public ScopeChangeDefs2 SetProperty<T>(System.ReadOnlySpan<byte> utf8Name, T value)
where T : struct, Menes.IJsonValue
{
...
public ScopeChangeDefs2.MenesPropertyEnumerator GetEnumerator()
{
...
System.Collections.Generic.IEnumerator<Menes.Property<ScopeChangeDefs2>> System.Collections.Generic.IEnumerable<Menes.Property<ScopeChangeDefs2>>.GetEnumerator()
{
    return this.GetEnumerator();
}
public ScopeChangeDefs2 WithList(Bar value)
{
    return new ScopeChangeDefs2(value, this._menesAdditionalPropertiesBacking);
}
...
/// <inheritdoc />
private bool TryGetPropertyAtIndex(int index, out Menes.Property<ScopeChangeDefs2> result)
{
if (this.HasJsonElement)
{
    int jsonPropertyIndex = 0;
    foreach (var property in this.JsonElement.EnumerateObject())
    {
        ...
        {
            result = new Menes.Property<ScopeChangeDefs2>(property);
            return true;
        }
        jsonPropertyIndex++;
    }
...
int currentIndex = 0;
    ...
    {
        result = new Menes.Property<ScopeChangeDefs2>(this, _MenesListJsonPropertyName);
      return true;
    }
    currentIndex++;
foreach (var property in this._menesAdditionalPropertiesBacking)
{
    if (currentIndex == index)
    {
        result = new Menes.Property<ScopeChangeDefs2>(this, property.NameAsMemory);
        return true;
    }
    currentIndex++;
}
...
private ScopeChangeDefs2 WithAdditionalProperties(System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> value)
{
    return new ScopeChangeDefs2(this.list, value);
}
public readonly struct BaseUriChangeFolderInSubschemaEntity : Menes.IJsonValue
{
public static readonly BaseUriChangeFolderInSubschemaEntity Null = default(BaseUriChangeFolderInSubschemaEntity);
private readonly System.Text.Json.JsonElement _menesJsonElementBacking;
public BaseUriChangeFolderInSubschemaEntity(System.Text.Json.JsonElement jsonElement)
{
    this._menesJsonElementBacking = jsonElement;
}
/// <inheritdoc />
...
public T As<T>()
    where T : struct, Menes.IJsonValue
{
if (typeof(T) == typeof(BaseUriChangeFolderInSubschemaEntity))
{
    return Corvus.Extensions.CastTo<T>.From(this);
}
    return Menes.JsonValue.As<BaseUriChangeFolderInSubschemaEntity, T>(this);
}
/// <inheritdoc />
public bool Is<T>()
    where T : struct, Menes.IJsonValue
{
if (typeof(T) == typeof(ScopeChangeDefs2.BaseUriChangeFolderInSubschemaEntity))
{
    return this.Validate(Menes.ValidationContext.ValidContext).IsValid;
}
    return this.As<T>().Validate(Menes.ValidationContext.ValidContext).IsValid;
...
/// <summary>
/// An enumerator for the properties in a <see cref="ScopeChangeDefs2"/>.
/// </summary>
public struct MenesPropertyEnumerator : System.Collections.Generic.IEnumerable<Menes.Property<ScopeChangeDefs2>>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.Property<ScopeChangeDefs2>>, System.Collections.IEnumerator
{
    private ScopeChangeDefs2 instance;
    private System.Text.Json.JsonElement.ObjectEnumerator jsonEnumerator;
    private bool hasJsonEnumerator;
    private int index;
    private int propertyCount;
    internal MenesPropertyEnumerator(ScopeChangeDefs2 instance)
    {
    ...
    /// <inheritdoc/>
    public Menes.Property<ScopeChangeDefs2> Current
    {
        get
        {
            if (this.hasJsonEnumerator)
            {
                return new Menes.Property<ScopeChangeDefs2>(this.jsonEnumerator.Current);
            }
            else if (this.index >= 0)
            {
                if (this.instance.TryGetPropertyAtIndex(this.index, out Menes.Property<ScopeChangeDefs2> result))
                {
                    return result;
                }
            ...
            return new Menes.Property<ScopeChangeDefs2>(this.instance, default);
        }
    }
    /// <inheritdoc/>
    ...
    /// </summary>
    /// <returns>An enumerator for the properties in a <see cref="ScopeChangeDefs2"/>.</returns>
