...
namespace RefRemoteFeature.BaseURChange
{
    public readonly struct RootEntity : Menes.IJsonValue, Menes.IJsonArray<RootEntity, RootEntity.BaseUriChangeEntity>
    {
        public static readonly RootEntity Null = default(RootEntity);
        private readonly System.Text.Json.JsonElement _menesJsonElementBacking;
        private readonly System.Collections.Immutable.ImmutableArray<RootEntity.BaseUriChangeEntity>? _menesArrayValueBacking;
        public RootEntity(System.Text.Json.JsonElement jsonElement)
        {
            this._menesJsonElementBacking = jsonElement;
            this._menesArrayValueBacking = default;
        }
        public RootEntity(System.Collections.Immutable.ImmutableArray<RootEntity.BaseUriChangeEntity> value)
        {
            this._menesArrayValueBacking = value;
            this._menesJsonElementBacking = default;
        }
        public static implicit operator RootEntity(System.Collections.Immutable.ImmutableArray<RootEntity.BaseUriChangeEntity> items)
        {
        ...
        public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
        {
            ...
            if (this.IsArray)
            {
                ...
                {
                    result = arrayEnumerator.Current.As<RootEntity.BaseUriChangeEntity>().Validate(result, level);
        ...
        System.Collections.Generic.IEnumerator<RootEntity.BaseUriChangeEntity> System.Collections.Generic.IEnumerable<RootEntity.BaseUriChangeEntity>.GetEnumerator()
        {
            return this.GetEnumerator();
        }
        /// <inheritdoc />
        ...
        {
            var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<RootEntity.BaseUriChangeEntity>();
            foreach (var oldItem in this._menesArrayValueBacking)
            {
                arrayBuilder.Add(oldItem);
            }
            arrayBuilder.Add(item1.As<RootEntity.BaseUriChangeEntity>());
            ...
            where T2 : struct, Menes.IJsonValue
        {
            ...
            arrayBuilder.Add(item1.As<RootEntity.BaseUriChangeEntity>());
            arrayBuilder.Add(item2.As<RootEntity.BaseUriChangeEntity>());
            return new RootEntity(arrayBuilder.ToImmutable());
        }
            ...
            where T3 : struct, Menes.IJsonValue
        {
            ...
            arrayBuilder.Add(item1.As<RootEntity.BaseUriChangeEntity>());
            arrayBuilder.Add(item2.As<RootEntity.BaseUriChangeEntity>());
            arrayBuilder.Add(item3.As<RootEntity.BaseUriChangeEntity>());
            return new RootEntity(arrayBuilder.ToImmutable());
        }
            ...
            where T4 : struct, Menes.IJsonValue
        {
            ...
            arrayBuilder.Add(item2.As<RootEntity.BaseUriChangeEntity>());
            arrayBuilder.Add(item3.As<RootEntity.BaseUriChangeEntity>());
            arrayBuilder.Add(item4.As<RootEntity.BaseUriChangeEntity>());
            return new RootEntity(arrayBuilder.ToImmutable());
        }
        ...
        public RootEntity RemoveIf(System.Predicate<RootEntity.BaseUriChangeEntity> condition)
        {
            return this.RemoveIf<RootEntity.BaseUriChangeEntity>(condition);
        }
        ...
        public readonly struct BaseUriChangeEntity : Menes.IJsonValue, Menes.IJsonArray<BaseUriChangeEntity, Menes.JsonInteger>
        {
            public static readonly BaseUriChangeEntity Null = default(BaseUriChangeEntity);
            private readonly System.Text.Json.JsonElement _menesJsonElementBacking;
            private readonly System.Collections.Immutable.ImmutableArray<Menes.JsonInteger>? _menesArrayValueBacking;
            public BaseUriChangeEntity(System.Text.Json.JsonElement jsonElement)
            {
                this._menesJsonElementBacking = jsonElement;
                this._menesArrayValueBacking = default;
            }
            public BaseUriChangeEntity(System.Collections.Immutable.ImmutableArray<Menes.JsonInteger> value)
            {
                this._menesArrayValueBacking = value;
                this._menesJsonElementBacking = default;
            }
            public static implicit operator BaseUriChangeEntity(System.Collections.Immutable.ImmutableArray<Menes.JsonInteger> items)
            {
                return new RootEntity.BaseUriChangeEntity(items);
            }
            /// <inheritdoc />
            public bool IsUndefined => !this.HasJsonElement && this.AllBackingFieldsAreNull();
            /// <inheritdoc />
            ...
            public T As<T>()
                where T : struct, Menes.IJsonValue
            {
                if (typeof(T) == typeof(BaseUriChangeEntity))
                {
                    return Corvus.Extensions.CastTo<T>.From(this);
                }
                return Menes.JsonValue.As<BaseUriChangeEntity, T>(this);
            }
            /// <inheritdoc />
            public bool Is<T>()
                where T : struct, Menes.IJsonValue
            {
                if (typeof(T) == typeof(RootEntity.BaseUriChangeEntity))
                {
                    return this.Validate(Menes.ValidationContext.ValidContext).IsValid;
                }
                return this.As<T>().Validate(Menes.ValidationContext.ValidContext).IsValid;
            ...
            public RootEntity.BaseUriChangeEntity.MenesArrayEnumerator GetEnumerator()
            {
                return new RootEntity.BaseUriChangeEntity.MenesArrayEnumerator(this);
            }
            public RootEntity.BaseUriChangeEntity.MenesArrayEnumerator EnumerateArray()
            {
                return new RootEntity.BaseUriChangeEntity.MenesArrayEnumerator(this);
            }
            System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            ...
            public BaseUriChangeEntity Add<T1>(T1 item1)
                where T1 : struct, Menes.IJsonValue
            {
                ...
                return new RootEntity.BaseUriChangeEntity(arrayBuilder.ToImmutable());
            }
            public BaseUriChangeEntity Add<T1, T2>(T1 item1, T2 item2)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonInteger>();
            ...
            public BaseUriChangeEntity Add<T1, T2, T3>(T1 item1, T2 item2, T3 item3)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
                where T3 : struct, Menes.IJsonValue
            {
            ...
            public BaseUriChangeEntity Add<T1, T2, T3, T4>(T1 item1, T2 item2, T3 item3, T4 item4)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
                where T3 : struct, Menes.IJsonValue
                where T4 : struct, Menes.IJsonValue
            ...
            public BaseUriChangeEntity Add<T>(params T[] items)
                where T : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonInteger>();
                foreach (var oldItem in this._menesArrayValueBacking)
            ...
            public BaseUriChangeEntity Insert<T>(int index, T item1)
                where T : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonInteger>();
                int currentIndex = 0;
            ...
            public BaseUriChangeEntity Insert<T1, T2>(int index, T1 item1, T2 item2)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonInteger>();
            ...
            public BaseUriChangeEntity Insert<T1, T2, T3>(int index, T1 item1, T2 item2, T3 item3)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
                where T3 : struct, Menes.IJsonValue
            {
            ...
            public BaseUriChangeEntity Insert<T1, T2, T3, T4>(int index, T1 item1, T2 item2, T3 item3, T4 item4)
                where T1 : struct, Menes.IJsonValue
                where T2 : struct, Menes.IJsonValue
                where T3 : struct, Menes.IJsonValue
                where T4 : struct, Menes.IJsonValue
            ...
            public BaseUriChangeEntity Insert<T>(int index, params T[] items)
                where T : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonInteger>();
                int currentIndex = 0;
            ...
            public BaseUriChangeEntity RemoveAt(int index)
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonInteger>();
                int currentIndex = 0;
                bool removed = false;
            ...
            public BaseUriChangeEntity RemoveIf(System.Predicate<Menes.JsonInteger> condition)
            {
                return this.RemoveIf<Menes.JsonInteger>(condition);
            }
            public BaseUriChangeEntity RemoveIf<T>(System.Predicate<T> condition)
                where T : struct, Menes.IJsonValue
            {
                var arrayBuilder = System.Collections.Immutable.ImmutableArray.CreateBuilder<Menes.JsonInteger>();
                foreach (var item in this._menesArrayValueBacking)
            ...
            /// <summary>
            /// An enumerator for the array values in a <see cref="BaseUriChangeEntity"/>.
            /// </summary>
            public struct MenesArrayEnumerator : System.Collections.Generic.IEnumerable<Menes.JsonInteger>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<Menes.JsonInteger>, System.Collections.IEnumerator
            {
                ...
                /// </summary>
                /// <returns>An enumerator for the array values in a <see cref="BaseUriChangeEntity"/>.</returns>
        ...
        /// </summary>
        public struct MenesArrayEnumerator : System.Collections.Generic.IEnumerable<RootEntity.BaseUriChangeEntity>, System.Collections.IEnumerable, System.Collections.Generic.IEnumerator<RootEntity.BaseUriChangeEntity>, System.Collections.IEnumerator
        {
            ...
            /// <inheritdoc/>
            public RootEntity.BaseUriChangeEntity Current
            {
                get
                {
                    if (this.hasJsonEnumerator)
                    {
                        return new RootEntity.BaseUriChangeEntity(this.jsonEnumerator.Current);
                    }
                    else if (this.instance._menesArrayValueBacking is System.Collections.Immutable.ImmutableArray<RootEntity.BaseUriChangeEntity> array && this.index >= 0 && this.index < array.Length)
                    {
                        return array[this.index];
                    }
                    return default;
            ...
            public bool MoveNext()
            {
                ...
                else if (this.instance._menesArrayValueBacking is System.Collections.Immutable.ImmutableArray<RootEntity.BaseUriChangeEntity> array && this.index + 1 < array.Length)
                {
                    this.index++;
                    return true;
                }
