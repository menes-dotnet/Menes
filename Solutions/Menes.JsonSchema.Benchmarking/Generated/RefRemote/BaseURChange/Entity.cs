...
namespace RefRemoteFeature.BaseURChange
{
                ...
                IEquatable<Entity>
    {
        ...
        public static Entity From(params RefRemoteFeature.BaseURChange.BaseUriChange[] items)
        {
            return new Entity(items.Select(i => (JsonAny)i).ToImmutableList());
        }
        ...
        /// <returns>The new array created from the items.</returns>
        public static Entity From(RefRemoteFeature.BaseURChange.BaseUriChange item1)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Entity From(RefRemoteFeature.BaseURChange.BaseUriChange item1, RefRemoteFeature.BaseURChange.BaseUriChange item2)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Entity From(RefRemoteFeature.BaseURChange.BaseUriChange item1, RefRemoteFeature.BaseURChange.BaseUriChange item2, RefRemoteFeature.BaseURChange.BaseUriChange item3)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Entity From(RefRemoteFeature.BaseURChange.BaseUriChange item1, RefRemoteFeature.BaseURChange.BaseUriChange item2, RefRemoteFeature.BaseURChange.BaseUriChange item3, RefRemoteFeature.BaseURChange.BaseUriChange item4)
        {
        ...
        public void WriteTo(Utf8JsonWriter writer)
        {
            ...
            writer.WriteNullValue();
                ...
                /// <summary>
        /// Enumerate the items in the array as a <see cref="RefRemoteFeature.BaseURChange.BaseUriChange" />.
        /// </summary>
        public JsonArrayEnumerator<RefRemoteFeature.BaseURChange.BaseUriChange> EnumerateItems()
        {
            if (this.arrayBacking is ImmutableList<JsonAny> items)
            {
                return new JsonArrayEnumerator<RefRemoteFeature.BaseURChange.BaseUriChange>(items);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
            {
                return new JsonArrayEnumerator<RefRemoteFeature.BaseURChange.BaseUriChange>(this.jsonElementBacking);
            }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        result = arrayEnumerator.Current.As<RefRemoteFeature.BaseURChange.BaseUriChange>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
