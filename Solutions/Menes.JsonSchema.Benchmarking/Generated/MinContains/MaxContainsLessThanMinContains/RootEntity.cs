...
namespace MinContainsFeature.MaxContainsLessThanMinContains
{
...
{
    containsCount++;
        if (level == Menes.ValidationLevel.Flag && containsCount > 1)
        {
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.4.4.  maxContains - exceeded maximum of 1");
}
else
{
...
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.4.4.  maxContains - greater than maximum of 1");
}
else
{
    result = result.WithResult(isValid: false);
...
if (level >= Menes.ValidationLevel.Basic)
{
    result = result.WithResult(isValid: false, message: "6.4.5.  minContains - less than minimum of 3");
}
else
{
    result = result.WithResult(isValid: false);
