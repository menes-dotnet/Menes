...
namespace MinContainsFeature.MinContainsEquals1WithContains
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("minContains.json", "#/1/schema", "#/001/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinContainsFeature.MinContainsEquals1WithContains.RootEntity>();
        }
        /// <summary>
