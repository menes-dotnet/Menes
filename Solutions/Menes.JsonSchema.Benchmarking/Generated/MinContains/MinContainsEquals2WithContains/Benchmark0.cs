...
namespace MinContainsFeature.MinContainsEquals2WithContains
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("minContains.json", "#/2/schema", "#/002/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinContainsFeature.MinContainsEquals2WithContains.RootEntity>();
        }
        /// <summary>
