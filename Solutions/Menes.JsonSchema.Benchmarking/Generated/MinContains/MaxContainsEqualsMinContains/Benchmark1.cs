...
namespace MinContainsFeature.MaxContainsEqualsMinContains
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("minContains.json", "#/3/schema", "#/003/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinContainsFeature.MaxContainsEqualsMinContains.RootEntity>();
        }
        /// <summary>
