                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<MinContainsFeature.MaxContainsEqualsMinContains.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
                ...
                if (containsResult.IsValid)
                {
                    ...
                    containsCount++;
                                ...
                                if (level == ValidationLevel.Flag && containsCount > 2)
                    {
            ...
            if (containsCount > 2)
            {
                ...
                {
                    result = result.WithResult(isValid: false, $"6.4.4. maxContains - {containsCount} exceeds maximum number of matching items 2.");
                }
                else if (level >= ValidationLevel.Basic)
                {
                    result = result.WithResult(isValid: false, "6.4.4. maxContains - item count exceeds maximum number of matching items 2.");
                }
                else
                {
                    return result.WithResult(isValid: false);
