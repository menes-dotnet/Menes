...
namespace OpenapiFeature.RealWorldValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("openapi.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<OpenapiFeature.RealWorldValidation.Schema>();
        }
        /// <summary>
