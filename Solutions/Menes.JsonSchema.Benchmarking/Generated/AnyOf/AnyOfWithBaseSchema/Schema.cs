...
namespace AnyOfFeature.AnyOfWithBaseSchema
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity"/> from which to construct the value.</param>
        public Schema(AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity"/> from which to construct the value.</param>
        public Schema(AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
        /// Gets the value as a <see cref="AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity" />.
        /// </summary>
        public AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity AsAnyOf0Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity" />.
        /// </summary>
        public bool IsAnyOf0Entity
        {
            get
            {
                return ((AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity" />.
        /// </summary>
        public AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity AsAnyOf1Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity" />.
        /// </summary>
        public bool IsAnyOf1Entity
        {
            get
            {
                return ((AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity(Schema value)
        {
                                    if (value.ValueKind == JsonValueKind.String)
            {
                return new AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity(value.AsString);
            }
                                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity(Schema value)
        {
                                    if (value.ValueKind == JsonValueKind.String)
            {
                return new AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity(value.AsString);
            }
                                    return default;
        }
        ...
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult0 = this.As<AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf0Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext anyOfResult1 = this.As<AnyOfFeature.AnyOfWithBaseSchema.Schema.AnyOf1Entity>().Validate(validationContext.CreateChildContext(), level);
