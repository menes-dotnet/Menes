...
namespace AnyOfFeature.AnyOf
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="AnyOfFeature.AnyOf.Schema.AnyOf1Entity"/> from which to construct the value.</param>
        public Schema(AnyOfFeature.AnyOf.Schema.AnyOf1Entity conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="AnyOfFeature.AnyOf.Schema.AnyOf1Entity" />.
        /// </summary>
        public AnyOfFeature.AnyOf.Schema.AnyOf1Entity AsAnyOf1Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="AnyOfFeature.AnyOf.Schema.AnyOf1Entity" />.
        /// </summary>
        public bool IsAnyOf1Entity
        {
            get
            {
                return ((AnyOfFeature.AnyOf.Schema.AnyOf1Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="AnyOfFeature.AnyOf.Schema.AnyOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(AnyOfFeature.AnyOf.Schema.AnyOf1Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="AnyOfFeature.AnyOf.Schema.AnyOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AnyOfFeature.AnyOf.Schema.AnyOf1Entity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new AnyOfFeature.AnyOf.Schema.AnyOf1Entity(value.AsNumber);
            }
                    return default;
        }
        ...
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult1 = this.As<AnyOfFeature.AnyOf.Schema.AnyOf1Entity>().Validate(validationContext.CreateChildContext(), level);
