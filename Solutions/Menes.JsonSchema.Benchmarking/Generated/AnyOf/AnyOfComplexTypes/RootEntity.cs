...
namespace AnyOfFeature.AnyOfComplexTypes
{
...
public AnyOf0Entity(Menes.JsonInteger bar)
{
    this._menesJsonElementBacking = default;
this.bar = bar;
this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
}
private AnyOf0Entity(Menes.JsonInteger? bar, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
{
    this._menesJsonElementBacking = default;
this.bar = bar;
...
public AnyOf0Entity WithBar(Menes.JsonInteger value)
{
...
public AnyOf1Entity(Menes.JsonString foo)
{
    this._menesJsonElementBacking = default;
this.foo = foo;
this._menesAdditionalPropertiesBacking = System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>>.Empty;
}
private AnyOf1Entity(Menes.JsonString? foo, in System.Collections.Immutable.ImmutableArray<Menes.AdditionalProperty<Menes.JsonAny>> _menesAdditionalPropertiesBacking)
{
    this._menesJsonElementBacking = default;
this.foo = foo;
this._menesAdditionalPropertiesBacking = _menesAdditionalPropertiesBacking;
...
public AnyOf1Entity WithFoo(Menes.JsonString value)
{
...
int currentIndex = 0;
    if (currentIndex == index)
    {
        result = new Menes.Property<AnyOf1Entity>(this, _MenesFooJsonPropertyName);
      return true;
    }
    currentIndex++;
foreach (var property in this._menesAdditionalPropertiesBacking)
...
{
    return new AnyOf1Entity(this.foo, value);
}
/// <summary>
