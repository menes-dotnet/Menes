...
namespace AnyOfFeature.NestedAnyOfToCheckValidationSemantics
{
    public readonly struct RootEntity : Menes.IJsonValue
    {
        ...
        {
            return (Menes.JsonNull)(RootEntity.AnyOf0Entity)value;
        }
        public static implicit operator RootEntity(Menes.JsonNull value)
        {
            return (RootEntity)(RootEntity.AnyOf0Entity)value;
        }
        /// <inheritdoc />
        ...
        public readonly struct AnyOf0Entity : Menes.IJsonValue
        {
            ...
            public static implicit operator Menes.JsonNull(AnyOf0Entity value)
            {
                return value.As<Menes.JsonNull>();
            }
            public static implicit operator AnyOf0Entity(Menes.JsonNull value)
            {
                return value.As<RootEntity.AnyOf0Entity>();
            }
            /// <inheritdoc />
            ...
            public Menes.ValidationContext Validate(in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
            {
                ...
                result = ValidateAnyOf(this, result, level);
                return result;
                Menes.ValidationContext ValidateAnyOf(in RootEntity.AnyOf0Entity that, in Menes.ValidationContext validationContext, Menes.ValidationLevel level = Menes.ValidationLevel.Flag)
                {
                    Menes.ValidationContext result = validationContext;
                    ...
                    {
                        anyOfResult0 = anyOf0.Validate(validationContext.CreateChildContext("#/anyOf/0/anyOf/0"), level);
                    }
                    if (anyOfResult0.IsValid)
                    {
                        result = result.MergeChildContext(anyOfResult0, false);
