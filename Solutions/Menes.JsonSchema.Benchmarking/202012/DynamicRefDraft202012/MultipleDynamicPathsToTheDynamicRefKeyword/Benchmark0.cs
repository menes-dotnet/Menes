...
namespace DynamicRefDraft202012Feature.MultipleDynamicPathsToTheDynamicRefKeyword
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\dynamicRef.json", "#/10/schema", "#/010/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DynamicRefDraft202012Feature.MultipleDynamicPathsToTheDynamicRefKeyword.Main>();
        }
        /// <summary>
