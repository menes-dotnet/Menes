...
namespace DynamicRefDraft202012Feature.ADynamicRefWithIntermediateScopesThatDonTIncludeAMatchingDynamicAnchorShouldNotAffectDynamicScopeResolution
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\dynamicRef.json", "#/4/schema", "#/004/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DynamicRefDraft202012Feature.ADynamicRefWithIntermediateScopesThatDonTIncludeAMatchingDynamicAnchorShouldNotAffectDynamicScopeResolution.JsonStringArray>();
        }
        /// <summary>
