...
namespace DynamicRefDraft202012Feature.ADynamicRefThatInitiallyResolvesToASchemaWithoutAMatchingDynamicAnchorShouldBehaveLikeANormalRefToAnchor
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("dynamicRef.json", "#/9/schema", "#/009/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DynamicRefDraft202012Feature.ADynamicRefThatInitiallyResolvesToASchemaWithoutAMatchingDynamicAnchorShouldBehaveLikeANormalRefToAnchor.Root>();
        }
        /// <summary>
