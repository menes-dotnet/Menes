...
namespace PropertiesDraft202012Feature.PropertiesWithBooleanSchema
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public Menes.Json.JsonNotAny Bar
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  Menes.Json.JsonNotAny(result);
                    }
                }
        ...
        ,             Menes.Json.JsonNotAny? bar = null
        ...
        )
        {
                            ...
                            if (foo is Menes.Json.JsonAny foo__)
            {
                builder.Add(FooJsonPropertyName, foo__);
                    ...
                    if (bar is Menes.Json.JsonNotAny bar__)
            {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithBar(Menes.Json.JsonNotAny value)
        {
        ...
        {
            Menes.Json.JsonNotAny property = that.Bar;
            return property.Validate(validationContext, level);
        }
