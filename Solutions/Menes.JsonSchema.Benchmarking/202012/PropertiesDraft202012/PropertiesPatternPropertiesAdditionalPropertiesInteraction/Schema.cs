...
namespace PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction
{
                    ...
                    IEquatable<Schema>
    {
                ...
                /// <summary>
        /// A pattern property matching f.o producing a <see cref="PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction.Schema.FOEntity" />.
        /// </summary>
        ...
        /// {Property examples}.
        /// </example>
        public PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction.Schema.FooArray Foo
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction.Schema.FooArray(result);
                    }
                }
        ...
        /// {Property examples}.
        /// </example>
        public Menes.Json.JsonArray Bar
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  Menes.Json.JsonArray(result);
                    }
                }
        ...
        public static Schema Create(
                            PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction.Schema.FooArray? foo = null
        ,             Menes.Json.JsonArray? bar = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<string, JsonAny>();
                            if (foo is PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction.Schema.FooArray foo__)
            {
                builder.Add(FooJsonPropertyName, foo__);
            }
                    if (bar is Menes.Json.JsonArray bar__)
            {
        ...
        public Schema WithFoo(PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction.Schema.FooArray value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithBar(Menes.Json.JsonArray value)
        {
            ...
            private static ImmutableDictionary<Regex, Func<Property, ValidationContext, ValidationLevel, ValidationContext>> CreatePatternPropertiesValidators()
        {
            ImmutableDictionary<Regex, Func<Property, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    return property.ValueAs<PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction.Schema.FOEntity>().Validate(validationContext, level);
                });
        ...
        private static ImmutableDictionary<string, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction.Schema.FooArray property = that.Foo;
