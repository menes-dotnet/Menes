...
namespace PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction
{
                    ...
                    IEquatable<Schema>
    {
        ...
        {
            return that.ValueAs<PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction.Schema.FOEntity>().Validate(validationContext, level);
        }
