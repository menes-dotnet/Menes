...
namespace PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\properties.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<PropertiesDraft202012Feature.PropertiesPatternPropertiesAdditionalPropertiesInteraction.Schema>();
        }
        /// <summary>
