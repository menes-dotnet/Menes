...
namespace OneOfDraft202012Feature.OneOfWithBaseSchema
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\oneOf.json", "#/1/schema", "#/001/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<OneOfDraft202012Feature.OneOfWithBaseSchema.Schema>();
        }
        /// <summary>
