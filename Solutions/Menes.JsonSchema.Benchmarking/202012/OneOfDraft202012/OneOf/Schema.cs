...
namespace OneOfDraft202012Feature.OneOf
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity"/> from which to construct the value.</param>
        public Schema(OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity" />.
        /// </summary>
        public OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity AsOneOf1Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity" />.
        /// </summary>
        public bool IsOneOf1Entity
        {
            get
            {
                return ((OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity(value.AsNumber);
            }
                    return default;
        }
        ...
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult1 = this.As<OneOfDraft202012Feature.OneOf.Schema.OneOf1Entity>().Validate(validationContext.CreateChildContext(), level);
