...
namespace OneOfDraft202012Feature.NestedOneOfToCheckValidationSemantics
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\oneOf.json", "#/10/schema", "#/010/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<OneOfDraft202012Feature.NestedOneOfToCheckValidationSemantics.Schema>();
        }
        /// <summary>
