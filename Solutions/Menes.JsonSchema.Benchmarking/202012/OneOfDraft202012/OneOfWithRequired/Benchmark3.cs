...
namespace OneOfDraft202012Feature.OneOfWithRequired
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\oneOf.json", "#/8/schema", "#/008/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<OneOfDraft202012Feature.OneOfWithRequired.Schema>();
        }
        /// <summary>
