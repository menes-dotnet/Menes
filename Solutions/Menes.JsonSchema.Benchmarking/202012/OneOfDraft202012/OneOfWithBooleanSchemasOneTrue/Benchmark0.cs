...
namespace OneOfDraft202012Feature.OneOfWithBooleanSchemasOneTrue
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("oneOf.json", "#/3/schema", "#/003/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<OneOfDraft202012Feature.OneOfWithBooleanSchemasOneTrue.Schema>();
        }
        /// <summary>
