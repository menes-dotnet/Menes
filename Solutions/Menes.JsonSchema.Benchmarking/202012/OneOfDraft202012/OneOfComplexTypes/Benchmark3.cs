...
namespace OneOfDraft202012Feature.OneOfComplexTypes
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\oneOf.json", "#/6/schema", "#/006/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<OneOfDraft202012Feature.OneOfComplexTypes.Schema>();
        }
        /// <summary>
