...
namespace UriTemplateDraft202012Feature.FormatUriTemplate
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\uri-template.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UriTemplateDraft202012Feature.FormatUriTemplate.Schema>();
        }
        /// <summary>
