...
namespace MinimumDraft202012Feature.MinimumValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minimum.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinimumDraft202012Feature.MinimumValidation.Schema>();
        }
        /// <summary>
