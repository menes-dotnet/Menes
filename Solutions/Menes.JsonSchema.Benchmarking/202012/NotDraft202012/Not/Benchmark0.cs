...
namespace NotDraft202012Feature.Not
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("not.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<NotDraft202012Feature.Not.Schema>();
        }
        /// <summary>
