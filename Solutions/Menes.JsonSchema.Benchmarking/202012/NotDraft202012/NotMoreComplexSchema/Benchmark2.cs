...
namespace NotDraft202012Feature.NotMoreComplexSchema
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("not.json", "#/2/schema", "#/002/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<NotDraft202012Feature.NotMoreComplexSchema.Schema>();
        }
        /// <summary>
