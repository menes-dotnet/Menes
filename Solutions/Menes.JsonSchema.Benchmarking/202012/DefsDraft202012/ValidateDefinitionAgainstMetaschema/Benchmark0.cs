...
namespace DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\defs.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.Schema>();
        }
        /// <summary>
