...
namespace DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema
{
                    ...
                    IEquatable<Core>
    {
        ...
        public Core WithId(DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.Core.IdEntity value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Core WithAnchor(DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.Core.AnchorStringValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Core WithDynamicAnchor(DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.Core.AnchorStringValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Core WithVocabulary(DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.Core.VocabularyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Core WithDefs(DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.Core.DefsValue value)
        {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<Core, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<Core, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.Core.IdEntity property = that.Id;
                ...
                (that, validationContext, level) =>
                {
                    DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.Core.AnchorStringValue property = that.Anchor;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.Core.AnchorStringValue property = that.DynamicAnchor;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.Core.VocabularyValue property = that.Vocabulary;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.Core.DefsValue property = that.Defs;
                    return property.Validate(validationContext, level);
                });
