...
namespace DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema
{
                    ...
                    IEquatable<MetaData>
    {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithDeprecated(DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.MetaData.DeprecatedValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithReadOnly(DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.MetaData.ReadOnlyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithWriteOnly(DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.MetaData.WriteOnlyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithExamples(DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.MetaData.JsonAnyArray value)
        {
        ...
        private static ImmutableDictionary<string, Func<MetaData, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, Func<MetaData, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                (that, validationContext, level) =>
                {
                    DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.MetaData.DeprecatedValue property = that.Deprecated;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.MetaData.ReadOnlyValue property = that.ReadOnly;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.MetaData.WriteOnlyValue property = that.WriteOnly;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    DefsDraft202012Feature.ValidateDefinitionAgainstMetaschema.MetaData.JsonAnyArray property = that.Examples;
                    return property.Validate(validationContext, level);
                });
