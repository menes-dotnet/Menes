...
namespace RefRemoteDraft202012Feature.BaseURChangeChangeFolderInSubschema
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\refRemote.json", "#/5/schema", "#/005/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefRemoteDraft202012Feature.BaseURChangeChangeFolderInSubschema.ScopeChangeDefs2Json>();
        }
        /// <summary>
