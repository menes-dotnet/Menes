...
namespace RefRemoteDraft202012Feature.BaseURChangeChangeFolder
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\refRemote.json", "#/4/schema", "#/004/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefRemoteDraft202012Feature.BaseURChangeChangeFolder.ScopeChangeDefs1Json>();
        }
        /// <summary>
