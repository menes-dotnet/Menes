...
namespace RefRemoteDraft202012Feature.BaseURChange
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\refRemote.json", "#/3/schema", "#/003/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefRemoteDraft202012Feature.BaseURChange.Entity>();
        }
        /// <summary>
