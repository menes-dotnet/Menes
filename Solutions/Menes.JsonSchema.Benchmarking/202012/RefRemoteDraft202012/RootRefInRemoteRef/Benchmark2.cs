...
namespace RefRemoteDraft202012Feature.RootRefInRemoteRef
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\refRemote.json", "#/6/schema", "#/006/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefRemoteDraft202012Feature.RootRefInRemoteRef.Object>();
        }
        /// <summary>
