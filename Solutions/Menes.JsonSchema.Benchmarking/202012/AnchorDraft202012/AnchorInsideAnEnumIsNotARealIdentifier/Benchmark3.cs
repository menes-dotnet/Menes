...
namespace AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\anchor.json", "#/3/schema", "#/003/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema>();
        }
        /// <summary>
