...
namespace AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity"/> from which to construct the value.</param>
        public Schema(AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity" />.
        /// </summary>
        public AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity AsAnchorInEnumEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity" />.
        /// </summary>
        public bool IsAnchorInEnumEntity
        {
            get
            {
                return ((AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity(value.AsObject);
            }
                                                    return default;
        }
        ...
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult0 = this.As<AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema.AnchorInEnumEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext anyOfResult1 = this.As<Menes.Json.JsonString>().Validate(validationContext.CreateChildContext(), level);
    ...
    /// A type generated from a JsonSchema specification.
    /// </summary>
    public readonly struct AnchorInEnumEntity :
            IJsonObject<AnchorInEnumEntity>,
                    IEquatable<AnchorInEnumEntity>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AnchorInEnumEntity"/> struct.
        /// </summary>
        /// <param name="value">The backing <see cref="JsonElement"/>.</param>
        public AnchorInEnumEntity(JsonElement value)
        {
            this.jsonElementBacking = value;
                this.objectBacking = default;
                            }
        ...
        /// </summary>
        /// <param name="value">A property dictionary.</param>
        public AnchorInEnumEntity(ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.objectBacking = value;
                                        }
        ...
        /// </summary>
        /// <param name="jsonObject">The <see cref="JsonObject"/> from which to construct the value.</param>
        public AnchorInEnumEntity(JsonObject jsonObject)
        {
            if (jsonObject.HasJsonElement)
            {
                this.jsonElementBacking = jsonObject.AsJsonElement;
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AnchorInEnumEntity(JsonAny value)
        {
            if (value.HasJsonElement)
            {
                return new AnchorInEnumEntity(value.AsJsonElement);
            }

            return value.As<AnchorInEnumEntity>();
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonAny(AnchorInEnumEntity value)
        {
            return value.AsAny;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AnchorInEnumEntity(JsonObject value)
        {
            return new AnchorInEnumEntity(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonObject(AnchorInEnumEntity value)
        {
            return value.AsObject;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonEncodedText, JsonAny>(AnchorInEnumEntity  value)
        {
            return value.AsObject.AsPropertyDictionary;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AnchorInEnumEntity (ImmutableDictionary<JsonEncodedText, JsonAny> value)
        {
            return new AnchorInEnumEntity (value);
        }
        ...
        /// <param name="rhs">The right hand side of the comparison.</param>
        /// <returns>True if they are equal.</returns>
        public static bool operator ==(AnchorInEnumEntity lhs, AnchorInEnumEntity rhs)
        {
            return lhs.Equals(rhs);
        }
        ...
        /// <inheritdoc/>
        public bool Equals(AnchorInEnumEntity other)
        {
            JsonValueKind valueKind = this.ValueKind;
        ...
        /// <inheritdoc/>
        public AnchorInEnumEntity SetProperty<TValue>(JsonEncodedText name, TValue value)
            where TValue : IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Object || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public AnchorInEnumEntity RemoveProperty(JsonEncodedText name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
                return this.AsObject.RemoveProperty(name);
        ...
        /// <inheritdoc/>
        public AnchorInEnumEntity RemoveProperty(string name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
                return this.AsObject.RemoveProperty(name);
        ...
        /// <inheritdoc/>
        public AnchorInEnumEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
                return this.AsObject.RemoveProperty(name);
        ...
        /// <inheritdoc/>
        public AnchorInEnumEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
                return this.AsObject.RemoveProperty(utf8Name);
        ...
        public static class EnumValues
        {
            ...
            /// {Description}.
            /// </remarks>
            public static readonly AnchorInEnumEntity Item0 = JsonAny.Parse("{\r\n                            \"$anchor\": \"my_anchor\",\r\n                            \"type\": \"null\"\r\n                        }");
