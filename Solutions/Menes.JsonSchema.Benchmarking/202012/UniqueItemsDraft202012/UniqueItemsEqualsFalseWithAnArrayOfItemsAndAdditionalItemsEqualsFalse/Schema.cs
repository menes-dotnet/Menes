...
namespace UniqueItemsDraft202012Feature.UniqueItemsEqualsFalseWithAnArrayOfItemsAndAdditionalItemsEqualsFalse
{
                ...
                IEquatable<Schema>
    {
        ...
        public static Schema From(params Menes.Json.JsonNotAny[] items)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Menes.Json.JsonNotAny item1)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Menes.Json.JsonNotAny item1, Menes.Json.JsonNotAny item2)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Menes.Json.JsonNotAny item1, Menes.Json.JsonNotAny item2, Menes.Json.JsonNotAny item3)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Menes.Json.JsonNotAny item1, Menes.Json.JsonNotAny item2, Menes.Json.JsonNotAny item3, Menes.Json.JsonNotAny item4)
        {
