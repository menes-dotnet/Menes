...
namespace AdditionalPropertiesDraft202012Feature.AdditionalPropertiesBeingFalseDoesNotAllowOtherProperties
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\additionalProperties.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AdditionalPropertiesDraft202012Feature.AdditionalPropertiesBeingFalseDoesNotAllowOtherProperties.Schema>();
        }
        /// <summary>
