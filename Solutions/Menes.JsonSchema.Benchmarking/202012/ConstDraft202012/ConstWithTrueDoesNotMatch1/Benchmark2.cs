...
namespace ConstDraft202012Feature.ConstWithTrueDoesNotMatch1
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\const.json", "#/5/schema", "#/005/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstDraft202012Feature.ConstWithTrueDoesNotMatch1.Schema>();
        }
        /// <summary>
