...
namespace ConstDraft202012Feature.NulCharactersInStrings
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\const.json", "#/14/schema", "#/014/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstDraft202012Feature.NulCharactersInStrings.Schema>();
        }
        /// <summary>
