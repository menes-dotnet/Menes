...
namespace ConstDraft202012Feature.ConstWithObject
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\const.json", "#/1/schema", "#/001/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstDraft202012Feature.ConstWithObject.Schema>();
        }
        /// <summary>
