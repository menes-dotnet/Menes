...
namespace ConstDraft202012Feature.ConstWith1DoesNotMatchTrue
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\const.json", "#/11/schema", "#/011/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ConstDraft202012Feature.ConstWith1DoesNotMatchTrue.Schema>();
        }
        /// <summary>
