...
namespace RequiredDraft202012Feature.RequiredWithEscapedCharacters
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\required.json", "#/3/schema", "#/003/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RequiredDraft202012Feature.RequiredWithEscapedCharacters.Schema>();
        }
        /// <summary>
