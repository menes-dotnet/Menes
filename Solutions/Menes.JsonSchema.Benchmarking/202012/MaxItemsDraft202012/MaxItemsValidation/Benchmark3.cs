...
namespace MaxItemsDraft202012Feature.MaxItemsValidation
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\maxItems.json", "#/0/schema", "#/000/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MaxItemsDraft202012Feature.MaxItemsValidation.Schema>();
        }
        /// <summary>
