...
namespace IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity"/> from which to construct the value.</param>
        public Schema(IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity"/> from which to construct the value.</param>
        public Schema(IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
        /// Gets the value as a <see cref="IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity" />.
        /// </summary>
        public IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity AsThenEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity" />.
        /// </summary>
        public bool IsThenEntity
        {
            get
            {
                return ((IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity" />.
        /// </summary>
        public IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity AsElseEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity" />.
        /// </summary>
        public bool IsElseEntity
        {
            get
            {
                return ((IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity)this).Validate().IsValid;
            }
        }
        ...
        public bool IsIfMatchThenEntity
        {
            get
            {
                return this.As<Menes.Json.JsonAny>().IsValid(); 
            }
        }
        ...
        /// </summary>
        public IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity AsIfMatchThenEntity
        {
            get
            {
                return this.As<IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity>(); 
            }
        }
        ...
        /// </summary>
        public IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity AsElseMatchElseEntity
        {
            get
            {
                return this.As<IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity>(); 
            }
        }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity(Schema value)
        {
                                    if (value.ValueKind == JsonValueKind.String)
            {
                return new IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity(value.AsString);
            }
                                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity(Schema value)
        {
                                    if (value.ValueKind == JsonValueKind.String)
            {
                return new IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity(value.AsString);
            }
                                    return default;
        }
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            if (ifResult.IsValid)
            {
                ValidationContext thenResult = this.As<IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (!ifResult.IsValid)
            {
                ValidationContext elseResult = this.As<IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
