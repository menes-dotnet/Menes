...
namespace IfThenElseDraft202012Feature.IfAndThenWithoutElse
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.IfEntity"/> from which to construct the value.</param>
        public Schema(IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.IfEntity conversion)
        {
        ...
        public Schema(IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.ThenEntity conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.IfEntity" />.
        /// </summary>
        public IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.IfEntity AsIfEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.IfEntity" />.
        /// </summary>
        public bool IsIfEntity
        {
            get
            {
                return ((IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.IfEntity)this).Validate().IsValid;
            }
        }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.IfEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.IfEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.IfEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.IfEntity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new IfThenElseDraft202012Feature.IfAndThenWithoutElse.Schema.IfEntity(value.AsNumber);
            }
                    return default;
        }
            /// <summary>
