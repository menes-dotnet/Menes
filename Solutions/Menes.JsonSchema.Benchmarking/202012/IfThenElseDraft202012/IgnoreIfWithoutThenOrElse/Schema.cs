...
namespace IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity"/> from which to construct the value.</param>
        public Schema(IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity" />.
        /// </summary>
        public IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity AsIfEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity" />.
        /// </summary>
        public bool IsIfEntity
        {
            get
            {
                return ((IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity(value.AsNumber);
            }
                    return default;
        }
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<IfThenElseDraft202012Feature.IgnoreIfWithoutThenOrElse.Schema.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            IEquatable<IfEntity>
    {
            ...
            private static readonly IfEntity __MenesConstValue = JsonAny.Parse("0");
