...
namespace IfThenElseDraft202012Feature.IfAndElseWithoutThen
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity"/> from which to construct the value.</param>
        public Schema(IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity"/> from which to construct the value.</param>
        public Schema(IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
        /// Gets the value as a <see cref="IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity" />.
        /// </summary>
        public IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity AsIfEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity" />.
        /// </summary>
        public bool IsIfEntity
        {
            get
            {
                return ((IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity" />.
        /// </summary>
        public IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity AsElseEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity" />.
        /// </summary>
        public bool IsElseEntity
        {
            get
            {
                return ((IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity)this).Validate().IsValid;
            }
        }
        ...
        public bool IsElseMatchElseEntity
        {
            get
            {
                return !this.As<IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity>().IsValid(); 
            }
        }
        ...
        /// </summary>
        public IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity AsElseMatchElseEntity
        {
            get
            {
                return this.As<IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity>(); 
            }
        }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity(value.AsNumber);
            }
                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity(value.AsNumber);
            }
                    return default;
        }
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (!ifResult.IsValid)
            {
                ValidationContext elseResult = this.As<IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
