...
namespace IfThenElseDraft202012Feature.IfAndElseWithoutThen
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\if-then-else.json", "#/4/schema", "#/004/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema>();
        }
        /// <summary>
