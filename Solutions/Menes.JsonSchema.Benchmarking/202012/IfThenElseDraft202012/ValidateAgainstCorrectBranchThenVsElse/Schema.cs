...
namespace IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity"/> from which to construct the value.</param>
        public Schema(IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity"/> from which to construct the value.</param>
        public Schema(IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity"/> from which to construct the value.</param>
        public Schema(IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
        /// Gets the value as a <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity" />.
        /// </summary>
        public IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity AsIfEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity" />.
        /// </summary>
        public bool IsIfEntity
        {
            get
            {
                return ((IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity" />.
        /// </summary>
        public IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity AsThenEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity" />.
        /// </summary>
        public bool IsThenEntity
        {
            get
            {
                return ((IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity" />.
        /// </summary>
        public IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity AsElseEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity" />.
        /// </summary>
        public bool IsElseEntity
        {
            get
            {
                return ((IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity)this).Validate().IsValid;
            }
        }
        ...
        public bool IsIfMatchThenEntity
        {
            get
            {
                return this.As<IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity>().IsValid(); 
            }
        }
        ...
        /// </summary>
        public IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity AsIfMatchThenEntity
        {
            get
            {
                return this.As<IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity>(); 
            }
        }
        ...
        /// </summary>
        public IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity AsElseMatchElseEntity
        {
            get
            {
                return this.As<IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity>(); 
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity(value.AsNumber);
            }
                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity(value.AsNumber);
            }
                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity(value.AsNumber);
            }
                    return default;
        }
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (ifResult.IsValid)
            {
                ValidationContext thenResult = this.As<IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (!ifResult.IsValid)
            {
                ValidationContext elseResult = this.As<IfThenElseDraft202012Feature.ValidateAgainstCorrectBranchThenVsElse.Schema.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
