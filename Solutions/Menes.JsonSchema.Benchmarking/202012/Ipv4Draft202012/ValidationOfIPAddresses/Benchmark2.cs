...
namespace Ipv4Draft202012Feature.ValidationOfIPAddresses
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\ipv4.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<Ipv4Draft202012Feature.ValidationOfIPAddresses.Schema>();
        }
        /// <summary>
