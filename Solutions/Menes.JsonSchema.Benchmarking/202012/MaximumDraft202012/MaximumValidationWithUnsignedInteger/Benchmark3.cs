...
namespace MaximumDraft202012Feature.MaximumValidationWithUnsignedInteger
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\maximum.json", "#/1/schema", "#/001/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MaximumDraft202012Feature.MaximumValidationWithUnsignedInteger.Schema>();
        }
        /// <summary>
