...
namespace MaximumDraft202012Feature.MaximumValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\maximum.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MaximumDraft202012Feature.MaximumValidation.Schema>();
        }
        /// <summary>
