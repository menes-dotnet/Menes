...
namespace DefaultDraft202012Feature.InvalidStringValueForDefault
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\default.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DefaultDraft202012Feature.InvalidStringValueForDefault.Schema>();
        }
        /// <summary>
