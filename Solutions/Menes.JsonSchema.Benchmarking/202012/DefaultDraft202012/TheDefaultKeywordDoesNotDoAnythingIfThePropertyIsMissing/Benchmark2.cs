...
namespace DefaultDraft202012Feature.TheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissing
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\default.json", "#/2/schema", "#/002/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DefaultDraft202012Feature.TheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissing.Schema>();
        }
        /// <summary>
