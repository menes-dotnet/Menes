...
namespace DefaultDraft202012Feature.InvalidTypeForDefault
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\default.json", "#/0/schema", "#/000/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DefaultDraft202012Feature.InvalidTypeForDefault.Schema>();
        }
        /// <summary>
