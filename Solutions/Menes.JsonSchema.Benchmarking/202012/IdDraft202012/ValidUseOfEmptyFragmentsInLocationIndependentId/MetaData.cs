...
namespace IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId
{
                    ...
                    IEquatable<MetaData>
    {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithDeprecated(IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.MetaData.DeprecatedValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithReadOnly(IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.MetaData.ReadOnlyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithWriteOnly(IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.MetaData.WriteOnlyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithExamples(IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.MetaData.JsonAnyArray value)
        {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<MetaData, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<MetaData, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.MetaData.DeprecatedValue property = that.Deprecated;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.MetaData.ReadOnlyValue property = that.ReadOnly;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.MetaData.WriteOnlyValue property = that.WriteOnly;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.MetaData.JsonAnyArray property = that.Examples;
                    return property.Validate(validationContext, level);
                });
