...
namespace IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\id.json", "#/1/schema", "#/001/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.Schema>();
        }
        /// <summary>
