...
namespace IdDraft202012Feature.UnnormalizedIdsAreAllowedButDiscouraged
{
                    ...
                    IEquatable<Unevaluated>
    {
        ...
        public Unevaluated WithUnevaluatedItems(IdDraft202012Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Unevaluated WithUnevaluatedProperties(IdDraft202012Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema value)
        {
        ...
        private static ImmutableDictionary<string, Func<Unevaluated, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, Func<Unevaluated, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    IdDraft202012Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema property = that.UnevaluatedItems;
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema property = that.UnevaluatedProperties;
                    return property.Validate(validationContext, level);
                });
