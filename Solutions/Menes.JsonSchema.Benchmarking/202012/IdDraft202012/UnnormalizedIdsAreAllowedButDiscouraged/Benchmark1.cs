...
namespace IdDraft202012Feature.UnnormalizedIdsAreAllowedButDiscouraged
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\id.json", "#/2/schema", "#/002/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<IdDraft202012Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema>();
        }
        /// <summary>
