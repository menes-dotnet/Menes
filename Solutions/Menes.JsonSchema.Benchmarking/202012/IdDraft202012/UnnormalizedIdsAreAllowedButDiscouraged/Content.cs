...
namespace IdDraft202012Feature.UnnormalizedIdsAreAllowedButDiscouraged
{
                    ...
                    IEquatable<Content>
    {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Content WithContentSchema(IdDraft202012Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema value)
        {
        ...
        {
            IdDraft202012Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema property = that.ContentSchema;
            return property.Validate(validationContext, level);
        }
