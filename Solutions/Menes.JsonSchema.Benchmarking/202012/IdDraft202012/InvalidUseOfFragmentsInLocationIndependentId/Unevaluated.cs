...
namespace IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId
{
                    ...
                    IEquatable<Unevaluated>
    {
        ...
        public Unevaluated WithUnevaluatedItems(IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Unevaluated WithUnevaluatedProperties(IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Schema value)
        {
