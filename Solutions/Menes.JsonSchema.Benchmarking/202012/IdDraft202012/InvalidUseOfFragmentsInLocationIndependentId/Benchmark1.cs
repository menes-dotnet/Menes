...
namespace IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\id.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Schema>();
        }
        /// <summary>
