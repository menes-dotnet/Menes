            ...
            foreach (Property property in this.EnumerateObject())
            {
                string propertyName = property.Name;
                        ...
                        string propertyNameAsString = property.Name;
                            ...
                            result = new JsonString(propertyNameAsString).As<IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Applicator.PatternPropertiesValue.PropertyNamesEntity>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
