...
namespace IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId
{
                    ...
                    IEquatable<MetaData>
    {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithDeprecated(IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.MetaData.DeprecatedValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithReadOnly(IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.MetaData.ReadOnlyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithWriteOnly(IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.MetaData.WriteOnlyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public MetaData WithExamples(IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.MetaData.JsonAnyArray value)
        {
        ...
        private static ImmutableDictionary<string, Func<MetaData, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, Func<MetaData, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.MetaData.DeprecatedValue property = that.Deprecated;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.MetaData.ReadOnlyValue property = that.ReadOnly;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.MetaData.WriteOnlyValue property = that.WriteOnly;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.MetaData.JsonAnyArray property = that.Examples;
                    return property.Validate(validationContext, level);
                });
