...
namespace IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId
{
                    ...
                    IEquatable<Core>
    {
        ...
        public Core WithId(IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Core.IdEntity value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Core WithAnchor(IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Core.AnchorStringValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Core WithDynamicAnchor(IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Core.AnchorStringValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Core WithVocabulary(IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Core.VocabularyValue value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Core WithDefs(IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Core.DefsValue value)
        {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<Core, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<Core, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Core.IdEntity property = that.Id;
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Core.AnchorStringValue property = that.Anchor;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Core.AnchorStringValue property = that.DynamicAnchor;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Core.VocabularyValue property = that.Vocabulary;
                    return property.Validate(validationContext, level);
                });
                    builder.Add(
                ...
                (that, validationContext, level) =>
                {
                    IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Core.DefsValue property = that.Defs;
                    return property.Validate(validationContext, level);
                });
