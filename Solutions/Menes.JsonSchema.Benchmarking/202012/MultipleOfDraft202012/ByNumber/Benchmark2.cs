...
namespace MultipleOfDraft202012Feature.ByNumber
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\multipleOf.json", "#/1/schema", "#/001/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MultipleOfDraft202012Feature.ByNumber.Schema>();
        }
        /// <summary>
