...
namespace MinLengthDraft202012Feature.MinLengthValidation
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minLength.json", "#/0/schema", "#/000/tests/004/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinLengthDraft202012Feature.MinLengthValidation.Schema>();
        }
        /// <summary>
