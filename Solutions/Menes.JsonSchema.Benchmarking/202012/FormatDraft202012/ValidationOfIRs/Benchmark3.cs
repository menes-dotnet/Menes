...
namespace FormatDraft202012Feature.ValidationOfIRs
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/12/schema", "#/012/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfIRs.Schema>();
        }
        /// <summary>
