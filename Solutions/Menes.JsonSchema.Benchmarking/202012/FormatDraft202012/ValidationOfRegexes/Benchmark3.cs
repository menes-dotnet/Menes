...
namespace FormatDraft202012Feature.ValidationOfRegexes
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/2/schema", "#/002/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfRegexes.Schema>();
        }
        /// <summary>
