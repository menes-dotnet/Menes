...
namespace FormatDraft202012Feature.ValidationOfUUDs
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/17/schema", "#/017/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfUUDs.Schema>();
        }
        /// <summary>
