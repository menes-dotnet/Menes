...
namespace FormatDraft202012Feature.ValidationOfIPAddresses
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/3/schema", "#/003/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfIPAddresses.Schema>();
        }
        /// <summary>
