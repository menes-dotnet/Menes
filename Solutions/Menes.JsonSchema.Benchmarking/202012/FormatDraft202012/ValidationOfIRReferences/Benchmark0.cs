...
namespace FormatDraft202012Feature.ValidationOfIRReferences
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/13/schema", "#/013/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfIRReferences.Schema>();
        }
        /// <summary>
