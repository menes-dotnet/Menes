...
namespace FormatDraft202012Feature.ValidationOfURs
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/14/schema", "#/014/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfURs.Schema>();
        }
        /// <summary>
