...
namespace FormatDraft202012Feature.ValidationOfDurations
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/18/schema", "#/018/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfDurations.Schema>();
        }
        /// <summary>
