...
namespace FormatDraft202012Feature.ValidationOfURTemplates
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/16/schema", "#/016/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfURTemplates.Schema>();
        }
        /// <summary>
