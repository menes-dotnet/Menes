...
namespace FormatDraft202012Feature.ValidationOfIPv6Addresses
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/4/schema", "#/004/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfIPv6Addresses.Schema>();
        }
        /// <summary>
