...
namespace FormatDraft202012Feature.ValidationOfDateStrings
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/7/schema", "#/007/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfDateStrings.Schema>();
        }
        /// <summary>
