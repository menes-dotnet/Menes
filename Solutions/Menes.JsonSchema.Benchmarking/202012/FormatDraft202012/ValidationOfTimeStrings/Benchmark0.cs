...
namespace FormatDraft202012Feature.ValidationOfTimeStrings
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/9/schema", "#/009/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfTimeStrings.Schema>();
        }
        /// <summary>
