...
namespace FormatDraft202012Feature.ValidationOfJSNPointers
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/10/schema", "#/010/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfJSNPointers.Schema>();
        }
        /// <summary>
