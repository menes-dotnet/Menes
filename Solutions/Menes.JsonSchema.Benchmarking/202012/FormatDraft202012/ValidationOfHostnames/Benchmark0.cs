...
namespace FormatDraft202012Feature.ValidationOfHostnames
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/6/schema", "#/006/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<FormatDraft202012Feature.ValidationOfHostnames.Schema>();
        }
        /// <summary>
