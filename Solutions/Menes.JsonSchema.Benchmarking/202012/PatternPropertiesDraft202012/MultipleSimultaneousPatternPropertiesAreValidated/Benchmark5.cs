...
namespace PatternPropertiesDraft202012Feature.MultipleSimultaneousPatternPropertiesAreValidated
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\patternProperties.json", "#/1/schema", "#/001/tests/005/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<PatternPropertiesDraft202012Feature.MultipleSimultaneousPatternPropertiesAreValidated.Schema>();
        }
        /// <summary>
