...
namespace EnumDraft202012Feature.EnumWithEscapedCharacters
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/4/schema", "#/004/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft202012Feature.EnumWithEscapedCharacters.Schema>();
        }
        /// <summary>
