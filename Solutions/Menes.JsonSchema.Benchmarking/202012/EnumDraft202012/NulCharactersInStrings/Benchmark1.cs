...
namespace EnumDraft202012Feature.NulCharactersInStrings
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/9/schema", "#/009/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft202012Feature.NulCharactersInStrings.Schema>();
        }
        /// <summary>
