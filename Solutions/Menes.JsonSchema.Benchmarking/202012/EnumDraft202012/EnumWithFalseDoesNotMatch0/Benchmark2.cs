...
namespace EnumDraft202012Feature.EnumWithFalseDoesNotMatch0
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/5/schema", "#/005/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft202012Feature.EnumWithFalseDoesNotMatch0.Schema>();
        }
        /// <summary>
