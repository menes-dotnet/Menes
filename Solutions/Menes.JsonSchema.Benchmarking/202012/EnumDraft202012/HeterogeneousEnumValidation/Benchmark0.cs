...
namespace EnumDraft202012Feature.HeterogeneousEnumValidation
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/1/schema", "#/001/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft202012Feature.HeterogeneousEnumValidation.Schema>();
        }
        /// <summary>
