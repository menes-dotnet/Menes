...
namespace EnumDraft202012Feature.EnumWithTrueDoesNotMatch1
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/6/schema", "#/006/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft202012Feature.EnumWithTrueDoesNotMatch1.Schema>();
        }
        /// <summary>
