...
namespace EnumDraft202012Feature.EnumWith0DoesNotMatchFalse
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/7/schema", "#/007/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft202012Feature.EnumWith0DoesNotMatchFalse.Schema>();
        }
        /// <summary>
