...
namespace EnumDraft202012Feature.EnumWith1DoesNotMatchTrue
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/8/schema", "#/008/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<EnumDraft202012Feature.EnumWith1DoesNotMatchTrue.Schema>();
        }
        /// <summary>
