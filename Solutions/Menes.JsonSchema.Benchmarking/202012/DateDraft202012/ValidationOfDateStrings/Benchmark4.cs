...
namespace DateDraft202012Feature.ValidationOfDateStrings
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\date.json", "#/0/schema", "#/000/tests/004/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<DateDraft202012Feature.ValidationOfDateStrings.Schema>();
        }
        /// <summary>
