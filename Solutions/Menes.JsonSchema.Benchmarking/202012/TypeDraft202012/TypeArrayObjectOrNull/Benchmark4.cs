...
namespace TypeDraft202012Feature.TypeArrayObjectOrNull
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\type.json", "#/10/schema", "#/010/tests/004/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<TypeDraft202012Feature.TypeArrayObjectOrNull.Schema>();
        }
        /// <summary>
