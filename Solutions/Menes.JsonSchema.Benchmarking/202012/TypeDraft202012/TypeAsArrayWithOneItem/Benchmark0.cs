...
namespace TypeDraft202012Feature.TypeAsArrayWithOneItem
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\type.json", "#/8/schema", "#/008/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<TypeDraft202012Feature.TypeAsArrayWithOneItem.Schema>();
        }
        /// <summary>
