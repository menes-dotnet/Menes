...
namespace ItemsDraft202012Feature.ItemsWithBooleanSchemaTrue
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\items.json", "#/1/schema", "#/001/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ItemsDraft202012Feature.ItemsWithBooleanSchemaTrue.Schema>();
        }
        /// <summary>
