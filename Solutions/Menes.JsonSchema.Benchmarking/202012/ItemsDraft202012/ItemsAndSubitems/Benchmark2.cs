...
namespace ItemsDraft202012Feature.ItemsAndSubitems
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\items.json", "#/3/schema", "#/003/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ItemsDraft202012Feature.ItemsAndSubitems.JsonNotAnyArray>();
        }
        /// <summary>
