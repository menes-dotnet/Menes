...
namespace ItemsDraft202012Feature.ItemsAndSubitems
{
                ...
                IEquatable<JsonNotAnyArray>
    {
        ...
        public static JsonNotAnyArray From(params Menes.Json.JsonNotAny[] items)
        {
            return new JsonNotAnyArray(items.Select(i => (JsonAny)i).ToImmutableList());
        }
        ...
        /// <returns>The new array created from the items.</returns>
        public static JsonNotAnyArray From(Menes.Json.JsonNotAny item1)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static JsonNotAnyArray From(Menes.Json.JsonNotAny item1, Menes.Json.JsonNotAny item2)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static JsonNotAnyArray From(Menes.Json.JsonNotAny item1, Menes.Json.JsonNotAny item2, Menes.Json.JsonNotAny item3)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static JsonNotAnyArray From(Menes.Json.JsonNotAny item1, Menes.Json.JsonNotAny item2, Menes.Json.JsonNotAny item3, Menes.Json.JsonNotAny item4)
        {
        ...
        {
            if (obj is JsonNotAnyArray entity)
            {
        ...
        public void WriteTo(Utf8JsonWriter writer)
        {
            ...
            writer.WriteNullValue();
                ...
                /// <summary>
        /// Enumerate the items in the array as a <see cref="Menes.Json.JsonNotAny" />.
        /// </summary>
        public JsonArrayEnumerator<Menes.Json.JsonNotAny> EnumerateItems()
        {
            if (this.arrayBacking is ImmutableList<JsonAny> items)
            {
                return new JsonArrayEnumerator<Menes.Json.JsonNotAny>(items);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
            {
                return new JsonArrayEnumerator<Menes.Json.JsonNotAny>(this.jsonElementBacking);
            }
                ...
                IEquatable<ItemJsonNotAnyArray>
    {
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemJsonNotAnyArray From(params Menes.Json.JsonNotAny[] items)
        {
            return new ItemJsonNotAnyArray(items.Select(i => (JsonAny)i).ToImmutableList());
        }
        ...
        /// <param name="item1">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemJsonNotAnyArray From(Menes.Json.JsonNotAny item1)
        {
        ...
        /// <param name="item2">The second item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemJsonNotAnyArray From(Menes.Json.JsonNotAny item1, Menes.Json.JsonNotAny item2)
        {
        ...
        /// <param name="item3">The third item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemJsonNotAnyArray From(Menes.Json.JsonNotAny item1, Menes.Json.JsonNotAny item2, Menes.Json.JsonNotAny item3)
        {
        ...
        /// <param name="item4">The fourth item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ItemJsonNotAnyArray From(Menes.Json.JsonNotAny item1, Menes.Json.JsonNotAny item2, Menes.Json.JsonNotAny item3, Menes.Json.JsonNotAny item4)
        {
        ...
        public override bool Equals(object? obj)
        {
            if (obj is ItemJsonNotAnyArray entity)
            {
                return this.Equals(entity);
            }
