...
namespace ItemsDraft202012Feature.ASchemaGivenForItems
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\items.json", "#/0/schema", "#/000/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ItemsDraft202012Feature.ASchemaGivenForItems.Schema>();
        }
        /// <summary>
