...
namespace ItemsDraft202012Feature.NestedItems
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\items.json", "#/4/schema", "#/004/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ItemsDraft202012Feature.NestedItems.ItemsArrayArray>();
        }
        /// <summary>
