...
namespace ItemsDraft202012Feature.ItemsWithBooleanSchemaFalse
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\items.json", "#/2/schema", "#/002/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ItemsDraft202012Feature.ItemsWithBooleanSchemaFalse.Schema>();
        }
        /// <summary>
