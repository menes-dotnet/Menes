...
namespace AllOfDraft202012Feature.AllOfSimpleTypes
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\allOf.json", "#/2/schema", "#/002/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AllOfDraft202012Feature.AllOfSimpleTypes.Schema>();
        }
        /// <summary>
