...
namespace AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema.AllOf0Entity"/> from which to construct the value.</param>
        public Schema(AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema.AllOf0Entity conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema.AllOf0Entity" />.
        /// </summary>
        public AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema.AllOf0Entity AsAllOf0Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema.AllOf0Entity" />.
        /// </summary>
        public bool IsAllOf0Entity
        {
            get
            {
                return ((AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema.AllOf0Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema.AllOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema.AllOf0Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema.AllOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema.AllOf0Entity(Schema value)
        {
                                                    return default;
        }
        ...
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema.AllOf0Entity>().Validate(validationContext.CreateChildContext(), level);
