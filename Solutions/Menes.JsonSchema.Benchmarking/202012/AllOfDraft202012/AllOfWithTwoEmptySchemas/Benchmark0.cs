...
namespace AllOfDraft202012Feature.AllOfWithTwoEmptySchemas
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\allOf.json", "#/7/schema", "#/007/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AllOfDraft202012Feature.AllOfWithTwoEmptySchemas.Schema>();
        }
        /// <summary>
