...
namespace AllOfDraft202012Feature.AllOfWithBaseSchema
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\allOf.json", "#/1/schema", "#/001/tests/004/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AllOfDraft202012Feature.AllOfWithBaseSchema.Schema>();
        }
        /// <summary>
