...
namespace AllOfDraft202012Feature.AllOfWithBooleanSchemasAllFalse
{
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<Menes.Json.JsonNotAny>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult1 = this.As<Menes.Json.JsonNotAny>().Validate(validationContext.CreateChildContext(), level);
