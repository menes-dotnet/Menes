...
namespace AllOfDraft202012Feature.AllOfWithTheFirstEmptySchema
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\allOf.json", "#/8/schema", "#/008/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AllOfDraft202012Feature.AllOfWithTheFirstEmptySchema.Schema>();
        }
        /// <summary>
