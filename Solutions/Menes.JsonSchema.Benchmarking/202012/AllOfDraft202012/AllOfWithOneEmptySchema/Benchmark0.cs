...
namespace AllOfDraft202012Feature.AllOfWithOneEmptySchema
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\allOf.json", "#/6/schema", "#/006/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AllOfDraft202012Feature.AllOfWithOneEmptySchema.Schema>();
        }
        /// <summary>
