...
namespace UnevaluatedItemsDraft202012Feature.ItemIsEvaluatedInAnUncleSchemaToUnevaluatedItems
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\unevaluatedItems.json", "#/16/schema", "#/016/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedItemsDraft202012Feature.ItemIsEvaluatedInAnUncleSchemaToUnevaluatedItems.Schema>();
        }
        /// <summary>
