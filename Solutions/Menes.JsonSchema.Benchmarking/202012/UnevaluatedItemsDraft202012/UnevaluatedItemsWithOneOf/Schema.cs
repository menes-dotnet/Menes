...
namespace UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf
{
                ...
                IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity"/> from which to construct the value.</param>
        public Schema(UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity"/> from which to construct the value.</param>
        public Schema(UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
        ...
        public int Length
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity" />.
        /// </summary>
        public UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity AsOneOf0Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity" />.
        /// </summary>
        public bool IsOneOf0Entity
        {
            get
            {
                return ((UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity" />.
        /// </summary>
        public UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity AsOneOf1Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity" />.
        /// </summary>
        public bool IsOneOf1Entity
        {
            get
            {
                return ((UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity(Schema value)
        {
                            if (value.ValueKind == JsonValueKind.Array)
            {
                return new UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity(value.AsArray);
            }
                                            return default;
        }
            /// <summary>
        /// Conversion from <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity(Schema value)
        {
                            if (value.ValueKind == JsonValueKind.Array)
            {
                return new UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity(value.AsArray);
            }
                                            return default;
        }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        result = arrayEnumerator.Current.As<UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.PrefixItems0Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
        ...
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        result = arrayEnumerator.Current.As<UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf0Entity.PrefixItems1Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        result = arrayEnumerator.Current.As<UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithOneOf.Schema.OneOf1Entity.PrefixItems1Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
            ...
            IEquatable<PrefixItems1Entity>
    {
            ...
            private static readonly PrefixItems1Entity __MenesConstValue = JsonAny.Parse("\"baz\"");
