...
namespace UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithAnyOf
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\unevaluatedItems.json", "#/9/schema", "#/009/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithAnyOf.Schema>();
        }
        /// <summary>
