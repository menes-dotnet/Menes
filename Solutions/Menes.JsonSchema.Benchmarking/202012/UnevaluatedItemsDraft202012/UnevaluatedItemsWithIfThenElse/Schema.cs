...
namespace UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse
{
                ...
                IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity"/> from which to construct the value.</param>
        public Schema(UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity conversion)
        {
        ...
        public int Length
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity" />.
        /// </summary>
        public UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity AsIfEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity" />.
        /// </summary>
        public bool IsIfEntity
        {
            get
            {
                return ((UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity)this).Validate().IsValid;
            }
        }
        ...
        public JsonNull AsNull
        {
            ...
            /// <summary>
        /// Conversion from <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity(Schema value)
        {
                            if (value.ValueKind == JsonValueKind.Array)
            {
                return new UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity(value.AsArray);
            }
                                            return default;
        }
            /// <summary>
            ...
            IEquatable<PrefixItems3Entity>
    {
            ...
            private static readonly PrefixItems3Entity __MenesConstValue = JsonAny.Parse("\"else\"");
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public PrefixItems3Entity(JsonEncodedText value)
        {
            this.jsonElementBacking = default;
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator PrefixItems3Entity(JsonEncodedText value)
        {
            return new PrefixItems3Entity(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator JsonEncodedText(PrefixItems3Entity value)
        {
            ...
            IEquatable<PrefixItems2Entity>
    {
            ...
            private static readonly PrefixItems2Entity __MenesConstValue = JsonAny.Parse("\"then\"");
