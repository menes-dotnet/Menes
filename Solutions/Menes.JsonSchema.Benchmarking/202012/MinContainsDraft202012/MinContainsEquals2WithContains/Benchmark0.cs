...
namespace MinContainsDraft202012Feature.MinContainsEquals2WithContains
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minContains.json", "#/2/schema", "#/002/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinContainsDraft202012Feature.MinContainsEquals2WithContains.Schema>();
        }
        /// <summary>
