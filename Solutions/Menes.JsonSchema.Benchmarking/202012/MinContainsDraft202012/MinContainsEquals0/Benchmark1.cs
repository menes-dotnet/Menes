...
namespace MinContainsDraft202012Feature.MinContainsEquals0
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minContains.json", "#/5/schema", "#/005/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinContainsDraft202012Feature.MinContainsEquals0.Schema>();
        }
        /// <summary>
