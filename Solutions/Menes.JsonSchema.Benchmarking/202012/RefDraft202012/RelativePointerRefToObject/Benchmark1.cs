...
namespace RefDraft202012Feature.RelativePointerRefToObject
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\ref.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefDraft202012Feature.RelativePointerRefToObject.Schema>();
        }
        /// <summary>
