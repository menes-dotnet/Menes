...
namespace RefDraft202012Feature.RootPointerRef
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public RefDraft202012Feature.RootPointerRef.Schema Foo
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefDraft202012Feature.RootPointerRef.Schema(result);
                    }
                }
        ...
        public static Schema Create(
                            RefDraft202012Feature.RootPointerRef.Schema? foo = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<string, JsonAny>();
                            if (foo is RefDraft202012Feature.RootPointerRef.Schema foo__)
            {
        ...
        public Schema WithFoo(RefDraft202012Feature.RootPointerRef.Schema value)
        {
        ...
        private static ImmutableDictionary<string, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    RefDraft202012Feature.RootPointerRef.Schema property = that.Foo;
