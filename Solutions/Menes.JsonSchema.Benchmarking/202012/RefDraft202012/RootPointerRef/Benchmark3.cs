...
namespace RefDraft202012Feature.RootPointerRef
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\ref.json", "#/0/schema", "#/000/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefDraft202012Feature.RootPointerRef.Schema>();
        }
        /// <summary>
