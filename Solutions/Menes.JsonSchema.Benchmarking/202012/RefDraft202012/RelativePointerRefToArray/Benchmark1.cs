...
namespace RefDraft202012Feature.RelativePointerRefToArray
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\ref.json", "#/2/schema", "#/002/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefDraft202012Feature.RelativePointerRefToArray.Schema>();
        }
        /// <summary>
