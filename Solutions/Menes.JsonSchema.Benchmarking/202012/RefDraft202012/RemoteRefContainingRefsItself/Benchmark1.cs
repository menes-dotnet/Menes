...
namespace RefDraft202012Feature.RemoteRefContainingRefsItself
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\ref.json", "#/6/schema", "#/006/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefDraft202012Feature.RemoteRefContainingRefsItself.Schema>();
        }
        /// <summary>
