...
namespace RefDraft202012Feature.RecursiveReferencesBetweenSchemas
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\ref.json", "#/11/schema", "#/011/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<RefDraft202012Feature.RecursiveReferencesBetweenSchemas.Tree>();
        }
        /// <summary>
