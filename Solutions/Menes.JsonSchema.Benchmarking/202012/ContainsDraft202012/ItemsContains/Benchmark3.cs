...
namespace ContainsDraft202012Feature.ItemsContains
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\contains.json", "#/4/schema", "#/004/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<ContainsDraft202012Feature.ItemsContains.Schema>();
        }
        /// <summary>
