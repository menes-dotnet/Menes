...
namespace ContainsDraft202012Feature.ItemsContains
{
                ...
                IEquatable<Schema>
    {
        ...
        public static Schema From(params ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity[] items)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity item1)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity item1, ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity item2)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity item1, ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity item2, ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity item3)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity item1, ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity item2, ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity item3, ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity item4)
        {
        ...
        public void WriteTo(Utf8JsonWriter writer)
        {
            ...
            writer.WriteNullValue();
                ...
                /// <summary>
        /// Enumerate the items in the array as a <see cref="ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity" />.
        /// </summary>
        public JsonArrayEnumerator<ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity> EnumerateItems()
        {
            if (this.arrayBacking is ImmutableList<JsonAny> items)
            {
                return new JsonArrayEnumerator<ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity>(items);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
            {
                return new JsonArrayEnumerator<ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity>(this.jsonElementBacking);
            }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<ContainsDraft202012Feature.ItemsContains.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
                ...
                if (containsResult.IsValid)
                {
                    ...
                    containsCount++;
                        ...
                        result = arrayEnumerator.Current.As<ContainsDraft202012Feature.ItemsContains.Schema.ItemsEntity>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
