...
namespace PatternDraft202012Feature.PatternValidation
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\pattern.json", "#/0/schema", "#/000/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<PatternDraft202012Feature.PatternValidation.Schema>();
        }
        /// <summary>
