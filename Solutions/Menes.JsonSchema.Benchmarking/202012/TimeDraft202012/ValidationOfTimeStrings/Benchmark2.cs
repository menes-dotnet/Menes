...
namespace TimeDraft202012Feature.ValidationOfTimeStrings
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\time.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<TimeDraft202012Feature.ValidationOfTimeStrings.Schema>();
        }
        /// <summary>
