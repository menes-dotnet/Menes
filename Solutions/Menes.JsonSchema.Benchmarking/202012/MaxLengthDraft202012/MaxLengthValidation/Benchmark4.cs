...
namespace MaxLengthDraft202012Feature.MaxLengthValidation
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\maxLength.json", "#/0/schema", "#/000/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MaxLengthDraft202012Feature.MaxLengthValidation.Schema>();
        }
        /// <summary>
