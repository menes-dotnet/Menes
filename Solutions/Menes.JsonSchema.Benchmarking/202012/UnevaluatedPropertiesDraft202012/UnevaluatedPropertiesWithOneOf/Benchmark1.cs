...
namespace UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithOneOf
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\unevaluatedProperties.json", "#/11/schema", "#/011/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithOneOf.Schema>();
        }
        /// <summary>
