...
namespace UnevaluatedPropertiesDraft202012Feature.NestedUnevaluatedPropertiesOuterFalseInnerTruePropertiesInside
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\unevaluatedProperties.json", "#/19/schema", "#/019/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedPropertiesDraft202012Feature.NestedUnevaluatedPropertiesOuterFalseInnerTruePropertiesInside.Schema>();
        }
        /// <summary>
