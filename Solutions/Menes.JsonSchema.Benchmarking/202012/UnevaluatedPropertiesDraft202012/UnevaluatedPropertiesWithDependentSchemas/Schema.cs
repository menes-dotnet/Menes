...
namespace UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithDependentSchemas
{
                    ...
                    IEquatable<Schema>
    {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>> CreateDependentSchemaValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<Schema, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                {
                    return entity.As<UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithDependentSchemas.Schema.FooEntity>().Validate(validationContext, level);
                });
                    ...
                    IEquatable<FooEntity>
    {
        ...
        /// {Property examples}.
        /// </example>
        public UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithDependentSchemas.Schema.FooEntity.BarEntity Bar
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<JsonEncodedText, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithDependentSchemas.Schema.FooEntity.BarEntity(result);
                    }
                }
        ...
        public static FooEntity Create(
                   UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithDependentSchemas.Schema.FooEntity.BarEntity bar
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public FooEntity WithBar(UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithDependentSchemas.Schema.FooEntity.BarEntity value)
        {
        ...
        private static ImmutableDictionary<JsonEncodedText, Func<FooEntity, ValidationContext, ValidationLevel, ValidationContext>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<JsonEncodedText, Func<FooEntity, ValidationContext, ValidationLevel, ValidationContext>>.Builder builder =
                ...
                (that, validationContext, level) =>
                {
                    UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithDependentSchemas.Schema.FooEntity.BarEntity property = that.Bar;
                    return property.Validate(validationContext, level);
                });
