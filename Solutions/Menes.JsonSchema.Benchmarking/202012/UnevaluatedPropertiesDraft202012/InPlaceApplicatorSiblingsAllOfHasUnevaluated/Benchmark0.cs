...
namespace UnevaluatedPropertiesDraft202012Feature.InPlaceApplicatorSiblingsAllOfHasUnevaluated
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\unevaluatedProperties.json", "#/25/schema", "#/025/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedPropertiesDraft202012Feature.InPlaceApplicatorSiblingsAllOfHasUnevaluated.Schema>();
        }
        /// <summary>
