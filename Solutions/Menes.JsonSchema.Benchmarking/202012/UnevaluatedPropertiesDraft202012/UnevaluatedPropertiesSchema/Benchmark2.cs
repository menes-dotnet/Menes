...
namespace UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesSchema
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\unevaluatedProperties.json", "#/1/schema", "#/001/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesSchema.Schema>();
        }
        /// <summary>
