...
namespace UnevaluatedPropertiesDraft202012Feature.NestedUnevaluatedPropertiesOuterTrueInnerFalsePropertiesOutside
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("unevaluatedProperties.json", "#/20/schema", "#/020/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedPropertiesDraft202012Feature.NestedUnevaluatedPropertiesOuterTrueInnerFalsePropertiesOutside.Schema>();
        }
        /// <summary>
