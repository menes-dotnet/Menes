...
namespace UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithNot
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\unevaluatedProperties.json", "#/12/schema", "#/012/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithNot.Schema>();
        }
        /// <summary>
