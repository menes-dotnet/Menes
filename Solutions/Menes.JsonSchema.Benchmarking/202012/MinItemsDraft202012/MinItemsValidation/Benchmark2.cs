...
namespace MinItemsDraft202012Feature.MinItemsValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minItems.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<MinItemsDraft202012Feature.MinItemsValidation.Schema>();
        }
        /// <summary>
