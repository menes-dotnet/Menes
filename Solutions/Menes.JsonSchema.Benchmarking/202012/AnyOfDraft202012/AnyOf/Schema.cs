...
namespace AnyOfDraft202012Feature.AnyOf
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity"/> from which to construct the value.</param>
        public Schema(AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity" />.
        /// </summary>
        public AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity AsAnyOf1Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity" />.
        /// </summary>
        public bool IsAnyOf1Entity
        {
            get
            {
                return ((AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity(Schema value)
        {
                                                    if (value.ValueKind == JsonValueKind.Number)
            {
                return new AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity(value.AsNumber);
            }
                    return default;
        }
        ...
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult1 = this.As<AnyOfDraft202012Feature.AnyOf.Schema.AnyOf1Entity>().Validate(validationContext.CreateChildContext(), level);
