...
namespace AnyOfDraft202012Feature.AnyOfWithBaseSchema
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\anyOf.json", "#/1/schema", "#/001/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AnyOfDraft202012Feature.AnyOfWithBaseSchema.Schema>();
        }
        /// <summary>
