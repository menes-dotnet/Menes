...
namespace AnyOfDraft202012Feature.AnyOfComplexTypes
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\anyOf.json", "#/5/schema", "#/005/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AnyOfDraft202012Feature.AnyOfComplexTypes.Schema>();
        }
        /// <summary>
