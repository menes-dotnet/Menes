...
namespace AnyOfDraft202012Feature.AnyOfWithOneEmptySchema
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\anyOf.json", "#/6/schema", "#/006/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateMenesCore<AnyOfDraft202012Feature.AnyOfWithOneEmptySchema.Schema>();
        }
        /// <summary>
