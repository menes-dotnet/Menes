...
namespace Menes
{
    ...
    /// </summary>
    public readonly struct JsonRegex : IJsonValue
    {
        /// <summary>
        /// The null value.
        /// </summary>
        public static readonly JsonRegex Null = default;
        ...
        /// </summary>
        /// <param name="value">The backing string value.</param>
        public JsonRegex(ReadOnlyMemory<char> value)
        {
            this.value = value;
            this.JsonElement = default;
        }
        ...
        /// <summary>
        /// Gets the <see cref="JsonRegex"/> as a <see cref="ReadOnlyMemory{T}"/> of <see cref="char"/>.
        /// </summary>
        /// <returns>The <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Gets the <see cref="JsonRegex"/> as a <see cref="ReadOnlySpan{T}"/> of char.
        /// </summary>
        /// <returns>The <see cref="string"/>.</returns>
        ...
        private static bool Parse(string? regex)
        {
            if (regex is string r)
            {
                try
                {
                    _ = new Regex(r, RegexOptions.None);
                    return true;
                }
                catch (Exception)
                {
