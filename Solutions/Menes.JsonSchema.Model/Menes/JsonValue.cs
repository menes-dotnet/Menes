...
namespace Menes
{
    ...
    public static class JsonValue
    {
        ...
        /// <remarks>This may not be a valid instance. Call <see cref="IJsonValue.Validate(in ValidationContext, ValidationLevel, System.Collections.Generic.HashSet{string})"/> to determine whether it is or not, after construction.</remarks>
