...
namespace Menes
{
    ...
    public readonly struct JsonPointer : IJsonValue
    {
        ...
        /// </summary>
        /// <param name="value">The string value from which to convert.</param>
        public static implicit operator JsonPointer(ReadOnlyMemory<char> value)
        {
            return new JsonPointer(value);
        }
        ...
        /// </summary>
        /// <param name="value">The string value from which to convert.</param>
        public static implicit operator ReadOnlyMemory<char>(JsonPointer value)
        {
        ...
        {
            return new JsonPointer(value.ToArray());
        }
        ...
        public ValidationContext Validate(ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            if ((this.HasJsonElement && (this.JsonElement.ValueKind != JsonValueKind.String || !Parse(this.JsonElement.GetString()))) || (this.value is ReadOnlyMemory<char> value && !Parse(value.ToString())))
            {
                ...
                {
                    return validationContext.WithResult(isValid: false, message: $"6.1.1.  type - should have been 'string' with format 'json-pointer'.");
                }
                else
                {
